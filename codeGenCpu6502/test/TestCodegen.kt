...
//}
        ...
        sub.add(PtVariable("particleX", DataType.arrayFor(BaseDataType.UBYTE), ZeropageWish.DONTCARE, null, 3u, Position.DUMMY))
        sub.add(PtVariable("particleDX", DataType.arrayFor(BaseDataType.UBYTE), ZeropageWish.DONTCARE, null, 3u, Position.DUMMY))
