...
pointerdereference:  (prefix = scoped_identifier '.')? derefchain ('.' field = identifier fieldindex = arrayindex?)? ;           // TODO  this doesn't look pretty when dealing with the difference between a final ^^ at the end or not
