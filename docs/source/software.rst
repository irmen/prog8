...
`Assembler <https://codeberg.org/irmen/cx16assem>`_
    File-based assembler for the Commander X16.

`Chess <https://codeberg.org/irmen/cx16chess>`_
    Chess game for the Commander X16, with 2-player or computer opponent game modes.

`Image viewer <https://codeberg.org/irmen/cx16imageviewer>`_
...
`Paint program <https://codeberg.org/irmen/cx16paint>`_
...
`Rock Runner <https://codeberg.org/irmen/cx16rockrunner>`_
...
`Shell <https://codeberg.org/irmen/cx16shell>`_
    Unix like command shell for the Commander X16.

`Streaming Music Demo <https://codeberg.org/irmen/cx16musicdemo>`_
