...
//}
        ...
        sub.add(PtVariable("pi", DataType.forDt(BaseDataType.UBYTE), ZeropageWish.DONTCARE, PtNumber(BaseDataType.UBYTE, 0.0, Position.DUMMY), null, Position.DUMMY))
        ...
        sub.add(PtVariable("particleDX",
            DataType.arrayFor(BaseDataType.UBYTE),
            ZeropageWish.DONTCARE, null, 3u, Position.DUMMY))
        sub.add(PtVariable("xx", DataType.forDt(BaseDataType.WORD), ZeropageWish.DONTCARE, PtNumber(BaseDataType.WORD, 1.0, Position.DUMMY), null, Position.DUMMY))
...
//}
        ...
        val block = PtBlock("main", false, SourceCode.Generated("test"), PtBlock.Options(), Position.DUMMY)
        val sub = PtSub("start", emptyList(), null, Position.DUMMY)
        sub.add(PtVariable("f1", DataType.forDt(BaseDataType.FLOAT), ZeropageWish.DONTCARE, null, null, Position.DUMMY))
...
//}
        ...
        val block = PtBlock("main", false, SourceCode.Generated("test"), PtBlock.Options(), Position.DUMMY)
        val sub = PtSub("start", emptyList(), null, Position.DUMMY)
        sub.add(PtVariable("sb1", DataType.forDt(BaseDataType.BYTE), ZeropageWish.DONTCARE, null, null, Position.DUMMY))
        val if1 = PtIfElse(Position.DUMMY)
        val cmp1 = PtBinaryExpression("==", DataType.forDt(BaseDataType.BOOL), Position.DUMMY)
...
//}
        ...
        val block = PtBlock("main", false, SourceCode.Generated("test"), PtBlock.Options(), Position.DUMMY)
        val sub = PtSub("start", emptyList(), null, Position.DUMMY)
        sub.add(PtVariable("ub1", DataType.forDt(BaseDataType.UBYTE), ZeropageWish.DONTCARE, null, null, Position.DUMMY))
        val if1 = PtIfElse(Position.DUMMY)
        val cmp1 = PtBinaryExpression("==", DataType.forDt(BaseDataType.BOOL), Position.DUMMY)
