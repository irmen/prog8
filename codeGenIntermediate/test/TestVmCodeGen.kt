...
//}
        ...
        sub.add(PtVariable("pi", DataTypeFull.forDt(BaseDataType.UBYTE), ZeropageWish.DONTCARE, PtNumber(BaseDataType.UBYTE, 0.0, Position.DUMMY), null, Position.DUMMY))
        sub.add(PtVariable("particleX",
            DataTypeFull.arrayFor(BaseDataType.UBYTE),
            ZeropageWish.DONTCARE, null, 3u, Position.DUMMY))
        sub.add(PtVariable("particleDX",
            DataTypeFull.arrayFor(BaseDataType.UBYTE),
            ZeropageWish.DONTCARE, null, 3u, Position.DUMMY))
        sub.add(PtVariable("xx", DataTypeFull.forDt(BaseDataType.WORD), ZeropageWish.DONTCARE, PtNumber(BaseDataType.WORD, 1.0, Position.DUMMY), null, Position.DUMMY))

        val assign = PtAugmentedAssign("+=", Position.DUMMY)
        val target = PtAssignTarget(false, Position.DUMMY).also {
            val targetIdx = PtArrayIndexer(DataTypeFull.forDt(BaseDataType.UBYTE), Position.DUMMY).also { idx ->
        ...
        val value = PtArrayIndexer(DataTypeFull.forDt(BaseDataType.UBYTE), Position.DUMMY)
        ...
        val prefixTarget = PtAssignTarget(false, Position.DUMMY).also {
            it.add(PtIdentifier("main.start.xx", DataTypeFull.forDt(BaseDataType.WORD), Position.DUMMY))
        }
        prefixAssign.add(prefixTarget)
        prefixAssign.add(PtIdentifier("main.start.xx", DataTypeFull.forDt(BaseDataType.WORD), Position.DUMMY))
        ...
        cxregAssign.add(PtIdentifier("cx16.r0", DataTypeFull.forDt(BaseDataType.UWORD), Position.DUMMY))
        sub.add(cxregAssign)
        ...
        cx16block.add(PtMemMapped("r0", DataTypeFull.forDt(BaseDataType.UWORD), 100u, null, Position.DUMMY))
...
//}
        ...
        val block = PtBlock("main", false, SourceCode.Generated("test"), PtBlock.Options(), Position.DUMMY)
        val sub = PtSub("start", emptyList(), null, Position.DUMMY)
        sub.add(PtVariable("f1", DataTypeFull.forDt(BaseDataType.FLOAT), ZeropageWish.DONTCARE, null, null, Position.DUMMY))
        val if1 = PtIfElse(Position.DUMMY)
        val cmp1 = PtBinaryExpression("==", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp1.add(PtIdentifier("main.start.f1", DataTypeFull.forDt(BaseDataType.FLOAT), Position.DUMMY))
        ...
        val cmp2 = PtBinaryExpression("!=", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp2.add(PtIdentifier("main.start.f1", DataTypeFull.forDt(BaseDataType.FLOAT), Position.DUMMY))
        ...
        val cmp3 = PtBinaryExpression("<", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp3.add(PtIdentifier("main.start.f1", DataTypeFull.forDt(BaseDataType.FLOAT), Position.DUMMY))
        ...
        val cmp4 = PtBinaryExpression(">", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp4.add(PtIdentifier("main.start.f1", DataTypeFull.forDt(BaseDataType.FLOAT), Position.DUMMY))
...
//}
        ...
        val block = PtBlock("main", false, SourceCode.Generated("test"), PtBlock.Options(), Position.DUMMY)
        val sub = PtSub("start", emptyList(), null, Position.DUMMY)
        sub.add(PtVariable("sb1", DataTypeFull.forDt(BaseDataType.BYTE), ZeropageWish.DONTCARE, null, null, Position.DUMMY))
        val if1 = PtIfElse(Position.DUMMY)
        val cmp1 = PtBinaryExpression("==", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp1.add(PtIdentifier("main.start.sb1", DataTypeFull.forDt(BaseDataType.BYTE), Position.DUMMY))
        ...
        val if2 = PtIfElse(Position.DUMMY)
        val cmp2 = PtBinaryExpression("!=", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp2.add(PtIdentifier("main.start.sb1", DataTypeFull.forDt(BaseDataType.BYTE), Position.DUMMY))
        ...
        val if3 = PtIfElse(Position.DUMMY)
        val cmp3 = PtBinaryExpression("<", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp3.add(PtIdentifier("main.start.sb1", DataTypeFull.forDt(BaseDataType.BYTE), Position.DUMMY))
        ...
        val if4 = PtIfElse(Position.DUMMY)
        val cmp4 = PtBinaryExpression(">", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp4.add(PtIdentifier("main.start.sb1", DataTypeFull.forDt(BaseDataType.BYTE), Position.DUMMY))
...
//}
        ...
        val block = PtBlock("main", false, SourceCode.Generated("test"), PtBlock.Options(), Position.DUMMY)
        val sub = PtSub("start", emptyList(), null, Position.DUMMY)
        sub.add(PtVariable("ub1", DataTypeFull.forDt(BaseDataType.UBYTE), ZeropageWish.DONTCARE, null, null, Position.DUMMY))
        val if1 = PtIfElse(Position.DUMMY)
        val cmp1 = PtBinaryExpression("==", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp1.add(PtIdentifier("main.start.ub1", DataTypeFull.forDt(BaseDataType.UBYTE), Position.DUMMY))
        ...
        val if2 = PtIfElse(Position.DUMMY)
        val cmp2 = PtBinaryExpression(">", DataTypeFull.forDt(BaseDataType.BOOL), Position.DUMMY)
        cmp2.add(PtIdentifier("main.start.ub1", DataTypeFull.forDt(BaseDataType.UBYTE), Position.DUMMY))
...
//}
        ...
        block.add(romsub)
        val sub = PtSub("start", emptyList(), null, Position.DUMMY)
        val call = PtFunctionCall("main.routine", true, DataTypeFull.forDt(BaseDataType.UNDEFINED), Position.DUMMY)
        sub.add(call)
        block.add(sub)
        program.add(block)
