...
coroutines {
    ...
    sub yield() -> pointer {
        ...
        pointer task_return_address
        tasklist[active_task] = popl()

skip_task:
        if not next_task() {
            void popl()     ; remove return to the termination handler
