...
graphics {
    ...
    const ubyte PLNCNTMSK = $0007
    const ubyte PLNCNTSHFT = $000c
    const ubyte PF2PRI = $0040
    const uword COLORON = $0200
    const uword DBLPF = $0400
    const uword HOLDNMODIFY = $0800
    const ubyte INTERLACE = $0004
    const ubyte PFA_FINE_SCROLL = $000f
    const ubyte PFB_FINE_SCROLL_SHIFT = $0004
    const ubyte PF_FINE_SCROLL_MASK = $000f
    const ubyte DIW_HORIZ_POS = $007f
    const uword DIW_VRTCL_POS = $01ff
    const ubyte DIW_VRTCL_POS_SHIFT = $0007
    const ubyte DFTCH_MASK = $00ff
    ...
    const ubyte DI_AVAIL_NOCHIPS = $0001
    const ubyte DI_AVAIL_NOMONITOR = $0002
    const ubyte DI_AVAIL_NOTWITHGENLOCK = $0004
    const ubyte DIPF_IS_LACE = $0001
    const ubyte DIPF_IS_DUALPF = $0002
    const ubyte DIPF_IS_PF2PRI = $0004
    const ubyte DIPF_IS_HAM = $0008
    const ubyte DIPF_IS_ECS = $0010
    const long DIPF_IS_AA = $00010000
    const ubyte DIPF_IS_PAL = $0020
    const ubyte DIPF_IS_SPRITES = $0040
    const ubyte DIPF_IS_GENLOCK = $0080
    const uword DIPF_IS_WB = $0100
    const uword DIPF_IS_DRAGGABLE = $0200
    const uword DIPF_IS_PANELLED = $0400
    const uword DIPF_IS_BEAMSYNC = $0800
    const uword DIPF_IS_EXTRAHALFBRITE = $1000
    const uword DIPF_IS_SPRITES_ATT = $2000
    const uword DIPF_IS_SPRITES_CHNG_RES = $4000
    const uword DIPF_IS_SPRITES_BORDER = $8000
    ...
    const ubyte LAYERUPDATING = $0010
    const ubyte LAYERBACKDROP = $0040
    const ubyte LAYERREFRESH = $0080
    const uword LAYERIREFRESH = $0200
    const uword LAYERIREFRESH2 = $0400
    const uword LAYER_CLIPRECTS_LOST = $0100
    const uword LAYERSAVEBACK = $0800
    ...
    const ubyte STANDARD_VIEW_X = $0081
    const ubyte STANDARD_VIEW_Y = $002c
    ...
    const ubyte BORDER_SPRITES = $0040
