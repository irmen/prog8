...
exec {
    ...
    const uword AO_ExecLib = $8001
    const uword AO_GraphicsLib = $8002
    const uword AO_LayersLib = $8003
    const uword AO_Intuition = $8004
    const uword AO_MathLib = $8005
    const uword AO_DOSLib = $8007
    const uword AO_RAMLib = $8008
    const uword AO_IconLib = $8009
    const uword AO_ExpansionLib = $800a
    const uword AO_DiskfontLib = $800b
    const uword AO_UtilityLib = $800c
    const uword AO_KeyMapLib = $800d
    const uword AO_AudioDev = $8010
    const uword AO_ConsoleDev = $8011
    const uword AO_GamePortDev = $8012
    const uword AO_KeyboardDev = $8013
    const uword AO_TrackDiskDev = $8014
    const uword AO_TimerDev = $8015
    const uword AO_CIARsrc = $8020
    const uword AO_DiskRsrc = $8021
    const uword AO_MiscRsrc = $8022
    const uword AO_BootStrap = $8030
    const uword AO_Workbench = $8031
    const uword AO_DiskCopy = $8032
    const uword AO_GadTools = $8033
    const uword AO_Unknown = $8035
