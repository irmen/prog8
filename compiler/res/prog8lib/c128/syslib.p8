...
extsub $FF7A = INDCMP(ubyte value @A, ubyte bank @X, ubyte offset @Y) clobbers(X) -> bool @Pc, bool @Pv, bool @Pz; compare byte in another bank (address in zp, ptr in $02c8)
