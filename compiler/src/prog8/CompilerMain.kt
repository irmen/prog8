...
private fun compileMain(args: Array<String>): Boolean {
    ...
    val sourceDirs by cli.option(ArgType.String, fullName="srcdirs", description = "list of extra paths, separated with ${File.pathSeparator}, to search in for imported modules (prepends to list)").multiple().delimiter(File.pathSeparator)
