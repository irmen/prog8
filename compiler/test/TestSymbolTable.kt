...
class TestSymbolTable: FunSpec({
    ...
    test("static vars") {
        ...
        val stVar1 = StStaticVariable("initialized", DataType.forDt(BaseDataType.UBYTE), 99.0, null, null, null, ZeropageWish.DONTCARE, node)
        val stVar2 = StStaticVariable("uninitialized", DataType.forDt(BaseDataType.UBYTE), null, null, null, null, ZeropageWish.DONTCARE, node)
        ...
        val stVar3 = StStaticVariable("initialized", DataType.arrayFor(BaseDataType.UWORD), null, null, arrayInitNonzero, 3, ZeropageWish.DONTCARE, node)
        val stVar4 = StStaticVariable("initialized", DataType.arrayFor(BaseDataType.UWORD), null, null, arrayInitAllzero, 3, ZeropageWish.DONTCARE, node)
        val stVar5 = StStaticVariable("uninitialized", DataType.arrayFor(BaseDataType.UWORD), null, null, null, 3, ZeropageWish.DONTCARE, node)
...
private fun makeSt(): SymbolTable {
    ...
    val astSub1v1 = PtVariable("v1", DataType.forDt(BaseDataType.BYTE), ZeropageWish.DONTCARE, null, null, Position.DUMMY)
    val astSub1v2 = PtVariable("v2", DataType.forDt(BaseDataType.BYTE), ZeropageWish.DONTCARE,null, null, Position.DUMMY)
    val astSub1v3 = PtVariable("v3", DataType.forDt(BaseDataType.FLOAT), ZeropageWish.DONTCARE,null, null, Position.DUMMY)
    val astSub1v4 = PtVariable("slab1", DataType.forDt(BaseDataType.UWORD), ZeropageWish.DONTCARE,null, null, Position.DUMMY)
    val astSub2v1 = PtVariable("v1", DataType.forDt(BaseDataType.BYTE), ZeropageWish.DONTCARE,null, null, Position.DUMMY)
    val astSub2v2 = PtVariable("v2", DataType.forDt(BaseDataType.BYTE), ZeropageWish.DONTCARE,null, null, Position.DUMMY)
    ...
    sub11.add(StStaticVariable("v1", DataType.forDt(BaseDataType.BYTE), null, null, null, null, ZeropageWish.DONTCARE, astSub1v1))
    sub11.add(StStaticVariable("v2", DataType.forDt(BaseDataType.BYTE), null, null, null, null, ZeropageWish.DONTCARE, astSub1v2))
    ...
    sub12.add(StStaticVariable("v1", DataType.forDt(BaseDataType.BYTE), null, null, null, null, ZeropageWish.DONTCARE, astSub2v1))
    sub12.add(StStaticVariable("v2", DataType.forDt(BaseDataType.BYTE), null, null, null, null, ZeropageWish.DONTCARE, astSub2v2))
