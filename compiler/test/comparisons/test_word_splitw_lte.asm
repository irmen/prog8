; w65c02 assembly code for 'test_word_splitw_lte'
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-03-13T21:14:52
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: test_word_splitw_lte.p8:8   main {
...
p8v_datatype	; PETSCII:"word"
	...
	; source: test_word_splitw_lte.p8:9   uword success = 0
	; source: test_word_splitw_lte.p8:10   str datatype = "word"
	; source: test_word_splitw_lte.p8:11   uword @shared comparison
	; source: test_word_splitw_lte.p8:13   sub start() {
...
; statements
	...
	lda  #13
	jsr  txt.chrout
	; source: test_word_splitw_lte.p8:17   test_stack.test()
	jsr  test_stack.test
	; source: test_word_splitw_lte.p8:18   txt.print("\n<=array[]: ")
	ldy  #>prog8_interned_strings.string_2
	lda  #<prog8_interned_strings.string_2
	jsr  txt.print
	; source: test_word_splitw_lte.p8:19   test_cmp_array()
	jsr  p8b_main.p8s_test_cmp_array
	; source: test_word_splitw_lte.p8:20   test_stack.test()
	jmp  test_stack.test
	; source: test_word_splitw_lte.p8:13   sub start() {
; variables
	.section BSS
	...
	.pend
	; source: test_word_splitw_lte.p8:23   sub verify_success(uword expected) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_expected+1
; statements
	; source: test_word_splitw_lte.p8:24   if success==expected {
	...
	bne  label_asm_2_else
	; source: test_word_splitw_lte.p8:25   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_word_splitw_lte.p8:27   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_4
	lda  #<prog8_interned_strings.string_4
	jsr  txt.print
	; source: test_word_splitw_lte.p8:28   txt.print_uw(success)
	ldy  p8b_main.p8v_success+1
	lda  p8b_main.p8v_success
	jsr  txt.print_uw
	; source: test_word_splitw_lte.p8:29   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_5
	lda  #<prog8_interned_strings.string_5
	jsr  txt.print
	; source: test_word_splitw_lte.p8:30   txt.print_uw(expected)
	ldy  p8v_expected+1
	lda  p8v_expected
	jsr  txt.print_uw
label_asm_1_afterif
...
p8v_expected	.word  ?
	.send BSS
	.pend
	; source: test_word_splitw_lte.p8:34   sub fail_word(uword idx) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_idx+1
; statements
	; source: test_word_splitw_lte.p8:35   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_6
	lda  #<prog8_interned_strings.string_6
	jsr  txt.print
	; source: test_word_splitw_lte.p8:36   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_word_splitw_lte.p8:37   txt.print(" **")
...
p8v_idx	.word  ?
	.send BSS
	.pend
	; source: test_word_splitw_lte.p8:47   sub test_cmp_array() {

p8s_test_cmp_array	.proc
; statements
	; source: test_word_splitw_lte.p8:48   word @shared x
	; source: test_word_splitw_lte.p8:49   word[] @split values = [0, 0]
	; source: test_word_splitw_lte.p8:50   word[] @split sources = [0, 0]
	; source: test_word_splitw_lte.p8:48   word @shared x
	stz  p8v_x
	stz  p8v_x+1
	; source: test_word_splitw_lte.p8:51   success = 0
	stz  p8b_main.p8v_success
	stz  p8b_main.p8v_success+1
	; source: test_word_splitw_lte.p8:52   x=-21829
	lda  #<-$5545
	ldy  #>-$5545
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_word_splitw_lte.p8:53   sources[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_sources_lsb,y
	lda  #>-$5545
	sta  p8v_sources_msb,y
	; source: test_word_splitw_lte.p8:54   values[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_values_lsb,y
	lda  #>-$5545
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:56   if x<=values[1]
	...
	eor  #128
+                           bmi  p8l_lbl1a
	; source: test_word_splitw_lte.p8:58   goto skip1a
	bra  p8l_skip1a
	; source: test_word_splitw_lte.p8:59   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:60   skip1a:
p8l_skip1a
	; source: test_word_splitw_lte.p8:62   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:63   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:65   goto skip1b
	bra  p8l_skip1b
	; source: test_word_splitw_lte.p8:66   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:67   skip1b:
p8l_skip1b
	; source: test_word_splitw_lte.p8:69   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_3_afterif
	; source: test_word_splitw_lte.p8:70   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_3_afterif
	; source: test_word_splitw_lte.p8:73   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_5_else
	; source: test_word_splitw_lte.p8:74   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_5_else
	; source: test_word_splitw_lte.p8:76   cx16.r0L++
	inc  cx16.r0L
label_asm_4_afterif
	; source: test_word_splitw_lte.p8:79   if sources[1]<=values[1]
	...
	eor  #128
+                           bmi  p8l_lbl1c
	; source: test_word_splitw_lte.p8:81   goto skip1c
	bra  p8l_skip1c
	; source: test_word_splitw_lte.p8:82   lbl1c:   success++
p8l_lbl1c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:83   skip1c:
p8l_skip1c
	; source: test_word_splitw_lte.p8:85   cx16.r3 = &lbl1d
	lda  #<p8l_lbl1d
	ldy  #>p8l_lbl1d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:86   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:88   goto skip1d
	bra  p8l_skip1d
	; source: test_word_splitw_lte.p8:89   lbl1d:   success++
p8l_lbl1d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:90   skip1d:
p8l_skip1d
	; source: test_word_splitw_lte.p8:92   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_6_afterif
	; source: test_word_splitw_lte.p8:93   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_6_afterif
	; source: test_word_splitw_lte.p8:96   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_8_else
	; source: test_word_splitw_lte.p8:97   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_8_else
	; source: test_word_splitw_lte.p8:99   cx16.r0L++
	inc  cx16.r0L
label_asm_7_afterif
	; source: test_word_splitw_lte.p8:101   values[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_values_lsb,y
	lda  #>-1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:103   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl2a
	; source: test_word_splitw_lte.p8:105   goto skip2a
	bra  p8l_skip2a
	; source: test_word_splitw_lte.p8:106   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:107   skip2a:
p8l_skip2a
	; source: test_word_splitw_lte.p8:109   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:110   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:112   goto skip2b
	bra  p8l_skip2b
	; source: test_word_splitw_lte.p8:113   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:114   skip2b:
p8l_skip2b
	; source: test_word_splitw_lte.p8:116   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_9_afterif
	; source: test_word_splitw_lte.p8:117   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_9_afterif
	; source: test_word_splitw_lte.p8:120   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_11_else
	; source: test_word_splitw_lte.p8:121   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_11_else
	; source: test_word_splitw_lte.p8:123   cx16.r0L++
	inc  cx16.r0L
label_asm_10_afterif
	; source: test_word_splitw_lte.p8:126   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl2c
	; source: test_word_splitw_lte.p8:128   goto skip2c
	bra  p8l_skip2c
	; source: test_word_splitw_lte.p8:129   lbl2c:   success++
p8l_lbl2c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:130   skip2c:
p8l_skip2c
	; source: test_word_splitw_lte.p8:132   cx16.r3 = &lbl2d
	lda  #<p8l_lbl2d
	ldy  #>p8l_lbl2d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:133   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:135   goto skip2d
	bra  p8l_skip2d
	; source: test_word_splitw_lte.p8:136   lbl2d:   success++
p8l_lbl2d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:137   skip2d:
p8l_skip2d
	; source: test_word_splitw_lte.p8:139   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_12_afterif
	; source: test_word_splitw_lte.p8:140   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_12_afterif
	; source: test_word_splitw_lte.p8:143   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_14_else
	; source: test_word_splitw_lte.p8:144   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_14_else
	; source: test_word_splitw_lte.p8:146   cx16.r0L++
	inc  cx16.r0L
label_asm_13_afterif
	; source: test_word_splitw_lte.p8:148   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:150   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl3a
	; source: test_word_splitw_lte.p8:152   goto skip3a
	bra  p8l_skip3a
	; source: test_word_splitw_lte.p8:153   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:154   skip3a:
p8l_skip3a
	; source: test_word_splitw_lte.p8:156   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:157   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:159   goto skip3b
	bra  p8l_skip3b
	; source: test_word_splitw_lte.p8:160   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:161   skip3b:
p8l_skip3b
	; source: test_word_splitw_lte.p8:163   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_15_afterif
	; source: test_word_splitw_lte.p8:164   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_15_afterif
	; source: test_word_splitw_lte.p8:167   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_17_else
	; source: test_word_splitw_lte.p8:168   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_17_else
	; source: test_word_splitw_lte.p8:170   cx16.r0L++
	inc  cx16.r0L
label_asm_16_afterif
	; source: test_word_splitw_lte.p8:173   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl3c
	; source: test_word_splitw_lte.p8:175   goto skip3c
	bra  p8l_skip3c
	; source: test_word_splitw_lte.p8:176   lbl3c:   success++
p8l_lbl3c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:177   skip3c:
p8l_skip3c
	; source: test_word_splitw_lte.p8:179   cx16.r3 = &lbl3d
	lda  #<p8l_lbl3d
	ldy  #>p8l_lbl3d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:180   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:182   goto skip3d
	bra  p8l_skip3d
	; source: test_word_splitw_lte.p8:183   lbl3d:   success++
p8l_lbl3d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:184   skip3d:
p8l_skip3d
	; source: test_word_splitw_lte.p8:186   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_18_afterif
	; source: test_word_splitw_lte.p8:187   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_18_afterif
	; source: test_word_splitw_lte.p8:190   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_20_else
	; source: test_word_splitw_lte.p8:191   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_20_else
	; source: test_word_splitw_lte.p8:193   cx16.r0L++
	inc  cx16.r0L
label_asm_19_afterif
	; source: test_word_splitw_lte.p8:195   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:197   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl4a
	; source: test_word_splitw_lte.p8:199   goto skip4a
	bra  p8l_skip4a
	; source: test_word_splitw_lte.p8:200   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:201   skip4a:
p8l_skip4a
	; source: test_word_splitw_lte.p8:203   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:204   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:206   goto skip4b
	bra  p8l_skip4b
	; source: test_word_splitw_lte.p8:207   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:208   skip4b:
p8l_skip4b
	; source: test_word_splitw_lte.p8:210   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_21_afterif
	; source: test_word_splitw_lte.p8:211   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_21_afterif
	; source: test_word_splitw_lte.p8:214   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_23_else
	; source: test_word_splitw_lte.p8:215   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_22_afterif
	; source: test_word_splitw_lte.p8:220   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl4c
	; source: test_word_splitw_lte.p8:222   goto skip4c
	bra  p8l_skip4c
	; source: test_word_splitw_lte.p8:223   lbl4c:   success++
p8l_lbl4c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:224   skip4c:
p8l_skip4c
	; source: test_word_splitw_lte.p8:226   cx16.r3 = &lbl4d
	lda  #<p8l_lbl4d
	ldy  #>p8l_lbl4d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:227   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:229   goto skip4d
	bra  p8l_skip4d
	; source: test_word_splitw_lte.p8:230   lbl4d:   success++
p8l_lbl4d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:231   skip4d:
p8l_skip4d
	; source: test_word_splitw_lte.p8:233   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_24_afterif
	; source: test_word_splitw_lte.p8:234   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_24_afterif
	; source: test_word_splitw_lte.p8:237   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_26_else
	; source: test_word_splitw_lte.p8:238   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_26_else
	; source: test_word_splitw_lte.p8:240   cx16.r0L++
	inc  cx16.r0L
label_asm_25_afterif
	; source: test_word_splitw_lte.p8:242   values[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_values_lsb,y
	lda  #>$aa
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:244   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl5a
	; source: test_word_splitw_lte.p8:246   goto skip5a
	bra  p8l_skip5a
	; source: test_word_splitw_lte.p8:247   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:248   skip5a:
p8l_skip5a
	; source: test_word_splitw_lte.p8:250   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:251   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:253   goto skip5b
	bra  p8l_skip5b
	; source: test_word_splitw_lte.p8:254   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:255   skip5b:
p8l_skip5b
	; source: test_word_splitw_lte.p8:257   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_27_afterif
	; source: test_word_splitw_lte.p8:258   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_27_afterif
	; source: test_word_splitw_lte.p8:261   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_29_else
	; source: test_word_splitw_lte.p8:262   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_29_else
	; source: test_word_splitw_lte.p8:264   cx16.r0L++
	inc  cx16.r0L
label_asm_28_afterif
	; source: test_word_splitw_lte.p8:267   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl5c
	; source: test_word_splitw_lte.p8:269   goto skip5c
	bra  p8l_skip5c
	; source: test_word_splitw_lte.p8:270   lbl5c:   success++
p8l_lbl5c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:271   skip5c:
p8l_skip5c
	; source: test_word_splitw_lte.p8:273   cx16.r3 = &lbl5d
	lda  #<p8l_lbl5d
	ldy  #>p8l_lbl5d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:274   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:276   goto skip5d
	bra  p8l_skip5d
	; source: test_word_splitw_lte.p8:277   lbl5d:   success++
p8l_lbl5d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:278   skip5d:
p8l_skip5d
	; source: test_word_splitw_lte.p8:280   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_30_afterif
	; source: test_word_splitw_lte.p8:281   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_30_afterif
	; source: test_word_splitw_lte.p8:284   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_32_else
	; source: test_word_splitw_lte.p8:285   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_32_else
	; source: test_word_splitw_lte.p8:287   cx16.r0L++
	inc  cx16.r0L
label_asm_31_afterif
	; source: test_word_splitw_lte.p8:289   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:291   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl6a
	; source: test_word_splitw_lte.p8:293   goto skip6a
	bra  p8l_skip6a
	; source: test_word_splitw_lte.p8:294   lbl6a:   success++
p8l_lbl6a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:295   skip6a:
p8l_skip6a
	; source: test_word_splitw_lte.p8:297   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:298   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:300   goto skip6b
	bra  p8l_skip6b
	; source: test_word_splitw_lte.p8:301   lbl6b:   success++
p8l_lbl6b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:302   skip6b:
p8l_skip6b
	; source: test_word_splitw_lte.p8:304   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_33_afterif
	; source: test_word_splitw_lte.p8:305   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_33_afterif
	; source: test_word_splitw_lte.p8:308   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_35_else
	; source: test_word_splitw_lte.p8:309   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_35_else
	; source: test_word_splitw_lte.p8:311   cx16.r0L++
	inc  cx16.r0L
label_asm_34_afterif
	; source: test_word_splitw_lte.p8:314   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl6c
	; source: test_word_splitw_lte.p8:316   goto skip6c
	bra  p8l_skip6c
	; source: test_word_splitw_lte.p8:317   lbl6c:   success++
p8l_lbl6c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:318   skip6c:
p8l_skip6c
	; source: test_word_splitw_lte.p8:320   cx16.r3 = &lbl6d
	lda  #<p8l_lbl6d
	ldy  #>p8l_lbl6d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:321   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:323   goto skip6d
	bra  p8l_skip6d
	; source: test_word_splitw_lte.p8:324   lbl6d:   success++
p8l_lbl6d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:325   skip6d:
p8l_skip6d
	; source: test_word_splitw_lte.p8:327   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_36_afterif
	; source: test_word_splitw_lte.p8:328   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_36_afterif
	; source: test_word_splitw_lte.p8:331   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_38_else
	; source: test_word_splitw_lte.p8:332   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_38_else
	; source: test_word_splitw_lte.p8:334   cx16.r0L++
	inc  cx16.r0L
label_asm_37_afterif
	; source: test_word_splitw_lte.p8:336   values[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_values_lsb,y
	lda  #>$7fff
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:338   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl7a
	; source: test_word_splitw_lte.p8:340   goto skip7a
	bra  p8l_skip7a
	; source: test_word_splitw_lte.p8:341   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:342   skip7a:
p8l_skip7a
	; source: test_word_splitw_lte.p8:344   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:345   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:347   goto skip7b
	bra  p8l_skip7b
	; source: test_word_splitw_lte.p8:348   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:349   skip7b:
p8l_skip7b
	; source: test_word_splitw_lte.p8:351   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_39_afterif
	; source: test_word_splitw_lte.p8:352   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_39_afterif
	; source: test_word_splitw_lte.p8:355   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_41_else
	; source: test_word_splitw_lte.p8:356   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_41_else
	; source: test_word_splitw_lte.p8:358   cx16.r0L++
	inc  cx16.r0L
label_asm_40_afterif
	; source: test_word_splitw_lte.p8:361   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl7c
	; source: test_word_splitw_lte.p8:363   goto skip7c
	bra  p8l_skip7c
	; source: test_word_splitw_lte.p8:364   lbl7c:   success++
p8l_lbl7c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:365   skip7c:
p8l_skip7c
	; source: test_word_splitw_lte.p8:367   cx16.r3 = &lbl7d
	lda  #<p8l_lbl7d
	ldy  #>p8l_lbl7d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:368   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:370   goto skip7d
	bra  p8l_skip7d
	; source: test_word_splitw_lte.p8:371   lbl7d:   success++
p8l_lbl7d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:372   skip7d:
p8l_skip7d
	; source: test_word_splitw_lte.p8:374   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_42_afterif
	; source: test_word_splitw_lte.p8:375   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_42_afterif
	; source: test_word_splitw_lte.p8:378   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_44_else
	; source: test_word_splitw_lte.p8:379   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_43_afterif
	; source: test_word_splitw_lte.p8:383   x=-1
	lda  #<-1
	ldy  #>-1
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_word_splitw_lte.p8:384   sources[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_sources_lsb,y
	lda  #>-1
	sta  p8v_sources_msb,y
	; source: test_word_splitw_lte.p8:385   values[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_values_lsb,y
	lda  #>-$5545
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:387   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl8a
	; source: test_word_splitw_lte.p8:389   goto skip8a
	bra  p8l_skip8a
	; source: test_word_splitw_lte.p8:390   lbl8a:   fail_word(1)
p8l_lbl8a
	ldy  #>1
	lda  #<1
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:391   skip8a:
p8l_skip8a
	; source: test_word_splitw_lte.p8:393   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:394   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:396   goto skip8b
	bra  p8l_skip8b
	; source: test_word_splitw_lte.p8:397   lbl8b:   fail_word(2)
p8l_lbl8b
	ldy  #>2
	lda  #<2
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:398   skip8b:
p8l_skip8b
	; source: test_word_splitw_lte.p8:400   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_45_afterif
	; source: test_word_splitw_lte.p8:401   fail_word(3)
	ldy  #>3
	lda  #<3
	jsr  p8b_main.p8s_fail_word
label_asm_45_afterif
	; source: test_word_splitw_lte.p8:404   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_47_else
	; source: test_word_splitw_lte.p8:405   fail_word(4)
	ldy  #>4
	lda  #<4
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_46_afterif
label_asm_47_else
	; source: test_word_splitw_lte.p8:407   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_46_afterif
	; source: test_word_splitw_lte.p8:410   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl8c
	; source: test_word_splitw_lte.p8:412   goto skip8c
	bra  p8l_skip8c
	; source: test_word_splitw_lte.p8:413   lbl8c:   fail_word(5)
p8l_lbl8c
	ldy  #>5
	lda  #<5
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:414   skip8c:
p8l_skip8c
	; source: test_word_splitw_lte.p8:416   cx16.r3 = &lbl8d
	lda  #<p8l_lbl8d
	ldy  #>p8l_lbl8d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:417   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:419   goto skip8d
	bra  p8l_skip8d
	; source: test_word_splitw_lte.p8:420   lbl8d:   fail_word(6)
p8l_lbl8d
	ldy  #>6
	lda  #<6
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:421   skip8d:
p8l_skip8d
	; source: test_word_splitw_lte.p8:423   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_48_afterif
	; source: test_word_splitw_lte.p8:424   fail_word(7)
	ldy  #>7
	lda  #<7
	jsr  p8b_main.p8s_fail_word
label_asm_48_afterif
	; source: test_word_splitw_lte.p8:427   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_50_else
	; source: test_word_splitw_lte.p8:428   fail_word(8)
	ldy  #>8
	lda  #<8
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_49_afterif
label_asm_50_else
	; source: test_word_splitw_lte.p8:430   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_49_afterif
	; source: test_word_splitw_lte.p8:432   values[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_values_lsb,y
	lda  #>-1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:434   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl9a
	; source: test_word_splitw_lte.p8:436   goto skip9a
	bra  p8l_skip9a
	; source: test_word_splitw_lte.p8:437   lbl9a:   success++
p8l_lbl9a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:438   skip9a:
p8l_skip9a
	; source: test_word_splitw_lte.p8:440   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:441   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:443   goto skip9b
	bra  p8l_skip9b
	; source: test_word_splitw_lte.p8:444   lbl9b:   success++
p8l_lbl9b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:445   skip9b:
p8l_skip9b
	; source: test_word_splitw_lte.p8:447   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_51_afterif
	; source: test_word_splitw_lte.p8:448   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_51_afterif
	; source: test_word_splitw_lte.p8:451   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_53_else
	; source: test_word_splitw_lte.p8:452   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_53_else
	; source: test_word_splitw_lte.p8:454   cx16.r0L++
	inc  cx16.r0L
label_asm_52_afterif
	; source: test_word_splitw_lte.p8:457   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl9c
	; source: test_word_splitw_lte.p8:459   goto skip9c
	bra  p8l_skip9c
	; source: test_word_splitw_lte.p8:460   lbl9c:   success++
p8l_lbl9c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:461   skip9c:
p8l_skip9c
	; source: test_word_splitw_lte.p8:463   cx16.r3 = &lbl9d
	lda  #<p8l_lbl9d
	ldy  #>p8l_lbl9d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:464   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:466   goto skip9d
	bra  p8l_skip9d
	; source: test_word_splitw_lte.p8:467   lbl9d:   success++
p8l_lbl9d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:468   skip9d:
p8l_skip9d
	; source: test_word_splitw_lte.p8:470   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_54_afterif
	; source: test_word_splitw_lte.p8:471   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_54_afterif
	; source: test_word_splitw_lte.p8:474   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_56_else
	; source: test_word_splitw_lte.p8:475   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_56_else
	; source: test_word_splitw_lte.p8:477   cx16.r0L++
	inc  cx16.r0L
label_asm_55_afterif
	; source: test_word_splitw_lte.p8:479   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:481   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl10a
	; source: test_word_splitw_lte.p8:483   goto skip10a
	bra  p8l_skip10a
	; source: test_word_splitw_lte.p8:484   lbl10a:   success++
p8l_lbl10a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:485   skip10a:
p8l_skip10a
	; source: test_word_splitw_lte.p8:487   cx16.r3 = &lbl10b
	lda  #<p8l_lbl10b
	ldy  #>p8l_lbl10b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:488   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:490   goto skip10b
	bra  p8l_skip10b
	; source: test_word_splitw_lte.p8:491   lbl10b:   success++
p8l_lbl10b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:492   skip10b:
p8l_skip10b
	; source: test_word_splitw_lte.p8:494   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_57_afterif
	; source: test_word_splitw_lte.p8:495   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_57_afterif
	; source: test_word_splitw_lte.p8:498   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_59_else
	; source: test_word_splitw_lte.p8:499   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_59_else
	; source: test_word_splitw_lte.p8:501   cx16.r0L++
	inc  cx16.r0L
label_asm_58_afterif
	; source: test_word_splitw_lte.p8:504   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl10c
	; source: test_word_splitw_lte.p8:506   goto skip10c
	bra  p8l_skip10c
	; source: test_word_splitw_lte.p8:507   lbl10c:   success++
p8l_lbl10c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:508   skip10c:
p8l_skip10c
	; source: test_word_splitw_lte.p8:510   cx16.r3 = &lbl10d
	lda  #<p8l_lbl10d
	ldy  #>p8l_lbl10d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:511   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:513   goto skip10d
	bra  p8l_skip10d
	; source: test_word_splitw_lte.p8:514   lbl10d:   success++
p8l_lbl10d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:515   skip10d:
p8l_skip10d
	; source: test_word_splitw_lte.p8:517   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_60_afterif
	; source: test_word_splitw_lte.p8:518   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_60_afterif
	; source: test_word_splitw_lte.p8:521   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_62_else
	; source: test_word_splitw_lte.p8:522   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_62_else
	; source: test_word_splitw_lte.p8:524   cx16.r0L++
	inc  cx16.r0L
label_asm_61_afterif
	; source: test_word_splitw_lte.p8:526   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:528   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl11a
	; source: test_word_splitw_lte.p8:530   goto skip11a
	bra  p8l_skip11a
	; source: test_word_splitw_lte.p8:531   lbl11a:   success++
p8l_lbl11a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:532   skip11a:
p8l_skip11a
	; source: test_word_splitw_lte.p8:534   cx16.r3 = &lbl11b
	lda  #<p8l_lbl11b
	ldy  #>p8l_lbl11b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:535   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:537   goto skip11b
	bra  p8l_skip11b
	; source: test_word_splitw_lte.p8:538   lbl11b:   success++
p8l_lbl11b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:539   skip11b:
p8l_skip11b
	; source: test_word_splitw_lte.p8:541   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_63_afterif
	; source: test_word_splitw_lte.p8:542   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_63_afterif
	; source: test_word_splitw_lte.p8:545   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_65_else
	; source: test_word_splitw_lte.p8:546   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_64_afterif
	; source: test_word_splitw_lte.p8:551   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl11c
	; source: test_word_splitw_lte.p8:553   goto skip11c
	bra  p8l_skip11c
	; source: test_word_splitw_lte.p8:554   lbl11c:   success++
p8l_lbl11c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:555   skip11c:
p8l_skip11c
	; source: test_word_splitw_lte.p8:557   cx16.r3 = &lbl11d
	lda  #<p8l_lbl11d
	ldy  #>p8l_lbl11d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:558   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:560   goto skip11d
	bra  p8l_skip11d
	; source: test_word_splitw_lte.p8:561   lbl11d:   success++
p8l_lbl11d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:562   skip11d:
p8l_skip11d
	; source: test_word_splitw_lte.p8:564   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_66_afterif
	; source: test_word_splitw_lte.p8:565   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_66_afterif
	; source: test_word_splitw_lte.p8:568   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_68_else
	; source: test_word_splitw_lte.p8:569   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_68_else
	; source: test_word_splitw_lte.p8:571   cx16.r0L++
	inc  cx16.r0L
label_asm_67_afterif
	; source: test_word_splitw_lte.p8:573   values[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_values_lsb,y
	lda  #>$aa
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:575   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl12a
	; source: test_word_splitw_lte.p8:577   goto skip12a
	bra  p8l_skip12a
	; source: test_word_splitw_lte.p8:578   lbl12a:   success++
p8l_lbl12a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:579   skip12a:
p8l_skip12a
	; source: test_word_splitw_lte.p8:581   cx16.r3 = &lbl12b
	lda  #<p8l_lbl12b
	ldy  #>p8l_lbl12b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:582   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:584   goto skip12b
	bra  p8l_skip12b
	; source: test_word_splitw_lte.p8:585   lbl12b:   success++
p8l_lbl12b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:586   skip12b:
p8l_skip12b
	; source: test_word_splitw_lte.p8:588   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_69_afterif
	; source: test_word_splitw_lte.p8:589   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_69_afterif
	; source: test_word_splitw_lte.p8:592   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_71_else
	; source: test_word_splitw_lte.p8:593   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_71_else
	; source: test_word_splitw_lte.p8:595   cx16.r0L++
	inc  cx16.r0L
label_asm_70_afterif
	; source: test_word_splitw_lte.p8:598   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl12c
	; source: test_word_splitw_lte.p8:600   goto skip12c
	bra  p8l_skip12c
	; source: test_word_splitw_lte.p8:601   lbl12c:   success++
p8l_lbl12c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:602   skip12c:
p8l_skip12c
	; source: test_word_splitw_lte.p8:604   cx16.r3 = &lbl12d
	lda  #<p8l_lbl12d
	ldy  #>p8l_lbl12d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:605   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:607   goto skip12d
	bra  p8l_skip12d
	; source: test_word_splitw_lte.p8:608   lbl12d:   success++
p8l_lbl12d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:609   skip12d:
p8l_skip12d
	; source: test_word_splitw_lte.p8:611   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_72_afterif
	; source: test_word_splitw_lte.p8:612   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_72_afterif
	; source: test_word_splitw_lte.p8:615   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_74_else
	; source: test_word_splitw_lte.p8:616   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_74_else
	; source: test_word_splitw_lte.p8:618   cx16.r0L++
	inc  cx16.r0L
label_asm_73_afterif
	; source: test_word_splitw_lte.p8:620   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:622   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl13a
	; source: test_word_splitw_lte.p8:624   goto skip13a
	bra  p8l_skip13a
	; source: test_word_splitw_lte.p8:625   lbl13a:   success++
p8l_lbl13a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:626   skip13a:
p8l_skip13a
	; source: test_word_splitw_lte.p8:628   cx16.r3 = &lbl13b
	lda  #<p8l_lbl13b
	ldy  #>p8l_lbl13b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:629   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:631   goto skip13b
	bra  p8l_skip13b
	; source: test_word_splitw_lte.p8:632   lbl13b:   success++
p8l_lbl13b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:633   skip13b:
p8l_skip13b
	; source: test_word_splitw_lte.p8:635   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_75_afterif
	; source: test_word_splitw_lte.p8:636   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_75_afterif
	; source: test_word_splitw_lte.p8:639   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_77_else
	; source: test_word_splitw_lte.p8:640   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_77_else
	; source: test_word_splitw_lte.p8:642   cx16.r0L++
	inc  cx16.r0L
label_asm_76_afterif
	; source: test_word_splitw_lte.p8:645   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl13c
	; source: test_word_splitw_lte.p8:647   goto skip13c
	bra  p8l_skip13c
	; source: test_word_splitw_lte.p8:648   lbl13c:   success++
p8l_lbl13c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:649   skip13c:
p8l_skip13c
	; source: test_word_splitw_lte.p8:651   cx16.r3 = &lbl13d
	lda  #<p8l_lbl13d
	ldy  #>p8l_lbl13d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:652   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:654   goto skip13d
	bra  p8l_skip13d
	; source: test_word_splitw_lte.p8:655   lbl13d:   success++
p8l_lbl13d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:656   skip13d:
p8l_skip13d
	; source: test_word_splitw_lte.p8:658   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_78_afterif
	; source: test_word_splitw_lte.p8:659   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_78_afterif
	; source: test_word_splitw_lte.p8:662   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_80_else
	; source: test_word_splitw_lte.p8:663   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_80_else
	; source: test_word_splitw_lte.p8:665   cx16.r0L++
	inc  cx16.r0L
label_asm_79_afterif
	; source: test_word_splitw_lte.p8:667   values[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_values_lsb,y
	lda  #>$7fff
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:669   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl14a
	; source: test_word_splitw_lte.p8:671   goto skip14a
	bra  p8l_skip14a
	; source: test_word_splitw_lte.p8:672   lbl14a:   success++
p8l_lbl14a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:673   skip14a:
p8l_skip14a
	; source: test_word_splitw_lte.p8:675   cx16.r3 = &lbl14b
	lda  #<p8l_lbl14b
	ldy  #>p8l_lbl14b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:676   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:678   goto skip14b
	bra  p8l_skip14b
	; source: test_word_splitw_lte.p8:679   lbl14b:   success++
p8l_lbl14b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:680   skip14b:
p8l_skip14b
	; source: test_word_splitw_lte.p8:682   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_81_afterif
	; source: test_word_splitw_lte.p8:683   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_81_afterif
	; source: test_word_splitw_lte.p8:686   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_83_else
	; source: test_word_splitw_lte.p8:687   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_82_afterif
	; source: test_word_splitw_lte.p8:692   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl14c
	; source: test_word_splitw_lte.p8:694   goto skip14c
	bra  p8l_skip14c
	; source: test_word_splitw_lte.p8:695   lbl14c:   success++
p8l_lbl14c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:696   skip14c:
p8l_skip14c
	; source: test_word_splitw_lte.p8:698   cx16.r3 = &lbl14d
	lda  #<p8l_lbl14d
	ldy  #>p8l_lbl14d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:699   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:701   goto skip14d
	bra  p8l_skip14d
	; source: test_word_splitw_lte.p8:702   lbl14d:   success++
p8l_lbl14d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:703   skip14d:
p8l_skip14d
	; source: test_word_splitw_lte.p8:705   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_84_afterif
	; source: test_word_splitw_lte.p8:706   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_84_afterif
	; source: test_word_splitw_lte.p8:709   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_86_else
	; source: test_word_splitw_lte.p8:710   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_86_else
	; source: test_word_splitw_lte.p8:712   cx16.r0L++
	inc  cx16.r0L
label_asm_85_afterif
	; source: test_word_splitw_lte.p8:714   x=0
	stz  p8v_x
	stz  p8v_x+1
	; source: test_word_splitw_lte.p8:715   sources[1]=0
	ldy  #1
	lda  #0
	sta  p8v_sources_lsb,y
	sta  p8v_sources_msb,y
	; source: test_word_splitw_lte.p8:716   values[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_values_lsb,y
	lda  #>-$5545
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:718   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl15a
	; source: test_word_splitw_lte.p8:720   goto skip15a
	bra  p8l_skip15a
	; source: test_word_splitw_lte.p8:721   lbl15a:   fail_word(9)
p8l_lbl15a
	ldy  #>9
	lda  #<9
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:722   skip15a:
p8l_skip15a
	; source: test_word_splitw_lte.p8:724   cx16.r3 = &lbl15b
	lda  #<p8l_lbl15b
	ldy  #>p8l_lbl15b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:725   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:727   goto skip15b
	bra  p8l_skip15b
	; source: test_word_splitw_lte.p8:728   lbl15b:   fail_word(10)
p8l_lbl15b
	ldy  #>10
	lda  #<10
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:729   skip15b:
p8l_skip15b
	; source: test_word_splitw_lte.p8:731   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_87_afterif
	; source: test_word_splitw_lte.p8:732   fail_word(11)
	ldy  #>11
	lda  #<11
	jsr  p8b_main.p8s_fail_word
label_asm_87_afterif
	; source: test_word_splitw_lte.p8:735   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_89_else
	; source: test_word_splitw_lte.p8:736   fail_word(12)
	ldy  #>12
	lda  #<12
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_88_afterif
label_asm_89_else
	; source: test_word_splitw_lte.p8:738   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_88_afterif
	; source: test_word_splitw_lte.p8:741   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl15c
	; source: test_word_splitw_lte.p8:743   goto skip15c
	bra  p8l_skip15c
	; source: test_word_splitw_lte.p8:744   lbl15c:   fail_word(13)
p8l_lbl15c
	ldy  #>13
	lda  #<13
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:745   skip15c:
p8l_skip15c
	; source: test_word_splitw_lte.p8:747   cx16.r3 = &lbl15d
	lda  #<p8l_lbl15d
	ldy  #>p8l_lbl15d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:748   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:750   goto skip15d
	bra  p8l_skip15d
	; source: test_word_splitw_lte.p8:751   lbl15d:   fail_word(14)
p8l_lbl15d
	ldy  #>14
	lda  #<14
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:752   skip15d:
p8l_skip15d
	; source: test_word_splitw_lte.p8:754   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_90_afterif
	; source: test_word_splitw_lte.p8:755   fail_word(15)
	ldy  #>15
	lda  #<15
	jsr  p8b_main.p8s_fail_word
label_asm_90_afterif
	; source: test_word_splitw_lte.p8:758   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_92_else
	; source: test_word_splitw_lte.p8:759   fail_word(16)
	ldy  #>$10
	lda  #<$10
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_91_afterif
label_asm_92_else
	; source: test_word_splitw_lte.p8:761   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_91_afterif
	; source: test_word_splitw_lte.p8:763   values[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_values_lsb,y
	lda  #>-1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:765   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl16a
	; source: test_word_splitw_lte.p8:767   goto skip16a
	bra  p8l_skip16a
	; source: test_word_splitw_lte.p8:768   lbl16a:   fail_word(17)
p8l_lbl16a
	ldy  #>$11
	lda  #<$11
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:769   skip16a:
p8l_skip16a
	; source: test_word_splitw_lte.p8:771   cx16.r3 = &lbl16b
	lda  #<p8l_lbl16b
	ldy  #>p8l_lbl16b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:772   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:774   goto skip16b
	bra  p8l_skip16b
	; source: test_word_splitw_lte.p8:775   lbl16b:   fail_word(18)
p8l_lbl16b
	ldy  #>$12
	lda  #<$12
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:776   skip16b:
p8l_skip16b
	; source: test_word_splitw_lte.p8:778   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_93_afterif
	; source: test_word_splitw_lte.p8:779   fail_word(19)
	ldy  #>$13
	lda  #<$13
	jsr  p8b_main.p8s_fail_word
label_asm_93_afterif
	; source: test_word_splitw_lte.p8:782   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_95_else
	; source: test_word_splitw_lte.p8:783   fail_word(20)
	ldy  #>$14
	lda  #<$14
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_94_afterif
label_asm_95_else
	; source: test_word_splitw_lte.p8:785   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_94_afterif
	; source: test_word_splitw_lte.p8:788   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl16c
	; source: test_word_splitw_lte.p8:790   goto skip16c
	bra  p8l_skip16c
	; source: test_word_splitw_lte.p8:791   lbl16c:   fail_word(21)
p8l_lbl16c
	ldy  #>$15
	lda  #<$15
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:792   skip16c:
p8l_skip16c
	; source: test_word_splitw_lte.p8:794   cx16.r3 = &lbl16d
	lda  #<p8l_lbl16d
	ldy  #>p8l_lbl16d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:795   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:797   goto skip16d
	bra  p8l_skip16d
	; source: test_word_splitw_lte.p8:798   lbl16d:   fail_word(22)
p8l_lbl16d
	ldy  #>$16
	lda  #<$16
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:799   skip16d:
p8l_skip16d
	; source: test_word_splitw_lte.p8:801   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_96_afterif
	; source: test_word_splitw_lte.p8:802   fail_word(23)
	ldy  #>$17
	lda  #<$17
	jsr  p8b_main.p8s_fail_word
label_asm_96_afterif
	; source: test_word_splitw_lte.p8:805   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_98_else
	; source: test_word_splitw_lte.p8:806   fail_word(24)
	ldy  #>$18
	lda  #<$18
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_97_afterif
label_asm_98_else
	; source: test_word_splitw_lte.p8:808   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_97_afterif
	; source: test_word_splitw_lte.p8:810   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:812   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl17a
	; source: test_word_splitw_lte.p8:814   goto skip17a
	bra  p8l_skip17a
	; source: test_word_splitw_lte.p8:815   lbl17a:   success++
p8l_lbl17a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:816   skip17a:
p8l_skip17a
	; source: test_word_splitw_lte.p8:818   cx16.r3 = &lbl17b
	lda  #<p8l_lbl17b
	ldy  #>p8l_lbl17b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:819   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:821   goto skip17b
	bra  p8l_skip17b
	; source: test_word_splitw_lte.p8:822   lbl17b:   success++
p8l_lbl17b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:823   skip17b:
p8l_skip17b
	; source: test_word_splitw_lte.p8:825   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_99_afterif
	; source: test_word_splitw_lte.p8:826   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_99_afterif
	; source: test_word_splitw_lte.p8:829   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_101_else
	; source: test_word_splitw_lte.p8:830   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_101_else
	; source: test_word_splitw_lte.p8:832   cx16.r0L++
	inc  cx16.r0L
label_asm_100_afterif
	; source: test_word_splitw_lte.p8:835   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl17c
	; source: test_word_splitw_lte.p8:837   goto skip17c
	bra  p8l_skip17c
	; source: test_word_splitw_lte.p8:838   lbl17c:   success++
p8l_lbl17c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:839   skip17c:
p8l_skip17c
	; source: test_word_splitw_lte.p8:841   cx16.r3 = &lbl17d
	lda  #<p8l_lbl17d
	ldy  #>p8l_lbl17d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:842   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:844   goto skip17d
	bra  p8l_skip17d
	; source: test_word_splitw_lte.p8:845   lbl17d:   success++
p8l_lbl17d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:846   skip17d:
p8l_skip17d
	; source: test_word_splitw_lte.p8:848   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_102_afterif
	; source: test_word_splitw_lte.p8:849   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_102_afterif
	; source: test_word_splitw_lte.p8:852   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_104_else
	; source: test_word_splitw_lte.p8:853   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_104_else
	; source: test_word_splitw_lte.p8:855   cx16.r0L++
	inc  cx16.r0L
label_asm_103_afterif
	; source: test_word_splitw_lte.p8:857   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:859   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl18a
	; source: test_word_splitw_lte.p8:861   goto skip18a
	bra  p8l_skip18a
	; source: test_word_splitw_lte.p8:862   lbl18a:   success++
p8l_lbl18a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:863   skip18a:
p8l_skip18a
	; source: test_word_splitw_lte.p8:865   cx16.r3 = &lbl18b
	lda  #<p8l_lbl18b
	ldy  #>p8l_lbl18b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:866   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:868   goto skip18b
	bra  p8l_skip18b
	; source: test_word_splitw_lte.p8:869   lbl18b:   success++
p8l_lbl18b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:870   skip18b:
p8l_skip18b
	; source: test_word_splitw_lte.p8:872   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_105_afterif
	; source: test_word_splitw_lte.p8:873   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_105_afterif
	; source: test_word_splitw_lte.p8:876   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_107_else
	; source: test_word_splitw_lte.p8:877   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_106_afterif
	; source: test_word_splitw_lte.p8:882   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl18c
	; source: test_word_splitw_lte.p8:884   goto skip18c
	bra  p8l_skip18c
	; source: test_word_splitw_lte.p8:885   lbl18c:   success++
p8l_lbl18c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:886   skip18c:
p8l_skip18c
	; source: test_word_splitw_lte.p8:888   cx16.r3 = &lbl18d
	lda  #<p8l_lbl18d
	ldy  #>p8l_lbl18d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:889   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:891   goto skip18d
	bra  p8l_skip18d
	; source: test_word_splitw_lte.p8:892   lbl18d:   success++
p8l_lbl18d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:893   skip18d:
p8l_skip18d
	; source: test_word_splitw_lte.p8:895   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_108_afterif
	; source: test_word_splitw_lte.p8:896   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_108_afterif
	; source: test_word_splitw_lte.p8:899   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_110_else
	; source: test_word_splitw_lte.p8:900   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_110_else
	; source: test_word_splitw_lte.p8:902   cx16.r0L++
	inc  cx16.r0L
label_asm_109_afterif
	; source: test_word_splitw_lte.p8:904   values[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_values_lsb,y
	lda  #>$aa
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:906   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl19a
	; source: test_word_splitw_lte.p8:908   goto skip19a
	bra  p8l_skip19a
	; source: test_word_splitw_lte.p8:909   lbl19a:   success++
p8l_lbl19a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:910   skip19a:
p8l_skip19a
	; source: test_word_splitw_lte.p8:912   cx16.r3 = &lbl19b
	lda  #<p8l_lbl19b
	ldy  #>p8l_lbl19b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:913   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:915   goto skip19b
	bra  p8l_skip19b
	; source: test_word_splitw_lte.p8:916   lbl19b:   success++
p8l_lbl19b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:917   skip19b:
p8l_skip19b
	; source: test_word_splitw_lte.p8:919   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_111_afterif
	; source: test_word_splitw_lte.p8:920   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_111_afterif
	; source: test_word_splitw_lte.p8:923   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_113_else
	; source: test_word_splitw_lte.p8:924   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_113_else
	; source: test_word_splitw_lte.p8:926   cx16.r0L++
	inc  cx16.r0L
label_asm_112_afterif
	; source: test_word_splitw_lte.p8:929   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl19c
	; source: test_word_splitw_lte.p8:931   goto skip19c
	bra  p8l_skip19c
	; source: test_word_splitw_lte.p8:932   lbl19c:   success++
p8l_lbl19c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:933   skip19c:
p8l_skip19c
	; source: test_word_splitw_lte.p8:935   cx16.r3 = &lbl19d
	lda  #<p8l_lbl19d
	ldy  #>p8l_lbl19d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:936   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:938   goto skip19d
	bra  p8l_skip19d
	; source: test_word_splitw_lte.p8:939   lbl19d:   success++
p8l_lbl19d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:940   skip19d:
p8l_skip19d
	; source: test_word_splitw_lte.p8:942   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_114_afterif
	; source: test_word_splitw_lte.p8:943   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_114_afterif
	; source: test_word_splitw_lte.p8:946   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_116_else
	; source: test_word_splitw_lte.p8:947   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_116_else
	; source: test_word_splitw_lte.p8:949   cx16.r0L++
	inc  cx16.r0L
label_asm_115_afterif
	; source: test_word_splitw_lte.p8:951   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:953   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl20a
	; source: test_word_splitw_lte.p8:955   goto skip20a
	bra  p8l_skip20a
	; source: test_word_splitw_lte.p8:956   lbl20a:   success++
p8l_lbl20a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:957   skip20a:
p8l_skip20a
	; source: test_word_splitw_lte.p8:959   cx16.r3 = &lbl20b
	lda  #<p8l_lbl20b
	ldy  #>p8l_lbl20b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:960   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:962   goto skip20b
	bra  p8l_skip20b
	; source: test_word_splitw_lte.p8:963   lbl20b:   success++
p8l_lbl20b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:964   skip20b:
p8l_skip20b
	; source: test_word_splitw_lte.p8:966   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_117_afterif
	; source: test_word_splitw_lte.p8:967   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_117_afterif
	; source: test_word_splitw_lte.p8:970   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_119_else
	; source: test_word_splitw_lte.p8:971   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_119_else
	; source: test_word_splitw_lte.p8:973   cx16.r0L++
	inc  cx16.r0L
label_asm_118_afterif
	; source: test_word_splitw_lte.p8:976   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl20c
	; source: test_word_splitw_lte.p8:978   goto skip20c
	bra  p8l_skip20c
	; source: test_word_splitw_lte.p8:979   lbl20c:   success++
p8l_lbl20c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:980   skip20c:
p8l_skip20c
	; source: test_word_splitw_lte.p8:982   cx16.r3 = &lbl20d
	lda  #<p8l_lbl20d
	ldy  #>p8l_lbl20d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:983   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:985   goto skip20d
	bra  p8l_skip20d
	; source: test_word_splitw_lte.p8:986   lbl20d:   success++
p8l_lbl20d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:987   skip20d:
p8l_skip20d
	; source: test_word_splitw_lte.p8:989   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_120_afterif
	; source: test_word_splitw_lte.p8:990   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_120_afterif
	; source: test_word_splitw_lte.p8:993   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_122_else
	; source: test_word_splitw_lte.p8:994   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_122_else
	; source: test_word_splitw_lte.p8:996   cx16.r0L++
	inc  cx16.r0L
label_asm_121_afterif
	; source: test_word_splitw_lte.p8:998   values[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_values_lsb,y
	lda  #>$7fff
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1000   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl21a
	; source: test_word_splitw_lte.p8:1002   goto skip21a
	bra  p8l_skip21a
	; source: test_word_splitw_lte.p8:1003   lbl21a:   success++
p8l_lbl21a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1004   skip21a:
p8l_skip21a
	; source: test_word_splitw_lte.p8:1006   cx16.r3 = &lbl21b
	lda  #<p8l_lbl21b
	ldy  #>p8l_lbl21b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1007   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1009   goto skip21b
	bra  p8l_skip21b
	; source: test_word_splitw_lte.p8:1010   lbl21b:   success++
p8l_lbl21b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1011   skip21b:
p8l_skip21b
	; source: test_word_splitw_lte.p8:1013   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_123_afterif
	; source: test_word_splitw_lte.p8:1014   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_123_afterif
	; source: test_word_splitw_lte.p8:1017   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_125_else
	; source: test_word_splitw_lte.p8:1018   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_125_else
	; source: test_word_splitw_lte.p8:1020   cx16.r0L++
	inc  cx16.r0L
label_asm_124_afterif
	; source: test_word_splitw_lte.p8:1023   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl21c
	; source: test_word_splitw_lte.p8:1025   goto skip21c
	bra  p8l_skip21c
	; source: test_word_splitw_lte.p8:1026   lbl21c:   success++
p8l_lbl21c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1027   skip21c:
p8l_skip21c
	; source: test_word_splitw_lte.p8:1029   cx16.r3 = &lbl21d
	lda  #<p8l_lbl21d
	ldy  #>p8l_lbl21d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1030   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1032   goto skip21d
	bra  p8l_skip21d
	; source: test_word_splitw_lte.p8:1033   lbl21d:   success++
p8l_lbl21d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1034   skip21d:
p8l_skip21d
	; source: test_word_splitw_lte.p8:1036   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_126_afterif
	; source: test_word_splitw_lte.p8:1037   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_126_afterif
	; source: test_word_splitw_lte.p8:1040   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_128_else
	; source: test_word_splitw_lte.p8:1041   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_128_else
	; source: test_word_splitw_lte.p8:1043   cx16.r0L++
	inc  cx16.r0L
label_asm_127_afterif
	; source: test_word_splitw_lte.p8:1045   x=1
	lda  #<1
	ldy  #>1
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_word_splitw_lte.p8:1046   sources[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_sources_lsb,y
	lda  #>1
	sta  p8v_sources_msb,y
	; source: test_word_splitw_lte.p8:1047   values[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_values_lsb,y
	lda  #>-$5545
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1049   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl22a
	; source: test_word_splitw_lte.p8:1051   goto skip22a
	bra  p8l_skip22a
	; source: test_word_splitw_lte.p8:1052   lbl22a:   fail_word(25)
p8l_lbl22a
	ldy  #>$19
	lda  #<$19
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1053   skip22a:
p8l_skip22a
	; source: test_word_splitw_lte.p8:1055   cx16.r3 = &lbl22b
	lda  #<p8l_lbl22b
	ldy  #>p8l_lbl22b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1056   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1058   goto skip22b
	bra  p8l_skip22b
	; source: test_word_splitw_lte.p8:1059   lbl22b:   fail_word(26)
p8l_lbl22b
	ldy  #>$1a
	lda  #<$1a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1060   skip22b:
p8l_skip22b
	; source: test_word_splitw_lte.p8:1062   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_129_afterif
	; source: test_word_splitw_lte.p8:1063   fail_word(27)
	ldy  #>$1b
	lda  #<$1b
	jsr  p8b_main.p8s_fail_word
label_asm_129_afterif
	; source: test_word_splitw_lte.p8:1066   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_131_else
	; source: test_word_splitw_lte.p8:1067   fail_word(28)
	ldy  #>$1c
	lda  #<$1c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_130_afterif
label_asm_131_else
	; source: test_word_splitw_lte.p8:1069   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_130_afterif
	; source: test_word_splitw_lte.p8:1072   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl22c
	; source: test_word_splitw_lte.p8:1074   goto skip22c
	bra  p8l_skip22c
	; source: test_word_splitw_lte.p8:1075   lbl22c:   fail_word(29)
p8l_lbl22c
	ldy  #>$1d
	lda  #<$1d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1076   skip22c:
p8l_skip22c
	; source: test_word_splitw_lte.p8:1078   cx16.r3 = &lbl22d
	lda  #<p8l_lbl22d
	ldy  #>p8l_lbl22d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1079   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1081   goto skip22d
	bra  p8l_skip22d
	; source: test_word_splitw_lte.p8:1082   lbl22d:   fail_word(30)
p8l_lbl22d
	ldy  #>$1e
	lda  #<$1e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1083   skip22d:
p8l_skip22d
	; source: test_word_splitw_lte.p8:1085   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_132_afterif
	; source: test_word_splitw_lte.p8:1086   fail_word(31)
	ldy  #>$1f
	lda  #<$1f
	jsr  p8b_main.p8s_fail_word
label_asm_132_afterif
	; source: test_word_splitw_lte.p8:1089   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_134_else
	; source: test_word_splitw_lte.p8:1090   fail_word(32)
	ldy  #>$20
	lda  #<$20
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_133_afterif
label_asm_134_else
	; source: test_word_splitw_lte.p8:1092   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_133_afterif
	; source: test_word_splitw_lte.p8:1094   values[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_values_lsb,y
	lda  #>-1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1096   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl23a
	; source: test_word_splitw_lte.p8:1098   goto skip23a
	bra  p8l_skip23a
	; source: test_word_splitw_lte.p8:1099   lbl23a:   fail_word(33)
p8l_lbl23a
	ldy  #>$21
	lda  #<$21
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1100   skip23a:
p8l_skip23a
	; source: test_word_splitw_lte.p8:1102   cx16.r3 = &lbl23b
	lda  #<p8l_lbl23b
	ldy  #>p8l_lbl23b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1103   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1105   goto skip23b
	bra  p8l_skip23b
	; source: test_word_splitw_lte.p8:1106   lbl23b:   fail_word(34)
p8l_lbl23b
	ldy  #>$22
	lda  #<$22
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1107   skip23b:
p8l_skip23b
	; source: test_word_splitw_lte.p8:1109   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_135_afterif
	; source: test_word_splitw_lte.p8:1110   fail_word(35)
	ldy  #>$23
	lda  #<$23
	jsr  p8b_main.p8s_fail_word
label_asm_135_afterif
	; source: test_word_splitw_lte.p8:1113   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_137_else
	; source: test_word_splitw_lte.p8:1114   fail_word(36)
	ldy  #>$24
	lda  #<$24
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_136_afterif
label_asm_137_else
	; source: test_word_splitw_lte.p8:1116   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_136_afterif
	; source: test_word_splitw_lte.p8:1119   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl23c
	; source: test_word_splitw_lte.p8:1121   goto skip23c
	bra  p8l_skip23c
	; source: test_word_splitw_lte.p8:1122   lbl23c:   fail_word(37)
p8l_lbl23c
	ldy  #>$25
	lda  #<$25
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1123   skip23c:
p8l_skip23c
	; source: test_word_splitw_lte.p8:1125   cx16.r3 = &lbl23d
	lda  #<p8l_lbl23d
	ldy  #>p8l_lbl23d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1126   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1128   goto skip23d
	bra  p8l_skip23d
	; source: test_word_splitw_lte.p8:1129   lbl23d:   fail_word(38)
p8l_lbl23d
	ldy  #>$26
	lda  #<$26
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1130   skip23d:
p8l_skip23d
	; source: test_word_splitw_lte.p8:1132   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_138_afterif
	; source: test_word_splitw_lte.p8:1133   fail_word(39)
	ldy  #>$27
	lda  #<$27
	jsr  p8b_main.p8s_fail_word
label_asm_138_afterif
	; source: test_word_splitw_lte.p8:1136   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_140_else
	; source: test_word_splitw_lte.p8:1137   fail_word(40)
	ldy  #>$28
	lda  #<$28
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_139_afterif
label_asm_140_else
	; source: test_word_splitw_lte.p8:1139   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_139_afterif
	; source: test_word_splitw_lte.p8:1141   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1143   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl24a
	; source: test_word_splitw_lte.p8:1145   goto skip24a
	bra  p8l_skip24a
	; source: test_word_splitw_lte.p8:1146   lbl24a:   fail_word(41)
p8l_lbl24a
	ldy  #>$29
	lda  #<$29
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1147   skip24a:
p8l_skip24a
	; source: test_word_splitw_lte.p8:1149   cx16.r3 = &lbl24b
	lda  #<p8l_lbl24b
	ldy  #>p8l_lbl24b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1150   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1152   goto skip24b
	bra  p8l_skip24b
	; source: test_word_splitw_lte.p8:1153   lbl24b:   fail_word(42)
p8l_lbl24b
	ldy  #>$2a
	lda  #<$2a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1154   skip24b:
p8l_skip24b
	; source: test_word_splitw_lte.p8:1156   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_141_afterif
	; source: test_word_splitw_lte.p8:1157   fail_word(43)
	ldy  #>$2b
	lda  #<$2b
	jsr  p8b_main.p8s_fail_word
label_asm_141_afterif
	; source: test_word_splitw_lte.p8:1160   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_143_else
	; source: test_word_splitw_lte.p8:1161   fail_word(44)
	ldy  #>$2c
	lda  #<$2c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_142_afterif
label_asm_143_else
	; source: test_word_splitw_lte.p8:1163   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_142_afterif
	; source: test_word_splitw_lte.p8:1166   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl24c
	; source: test_word_splitw_lte.p8:1168   goto skip24c
	bra  p8l_skip24c
	; source: test_word_splitw_lte.p8:1169   lbl24c:   fail_word(45)
p8l_lbl24c
	ldy  #>$2d
	lda  #<$2d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1170   skip24c:
p8l_skip24c
	; source: test_word_splitw_lte.p8:1172   cx16.r3 = &lbl24d
	lda  #<p8l_lbl24d
	ldy  #>p8l_lbl24d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1173   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1175   goto skip24d
	bra  p8l_skip24d
	; source: test_word_splitw_lte.p8:1176   lbl24d:   fail_word(46)
p8l_lbl24d
	ldy  #>$2e
	lda  #<$2e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1177   skip24d:
p8l_skip24d
	; source: test_word_splitw_lte.p8:1179   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_144_afterif
	; source: test_word_splitw_lte.p8:1180   fail_word(47)
	ldy  #>$2f
	lda  #<$2f
	jsr  p8b_main.p8s_fail_word
label_asm_144_afterif
	; source: test_word_splitw_lte.p8:1183   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_146_else
	; source: test_word_splitw_lte.p8:1184   fail_word(48)
	ldy  #>$30
	lda  #<$30
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_145_afterif
label_asm_146_else
	; source: test_word_splitw_lte.p8:1186   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_145_afterif
	; source: test_word_splitw_lte.p8:1188   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1190   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl25a
	; source: test_word_splitw_lte.p8:1192   goto skip25a
	bra  p8l_skip25a
	; source: test_word_splitw_lte.p8:1193   lbl25a:   success++
p8l_lbl25a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1194   skip25a:
p8l_skip25a
	; source: test_word_splitw_lte.p8:1196   cx16.r3 = &lbl25b
	lda  #<p8l_lbl25b
	ldy  #>p8l_lbl25b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1197   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1199   goto skip25b
	bra  p8l_skip25b
	; source: test_word_splitw_lte.p8:1200   lbl25b:   success++
p8l_lbl25b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1201   skip25b:
p8l_skip25b
	; source: test_word_splitw_lte.p8:1203   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_147_afterif
	; source: test_word_splitw_lte.p8:1204   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_147_afterif
	; source: test_word_splitw_lte.p8:1207   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_149_else
	; source: test_word_splitw_lte.p8:1208   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_149_else
	; source: test_word_splitw_lte.p8:1210   cx16.r0L++
	inc  cx16.r0L
label_asm_148_afterif
	; source: test_word_splitw_lte.p8:1213   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl25c
	; source: test_word_splitw_lte.p8:1215   goto skip25c
	bra  p8l_skip25c
	; source: test_word_splitw_lte.p8:1216   lbl25c:   success++
p8l_lbl25c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1217   skip25c:
p8l_skip25c
	; source: test_word_splitw_lte.p8:1219   cx16.r3 = &lbl25d
	lda  #<p8l_lbl25d
	ldy  #>p8l_lbl25d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1220   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1222   goto skip25d
	bra  p8l_skip25d
	; source: test_word_splitw_lte.p8:1223   lbl25d:   success++
p8l_lbl25d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1224   skip25d:
p8l_skip25d
	; source: test_word_splitw_lte.p8:1226   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_150_afterif
	; source: test_word_splitw_lte.p8:1227   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_150_afterif
	; source: test_word_splitw_lte.p8:1230   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_152_else
	; source: test_word_splitw_lte.p8:1231   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_152_else
	; source: test_word_splitw_lte.p8:1233   cx16.r0L++
	inc  cx16.r0L
label_asm_151_afterif
	; source: test_word_splitw_lte.p8:1235   values[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_values_lsb,y
	lda  #>$aa
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1237   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl26a
	; source: test_word_splitw_lte.p8:1239   goto skip26a
	bra  p8l_skip26a
	; source: test_word_splitw_lte.p8:1240   lbl26a:   success++
p8l_lbl26a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1241   skip26a:
p8l_skip26a
	; source: test_word_splitw_lte.p8:1243   cx16.r3 = &lbl26b
	lda  #<p8l_lbl26b
	ldy  #>p8l_lbl26b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1244   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1246   goto skip26b
	bra  p8l_skip26b
	; source: test_word_splitw_lte.p8:1247   lbl26b:   success++
p8l_lbl26b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1248   skip26b:
p8l_skip26b
	; source: test_word_splitw_lte.p8:1250   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_153_afterif
	; source: test_word_splitw_lte.p8:1251   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_153_afterif
	; source: test_word_splitw_lte.p8:1254   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_155_else
	; source: test_word_splitw_lte.p8:1255   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_154_afterif
	; source: test_word_splitw_lte.p8:1260   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl26c
	; source: test_word_splitw_lte.p8:1262   goto skip26c
	bra  p8l_skip26c
	; source: test_word_splitw_lte.p8:1263   lbl26c:   success++
p8l_lbl26c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1264   skip26c:
p8l_skip26c
	; source: test_word_splitw_lte.p8:1266   cx16.r3 = &lbl26d
	lda  #<p8l_lbl26d
	ldy  #>p8l_lbl26d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1267   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1269   goto skip26d
	bra  p8l_skip26d
	; source: test_word_splitw_lte.p8:1270   lbl26d:   success++
p8l_lbl26d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1271   skip26d:
p8l_skip26d
	; source: test_word_splitw_lte.p8:1273   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_156_afterif
	; source: test_word_splitw_lte.p8:1274   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_156_afterif
	; source: test_word_splitw_lte.p8:1277   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_158_else
	; source: test_word_splitw_lte.p8:1278   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_158_else
	; source: test_word_splitw_lte.p8:1280   cx16.r0L++
	inc  cx16.r0L
label_asm_157_afterif
	; source: test_word_splitw_lte.p8:1282   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1284   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl27a
	; source: test_word_splitw_lte.p8:1286   goto skip27a
	bra  p8l_skip27a
	; source: test_word_splitw_lte.p8:1287   lbl27a:   success++
p8l_lbl27a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1288   skip27a:
p8l_skip27a
	; source: test_word_splitw_lte.p8:1290   cx16.r3 = &lbl27b
	lda  #<p8l_lbl27b
	ldy  #>p8l_lbl27b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1291   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1293   goto skip27b
	bra  p8l_skip27b
	; source: test_word_splitw_lte.p8:1294   lbl27b:   success++
p8l_lbl27b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1295   skip27b:
p8l_skip27b
	; source: test_word_splitw_lte.p8:1297   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_159_afterif
	; source: test_word_splitw_lte.p8:1298   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_159_afterif
	; source: test_word_splitw_lte.p8:1301   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_161_else
	; source: test_word_splitw_lte.p8:1302   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_160_afterif
	; source: test_word_splitw_lte.p8:1307   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl27c
	; source: test_word_splitw_lte.p8:1309   goto skip27c
	bra  p8l_skip27c
	; source: test_word_splitw_lte.p8:1310   lbl27c:   success++
p8l_lbl27c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1311   skip27c:
p8l_skip27c
	; source: test_word_splitw_lte.p8:1313   cx16.r3 = &lbl27d
	lda  #<p8l_lbl27d
	ldy  #>p8l_lbl27d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1314   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1316   goto skip27d
	bra  p8l_skip27d
	; source: test_word_splitw_lte.p8:1317   lbl27d:   success++
p8l_lbl27d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1318   skip27d:
p8l_skip27d
	; source: test_word_splitw_lte.p8:1320   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_162_afterif
	; source: test_word_splitw_lte.p8:1321   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_162_afterif
	; source: test_word_splitw_lte.p8:1324   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_164_else
	; source: test_word_splitw_lte.p8:1325   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_164_else
	; source: test_word_splitw_lte.p8:1327   cx16.r0L++
	inc  cx16.r0L
label_asm_163_afterif
	; source: test_word_splitw_lte.p8:1329   values[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_values_lsb,y
	lda  #>$7fff
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1331   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl28a
	; source: test_word_splitw_lte.p8:1333   goto skip28a
	bra  p8l_skip28a
	; source: test_word_splitw_lte.p8:1334   lbl28a:   success++
p8l_lbl28a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1335   skip28a:
p8l_skip28a
	; source: test_word_splitw_lte.p8:1337   cx16.r3 = &lbl28b
	lda  #<p8l_lbl28b
	ldy  #>p8l_lbl28b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1338   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1340   goto skip28b
	bra  p8l_skip28b
	; source: test_word_splitw_lte.p8:1341   lbl28b:   success++
p8l_lbl28b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1342   skip28b:
p8l_skip28b
	; source: test_word_splitw_lte.p8:1344   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_165_afterif
	; source: test_word_splitw_lte.p8:1345   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_165_afterif
	; source: test_word_splitw_lte.p8:1348   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_167_else
	; source: test_word_splitw_lte.p8:1349   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_167_else
	; source: test_word_splitw_lte.p8:1351   cx16.r0L++
	inc  cx16.r0L
label_asm_166_afterif
	; source: test_word_splitw_lte.p8:1354   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl28c
	; source: test_word_splitw_lte.p8:1356   goto skip28c
	bra  p8l_skip28c
	; source: test_word_splitw_lte.p8:1357   lbl28c:   success++
p8l_lbl28c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1358   skip28c:
p8l_skip28c
	; source: test_word_splitw_lte.p8:1360   cx16.r3 = &lbl28d
	lda  #<p8l_lbl28d
	ldy  #>p8l_lbl28d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1361   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1363   goto skip28d
	bra  p8l_skip28d
	; source: test_word_splitw_lte.p8:1364   lbl28d:   success++
p8l_lbl28d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1365   skip28d:
p8l_skip28d
	; source: test_word_splitw_lte.p8:1367   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_168_afterif
	; source: test_word_splitw_lte.p8:1368   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_168_afterif
	; source: test_word_splitw_lte.p8:1371   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_170_else
	; source: test_word_splitw_lte.p8:1372   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_169_afterif
	; source: test_word_splitw_lte.p8:1376   x=170
	lda  #<$aa
	ldy  #>$aa
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_word_splitw_lte.p8:1377   sources[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_sources_lsb,y
	lda  #>$aa
	sta  p8v_sources_msb,y
	; source: test_word_splitw_lte.p8:1378   values[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_values_lsb,y
	lda  #>-$5545
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1380   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl29a
	; source: test_word_splitw_lte.p8:1382   goto skip29a
	bra  p8l_skip29a
	; source: test_word_splitw_lte.p8:1383   lbl29a:   fail_word(49)
p8l_lbl29a
	ldy  #>$31
	lda  #<$31
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1384   skip29a:
p8l_skip29a
	; source: test_word_splitw_lte.p8:1386   cx16.r3 = &lbl29b
	lda  #<p8l_lbl29b
	ldy  #>p8l_lbl29b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1387   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1389   goto skip29b
	bra  p8l_skip29b
	; source: test_word_splitw_lte.p8:1390   lbl29b:   fail_word(50)
p8l_lbl29b
	ldy  #>$32
	lda  #<$32
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1391   skip29b:
p8l_skip29b
	; source: test_word_splitw_lte.p8:1393   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_171_afterif
	; source: test_word_splitw_lte.p8:1394   fail_word(51)
	ldy  #>$33
	lda  #<$33
	jsr  p8b_main.p8s_fail_word
label_asm_171_afterif
	; source: test_word_splitw_lte.p8:1397   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_173_else
	; source: test_word_splitw_lte.p8:1398   fail_word(52)
	ldy  #>$34
	lda  #<$34
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_172_afterif
label_asm_173_else
	; source: test_word_splitw_lte.p8:1400   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_172_afterif
	; source: test_word_splitw_lte.p8:1403   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl29c
	; source: test_word_splitw_lte.p8:1405   goto skip29c
	bra  p8l_skip29c
	; source: test_word_splitw_lte.p8:1406   lbl29c:   fail_word(53)
p8l_lbl29c
	ldy  #>$35
	lda  #<$35
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1407   skip29c:
p8l_skip29c
	; source: test_word_splitw_lte.p8:1409   cx16.r3 = &lbl29d
	lda  #<p8l_lbl29d
	ldy  #>p8l_lbl29d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1410   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1412   goto skip29d
	bra  p8l_skip29d
	; source: test_word_splitw_lte.p8:1413   lbl29d:   fail_word(54)
p8l_lbl29d
	ldy  #>$36
	lda  #<$36
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1414   skip29d:
p8l_skip29d
	; source: test_word_splitw_lte.p8:1416   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_174_afterif
	; source: test_word_splitw_lte.p8:1417   fail_word(55)
	ldy  #>$37
	lda  #<$37
	jsr  p8b_main.p8s_fail_word
label_asm_174_afterif
	; source: test_word_splitw_lte.p8:1420   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_176_else
	; source: test_word_splitw_lte.p8:1421   fail_word(56)
	ldy  #>$38
	lda  #<$38
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_175_afterif
label_asm_176_else
	; source: test_word_splitw_lte.p8:1423   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_175_afterif
	; source: test_word_splitw_lte.p8:1425   values[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_values_lsb,y
	lda  #>-1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1427   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl30a
	; source: test_word_splitw_lte.p8:1429   goto skip30a
	bra  p8l_skip30a
	; source: test_word_splitw_lte.p8:1430   lbl30a:   fail_word(57)
p8l_lbl30a
	ldy  #>$39
	lda  #<$39
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1431   skip30a:
p8l_skip30a
	; source: test_word_splitw_lte.p8:1433   cx16.r3 = &lbl30b
	lda  #<p8l_lbl30b
	ldy  #>p8l_lbl30b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1434   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1436   goto skip30b
	bra  p8l_skip30b
	; source: test_word_splitw_lte.p8:1437   lbl30b:   fail_word(58)
p8l_lbl30b
	ldy  #>$3a
	lda  #<$3a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1438   skip30b:
p8l_skip30b
	; source: test_word_splitw_lte.p8:1440   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_177_afterif
	; source: test_word_splitw_lte.p8:1441   fail_word(59)
	ldy  #>$3b
	lda  #<$3b
	jsr  p8b_main.p8s_fail_word
label_asm_177_afterif
	; source: test_word_splitw_lte.p8:1444   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_179_else
	; source: test_word_splitw_lte.p8:1445   fail_word(60)
	ldy  #>$3c
	lda  #<$3c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_178_afterif
label_asm_179_else
	; source: test_word_splitw_lte.p8:1447   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_178_afterif
	; source: test_word_splitw_lte.p8:1450   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl30c
	; source: test_word_splitw_lte.p8:1452   goto skip30c
	bra  p8l_skip30c
	; source: test_word_splitw_lte.p8:1453   lbl30c:   fail_word(61)
p8l_lbl30c
	ldy  #>$3d
	lda  #<$3d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1454   skip30c:
p8l_skip30c
	; source: test_word_splitw_lte.p8:1456   cx16.r3 = &lbl30d
	lda  #<p8l_lbl30d
	ldy  #>p8l_lbl30d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1457   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1459   goto skip30d
	bra  p8l_skip30d
	; source: test_word_splitw_lte.p8:1460   lbl30d:   fail_word(62)
p8l_lbl30d
	ldy  #>$3e
	lda  #<$3e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1461   skip30d:
p8l_skip30d
	; source: test_word_splitw_lte.p8:1463   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_180_afterif
	; source: test_word_splitw_lte.p8:1464   fail_word(63)
	ldy  #>$3f
	lda  #<$3f
	jsr  p8b_main.p8s_fail_word
label_asm_180_afterif
	; source: test_word_splitw_lte.p8:1467   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_182_else
	; source: test_word_splitw_lte.p8:1468   fail_word(64)
	ldy  #>$40
	lda  #<$40
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_181_afterif
label_asm_182_else
	; source: test_word_splitw_lte.p8:1470   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_181_afterif
	; source: test_word_splitw_lte.p8:1472   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1474   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl31a
	; source: test_word_splitw_lte.p8:1476   goto skip31a
	bra  p8l_skip31a
	; source: test_word_splitw_lte.p8:1477   lbl31a:   fail_word(65)
p8l_lbl31a
	ldy  #>$41
	lda  #<$41
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1478   skip31a:
p8l_skip31a
	; source: test_word_splitw_lte.p8:1480   cx16.r3 = &lbl31b
	lda  #<p8l_lbl31b
	ldy  #>p8l_lbl31b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1481   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1483   goto skip31b
	bra  p8l_skip31b
	; source: test_word_splitw_lte.p8:1484   lbl31b:   fail_word(66)
p8l_lbl31b
	ldy  #>$42
	lda  #<$42
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1485   skip31b:
p8l_skip31b
	; source: test_word_splitw_lte.p8:1487   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_183_afterif
	; source: test_word_splitw_lte.p8:1488   fail_word(67)
	ldy  #>$43
	lda  #<$43
	jsr  p8b_main.p8s_fail_word
label_asm_183_afterif
	; source: test_word_splitw_lte.p8:1491   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_185_else
	; source: test_word_splitw_lte.p8:1492   fail_word(68)
	ldy  #>$44
	lda  #<$44
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_184_afterif
label_asm_185_else
	; source: test_word_splitw_lte.p8:1494   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_184_afterif
	; source: test_word_splitw_lte.p8:1497   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl31c
	; source: test_word_splitw_lte.p8:1499   goto skip31c
	bra  p8l_skip31c
	; source: test_word_splitw_lte.p8:1500   lbl31c:   fail_word(69)
p8l_lbl31c
	ldy  #>$45
	lda  #<$45
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1501   skip31c:
p8l_skip31c
	; source: test_word_splitw_lte.p8:1503   cx16.r3 = &lbl31d
	lda  #<p8l_lbl31d
	ldy  #>p8l_lbl31d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1504   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1506   goto skip31d
	bra  p8l_skip31d
	; source: test_word_splitw_lte.p8:1507   lbl31d:   fail_word(70)
p8l_lbl31d
	ldy  #>$46
	lda  #<$46
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1508   skip31d:
p8l_skip31d
	; source: test_word_splitw_lte.p8:1510   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_186_afterif
	; source: test_word_splitw_lte.p8:1511   fail_word(71)
	ldy  #>$47
	lda  #<$47
	jsr  p8b_main.p8s_fail_word
label_asm_186_afterif
	; source: test_word_splitw_lte.p8:1514   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_188_else
	; source: test_word_splitw_lte.p8:1515   fail_word(72)
	ldy  #>$48
	lda  #<$48
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_187_afterif
label_asm_188_else
	; source: test_word_splitw_lte.p8:1517   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_187_afterif
	; source: test_word_splitw_lte.p8:1519   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1521   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl32a
	; source: test_word_splitw_lte.p8:1523   goto skip32a
	bra  p8l_skip32a
	; source: test_word_splitw_lte.p8:1524   lbl32a:   fail_word(73)
p8l_lbl32a
	ldy  #>$49
	lda  #<$49
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1525   skip32a:
p8l_skip32a
	; source: test_word_splitw_lte.p8:1527   cx16.r3 = &lbl32b
	lda  #<p8l_lbl32b
	ldy  #>p8l_lbl32b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1528   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1530   goto skip32b
	bra  p8l_skip32b
	; source: test_word_splitw_lte.p8:1531   lbl32b:   fail_word(74)
p8l_lbl32b
	ldy  #>$4a
	lda  #<$4a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1532   skip32b:
p8l_skip32b
	; source: test_word_splitw_lte.p8:1534   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_189_afterif
	; source: test_word_splitw_lte.p8:1535   fail_word(75)
	ldy  #>$4b
	lda  #<$4b
	jsr  p8b_main.p8s_fail_word
label_asm_189_afterif
	; source: test_word_splitw_lte.p8:1538   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_191_else
	; source: test_word_splitw_lte.p8:1539   fail_word(76)
	ldy  #>$4c
	lda  #<$4c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_190_afterif
label_asm_191_else
	; source: test_word_splitw_lte.p8:1541   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_190_afterif
	; source: test_word_splitw_lte.p8:1544   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl32c
	; source: test_word_splitw_lte.p8:1546   goto skip32c
	bra  p8l_skip32c
	; source: test_word_splitw_lte.p8:1547   lbl32c:   fail_word(77)
p8l_lbl32c
	ldy  #>$4d
	lda  #<$4d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1548   skip32c:
p8l_skip32c
	; source: test_word_splitw_lte.p8:1550   cx16.r3 = &lbl32d
	lda  #<p8l_lbl32d
	ldy  #>p8l_lbl32d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1551   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1553   goto skip32d
	bra  p8l_skip32d
	; source: test_word_splitw_lte.p8:1554   lbl32d:   fail_word(78)
p8l_lbl32d
	ldy  #>$4e
	lda  #<$4e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1555   skip32d:
p8l_skip32d
	; source: test_word_splitw_lte.p8:1557   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_192_afterif
	; source: test_word_splitw_lte.p8:1558   fail_word(79)
	ldy  #>$4f
	lda  #<$4f
	jsr  p8b_main.p8s_fail_word
label_asm_192_afterif
	; source: test_word_splitw_lte.p8:1561   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_194_else
	; source: test_word_splitw_lte.p8:1562   fail_word(80)
	ldy  #>$50
	lda  #<$50
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_193_afterif
label_asm_194_else
	; source: test_word_splitw_lte.p8:1564   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_193_afterif
	; source: test_word_splitw_lte.p8:1566   values[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_values_lsb,y
	lda  #>$aa
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1568   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl33a
	; source: test_word_splitw_lte.p8:1570   goto skip33a
	bra  p8l_skip33a
	; source: test_word_splitw_lte.p8:1571   lbl33a:   success++
p8l_lbl33a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1572   skip33a:
p8l_skip33a
	; source: test_word_splitw_lte.p8:1574   cx16.r3 = &lbl33b
	lda  #<p8l_lbl33b
	ldy  #>p8l_lbl33b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1575   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1577   goto skip33b
	bra  p8l_skip33b
	; source: test_word_splitw_lte.p8:1578   lbl33b:   success++
p8l_lbl33b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1579   skip33b:
p8l_skip33b
	; source: test_word_splitw_lte.p8:1581   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_195_afterif
	; source: test_word_splitw_lte.p8:1582   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_195_afterif
	; source: test_word_splitw_lte.p8:1585   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_197_else
	; source: test_word_splitw_lte.p8:1586   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_197_else
	; source: test_word_splitw_lte.p8:1588   cx16.r0L++
	inc  cx16.r0L
label_asm_196_afterif
	; source: test_word_splitw_lte.p8:1591   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl33c
	; source: test_word_splitw_lte.p8:1593   goto skip33c
	bra  p8l_skip33c
	; source: test_word_splitw_lte.p8:1594   lbl33c:   success++
p8l_lbl33c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1595   skip33c:
p8l_skip33c
	; source: test_word_splitw_lte.p8:1597   cx16.r3 = &lbl33d
	lda  #<p8l_lbl33d
	ldy  #>p8l_lbl33d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1598   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1600   goto skip33d
	bra  p8l_skip33d
	; source: test_word_splitw_lte.p8:1601   lbl33d:   success++
p8l_lbl33d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1602   skip33d:
p8l_skip33d
	; source: test_word_splitw_lte.p8:1604   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_198_afterif
	; source: test_word_splitw_lte.p8:1605   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_198_afterif
	; source: test_word_splitw_lte.p8:1608   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_200_else
	; source: test_word_splitw_lte.p8:1609   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_200_else
	; source: test_word_splitw_lte.p8:1611   cx16.r0L++
	inc  cx16.r0L
label_asm_199_afterif
	; source: test_word_splitw_lte.p8:1613   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1615   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl34a
	; source: test_word_splitw_lte.p8:1617   goto skip34a
	bra  p8l_skip34a
	; source: test_word_splitw_lte.p8:1618   lbl34a:   success++
p8l_lbl34a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1619   skip34a:
p8l_skip34a
	; source: test_word_splitw_lte.p8:1621   cx16.r3 = &lbl34b
	lda  #<p8l_lbl34b
	ldy  #>p8l_lbl34b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1622   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1624   goto skip34b
	bra  p8l_skip34b
	; source: test_word_splitw_lte.p8:1625   lbl34b:   success++
p8l_lbl34b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1626   skip34b:
p8l_skip34b
	; source: test_word_splitw_lte.p8:1628   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_201_afterif
	; source: test_word_splitw_lte.p8:1629   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_201_afterif
	; source: test_word_splitw_lte.p8:1632   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_203_else
	; source: test_word_splitw_lte.p8:1633   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_203_else
	; source: test_word_splitw_lte.p8:1635   cx16.r0L++
	inc  cx16.r0L
label_asm_202_afterif
	; source: test_word_splitw_lte.p8:1638   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl34c
	; source: test_word_splitw_lte.p8:1640   goto skip34c
	bra  p8l_skip34c
	; source: test_word_splitw_lte.p8:1641   lbl34c:   success++
p8l_lbl34c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1642   skip34c:
p8l_skip34c
	; source: test_word_splitw_lte.p8:1644   cx16.r3 = &lbl34d
	lda  #<p8l_lbl34d
	ldy  #>p8l_lbl34d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1645   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1647   goto skip34d
	bra  p8l_skip34d
	; source: test_word_splitw_lte.p8:1648   lbl34d:   success++
p8l_lbl34d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1649   skip34d:
p8l_skip34d
	; source: test_word_splitw_lte.p8:1651   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_204_afterif
	; source: test_word_splitw_lte.p8:1652   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_204_afterif
	; source: test_word_splitw_lte.p8:1655   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_206_else
	; source: test_word_splitw_lte.p8:1656   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_206_else
	; source: test_word_splitw_lte.p8:1658   cx16.r0L++
	inc  cx16.r0L
label_asm_205_afterif
	; source: test_word_splitw_lte.p8:1660   values[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_values_lsb,y
	lda  #>$7fff
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1662   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl35a
	; source: test_word_splitw_lte.p8:1664   goto skip35a
	bra  p8l_skip35a
	; source: test_word_splitw_lte.p8:1665   lbl35a:   success++
p8l_lbl35a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1666   skip35a:
p8l_skip35a
	; source: test_word_splitw_lte.p8:1668   cx16.r3 = &lbl35b
	lda  #<p8l_lbl35b
	ldy  #>p8l_lbl35b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1669   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1671   goto skip35b
	bra  p8l_skip35b
	; source: test_word_splitw_lte.p8:1672   lbl35b:   success++
p8l_lbl35b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1673   skip35b:
p8l_skip35b
	; source: test_word_splitw_lte.p8:1675   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_207_afterif
	; source: test_word_splitw_lte.p8:1676   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_207_afterif
	; source: test_word_splitw_lte.p8:1679   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_209_else
	; source: test_word_splitw_lte.p8:1680   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_209_else
	; source: test_word_splitw_lte.p8:1682   cx16.r0L++
	inc  cx16.r0L
label_asm_208_afterif
	; source: test_word_splitw_lte.p8:1685   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl35c
	; source: test_word_splitw_lte.p8:1687   goto skip35c
	bra  p8l_skip35c
	; source: test_word_splitw_lte.p8:1688   lbl35c:   success++
p8l_lbl35c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1689   skip35c:
p8l_skip35c
	; source: test_word_splitw_lte.p8:1691   cx16.r3 = &lbl35d
	lda  #<p8l_lbl35d
	ldy  #>p8l_lbl35d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1692   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1694   goto skip35d
	bra  p8l_skip35d
	; source: test_word_splitw_lte.p8:1695   lbl35d:   success++
p8l_lbl35d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1696   skip35d:
p8l_skip35d
	; source: test_word_splitw_lte.p8:1698   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_210_afterif
	; source: test_word_splitw_lte.p8:1699   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_210_afterif
	; source: test_word_splitw_lte.p8:1702   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_212_else
	; source: test_word_splitw_lte.p8:1703   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_212_else
	; source: test_word_splitw_lte.p8:1705   cx16.r0L++
	inc  cx16.r0L
label_asm_211_afterif
	; source: test_word_splitw_lte.p8:1707   x=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_word_splitw_lte.p8:1708   sources[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_sources_lsb,y
	lda  #>$7700
	sta  p8v_sources_msb,y
	; source: test_word_splitw_lte.p8:1709   values[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_values_lsb,y
	lda  #>-$5545
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1711   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl36a
	; source: test_word_splitw_lte.p8:1713   goto skip36a
	bra  p8l_skip36a
	; source: test_word_splitw_lte.p8:1714   lbl36a:   fail_word(81)
p8l_lbl36a
	ldy  #>$51
	lda  #<$51
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1715   skip36a:
p8l_skip36a
	; source: test_word_splitw_lte.p8:1717   cx16.r3 = &lbl36b
	lda  #<p8l_lbl36b
	ldy  #>p8l_lbl36b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1718   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1720   goto skip36b
	bra  p8l_skip36b
	; source: test_word_splitw_lte.p8:1721   lbl36b:   fail_word(82)
p8l_lbl36b
	ldy  #>$52
	lda  #<$52
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1722   skip36b:
p8l_skip36b
	; source: test_word_splitw_lte.p8:1724   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_213_afterif
	; source: test_word_splitw_lte.p8:1725   fail_word(83)
	ldy  #>$53
	lda  #<$53
	jsr  p8b_main.p8s_fail_word
label_asm_213_afterif
	; source: test_word_splitw_lte.p8:1728   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_215_else
	; source: test_word_splitw_lte.p8:1729   fail_word(84)
	ldy  #>$54
	lda  #<$54
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_214_afterif
label_asm_215_else
	; source: test_word_splitw_lte.p8:1731   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_214_afterif
	; source: test_word_splitw_lte.p8:1734   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl36c
	; source: test_word_splitw_lte.p8:1736   goto skip36c
	bra  p8l_skip36c
	; source: test_word_splitw_lte.p8:1737   lbl36c:   fail_word(85)
p8l_lbl36c
	ldy  #>$55
	lda  #<$55
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1738   skip36c:
p8l_skip36c
	; source: test_word_splitw_lte.p8:1740   cx16.r3 = &lbl36d
	lda  #<p8l_lbl36d
	ldy  #>p8l_lbl36d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1741   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1743   goto skip36d
	bra  p8l_skip36d
	; source: test_word_splitw_lte.p8:1744   lbl36d:   fail_word(86)
p8l_lbl36d
	ldy  #>$56
	lda  #<$56
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1745   skip36d:
p8l_skip36d
	; source: test_word_splitw_lte.p8:1747   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_216_afterif
	; source: test_word_splitw_lte.p8:1748   fail_word(87)
	ldy  #>$57
	lda  #<$57
	jsr  p8b_main.p8s_fail_word
label_asm_216_afterif
	; source: test_word_splitw_lte.p8:1751   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_218_else
	; source: test_word_splitw_lte.p8:1752   fail_word(88)
	ldy  #>$58
	lda  #<$58
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_217_afterif
label_asm_218_else
	; source: test_word_splitw_lte.p8:1754   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_217_afterif
	; source: test_word_splitw_lte.p8:1756   values[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_values_lsb,y
	lda  #>-1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1758   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl37a
	; source: test_word_splitw_lte.p8:1760   goto skip37a
	bra  p8l_skip37a
	; source: test_word_splitw_lte.p8:1761   lbl37a:   fail_word(89)
p8l_lbl37a
	ldy  #>$59
	lda  #<$59
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1762   skip37a:
p8l_skip37a
	; source: test_word_splitw_lte.p8:1764   cx16.r3 = &lbl37b
	lda  #<p8l_lbl37b
	ldy  #>p8l_lbl37b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1765   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1767   goto skip37b
	bra  p8l_skip37b
	; source: test_word_splitw_lte.p8:1768   lbl37b:   fail_word(90)
p8l_lbl37b
	ldy  #>$5a
	lda  #<$5a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1769   skip37b:
p8l_skip37b
	; source: test_word_splitw_lte.p8:1771   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_219_afterif
	; source: test_word_splitw_lte.p8:1772   fail_word(91)
	ldy  #>$5b
	lda  #<$5b
	jsr  p8b_main.p8s_fail_word
label_asm_219_afterif
	; source: test_word_splitw_lte.p8:1775   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_221_else
	; source: test_word_splitw_lte.p8:1776   fail_word(92)
	ldy  #>$5c
	lda  #<$5c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_220_afterif
label_asm_221_else
	; source: test_word_splitw_lte.p8:1778   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_220_afterif
	; source: test_word_splitw_lte.p8:1781   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl37c
	; source: test_word_splitw_lte.p8:1783   goto skip37c
	bra  p8l_skip37c
	; source: test_word_splitw_lte.p8:1784   lbl37c:   fail_word(93)
p8l_lbl37c
	ldy  #>$5d
	lda  #<$5d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1785   skip37c:
p8l_skip37c
	; source: test_word_splitw_lte.p8:1787   cx16.r3 = &lbl37d
	lda  #<p8l_lbl37d
	ldy  #>p8l_lbl37d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1788   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1790   goto skip37d
	bra  p8l_skip37d
	; source: test_word_splitw_lte.p8:1791   lbl37d:   fail_word(94)
p8l_lbl37d
	ldy  #>$5e
	lda  #<$5e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1792   skip37d:
p8l_skip37d
	; source: test_word_splitw_lte.p8:1794   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_222_afterif
	; source: test_word_splitw_lte.p8:1795   fail_word(95)
	ldy  #>$5f
	lda  #<$5f
	jsr  p8b_main.p8s_fail_word
label_asm_222_afterif
	; source: test_word_splitw_lte.p8:1798   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_224_else
	; source: test_word_splitw_lte.p8:1799   fail_word(96)
	ldy  #>$60
	lda  #<$60
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_223_afterif
label_asm_224_else
	; source: test_word_splitw_lte.p8:1801   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_223_afterif
	; source: test_word_splitw_lte.p8:1803   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1805   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl38a
	; source: test_word_splitw_lte.p8:1807   goto skip38a
	bra  p8l_skip38a
	; source: test_word_splitw_lte.p8:1808   lbl38a:   fail_word(97)
p8l_lbl38a
	ldy  #>$61
	lda  #<$61
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1809   skip38a:
p8l_skip38a
	; source: test_word_splitw_lte.p8:1811   cx16.r3 = &lbl38b
	lda  #<p8l_lbl38b
	ldy  #>p8l_lbl38b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1812   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1814   goto skip38b
	bra  p8l_skip38b
	; source: test_word_splitw_lte.p8:1815   lbl38b:   fail_word(98)
p8l_lbl38b
	ldy  #>$62
	lda  #<$62
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1816   skip38b:
p8l_skip38b
	; source: test_word_splitw_lte.p8:1818   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_225_afterif
	; source: test_word_splitw_lte.p8:1819   fail_word(99)
	ldy  #>$63
	lda  #<$63
	jsr  p8b_main.p8s_fail_word
label_asm_225_afterif
	; source: test_word_splitw_lte.p8:1822   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_227_else
	; source: test_word_splitw_lte.p8:1823   fail_word(100)
	ldy  #>$64
	lda  #<$64
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_226_afterif
label_asm_227_else
	; source: test_word_splitw_lte.p8:1825   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_226_afterif
	; source: test_word_splitw_lte.p8:1828   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl38c
	; source: test_word_splitw_lte.p8:1830   goto skip38c
	bra  p8l_skip38c
	; source: test_word_splitw_lte.p8:1831   lbl38c:   fail_word(101)
p8l_lbl38c
	ldy  #>$65
	lda  #<$65
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1832   skip38c:
p8l_skip38c
	; source: test_word_splitw_lte.p8:1834   cx16.r3 = &lbl38d
	lda  #<p8l_lbl38d
	ldy  #>p8l_lbl38d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1835   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1837   goto skip38d
	bra  p8l_skip38d
	; source: test_word_splitw_lte.p8:1838   lbl38d:   fail_word(102)
p8l_lbl38d
	ldy  #>$66
	lda  #<$66
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1839   skip38d:
p8l_skip38d
	; source: test_word_splitw_lte.p8:1841   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_228_afterif
	; source: test_word_splitw_lte.p8:1842   fail_word(103)
	ldy  #>$67
	lda  #<$67
	jsr  p8b_main.p8s_fail_word
label_asm_228_afterif
	; source: test_word_splitw_lte.p8:1845   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_230_else
	; source: test_word_splitw_lte.p8:1846   fail_word(104)
	ldy  #>$68
	lda  #<$68
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_229_afterif
label_asm_230_else
	; source: test_word_splitw_lte.p8:1848   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_229_afterif
	; source: test_word_splitw_lte.p8:1850   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1852   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl39a
	; source: test_word_splitw_lte.p8:1854   goto skip39a
	bra  p8l_skip39a
	; source: test_word_splitw_lte.p8:1855   lbl39a:   fail_word(105)
p8l_lbl39a
	ldy  #>$69
	lda  #<$69
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1856   skip39a:
p8l_skip39a
	; source: test_word_splitw_lte.p8:1858   cx16.r3 = &lbl39b
	lda  #<p8l_lbl39b
	ldy  #>p8l_lbl39b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1859   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1861   goto skip39b
	bra  p8l_skip39b
	; source: test_word_splitw_lte.p8:1862   lbl39b:   fail_word(106)
p8l_lbl39b
	ldy  #>$6a
	lda  #<$6a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1863   skip39b:
p8l_skip39b
	; source: test_word_splitw_lte.p8:1865   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_231_afterif
	; source: test_word_splitw_lte.p8:1866   fail_word(107)
	ldy  #>$6b
	lda  #<$6b
	jsr  p8b_main.p8s_fail_word
label_asm_231_afterif
	; source: test_word_splitw_lte.p8:1869   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_233_else
	; source: test_word_splitw_lte.p8:1870   fail_word(108)
	ldy  #>$6c
	lda  #<$6c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_232_afterif
label_asm_233_else
	; source: test_word_splitw_lte.p8:1872   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_232_afterif
	; source: test_word_splitw_lte.p8:1875   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl39c
	; source: test_word_splitw_lte.p8:1877   goto skip39c
	bra  p8l_skip39c
	; source: test_word_splitw_lte.p8:1878   lbl39c:   fail_word(109)
p8l_lbl39c
	ldy  #>$6d
	lda  #<$6d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1879   skip39c:
p8l_skip39c
	; source: test_word_splitw_lte.p8:1881   cx16.r3 = &lbl39d
	lda  #<p8l_lbl39d
	ldy  #>p8l_lbl39d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1882   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1884   goto skip39d
	bra  p8l_skip39d
	; source: test_word_splitw_lte.p8:1885   lbl39d:   fail_word(110)
p8l_lbl39d
	ldy  #>$6e
	lda  #<$6e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1886   skip39d:
p8l_skip39d
	; source: test_word_splitw_lte.p8:1888   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_234_afterif
	; source: test_word_splitw_lte.p8:1889   fail_word(111)
	ldy  #>$6f
	lda  #<$6f
	jsr  p8b_main.p8s_fail_word
label_asm_234_afterif
	; source: test_word_splitw_lte.p8:1892   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_236_else
	; source: test_word_splitw_lte.p8:1893   fail_word(112)
	ldy  #>$70
	lda  #<$70
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_235_afterif
label_asm_236_else
	; source: test_word_splitw_lte.p8:1895   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_235_afterif
	; source: test_word_splitw_lte.p8:1897   values[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_values_lsb,y
	lda  #>$aa
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1899   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl40a
	; source: test_word_splitw_lte.p8:1901   goto skip40a
	bra  p8l_skip40a
	; source: test_word_splitw_lte.p8:1902   lbl40a:   fail_word(113)
p8l_lbl40a
	ldy  #>$71
	lda  #<$71
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1903   skip40a:
p8l_skip40a
	; source: test_word_splitw_lte.p8:1905   cx16.r3 = &lbl40b
	lda  #<p8l_lbl40b
	ldy  #>p8l_lbl40b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1906   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1908   goto skip40b
	bra  p8l_skip40b
	; source: test_word_splitw_lte.p8:1909   lbl40b:   fail_word(114)
p8l_lbl40b
	ldy  #>$72
	lda  #<$72
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1910   skip40b:
p8l_skip40b
	; source: test_word_splitw_lte.p8:1912   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_237_afterif
	; source: test_word_splitw_lte.p8:1913   fail_word(115)
	ldy  #>$73
	lda  #<$73
	jsr  p8b_main.p8s_fail_word
label_asm_237_afterif
	; source: test_word_splitw_lte.p8:1916   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_239_else
	; source: test_word_splitw_lte.p8:1917   fail_word(116)
	ldy  #>$74
	lda  #<$74
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_238_afterif
label_asm_239_else
	; source: test_word_splitw_lte.p8:1919   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_238_afterif
	; source: test_word_splitw_lte.p8:1922   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl40c
	; source: test_word_splitw_lte.p8:1924   goto skip40c
	bra  p8l_skip40c
	; source: test_word_splitw_lte.p8:1925   lbl40c:   fail_word(117)
p8l_lbl40c
	ldy  #>$75
	lda  #<$75
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1926   skip40c:
p8l_skip40c
	; source: test_word_splitw_lte.p8:1928   cx16.r3 = &lbl40d
	lda  #<p8l_lbl40d
	ldy  #>p8l_lbl40d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1929   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1931   goto skip40d
	bra  p8l_skip40d
	; source: test_word_splitw_lte.p8:1932   lbl40d:   fail_word(118)
p8l_lbl40d
	ldy  #>$76
	lda  #<$76
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:1933   skip40d:
p8l_skip40d
	; source: test_word_splitw_lte.p8:1935   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_240_afterif
	; source: test_word_splitw_lte.p8:1936   fail_word(119)
	ldy  #>$77
	lda  #<$77
	jsr  p8b_main.p8s_fail_word
label_asm_240_afterif
	; source: test_word_splitw_lte.p8:1939   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_242_else
	; source: test_word_splitw_lte.p8:1940   fail_word(120)
	ldy  #>$78
	lda  #<$78
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_241_afterif
label_asm_242_else
	; source: test_word_splitw_lte.p8:1942   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_241_afterif
	; source: test_word_splitw_lte.p8:1944   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1946   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl41a
	; source: test_word_splitw_lte.p8:1948   goto skip41a
	bra  p8l_skip41a
	; source: test_word_splitw_lte.p8:1949   lbl41a:   success++
p8l_lbl41a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1950   skip41a:
p8l_skip41a
	; source: test_word_splitw_lte.p8:1952   cx16.r3 = &lbl41b
	lda  #<p8l_lbl41b
	ldy  #>p8l_lbl41b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1953   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1955   goto skip41b
	bra  p8l_skip41b
	; source: test_word_splitw_lte.p8:1956   lbl41b:   success++
p8l_lbl41b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1957   skip41b:
p8l_skip41b
	; source: test_word_splitw_lte.p8:1959   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_243_afterif
	; source: test_word_splitw_lte.p8:1960   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_243_afterif
	; source: test_word_splitw_lte.p8:1963   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_245_else
	; source: test_word_splitw_lte.p8:1964   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_245_else
	; source: test_word_splitw_lte.p8:1966   cx16.r0L++
	inc  cx16.r0L
label_asm_244_afterif
	; source: test_word_splitw_lte.p8:1969   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl41c
	; source: test_word_splitw_lte.p8:1971   goto skip41c
	bra  p8l_skip41c
	; source: test_word_splitw_lte.p8:1972   lbl41c:   success++
p8l_lbl41c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1973   skip41c:
p8l_skip41c
	; source: test_word_splitw_lte.p8:1975   cx16.r3 = &lbl41d
	lda  #<p8l_lbl41d
	ldy  #>p8l_lbl41d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:1976   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:1978   goto skip41d
	bra  p8l_skip41d
	; source: test_word_splitw_lte.p8:1979   lbl41d:   success++
p8l_lbl41d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1980   skip41d:
p8l_skip41d
	; source: test_word_splitw_lte.p8:1982   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_246_afterif
	; source: test_word_splitw_lte.p8:1983   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_246_afterif
	; source: test_word_splitw_lte.p8:1986   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_248_else
	; source: test_word_splitw_lte.p8:1987   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_248_else
	; source: test_word_splitw_lte.p8:1989   cx16.r0L++
	inc  cx16.r0L
label_asm_247_afterif
	; source: test_word_splitw_lte.p8:1991   values[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_values_lsb,y
	lda  #>$7fff
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:1993   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl42a
	; source: test_word_splitw_lte.p8:1995   goto skip42a
	bra  p8l_skip42a
	; source: test_word_splitw_lte.p8:1996   lbl42a:   success++
p8l_lbl42a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:1997   skip42a:
p8l_skip42a
	; source: test_word_splitw_lte.p8:1999   cx16.r3 = &lbl42b
	lda  #<p8l_lbl42b
	ldy  #>p8l_lbl42b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2000   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2002   goto skip42b
	bra  p8l_skip42b
	; source: test_word_splitw_lte.p8:2003   lbl42b:   success++
p8l_lbl42b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:2004   skip42b:
p8l_skip42b
	; source: test_word_splitw_lte.p8:2006   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_249_afterif
	; source: test_word_splitw_lte.p8:2007   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_249_afterif
	; source: test_word_splitw_lte.p8:2010   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_251_else
	; source: test_word_splitw_lte.p8:2011   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_251_else
	; source: test_word_splitw_lte.p8:2013   cx16.r0L++
	inc  cx16.r0L
label_asm_250_afterif
	; source: test_word_splitw_lte.p8:2016   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl42c
	; source: test_word_splitw_lte.p8:2018   goto skip42c
	bra  p8l_skip42c
	; source: test_word_splitw_lte.p8:2019   lbl42c:   success++
p8l_lbl42c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:2020   skip42c:
p8l_skip42c
	; source: test_word_splitw_lte.p8:2022   cx16.r3 = &lbl42d
	lda  #<p8l_lbl42d
	ldy  #>p8l_lbl42d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2023   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2025   goto skip42d
	bra  p8l_skip42d
	; source: test_word_splitw_lte.p8:2026   lbl42d:   success++
p8l_lbl42d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:2027   skip42d:
p8l_skip42d
	; source: test_word_splitw_lte.p8:2029   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_252_afterif
	; source: test_word_splitw_lte.p8:2030   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_252_afterif
	; source: test_word_splitw_lte.p8:2033   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_254_else
	; source: test_word_splitw_lte.p8:2034   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_254_else
	; source: test_word_splitw_lte.p8:2036   cx16.r0L++
	inc  cx16.r0L
label_asm_253_afterif
	; source: test_word_splitw_lte.p8:2038   x=32767
	lda  #<$7fff
	ldy  #>$7fff
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_word_splitw_lte.p8:2039   sources[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_sources_lsb,y
	lda  #>$7fff
	sta  p8v_sources_msb,y
	; source: test_word_splitw_lte.p8:2040   values[1]=-21829
	ldy  #1
	lda  #<-$5545
	sta  p8v_values_lsb,y
	lda  #>-$5545
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:2042   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl43a
	; source: test_word_splitw_lte.p8:2044   goto skip43a
	bra  p8l_skip43a
	; source: test_word_splitw_lte.p8:2045   lbl43a:   fail_word(121)
p8l_lbl43a
	ldy  #>$79
	lda  #<$79
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2046   skip43a:
p8l_skip43a
	; source: test_word_splitw_lte.p8:2048   cx16.r3 = &lbl43b
	lda  #<p8l_lbl43b
	ldy  #>p8l_lbl43b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2049   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2051   goto skip43b
	bra  p8l_skip43b
	; source: test_word_splitw_lte.p8:2052   lbl43b:   fail_word(122)
p8l_lbl43b
	ldy  #>$7a
	lda  #<$7a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2053   skip43b:
p8l_skip43b
	; source: test_word_splitw_lte.p8:2055   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_255_afterif
	; source: test_word_splitw_lte.p8:2056   fail_word(123)
	ldy  #>$7b
	lda  #<$7b
	jsr  p8b_main.p8s_fail_word
label_asm_255_afterif
	; source: test_word_splitw_lte.p8:2059   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_257_else
	; source: test_word_splitw_lte.p8:2060   fail_word(124)
	ldy  #>$7c
	lda  #<$7c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_256_afterif
label_asm_257_else
	; source: test_word_splitw_lte.p8:2062   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_256_afterif
	; source: test_word_splitw_lte.p8:2065   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl43c
	; source: test_word_splitw_lte.p8:2067   goto skip43c
	bra  p8l_skip43c
	; source: test_word_splitw_lte.p8:2068   lbl43c:   fail_word(125)
p8l_lbl43c
	ldy  #>$7d
	lda  #<$7d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2069   skip43c:
p8l_skip43c
	; source: test_word_splitw_lte.p8:2071   cx16.r3 = &lbl43d
	lda  #<p8l_lbl43d
	ldy  #>p8l_lbl43d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2072   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2074   goto skip43d
	bra  p8l_skip43d
	; source: test_word_splitw_lte.p8:2075   lbl43d:   fail_word(126)
p8l_lbl43d
	ldy  #>$7e
	lda  #<$7e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2076   skip43d:
p8l_skip43d
	; source: test_word_splitw_lte.p8:2078   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_258_afterif
	; source: test_word_splitw_lte.p8:2079   fail_word(127)
	ldy  #>$7f
	lda  #<$7f
	jsr  p8b_main.p8s_fail_word
label_asm_258_afterif
	; source: test_word_splitw_lte.p8:2082   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_260_else
	; source: test_word_splitw_lte.p8:2083   fail_word(128)
	ldy  #>$80
	lda  #<$80
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_259_afterif
label_asm_260_else
	; source: test_word_splitw_lte.p8:2085   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_259_afterif
	; source: test_word_splitw_lte.p8:2087   values[1]=-1
	ldy  #1
	lda  #<-1
	sta  p8v_values_lsb,y
	lda  #>-1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:2089   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl44a
	; source: test_word_splitw_lte.p8:2091   goto skip44a
	bra  p8l_skip44a
	; source: test_word_splitw_lte.p8:2092   lbl44a:   fail_word(129)
p8l_lbl44a
	ldy  #>$81
	lda  #<$81
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2093   skip44a:
p8l_skip44a
	; source: test_word_splitw_lte.p8:2095   cx16.r3 = &lbl44b
	lda  #<p8l_lbl44b
	ldy  #>p8l_lbl44b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2096   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2098   goto skip44b
	bra  p8l_skip44b
	; source: test_word_splitw_lte.p8:2099   lbl44b:   fail_word(130)
p8l_lbl44b
	ldy  #>$82
	lda  #<$82
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2100   skip44b:
p8l_skip44b
	; source: test_word_splitw_lte.p8:2102   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_261_afterif
	; source: test_word_splitw_lte.p8:2103   fail_word(131)
	ldy  #>$83
	lda  #<$83
	jsr  p8b_main.p8s_fail_word
label_asm_261_afterif
	; source: test_word_splitw_lte.p8:2106   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_263_else
	; source: test_word_splitw_lte.p8:2107   fail_word(132)
	ldy  #>$84
	lda  #<$84
	jsr  p8b_main.p8s_fail_word
...
label_asm_262_afterif
	; source: test_word_splitw_lte.p8:2112   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl44c
	; source: test_word_splitw_lte.p8:2114   goto skip44c
	bra  p8l_skip44c
	; source: test_word_splitw_lte.p8:2115   lbl44c:   fail_word(133)
p8l_lbl44c
	ldy  #>$85
	lda  #<$85
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2116   skip44c:
p8l_skip44c
	; source: test_word_splitw_lte.p8:2118   cx16.r3 = &lbl44d
	lda  #<p8l_lbl44d
	ldy  #>p8l_lbl44d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2119   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2121   goto skip44d
	bra  p8l_skip44d
	; source: test_word_splitw_lte.p8:2122   lbl44d:   fail_word(134)
p8l_lbl44d
	ldy  #>$86
	lda  #<$86
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2123   skip44d:
p8l_skip44d
	; source: test_word_splitw_lte.p8:2125   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_264_afterif
	; source: test_word_splitw_lte.p8:2126   fail_word(135)
	ldy  #>$87
	lda  #<$87
	jsr  p8b_main.p8s_fail_word
label_asm_264_afterif
	; source: test_word_splitw_lte.p8:2129   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_266_else
	; source: test_word_splitw_lte.p8:2130   fail_word(136)
	ldy  #>$88
	lda  #<$88
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_265_afterif
label_asm_266_else
	; source: test_word_splitw_lte.p8:2132   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_265_afterif
	; source: test_word_splitw_lte.p8:2134   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:2136   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl45a
	; source: test_word_splitw_lte.p8:2138   goto skip45a
	bra  p8l_skip45a
	; source: test_word_splitw_lte.p8:2139   lbl45a:   fail_word(137)
p8l_lbl45a
	ldy  #>$89
	lda  #<$89
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2140   skip45a:
p8l_skip45a
	; source: test_word_splitw_lte.p8:2142   cx16.r3 = &lbl45b
	lda  #<p8l_lbl45b
	ldy  #>p8l_lbl45b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2143   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2145   goto skip45b
	bra  p8l_skip45b
	; source: test_word_splitw_lte.p8:2146   lbl45b:   fail_word(138)
p8l_lbl45b
	ldy  #>$8a
	lda  #<$8a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2147   skip45b:
p8l_skip45b
	; source: test_word_splitw_lte.p8:2149   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_267_afterif
	; source: test_word_splitw_lte.p8:2150   fail_word(139)
	ldy  #>$8b
	lda  #<$8b
	jsr  p8b_main.p8s_fail_word
label_asm_267_afterif
	; source: test_word_splitw_lte.p8:2153   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_269_else
	; source: test_word_splitw_lte.p8:2154   fail_word(140)
	ldy  #>$8c
	lda  #<$8c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_268_afterif
label_asm_269_else
	; source: test_word_splitw_lte.p8:2156   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_268_afterif
	; source: test_word_splitw_lte.p8:2159   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl45c
	; source: test_word_splitw_lte.p8:2161   goto skip45c
	bra  p8l_skip45c
	; source: test_word_splitw_lte.p8:2162   lbl45c:   fail_word(141)
p8l_lbl45c
	ldy  #>$8d
	lda  #<$8d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2163   skip45c:
p8l_skip45c
	; source: test_word_splitw_lte.p8:2165   cx16.r3 = &lbl45d
	lda  #<p8l_lbl45d
	ldy  #>p8l_lbl45d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2166   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2168   goto skip45d
	bra  p8l_skip45d
	; source: test_word_splitw_lte.p8:2169   lbl45d:   fail_word(142)
p8l_lbl45d
	ldy  #>$8e
	lda  #<$8e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2170   skip45d:
p8l_skip45d
	; source: test_word_splitw_lte.p8:2172   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_270_afterif
	; source: test_word_splitw_lte.p8:2173   fail_word(143)
	ldy  #>$8f
	lda  #<$8f
	jsr  p8b_main.p8s_fail_word
label_asm_270_afterif
	; source: test_word_splitw_lte.p8:2176   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_272_else
	; source: test_word_splitw_lte.p8:2177   fail_word(144)
	ldy  #>$90
	lda  #<$90
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_271_afterif
label_asm_272_else
	; source: test_word_splitw_lte.p8:2179   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_271_afterif
	; source: test_word_splitw_lte.p8:2181   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:2183   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl46a
	; source: test_word_splitw_lte.p8:2185   goto skip46a
	bra  p8l_skip46a
	; source: test_word_splitw_lte.p8:2186   lbl46a:   fail_word(145)
p8l_lbl46a
	ldy  #>$91
	lda  #<$91
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2187   skip46a:
p8l_skip46a
	; source: test_word_splitw_lte.p8:2189   cx16.r3 = &lbl46b
	lda  #<p8l_lbl46b
	ldy  #>p8l_lbl46b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2190   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2192   goto skip46b
	bra  p8l_skip46b
	; source: test_word_splitw_lte.p8:2193   lbl46b:   fail_word(146)
p8l_lbl46b
	ldy  #>$92
	lda  #<$92
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2194   skip46b:
p8l_skip46b
	; source: test_word_splitw_lte.p8:2196   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_273_afterif
	; source: test_word_splitw_lte.p8:2197   fail_word(147)
	ldy  #>$93
	lda  #<$93
	jsr  p8b_main.p8s_fail_word
label_asm_273_afterif
	; source: test_word_splitw_lte.p8:2200   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_275_else
	; source: test_word_splitw_lte.p8:2201   fail_word(148)
	ldy  #>$94
	lda  #<$94
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_274_afterif
label_asm_275_else
	; source: test_word_splitw_lte.p8:2203   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_274_afterif
	; source: test_word_splitw_lte.p8:2206   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl46c
	; source: test_word_splitw_lte.p8:2208   goto skip46c
	bra  p8l_skip46c
	; source: test_word_splitw_lte.p8:2209   lbl46c:   fail_word(149)
p8l_lbl46c
	ldy  #>$95
	lda  #<$95
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2210   skip46c:
p8l_skip46c
	; source: test_word_splitw_lte.p8:2212   cx16.r3 = &lbl46d
	lda  #<p8l_lbl46d
	ldy  #>p8l_lbl46d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2213   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2215   goto skip46d
	bra  p8l_skip46d
	; source: test_word_splitw_lte.p8:2216   lbl46d:   fail_word(150)
p8l_lbl46d
	ldy  #>$96
	lda  #<$96
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2217   skip46d:
p8l_skip46d
	; source: test_word_splitw_lte.p8:2219   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_276_afterif
	; source: test_word_splitw_lte.p8:2220   fail_word(151)
	ldy  #>$97
	lda  #<$97
	jsr  p8b_main.p8s_fail_word
label_asm_276_afterif
	; source: test_word_splitw_lte.p8:2223   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_278_else
	; source: test_word_splitw_lte.p8:2224   fail_word(152)
	ldy  #>$98
	lda  #<$98
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_277_afterif
label_asm_278_else
	; source: test_word_splitw_lte.p8:2226   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_277_afterif
	; source: test_word_splitw_lte.p8:2228   values[1]=170
	ldy  #1
	lda  #<$aa
	sta  p8v_values_lsb,y
	lda  #>$aa
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:2230   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl47a
	; source: test_word_splitw_lte.p8:2232   goto skip47a
	bra  p8l_skip47a
	; source: test_word_splitw_lte.p8:2233   lbl47a:   fail_word(153)
p8l_lbl47a
	ldy  #>$99
	lda  #<$99
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2234   skip47a:
p8l_skip47a
	; source: test_word_splitw_lte.p8:2236   cx16.r3 = &lbl47b
	lda  #<p8l_lbl47b
	ldy  #>p8l_lbl47b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2237   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2239   goto skip47b
	bra  p8l_skip47b
	; source: test_word_splitw_lte.p8:2240   lbl47b:   fail_word(154)
p8l_lbl47b
	ldy  #>$9a
	lda  #<$9a
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2241   skip47b:
p8l_skip47b
	; source: test_word_splitw_lte.p8:2243   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_279_afterif
	; source: test_word_splitw_lte.p8:2244   fail_word(155)
	ldy  #>$9b
	lda  #<$9b
	jsr  p8b_main.p8s_fail_word
label_asm_279_afterif
	; source: test_word_splitw_lte.p8:2247   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_281_else
	; source: test_word_splitw_lte.p8:2248   fail_word(156)
	ldy  #>$9c
	lda  #<$9c
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_280_afterif
label_asm_281_else
	; source: test_word_splitw_lte.p8:2250   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_280_afterif
	; source: test_word_splitw_lte.p8:2253   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl47c
	; source: test_word_splitw_lte.p8:2255   goto skip47c
	bra  p8l_skip47c
	; source: test_word_splitw_lte.p8:2256   lbl47c:   fail_word(157)
p8l_lbl47c
	ldy  #>$9d
	lda  #<$9d
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2257   skip47c:
p8l_skip47c
	; source: test_word_splitw_lte.p8:2259   cx16.r3 = &lbl47d
	lda  #<p8l_lbl47d
	ldy  #>p8l_lbl47d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2260   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2262   goto skip47d
	bra  p8l_skip47d
	; source: test_word_splitw_lte.p8:2263   lbl47d:   fail_word(158)
p8l_lbl47d
	ldy  #>$9e
	lda  #<$9e
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2264   skip47d:
p8l_skip47d
	; source: test_word_splitw_lte.p8:2266   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_282_afterif
	; source: test_word_splitw_lte.p8:2267   fail_word(159)
	ldy  #>$9f
	lda  #<$9f
	jsr  p8b_main.p8s_fail_word
label_asm_282_afterif
	; source: test_word_splitw_lte.p8:2270   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_284_else
	; source: test_word_splitw_lte.p8:2271   fail_word(160)
	ldy  #>$a0
	lda  #<$a0
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_283_afterif
label_asm_284_else
	; source: test_word_splitw_lte.p8:2273   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_283_afterif
	; source: test_word_splitw_lte.p8:2275   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:2277   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl48a
	; source: test_word_splitw_lte.p8:2279   goto skip48a
	bra  p8l_skip48a
	; source: test_word_splitw_lte.p8:2280   lbl48a:   fail_word(161)
p8l_lbl48a
	ldy  #>$a1
	lda  #<$a1
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2281   skip48a:
p8l_skip48a
	; source: test_word_splitw_lte.p8:2283   cx16.r3 = &lbl48b
	lda  #<p8l_lbl48b
	ldy  #>p8l_lbl48b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2284   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2286   goto skip48b
	bra  p8l_skip48b
	; source: test_word_splitw_lte.p8:2287   lbl48b:   fail_word(162)
p8l_lbl48b
	ldy  #>$a2
	lda  #<$a2
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2288   skip48b:
p8l_skip48b
	; source: test_word_splitw_lte.p8:2290   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_285_afterif
	; source: test_word_splitw_lte.p8:2291   fail_word(163)
	ldy  #>$a3
	lda  #<$a3
	jsr  p8b_main.p8s_fail_word
label_asm_285_afterif
	; source: test_word_splitw_lte.p8:2294   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_287_else
	; source: test_word_splitw_lte.p8:2295   fail_word(164)
	ldy  #>$a4
	lda  #<$a4
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_286_afterif
label_asm_287_else
	; source: test_word_splitw_lte.p8:2297   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_286_afterif
	; source: test_word_splitw_lte.p8:2300   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl48c
	; source: test_word_splitw_lte.p8:2302   goto skip48c
	bra  p8l_skip48c
...
p8l_lbl48c
	...
	lda  #<$a5
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2304   skip48c:
p8l_skip48c
	; source: test_word_splitw_lte.p8:2306   cx16.r3 = &lbl48d
	lda  #<p8l_lbl48d
	ldy  #>p8l_lbl48d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2307   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2309   goto skip48d
	bra  p8l_skip48d
	; source: test_word_splitw_lte.p8:2310   lbl48d:   fail_word(166)
p8l_lbl48d
	ldy  #>$a6
	lda  #<$a6
	jsr  p8b_main.p8s_fail_word
	; source: test_word_splitw_lte.p8:2311   skip48d:
p8l_skip48d
	; source: test_word_splitw_lte.p8:2313   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_288_afterif
	; source: test_word_splitw_lte.p8:2314   fail_word(167)
	ldy  #>$a7
	lda  #<$a7
	jsr  p8b_main.p8s_fail_word
label_asm_288_afterif
	; source: test_word_splitw_lte.p8:2317   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_290_else
	; source: test_word_splitw_lte.p8:2318   fail_word(168)
	ldy  #>$a8
	lda  #<$a8
	jsr  p8b_main.p8s_fail_word
	bra  label_asm_289_afterif
label_asm_290_else
	; source: test_word_splitw_lte.p8:2320   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_289_afterif
	; source: test_word_splitw_lte.p8:2322   values[1]=32767
	ldy  #1
	lda  #<$7fff
	sta  p8v_values_lsb,y
	lda  #>$7fff
	sta  p8v_values_msb,y
	; source: test_word_splitw_lte.p8:2324   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	eor  #128
+                           bmi  p8l_lbl49a
	; source: test_word_splitw_lte.p8:2326   goto skip49a
	bra  p8l_skip49a
	; source: test_word_splitw_lte.p8:2327   lbl49a:   success++
p8l_lbl49a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:2328   skip49a:
p8l_skip49a
	; source: test_word_splitw_lte.p8:2330   cx16.r3 = &lbl49b
	lda  #<p8l_lbl49b
	ldy  #>p8l_lbl49b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2331   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2333   goto skip49b
	bra  p8l_skip49b
	; source: test_word_splitw_lte.p8:2334   lbl49b:   success++
p8l_lbl49b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:2335   skip49b:
p8l_skip49b
	; source: test_word_splitw_lte.p8:2337   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_291_afterif
	; source: test_word_splitw_lte.p8:2338   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_291_afterif
	; source: test_word_splitw_lte.p8:2341   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
...
+                           bmi  label_asm_293_else
	; source: test_word_splitw_lte.p8:2342   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_293_else
	; source: test_word_splitw_lte.p8:2344   cx16.r0L++
	inc  cx16.r0L
label_asm_292_afterif
	; source: test_word_splitw_lte.p8:2347   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	eor  #128
+                           bmi  p8l_lbl49c
	; source: test_word_splitw_lte.p8:2349   goto skip49c
	bra  p8l_skip49c
	; source: test_word_splitw_lte.p8:2350   lbl49c:   success++
p8l_lbl49c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:2351   skip49c:
p8l_skip49c
	; source: test_word_splitw_lte.p8:2353   cx16.r3 = &lbl49d
	lda  #<p8l_lbl49d
	ldy  #>p8l_lbl49d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_word_splitw_lte.p8:2354   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bpl  +
	jmp  (cx16.r3)
+
	; source: test_word_splitw_lte.p8:2356   goto skip49d
	bra  p8l_skip49d
	; source: test_word_splitw_lte.p8:2357   lbl49d:   success++
p8l_lbl49d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_word_splitw_lte.p8:2358   skip49d:
p8l_skip49d
	; source: test_word_splitw_lte.p8:2360   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_294_afterif
	; source: test_word_splitw_lte.p8:2361   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_294_afterif
	; source: test_word_splitw_lte.p8:2364   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
+                           bmi  label_asm_296_else
	; source: test_word_splitw_lte.p8:2365   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_296_else
	; source: test_word_splitw_lte.p8:2367   cx16.r0L++
	inc  cx16.r0L
label_asm_295_afterif
	; source: test_word_splitw_lte.p8:2369   verify_success(266)
	ldy  #>$010a
	lda  #<$010a
...
; non-zeropage variables
string_1	; PETSCII:"\nless-equal split words array tests for: "
	.byte  $0d, $4c, $45, $53, $53, $2d, $45, $51, $55, $41, $4c, $20, $53, $50, $4c, $49
	.byte  $54, $20, $57, $4f, $52, $44, $53, $20, $41, $52, $52, $41, $59, $20, $54, $45
