...
skip20b:
    ...
    sources[1]=-21829
    ; direct jump
        if sources[1]==cx16.r4s+-21829-cx16.r5s
            goto lbl1a
        goto skip1a
lbl1a:   success++
skip1a:
...
skip1b:
    ...
    ; direct jump
        if sources[1]==cx16.r4s+170-cx16.r5s
            goto lbl2a
        goto skip2a
...
skip2b:
    ...
    ; direct jump
        if sources[1]==cx16.r4s+30464-cx16.r5s
            goto lbl3a
        goto skip3a
...
skip3b:
    ...
    ; direct jump
        if sources[1]==cx16.r4s+32767-cx16.r5s
            goto lbl4a
        goto skip4a
...
skip20b:
    ...
    sub test_is_array_splitw() {
    
        word[] @split values = [9999, 8888]
