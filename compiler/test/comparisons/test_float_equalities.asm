; w65c02 assembly code for 'test_float_equalities'
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: test_float_equalities.p8:8   main {
...
p8v_datatype	; PETSCII:"float"
	.byte  $46, $4c, $4f, $41, $54, $00

	; source: test_float_equalities.p8:9   ubyte success = 0
	; source: test_float_equalities.p8:10   str datatype = "float"
	; source: test_float_equalities.p8:11   uword @shared comparison
	; source: test_float_equalities.p8:13   sub start() {
...
; statements
	...
	lda  #13
	jsr  txt.chrout
	; source: test_float_equalities.p8:17   test_stack.test()
	jsr  test_stack.test
	; source: test_float_equalities.p8:18   txt.print("==0: ")
	ldy  #>prog8_interned_strings.string_2
	lda  #<prog8_interned_strings.string_2
	jsr  txt.print
	; source: test_float_equalities.p8:19   test_is_zero()
	jsr  p8b_main.p8s_test_is_zero
	; source: test_float_equalities.p8:20   txt.print("\n!=0: ")
	ldy  #>prog8_interned_strings.string_3
	lda  #<prog8_interned_strings.string_3
	jsr  txt.print
	; source: test_float_equalities.p8:21   test_not_zero()
	jsr  p8b_main.p8s_test_not_zero
	; source: test_float_equalities.p8:22   txt.print("\n==number: ")
	ldy  #>prog8_interned_strings.string_4
	lda  #<prog8_interned_strings.string_4
	jsr  txt.print
	; source: test_float_equalities.p8:23   test_is_number()
	jsr  p8b_main.p8s_test_is_number
	; source: test_float_equalities.p8:24   txt.print("\n!=number: ")
	ldy  #>prog8_interned_strings.string_5
	lda  #<prog8_interned_strings.string_5
	jsr  txt.print
	; source: test_float_equalities.p8:25   test_not_number()
	jsr  p8b_main.p8s_test_not_number
	; source: test_float_equalities.p8:26   txt.print("\n==var: ")
	ldy  #>prog8_interned_strings.string_6
	lda  #<prog8_interned_strings.string_6
	jsr  txt.print
	; source: test_float_equalities.p8:27   test_is_var()
	jsr  p8b_main.p8s_test_is_var
	; source: test_float_equalities.p8:28   txt.print("\n!=var: ")
	ldy  #>prog8_interned_strings.string_7
	lda  #<prog8_interned_strings.string_7
	jsr  txt.print
	; source: test_float_equalities.p8:29   test_not_var()
	jsr  p8b_main.p8s_test_not_var
	; source: test_float_equalities.p8:30   txt.print("\n==array[]: ")
	ldy  #>prog8_interned_strings.string_8
	lda  #<prog8_interned_strings.string_8
	jsr  txt.print
	; source: test_float_equalities.p8:31   test_is_array()
	jsr  p8b_main.p8s_test_is_array
	; source: test_float_equalities.p8:32   txt.print("\n!=array[]: ")
	ldy  #>prog8_interned_strings.string_9
	lda  #<prog8_interned_strings.string_9
	jsr  txt.print
	; source: test_float_equalities.p8:33   test_not_array()
	jsr  p8b_main.p8s_test_not_array
	; source: test_float_equalities.p8:34   txt.print("\n==expr: ")
	ldy  #>prog8_interned_strings.string_10
	lda  #<prog8_interned_strings.string_10
	jsr  txt.print
	; source: test_float_equalities.p8:35   test_is_expr()
	jsr  p8b_main.p8s_test_is_expr
	; source: test_float_equalities.p8:36   txt.print("\n!=expr: ")
	ldy  #>prog8_interned_strings.string_11
	lda  #<prog8_interned_strings.string_11
	jsr  txt.print
	; source: test_float_equalities.p8:37   test_not_expr()
	jsr  p8b_main.p8s_test_not_expr
	; source: test_float_equalities.p8:38   test_stack.test()
	jmp  test_stack.test
	; source: test_float_equalities.p8:13   sub start() {
; variables
	.section BSS
	...
	.pend
	; source: test_float_equalities.p8:41   sub verify_success(ubyte expected) {

p8s_verify_success	.proc
; simple int arg(s) passed via register(s)
	sta  p8v_expected
; statements
	; source: test_float_equalities.p8:42   if success==expected {
	lda  p8b_main.p8v_success
	cmp  p8v_expected
	bne  label_asm_2_else
	; source: test_float_equalities.p8:43   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_float_equalities.p8:45   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_13
	lda  #<prog8_interned_strings.string_13
	jsr  txt.print
	; source: test_float_equalities.p8:46   txt.print_ub(success)
	lda  p8b_main.p8v_success
	jsr  txt.print_ub
	; source: test_float_equalities.p8:47   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_14
	lda  #<prog8_interned_strings.string_14
	jsr  txt.print
	; source: test_float_equalities.p8:48   txt.print_ub(expected)
	lda  p8v_expected
	jsr  txt.print_ub
label_asm_1_afterif
	; source: test_float_equalities.p8:41   sub verify_success(ubyte expected) {
...
p8v_expected	.byte  ?
	.send BSS
	.pend
	; source: test_float_equalities.p8:84   sub fail_float(uword idx, float v1) {

p8s_fail_float	.proc
; statements
	; source: test_float_equalities.p8:85   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_15
	lda  #<prog8_interned_strings.string_15
	jsr  txt.print
	; source: test_float_equalities.p8:86   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_float_equalities.p8:87   txt.chrout(':')
	lda  #$3a
	jsr  txt.chrout
	; source: test_float_equalities.p8:88   floats.print(v1)
	lda  #<p8v_v1
	ldy  #>p8v_v1
	jsr  floats.MOVFM
	jsr  floats.print
	; source: test_float_equalities.p8:89   txt.print(" **")
...
p8v_v1	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:94   sub test_is_zero() {

p8s_test_is_zero	.proc
; statements
	; source: test_float_equalities.p8:95   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:96   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:98   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:100   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	cmp  #0
	beq  p8l_lbl1
	; source: test_float_equalities.p8:102   goto skip1
	bra  p8l_skip1
	; source: test_float_equalities.p8:103   lbl1:   success++
p8l_lbl1
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:104   skip1:
p8l_skip1
	; source: test_float_equalities.p8:106   cx16.r3 = &lbl2
	lda  #<p8l_lbl2
	ldy  #>p8l_lbl2
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:107   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:109   goto skip2
	bra  p8l_skip2
	; source: test_float_equalities.p8:110   lbl2:   success++
p8l_lbl2
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:111   skip2:
p8l_skip2
	; source: test_float_equalities.p8:113   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:114   success++
	inc  p8b_main.p8v_success
label_asm_3_afterif
	; source: test_float_equalities.p8:117   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:118   success++
	inc  p8b_main.p8v_success
	bra  label_asm_4_afterif
label_asm_5_else
	; source: test_float_equalities.p8:120   cx16.r0L++
	inc  cx16.r0L
label_asm_4_afterif
	; source: test_float_equalities.p8:122   x = 1234.56
	...
	; source: test_float_equalities.p8:124   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	cmp  #0
	beq  p8l_skip3
	; source: test_float_equalities.p8:126   success++
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:127   skip3:
p8l_skip3
	; source: test_float_equalities.p8:129   cx16.r3 = &skip4
	lda  #<p8l_skip4
	ldy  #>p8l_skip4
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:130   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:132   success++
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:133   skip4:
p8l_skip4
	; source: test_float_equalities.p8:135   success++
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:136   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:137   success--
	dec  p8b_main.p8v_success
label_asm_6_afterif
	; source: test_float_equalities.p8:140   if x==0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:141   cx16.r0L++
	inc  cx16.r0L
	bra  label_asm_7_afterif
label_asm_8_else
	; source: test_float_equalities.p8:143   success++
	inc  p8b_main.p8v_success
label_asm_7_afterif
	; source: test_float_equalities.p8:145   verify_success(8)
	lda  #8
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:149   sub test_not_zero() {

p8s_test_not_zero	.proc
; statements
	; source: test_float_equalities.p8:150   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:151   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:153   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:155   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	cmp  #0
	bne  p8l_lbl1
	; source: test_float_equalities.p8:157   goto skip1
	bra  p8l_skip1
	; source: test_float_equalities.p8:158   lbl1:   success++
p8l_lbl1
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:159   skip1:
p8l_skip1
	; source: test_float_equalities.p8:161   cx16.r3 = &lbl2
	lda  #<p8l_lbl2
	ldy  #>p8l_lbl2
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:162   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:164   goto skip2
	bra  p8l_skip2
	; source: test_float_equalities.p8:165   lbl2:   success++
p8l_lbl2
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:166   skip2:
p8l_skip2
	; source: test_float_equalities.p8:168   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:169   success++
	inc  p8b_main.p8v_success
label_asm_9_afterif
	; source: test_float_equalities.p8:172   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:173   success++
	inc  p8b_main.p8v_success
	bra  label_asm_10_afterif
label_asm_11_else
	; source: test_float_equalities.p8:175   cx16.r0L++
	inc  cx16.r0L
label_asm_10_afterif
	; source: test_float_equalities.p8:177   x = 0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:179   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	cmp  #0
	bne  p8l_skip3
	; source: test_float_equalities.p8:181   success++
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:182   skip3:
p8l_skip3
	; source: test_float_equalities.p8:184   cx16.r3 = &skip4
	lda  #<p8l_skip4
	ldy  #>p8l_skip4
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:185   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:187   success++
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:188   skip4:
p8l_skip4
	; source: test_float_equalities.p8:190   success++
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:191   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:192   success--
	dec  p8b_main.p8v_success
label_asm_12_afterif
	; source: test_float_equalities.p8:195   if x!=0
	lda  #<p8v_x
	ldy  #>p8v_x
	jsr  floats.MOVFM
	jsr  floats.SIGN
	...
	; source: test_float_equalities.p8:196   cx16.r0L++
	inc  cx16.r0L
	bra  label_asm_13_afterif
label_asm_14_else
	; source: test_float_equalities.p8:198   success++
	inc  p8b_main.p8v_success
label_asm_13_afterif
	; source: test_float_equalities.p8:200   verify_success(8)
	lda  #8
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:149   sub test_not_zero() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:203   sub test_is_number() {

p8s_test_is_number	.proc
; statements
	; source: test_float_equalities.p8:204   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:205   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:206   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:208   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	bne  p8l_lbl1a
	; source: test_float_equalities.p8:210   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:211   lbl1a:   fail_float(1,0.0)
p8l_lbl1a
	lda  #<1
	ldy  #>1
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
	
	stz  p8b_main.p8s_fail_float.p8v_v1
	stz  p8b_main.p8s_fail_float.p8v_v1+1
	stz  p8b_main.p8s_fail_float.p8v_v1+2
	stz  p8b_main.p8s_fail_float.p8v_v1+3
	stz  p8b_main.p8s_fail_float.p8v_v1+4
	
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:212   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:214   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:215   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:217   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:218   lbl1b:   fail_float(2,0.0)
p8l_lbl1b
	lda  #<2
	ldy  #>2
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:219   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:221   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:222   fail_float(3,0.0)
	lda  #<3
	ldy  #>3
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_15_afterif
	; source: test_float_equalities.p8:225   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:226   fail_float(4,0.0)
	lda  #<4
	ldy  #>4
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_17_else
	; source: test_float_equalities.p8:228   cx16.r0L++
	inc  cx16.r0L
label_asm_16_afterif
	; source: test_float_equalities.p8:230   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:232   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.vars_equal_f
	bne  p8l_lbl2a
	; source: test_float_equalities.p8:234   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:235   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:236   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:238   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:239   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:241   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:242   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:243   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:245   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:246   success++
	inc  p8b_main.p8v_success
label_asm_18_afterif
	; source: test_float_equalities.p8:249   if x==1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>prog8_float_const_0
	jsr  floats.vars_equal_f
	beq  label_asm_20_else
	; source: test_float_equalities.p8:250   success++
	inc  p8b_main.p8v_success
	bra  label_asm_19_afterif
label_asm_20_else
	; source: test_float_equalities.p8:252   cx16.r0L++
	inc  cx16.r0L
label_asm_19_afterif
	; source: test_float_equalities.p8:254   verify_success(4)
	lda  #4
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:203   sub test_is_number() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:256   sub test_not_number() {

p8s_test_not_number	.proc
; statements
	; source: test_float_equalities.p8:257   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:258   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:259   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:261   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.vars_equal_f
	beq  p8l_lbl1a
	; source: test_float_equalities.p8:263   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:264   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:265   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:267   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:268   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:270   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:271   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:272   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:274   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:275   success++
	inc  p8b_main.p8v_success
label_asm_21_afterif
	; source: test_float_equalities.p8:278   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:279   success++
	inc  p8b_main.p8v_success
	bra  label_asm_22_afterif
label_asm_23_else
	; source: test_float_equalities.p8:281   cx16.r0L++
	inc  cx16.r0L
label_asm_22_afterif
	; source: test_float_equalities.p8:283   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:285   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.vars_equal_f
	beq  p8l_lbl2a
	; source: test_float_equalities.p8:287   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:288   lbl2a:   fail_float(5,1234.56)
p8l_lbl2a
	lda  #<5
	ldy  #>5
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	lda  #<p8b_main.p8s_fail_float.p8v_v1
	ldy  #>p8b_main.p8s_fail_float.p8v_v1
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:289   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:291   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:292   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:294   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:295   lbl2b:   fail_float(6,1234.56)
p8l_lbl2b
	lda  #<6
	ldy  #>6
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:296   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:298   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:299   fail_float(7,1234.56)
	lda  #<7
	ldy  #>7
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_24_afterif
	; source: test_float_equalities.p8:302   if x!=1234.56
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:303   fail_float(8,1234.56)
	lda  #<8
	ldy  #>8
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_26_else
	; source: test_float_equalities.p8:305   cx16.r0L++
	inc  cx16.r0L
label_asm_25_afterif
	; source: test_float_equalities.p8:307   verify_success(4)
	lda  #4
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:256   sub test_not_number() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:309   sub test_is_var() {

p8s_test_is_var	.proc
; statements
	; source: test_float_equalities.p8:310   float @shared x, value
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_equalities.p8:311   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:312   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:313   value=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_equalities.p8:315   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.vars_equal_f
	bne  p8l_lbl1a
	; source: test_float_equalities.p8:317   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:318   lbl1a:   fail_float(9,0.0)
p8l_lbl1a
	lda  #<9
	ldy  #>9
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:319   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:321   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:322   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:324   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:325   lbl1b:   fail_float(10,0.0)
p8l_lbl1b
	lda  #<10
	ldy  #>10
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:326   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:328   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:329   fail_float(11,0.0)
	lda  #<11
	ldy  #>11
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_27_afterif
	; source: test_float_equalities.p8:332   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:333   fail_float(12,0.0)
	lda  #<12
	ldy  #>12
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_29_else
	; source: test_float_equalities.p8:335   cx16.r0L++
	inc  cx16.r0L
label_asm_28_afterif
	; source: test_float_equalities.p8:337   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:338   value=1234.56
	lda  #<p8v_value
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_equalities.p8:340   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.vars_equal_f
	bne  p8l_lbl2a
	; source: test_float_equalities.p8:342   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:343   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:344   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:346   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:347   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:349   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:350   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:351   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:353   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:354   success++
	inc  p8b_main.p8v_success
label_asm_30_afterif
	; source: test_float_equalities.p8:357   if x==value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:358   success++
	inc  p8b_main.p8v_success
	bra  label_asm_31_afterif
label_asm_32_else
	; source: test_float_equalities.p8:360   cx16.r0L++
	inc  cx16.r0L
label_asm_31_afterif
	; source: test_float_equalities.p8:362   verify_success(4)
	lda  #4
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:309   sub test_is_var() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:364   sub test_not_var() {

p8s_test_not_var	.proc
; statements
	; source: test_float_equalities.p8:365   float @shared x, value
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_equalities.p8:366   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:367   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:368   value=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_equalities.p8:370   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.vars_equal_f
	beq  p8l_lbl1a
	; source: test_float_equalities.p8:372   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:373   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:374   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:376   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:377   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:379   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:380   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:381   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:383   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:384   success++
	inc  p8b_main.p8v_success
label_asm_33_afterif
	; source: test_float_equalities.p8:387   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:388   success++
	inc  p8b_main.p8v_success
	bra  label_asm_34_afterif
label_asm_35_else
	; source: test_float_equalities.p8:390   cx16.r0L++
	inc  cx16.r0L
label_asm_34_afterif
	; source: test_float_equalities.p8:392   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:393   value=1234.56
	lda  #<p8v_value
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_equalities.p8:395   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.vars_equal_f
	beq  p8l_lbl2a
	; source: test_float_equalities.p8:397   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:398   lbl2a:   fail_float(13,1234.56)
p8l_lbl2a
	lda  #<13
	ldy  #>13
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:399   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:401   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:402   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:404   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:405   lbl2b:   fail_float(14,1234.56)
p8l_lbl2b
	lda  #<14
	ldy  #>14
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:406   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:408   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:409   fail_float(15,1234.56)
	lda  #<15
	ldy  #>15
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_36_afterif
	; source: test_float_equalities.p8:412   if x!=value
	lda  #<p8v_x
	ldy  #>p8v_x
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:413   fail_float(16,1234.56)
	lda  #<$10
	ldy  #>$10
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_38_else
	; source: test_float_equalities.p8:415   cx16.r0L++
	inc  cx16.r0L
label_asm_37_afterif
	; source: test_float_equalities.p8:417   verify_success(4)
	lda  #4
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:364   sub test_not_var() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:419   sub test_is_expr() {

p8s_test_is_expr	.proc
; statements
	; source: test_float_equalities.p8:420   float @shared x
	; source: test_float_equalities.p8:423   float @shared f4 = 1.0
	; source: test_float_equalities.p8:424   float @shared f5 = 1.0
	; source: test_float_equalities.p8:420   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	...
	; source: test_float_equalities.p8:421   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_float_equalities.p8:422   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_float_equalities.p8:425   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:426   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:428   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	bne  p8l_lbl1a
	; source: test_float_equalities.p8:430   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:431   lbl1a:   fail_float(17,0.0)
p8l_lbl1a
	lda  #<$11
	ldy  #>$11
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:432   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:434   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:435   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:437   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:438   lbl1b:   fail_float(18,0.0)
p8l_lbl1b
	lda  #<$12
	ldy  #>$12
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:439   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:441   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:442   fail_float(19,0.0)
	lda  #<$13
	ldy  #>$13
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_39_afterif
	; source: test_float_equalities.p8:445   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:446   fail_float(20,0.0)
	lda  #<$14
	ldy  #>$14
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_41_else
	; source: test_float_equalities.p8:448   cx16.r0L++
	inc  cx16.r0L
label_asm_40_afterif
	; source: test_float_equalities.p8:450   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:452   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	jsr  floats.var_fac1_equal_f
	bne  p8l_lbl2a
	; source: test_float_equalities.p8:454   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:455   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:456   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:458   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:459   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:461   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:462   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:463   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:465   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:466   success++
	inc  p8b_main.p8v_success
label_asm_42_afterif
	; source: test_float_equalities.p8:469   if x==f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:470   success++
	inc  p8b_main.p8v_success
	bra  label_asm_43_afterif
label_asm_44_else
	; source: test_float_equalities.p8:472   cx16.r0L++
	inc  cx16.r0L
label_asm_43_afterif
	; source: test_float_equalities.p8:474   verify_success(4)
	lda  #4
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:419   sub test_is_expr() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:476   sub test_not_expr() {

p8s_test_not_expr	.proc
; statements
	; source: test_float_equalities.p8:477   float @shared x
	; source: test_float_equalities.p8:480   float @shared f4 = 1.0
	; source: test_float_equalities.p8:481   float @shared f5 = 1.0
	; source: test_float_equalities.p8:477   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	...
	; source: test_float_equalities.p8:478   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_float_equalities.p8:479   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_float_equalities.p8:482   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:483   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:485   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	jsr  floats.var_fac1_equal_f
	beq  p8l_lbl1a
	; source: test_float_equalities.p8:487   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:488   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:489   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:491   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:492   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:494   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:495   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:496   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:498   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:499   success++
	inc  p8b_main.p8v_success
label_asm_45_afterif
	; source: test_float_equalities.p8:502   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:503   success++
	inc  p8b_main.p8v_success
	bra  label_asm_46_afterif
label_asm_47_else
	; source: test_float_equalities.p8:505   cx16.r0L++
	inc  cx16.r0L
label_asm_46_afterif
	; source: test_float_equalities.p8:507   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:509   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	jsr  floats.var_fac1_equal_f
	beq  p8l_lbl2a
	; source: test_float_equalities.p8:511   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:512   lbl2a:   fail_float(21,1234.56)
p8l_lbl2a
	lda  #<$15
	ldy  #>$15
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:513   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:515   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:516   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:518   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:519   lbl2b:   fail_float(22,1234.56)
p8l_lbl2b
	lda  #<$16
	ldy  #>$16
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:520   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:522   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:523   fail_float(23,1234.56)
	lda  #<$17
	ldy  #>$17
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_48_afterif
	; source: test_float_equalities.p8:526   if x!=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
	...
	; source: test_float_equalities.p8:527   fail_float(24,1234.56)
	lda  #<$18
	ldy  #>$18
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_50_else
	; source: test_float_equalities.p8:529   cx16.r0L++
	inc  cx16.r0L
label_asm_49_afterif
	; source: test_float_equalities.p8:531   verify_success(4)
	lda  #4
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:476   sub test_not_expr() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_equalities.p8:533   sub test_is_array() {

p8s_test_is_array	.proc
; statements
	; source: test_float_equalities.p8:534   float @shared x
	; source: test_float_equalities.p8:535   float[] values = [0, 0]
	; source: test_float_equalities.p8:536   float[] sources = [0, 0]
	; source: test_float_equalities.p8:534   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	...
	; source: test_float_equalities.p8:537   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:538   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:539   sources[1]=0.0
	lda  #1
	ldy  #<p8v_sources
	sty  P8ZP_SCRATCH_W1
	ldy  #>p8v_sources
	...
	; source: test_float_equalities.p8:540   values[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_0
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_0
	...
	; source: test_float_equalities.p8:542   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jsr  floats.var_fac1_equal_f
	bne  p8l_lbl1a
	; source: test_float_equalities.p8:544   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:545   lbl1a:   fail_float(25,0.0)
p8l_lbl1a
	lda  #<$19
	ldy  #>$19
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:546   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:548   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:549   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:551   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:552   lbl1b:   fail_float(26,0.0)
p8l_lbl1b
	lda  #<$1a
	ldy  #>$1a
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:553   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:555   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:556   fail_float(27,0.0)
	lda  #<$1b
	ldy  #>$1b
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_51_afterif
	; source: test_float_equalities.p8:559   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:560   fail_float(28,0.0)
	lda  #<$1c
	ldy  #>$1c
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_53_else
	; source: test_float_equalities.p8:562   cx16.r0L++
	inc  cx16.r0L
label_asm_52_afterif
	; source: test_float_equalities.p8:565   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.var_fac1_equal_f
	bne  p8l_lbl1c
	; source: test_float_equalities.p8:567   goto skip1c
	bra  p8l_skip1c
	; source: test_float_equalities.p8:568   lbl1c:   fail_float(29,0.0)
p8l_lbl1c
	lda  #<$1d
	ldy  #>$1d
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:569   skip1c:
p8l_skip1c
	; source: test_float_equalities.p8:571   cx16.r3 = &lbl1d
	lda  #<p8l_lbl1d
	ldy  #>p8l_lbl1d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:572   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:574   goto skip1d
	bra  p8l_skip1d
	; source: test_float_equalities.p8:575   lbl1d:   fail_float(30,0.0)
p8l_lbl1d
	lda  #<$1e
	ldy  #>$1e
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:576   skip1d:
p8l_skip1d
	; source: test_float_equalities.p8:578   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:579   fail_float(31,0.0)
	lda  #<$1f
	ldy  #>$1f
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_54_afterif
	; source: test_float_equalities.p8:582   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:583   fail_float(32,0.0)
	lda  #<$20
	ldy  #>$20
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_56_else
	; source: test_float_equalities.p8:585   cx16.r0L++
	inc  cx16.r0L
label_asm_55_afterif
	; source: test_float_equalities.p8:587   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:588   sources[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_0
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_0
	...
	; source: test_float_equalities.p8:589   values[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_0
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_0
	...
	; source: test_float_equalities.p8:591   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jsr  floats.var_fac1_equal_f
	bne  p8l_lbl2a
	; source: test_float_equalities.p8:593   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:594   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:595   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:597   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:598   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:600   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:601   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:602   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:604   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:605   success++
	inc  p8b_main.p8v_success
label_asm_57_afterif
	; source: test_float_equalities.p8:608   if x==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:609   success++
	inc  p8b_main.p8v_success
	bra  label_asm_58_afterif
label_asm_59_else
	; source: test_float_equalities.p8:611   cx16.r0L++
	inc  cx16.r0L
label_asm_58_afterif
	; source: test_float_equalities.p8:614   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.var_fac1_equal_f
	bne  p8l_lbl2c
	; source: test_float_equalities.p8:616   goto skip2c
	bra  p8l_skip2c
	; source: test_float_equalities.p8:617   lbl2c:   success++
p8l_lbl2c
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:618   skip2c:
p8l_skip2c
	; source: test_float_equalities.p8:620   cx16.r3 = &lbl2d
	lda  #<p8l_lbl2d
	ldy  #>p8l_lbl2d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:621   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:623   goto skip2d
	bra  p8l_skip2d
	; source: test_float_equalities.p8:624   lbl2d:   success++
p8l_lbl2d
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:625   skip2d:
p8l_skip2d
	; source: test_float_equalities.p8:627   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:628   success++
	inc  p8b_main.p8v_success
label_asm_60_afterif
	; source: test_float_equalities.p8:631   if sources[1]==values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:632   success++
	inc  p8b_main.p8v_success
	bra  label_asm_61_afterif
label_asm_62_else
	; source: test_float_equalities.p8:634   cx16.r0L++
	inc  cx16.r0L
label_asm_61_afterif
	; source: test_float_equalities.p8:636   verify_success(8)
	lda  #8
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:533   sub test_is_array() {
; variables
...
; non-zeropage variables
p8v_sources
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@23c767e6
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@feb098f
p8v_values
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@19e21f89
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@31e739bf
	.pend
	; source: test_float_equalities.p8:638   sub test_not_array() {

p8s_test_not_array	.proc
; statements
	; source: test_float_equalities.p8:639   float @shared x
	; source: test_float_equalities.p8:640   float[] values = [0, 0]
	; source: test_float_equalities.p8:641   float[] sources = [0, 0]
	; source: test_float_equalities.p8:639   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	...
	; source: test_float_equalities.p8:642   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_equalities.p8:643   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_equalities.p8:644   sources[1]=0.0
	lda  #1
	ldy  #<p8v_sources
	sty  P8ZP_SCRATCH_W1
	ldy  #>p8v_sources
	sty  P8ZP_SCRATCH_W1+1
	jsr  floats.set_0_array_float
	; source: test_float_equalities.p8:645   values[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_0
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_0
	...
	; source: test_float_equalities.p8:647   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jsr  floats.var_fac1_equal_f
	beq  p8l_lbl1a
	; source: test_float_equalities.p8:649   goto skip1a
	bra  p8l_skip1a
	; source: test_float_equalities.p8:650   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:651   skip1a:
p8l_skip1a
	; source: test_float_equalities.p8:653   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:654   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:656   goto skip1b
	bra  p8l_skip1b
	; source: test_float_equalities.p8:657   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:658   skip1b:
p8l_skip1b
	; source: test_float_equalities.p8:660   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:661   success++
	inc  p8b_main.p8v_success
label_asm_63_afterif
	; source: test_float_equalities.p8:664   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:665   success++
	inc  p8b_main.p8v_success
	bra  label_asm_64_afterif
label_asm_65_else
	; source: test_float_equalities.p8:667   cx16.r0L++
	inc  cx16.r0L
label_asm_64_afterif
	; source: test_float_equalities.p8:670   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.var_fac1_equal_f
	beq  p8l_lbl1c
	; source: test_float_equalities.p8:672   goto skip1c
	bra  p8l_skip1c
	; source: test_float_equalities.p8:673   lbl1c:   success++
p8l_lbl1c
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:674   skip1c:
p8l_skip1c
	; source: test_float_equalities.p8:676   cx16.r3 = &lbl1d
	lda  #<p8l_lbl1d
	ldy  #>p8l_lbl1d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:677   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:679   goto skip1d
	bra  p8l_skip1d
	; source: test_float_equalities.p8:680   lbl1d:   success++
p8l_lbl1d
	inc  p8b_main.p8v_success
	; source: test_float_equalities.p8:681   skip1d:
p8l_skip1d
	; source: test_float_equalities.p8:683   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:684   success++
	inc  p8b_main.p8v_success
label_asm_66_afterif
	; source: test_float_equalities.p8:687   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:688   success++
	inc  p8b_main.p8v_success
	bra  label_asm_67_afterif
label_asm_68_else
	; source: test_float_equalities.p8:690   cx16.r0L++
	inc  cx16.r0L
label_asm_67_afterif
	; source: test_float_equalities.p8:692   x=1234.56
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_equalities.p8:693   sources[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_0
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_0
	...
	; source: test_float_equalities.p8:694   values[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_0
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_0
	...
	; source: test_float_equalities.p8:696   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jsr  floats.var_fac1_equal_f
	beq  p8l_lbl2a
	; source: test_float_equalities.p8:698   goto skip2a
	bra  p8l_skip2a
	; source: test_float_equalities.p8:699   lbl2a:   fail_float(33,1234.56)
p8l_lbl2a
	lda  #<$21
	ldy  #>$21
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:700   skip2a:
p8l_skip2a
	; source: test_float_equalities.p8:702   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:703   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:705   goto skip2b
	bra  p8l_skip2b
	; source: test_float_equalities.p8:706   lbl2b:   fail_float(34,1234.56)
p8l_lbl2b
	lda  #<$22
	ldy  #>$22
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:707   skip2b:
p8l_skip2b
	; source: test_float_equalities.p8:709   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:710   fail_float(35,1234.56)
	lda  #<$23
	ldy  #>$23
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_69_afterif
	; source: test_float_equalities.p8:713   if x!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	jsr  floats.MOVFM
	lda  #<p8v_x
	...
	; source: test_float_equalities.p8:714   fail_float(36,1234.56)
	lda  #<$24
	ldy  #>$24
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_71_else
	; source: test_float_equalities.p8:716   cx16.r0L++
	inc  cx16.r0L
label_asm_70_afterif
	; source: test_float_equalities.p8:719   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jsr  floats.var_fac1_equal_f
	beq  p8l_lbl2c
	; source: test_float_equalities.p8:721   goto skip2c
	bra  p8l_skip2c
	; source: test_float_equalities.p8:722   lbl2c:   fail_float(37,1234.56)
p8l_lbl2c
	lda  #<$25
	ldy  #>$25
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:723   skip2c:
p8l_skip2c
	; source: test_float_equalities.p8:725   cx16.r3 = &lbl2d
	lda  #<p8l_lbl2d
	ldy  #>p8l_lbl2d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_equalities.p8:726   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	jmp  (cx16.r3)
+
	; source: test_float_equalities.p8:728   goto skip2d
	bra  p8l_skip2d
	; source: test_float_equalities.p8:729   lbl2d:   fail_float(38,1234.56)
p8l_lbl2d
	lda  #<$26
	ldy  #>$26
	sta  p8b_main.p8s_fail_float.p8v_idx
	...
	jsr  floats.copy_float
	jsr  p8b_main.p8s_fail_float
	; source: test_float_equalities.p8:730   skip2d:
p8l_skip2d
	; source: test_float_equalities.p8:732   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:733   fail_float(39,1234.56)
	lda  #<$27
	ldy  #>$27
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_72_afterif
	; source: test_float_equalities.p8:736   if sources[1]!=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_equalities.p8:737   fail_float(40,1234.56)
	lda  #<$28
	ldy  #>$28
	sta  p8b_main.p8s_fail_float.p8v_idx
	sty  p8b_main.p8s_fail_float.p8v_idx+1
...
label_asm_74_else
	; source: test_float_equalities.p8:739   cx16.r0L++
	inc  cx16.r0L
label_asm_73_afterif
	; source: test_float_equalities.p8:741   verify_success(8)
	lda  #8
	jmp  p8b_main.p8s_verify_success
	; source: test_float_equalities.p8:638   sub test_not_array() {
; variables
...
; non-zeropage variables
p8v_sources
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@7e7743ec
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@776015fc
p8v_values
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@7f42e06e
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@6ad179b4
	.pend
...
string_9	; PETSCII:"\n!=array[]: "
	...
	; source: test_float_equalities.p8:45   txt.print(" **failed** ")
	; source: test_float_equalities.p8:47   txt.print(" success, expected ")
	; source: test_float_equalities.p8:53   txt.print(" **fail#")
	; source: test_float_equalities.p8:57   txt.print(" **")
	.pend
...
prog8_float_const_0	.byte  $8b, $1a, $51, $eb, $85  ; float 1234.56
prog8_float_const_1	.byte  $81, $00, $00, $00, $00  ; float 1.0
