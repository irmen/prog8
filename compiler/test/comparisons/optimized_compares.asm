; w65c02 assembly code for 'optimized_compares'
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: optimized_compares.p8:4   main {


	; source: optimized_compares.p8:5   sub start() {
...
+        
	...
	clc
; statements
	; source: optimized_compares.p8:6   greater()
	jsr  p8b_main.p8s_greater
	; source: optimized_compares.p8:7   greater_signed()
	jsr  p8b_main.p8s_greater_signed
	; source: optimized_compares.p8:8   less()
	jsr  p8b_main.p8s_less
	; source: optimized_compares.p8:9   less_signed()
	jsr  p8b_main.p8s_less_signed
	; source: optimized_compares.p8:11   greatereq()
	jsr  p8b_main.p8s_greatereq
	; source: optimized_compares.p8:12   greatereq_signed()
	jsr  p8b_main.p8s_greatereq_signed
	; source: optimized_compares.p8:13   lesseq()
	jsr  p8b_main.p8s_lesseq
	; source: optimized_compares.p8:14   lesseq_signed()
	jmp  p8b_main.p8s_lesseq_signed
	; source: optimized_compares.p8:5   sub start() {
; variables
	.section BSS
	.send BSS
	...
	.pend
	; source: optimized_compares.p8:17   sub value(ubyte arg) -> ubyte {
...
; simple int arg(s) passed via register(s)
	sta  p8v_arg
; statements
	; source: optimized_compares.p8:18   cx16.r0++
	inc  cx16.r0
	bne  +
	inc  cx16.r0+1
+
	; source: optimized_compares.p8:19   return arg
	lda  p8v_arg
	rts
; variables
	.section BSS
	...
	.pend
	; source: optimized_compares.p8:22   sub svalue(byte arg) -> byte {
...
; simple int arg(s) passed via register(s)
	sta  p8v_arg
; statements
	; source: optimized_compares.p8:23   cx16.r0++
	inc  cx16.r0
	bne  +
	inc  cx16.r0+1
+
	; source: optimized_compares.p8:24   return arg
	lda  p8v_arg
	rts
; variables
	.section BSS
	...
	.pend
	; source: optimized_compares.p8:27   sub greater () {
...
p8v_b1 	= 71 	; zp UBYTE
; statements
	; source: optimized_compares.p8:28   ubyte @shared b1 = 10
	; source: optimized_compares.p8:29   ubyte @shared b2 = 20
	; source: optimized_compares.p8:30   ubyte @shared b3 = 10
	; source: optimized_compares.p8:33   bool xx
	; source: optimized_compares.p8:28   ubyte @shared b1 = 10
	lda  #10
	sta  p8v_b1
	; source: optimized_compares.p8:29   ubyte @shared b2 = 20
	...
	lda  #10
	sta  p8v_b3
	; source: optimized_compares.p8:32   txt.print(">(u):  101010: ")
	ldy  #>prog8_interned_strings.string_1
	lda  #<prog8_interned_strings.string_1
	jsr  txt.print
	; source: optimized_compares.p8:34   xx = b2>10
	lda  p8v_b2
	cmp  #11
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:35   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:38   xx = b2>20
	lda  p8v_b2
	cmp  #21
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:39   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:42   xx = b2>b1
	stz  p8v_xx
  lda   p8v_b1
  cmp   p8v_b2
  bcs   label_asm_1_afterif
	lda  #1
	sta  p8v_xx
label_asm_1_afterif
	; source: optimized_compares.p8:43   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:46   xx = b3>b1
	stz  p8v_xx
  lda   p8v_b1
  cmp   p8v_b3
  bcs   label_asm_2_afterif
	lda  #1
	sta  p8v_xx
label_asm_2_afterif
	; source: optimized_compares.p8:47   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:50   xx = b2>value(10)
	stz  p8v_xx
	lda  p8v_b2
	pha
	lda  #10
	jsr  p8b_main.p8s_value
	...
	sta  p8v_xx
label_asm_3_afterif
	; source: optimized_compares.p8:51   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:53   xx = b3>value(20)
	stz  p8v_xx
	lda  p8v_b3
	pha
	lda  #$14
	...
	pla
	cmp  P8ZP_SCRATCH_REG
	bcc  label_asm_4_afterif
	beq  label_asm_4_afterif
	lda  #1
	sta  p8v_xx
label_asm_4_afterif
	; source: optimized_compares.p8:54   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
; variables
	...
	.pend
	; source: optimized_compares.p8:60   sub greater_signed () {

p8s_greater_signed	.proc
p8v_xx 	= 64 	; zp BOOL
p8v_b3 	= 65 	; zp BYTE
p8v_b2 	= 66 	; zp BYTE
p8v_b1 	= 67 	; zp BYTE
; statements
	; source: optimized_compares.p8:61   byte @shared b1 = -20
	; source: optimized_compares.p8:62   byte @shared b2 = -10
	; source: optimized_compares.p8:63   byte @shared b3 = -20
	; source: optimized_compares.p8:66   bool xx
	; source: optimized_compares.p8:61   byte @shared b1 = -20
	lda  #-$14
	sta  p8v_b1
	; source: optimized_compares.p8:62   byte @shared b2 = -10
	...
	lda  #-$14
	sta  p8v_b3
	; source: optimized_compares.p8:65   txt.print(">(s):  101010: ")
	ldy  #>prog8_interned_strings.string_2
	lda  #<prog8_interned_strings.string_2
	jsr  txt.print
	; source: optimized_compares.p8:67   xx = b2 > -20
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-19
	bmi  label_asm_5_afterif
	lda  #1
	sta  p8v_xx
label_asm_5_afterif
	; source: optimized_compares.p8:68   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:71   xx = b2 > -10
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-9
	...
	sta  p8v_xx
label_asm_6_afterif
	; source: optimized_compares.p8:72   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:75   xx = b2>b1
	stz  p8v_xx
	lda  p8v_b1
	sec
	sbc  p8v_b2
	bpl  label_asm_7_afterif
	lda  #1
	sta  p8v_xx
label_asm_7_afterif
	; source: optimized_compares.p8:76   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:79   xx = b3>b1
	stz  p8v_xx
	lda  p8v_b1
	sec
	sbc  p8v_b3
	bpl  label_asm_8_afterif
	lda  #1
	sta  p8v_xx
label_asm_8_afterif
	; source: optimized_compares.p8:80   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:83   xx = b2>svalue(-20)
	stz  p8v_xx
	lda  #-$14
	jsr  p8b_main.p8s_svalue
	sec
	sbc  p8v_b2
	...
	sta  p8v_xx
label_asm_9_afterif
	; source: optimized_compares.p8:84   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:86   xx = b3>svalue(-10)
	stz  p8v_xx
	lda  #-10
	jsr  p8b_main.p8s_svalue
	sec
	sbc  p8v_b3
	bpl  label_asm_10_afterif
	lda  #1
	sta  p8v_xx
label_asm_10_afterif
	; source: optimized_compares.p8:87   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
; variables
	...
	.pend
	; source: optimized_compares.p8:93   sub less () {
...
p8v_b1 	= 53 	; zp UBYTE
; statements
	; source: optimized_compares.p8:94   ubyte @shared b1 = 20
	; source: optimized_compares.p8:95   ubyte @shared b2 = 10
	; source: optimized_compares.p8:96   ubyte @shared b3 = 20
	; source: optimized_compares.p8:99   bool xx
	; source: optimized_compares.p8:94   ubyte @shared b1 = 20
	lda  #$14
	sta  p8v_b1
	; source: optimized_compares.p8:95   ubyte @shared b2 = 10
	...
	lda  #$14
	sta  p8v_b3
	; source: optimized_compares.p8:98   txt.print("<(u):  101010: ")
	ldy  #>prog8_interned_strings.string_3
	lda  #<prog8_interned_strings.string_3
	jsr  txt.print
	; source: optimized_compares.p8:100   xx = b2<20
	lda  p8v_b2
	cmp  #20
	rol  a
	and  #1
	eor  #1
	sta  p8v_xx
	; source: optimized_compares.p8:101   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:104   xx = b2<10
	lda  p8v_b2
	cmp  #10
	rol  a
	and  #1
	eor  #1
	sta  p8v_xx
	; source: optimized_compares.p8:105   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:108   xx = b2<b1
	lda  p8v_b2
	cmp  p8b_main.p8s_less.p8v_b1
	rol  a
	and  #1
	eor  #1
	sta  p8v_xx
	; source: optimized_compares.p8:109   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:112   xx = b3<b1
	lda  p8v_b3
	cmp  p8b_main.p8s_less.p8v_b1
	rol  a
	and  #1
	eor  #1
	sta  p8v_xx
	; source: optimized_compares.p8:113   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:116   xx = b2<value(20)
	lda  p8v_b2
	stz  p8v_xx
	lda  p8v_b2
	pha
	...
	pla
	cmp  P8ZP_SCRATCH_REG
	bcs  label_asm_11_afterif
	lda  #1
	sta  p8v_xx
label_asm_11_afterif
	; source: optimized_compares.p8:117   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:119   xx = b2<value(10)
	lda  p8v_b2
	stz  p8v_xx
	lda  p8v_b2
	pha
...
label_asm_12_afterif
	; source: optimized_compares.p8:120   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
; variables
	...
	.pend
	; source: optimized_compares.p8:126   sub less_signed () {

p8s_less_signed	.proc
p8v_xx 	= 46 	; zp BOOL
p8v_b3 	= 47 	; zp BYTE
p8v_b2 	= 48 	; zp BYTE
p8v_b1 	= 49 	; zp BYTE
; statements
	; source: optimized_compares.p8:127   byte @shared b1 = -10
	; source: optimized_compares.p8:128   byte @shared b2 = -20
	; source: optimized_compares.p8:129   byte @shared b3 = -10
	; source: optimized_compares.p8:132   bool xx
	; source: optimized_compares.p8:127   byte @shared b1 = -10
	lda  #-10
	sta  p8v_b1
	; source: optimized_compares.p8:128   byte @shared b2 = -20
	...
	lda  #-10
	sta  p8v_b3
	; source: optimized_compares.p8:131   txt.print("<(s):  101010: ")
	ldy  #>prog8_interned_strings.string_4
	lda  #<prog8_interned_strings.string_4
	jsr  txt.print
	; source: optimized_compares.p8:133   xx = b2 < -10
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-10
	bpl  label_asm_13_afterif
	lda  #1
	sta  p8v_xx
label_asm_13_afterif
	; source: optimized_compares.p8:134   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:137   xx = b2 < -20
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-20
	bpl  label_asm_14_afterif
	lda  #1
	sta  p8v_xx
label_asm_14_afterif
	; source: optimized_compares.p8:138   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:141   xx = b2<b1
	stz  p8v_xx
	lda  p8v_b2
	cmp  p8v_b1
...
label_asm_15_afterif
	; source: optimized_compares.p8:142   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:145   xx = b3<b1
	stz  p8v_xx
	lda  p8v_b3
	cmp  p8v_b1
	bpl  label_asm_16_afterif
	lda  #1
	sta  p8v_xx
label_asm_16_afterif
	; source: optimized_compares.p8:146   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:149   xx = b2<svalue(-10)
	stz  p8v_xx
	lda  p8v_b2
	pha
	lda  #-10
	...
	pla
	cmp  P8ZP_SCRATCH_REG
	bpl  label_asm_17_afterif
	lda  #1
	sta  p8v_xx
label_asm_17_afterif
	; source: optimized_compares.p8:150   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:152   xx = b3<svalue(-20)
	stz  p8v_xx
	lda  p8v_b3
	pha
	lda  #-$14
...
label_asm_18_afterif
	; source: optimized_compares.p8:153   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
; variables
	...
	.pend
	; source: optimized_compares.p8:159   sub greatereq () {
...
p8v_b1 	= 63 	; zp UBYTE
; statements
	; source: optimized_compares.p8:160   ubyte @shared b1 = 19
	; source: optimized_compares.p8:161   ubyte @shared b2 = 20
	; source: optimized_compares.p8:162   ubyte @shared b3 = 21
	; source: optimized_compares.p8:163   ubyte @shared b4 = 20
	; source: optimized_compares.p8:166   bool xx
	; source: optimized_compares.p8:160   ubyte @shared b1 = 19
	lda  #$13
	sta  p8v_b1
	; source: optimized_compares.p8:161   ubyte @shared b2 = 20
	...
	lda  #$14
	sta  p8v_b4
	; source: optimized_compares.p8:165   txt.print(">=(u): 110110110: ")
	ldy  #>prog8_interned_strings.string_5
	lda  #<prog8_interned_strings.string_5
	jsr  txt.print
	; source: optimized_compares.p8:167   xx = b2>=19
	lda  p8v_b2
	cmp  #19
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:168   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:171   xx = b2>=20
	lda  p8v_b2
	cmp  #20
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:172   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:175   xx = b2>=21
	lda  p8v_b2
	cmp  #21
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:176   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:179   xx = b2>=b1
	lda  p8v_b2
	cmp  p8b_main.p8s_greatereq.p8v_b1
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:180   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:183   xx = b2>=b4
	lda  p8v_b2
	cmp  p8b_main.p8s_greatereq.p8v_b4
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:184   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:187   xx = b2>=b3
	lda  p8v_b2
	cmp  p8b_main.p8s_greatereq.p8v_b3
	rol  a
	and  #1
	sta  p8v_xx
	; source: optimized_compares.p8:188   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:191   xx = b2>=value(19)
	lda  p8v_b2
	stz  p8v_xx
	lda  p8v_b2
	pha
	...
	pla
	cmp  P8ZP_SCRATCH_REG
	bcc  label_asm_19_afterif
	lda  #1
	sta  p8v_xx
label_asm_19_afterif
	; source: optimized_compares.p8:192   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:194   xx = b2>=value(20)
	lda  p8v_b2
	stz  p8v_xx
	lda  p8v_b2
	pha
	...
	pla
	cmp  P8ZP_SCRATCH_REG
	bcc  label_asm_20_afterif
	lda  #1
	sta  p8v_xx
label_asm_20_afterif
	; source: optimized_compares.p8:195   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:197   xx = b2>=value(21)
	lda  p8v_b2
	stz  p8v_xx
	lda  p8v_b2
	pha
...
label_asm_21_afterif
	; source: optimized_compares.p8:198   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
; variables
	...
	.pend
	; source: optimized_compares.p8:204   sub greatereq_signed () {

p8s_greatereq_signed	.proc
p8v_xx 	= 54 	; zp BOOL
p8v_b4 	= 55 	; zp BYTE
p8v_b3 	= 56 	; zp BYTE
p8v_b2 	= 57 	; zp BYTE
p8v_b1 	= 58 	; zp BYTE
; statements
	; source: optimized_compares.p8:205   byte @shared b1 = -19
	; source: optimized_compares.p8:206   byte @shared b2 = -20
	; source: optimized_compares.p8:207   byte @shared b3 = -21
	; source: optimized_compares.p8:208   byte @shared b4 = -20
	; source: optimized_compares.p8:211   bool xx
	; source: optimized_compares.p8:205   byte @shared b1 = -19
	lda  #-$13
	sta  p8v_b1
	; source: optimized_compares.p8:206   byte @shared b2 = -20
	...
	lda  #-$14
	sta  p8v_b4
	; source: optimized_compares.p8:210   txt.print(">=(s): 011011011: ")
	ldy  #>prog8_interned_strings.string_6
	lda  #<prog8_interned_strings.string_6
	jsr  txt.print
	; source: optimized_compares.p8:212   xx = b2>= -19
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-19
	bmi  label_asm_22_afterif
	lda  #1
	sta  p8v_xx
label_asm_22_afterif
	; source: optimized_compares.p8:213   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:216   xx = b2>= -20
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-20
	bmi  label_asm_23_afterif
	lda  #1
	sta  p8v_xx
label_asm_23_afterif
	; source: optimized_compares.p8:217   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:220   xx = b2>= -21
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-21
...
label_asm_24_afterif
	; source: optimized_compares.p8:221   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:224   xx = b2>=b1
	stz  p8v_xx
	lda  p8v_b2
	cmp  p8v_b1
	bmi  label_asm_25_afterif
	lda  #1
	sta  p8v_xx
label_asm_25_afterif
	; source: optimized_compares.p8:225   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:228   xx = b2>=b4
	stz  p8v_xx
	lda  p8v_b2
	cmp  p8v_b4
	bmi  label_asm_26_afterif
	lda  #1
	sta  p8v_xx
label_asm_26_afterif
	; source: optimized_compares.p8:229   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:232   xx = b2>=b3
	stz  p8v_xx
	lda  p8v_b2
	cmp  p8v_b3
...
label_asm_27_afterif
	; source: optimized_compares.p8:233   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:236   xx = b2>=svalue(-19)
	stz  p8v_xx
	lda  p8v_b2
	pha
	lda  #-$13
	...
	pla
	cmp  P8ZP_SCRATCH_REG
	bmi  label_asm_28_afterif
	lda  #1
	sta  p8v_xx
label_asm_28_afterif
	; source: optimized_compares.p8:237   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:239   xx = b2>=svalue(-20)
	stz  p8v_xx
	lda  p8v_b2
	pha
	lda  #-$14
	...
	pla
	cmp  P8ZP_SCRATCH_REG
	bmi  label_asm_29_afterif
	lda  #1
	sta  p8v_xx
label_asm_29_afterif
	; source: optimized_compares.p8:240   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:242   xx = b2>=svalue(-21)
	stz  p8v_xx
	lda  p8v_b2
	pha
	lda  #-$15
...
label_asm_30_afterif
	; source: optimized_compares.p8:243   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
; variables
	...
	.pend
	; source: optimized_compares.p8:249   sub lesseq () {
...
p8v_b1 	= 45 	; zp UBYTE
; statements
	; source: optimized_compares.p8:250   ubyte @shared b1 = 19
	; source: optimized_compares.p8:251   ubyte @shared b2 = 20
	; source: optimized_compares.p8:252   ubyte @shared b3 = 21
	; source: optimized_compares.p8:253   ubyte @shared b4 = 20
	; source: optimized_compares.p8:256   bool xx
	; source: optimized_compares.p8:250   ubyte @shared b1 = 19
	lda  #$13
	sta  p8v_b1
	; source: optimized_compares.p8:251   ubyte @shared b2 = 20
	...
	lda  #$14
	sta  p8v_b4
	; source: optimized_compares.p8:255   txt.print("<=(u): 011011011: ")
	ldy  #>prog8_interned_strings.string_7
	lda  #<prog8_interned_strings.string_7
	jsr  txt.print
	; source: optimized_compares.p8:257   xx = b2<=19
	lda  p8v_b2
	cmp  #20
	rol  a
	and  #1
	eor  #1
	sta  p8v_xx
	; source: optimized_compares.p8:258   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:261   xx = b2<=20
	lda  p8v_b2
	cmp  #21
	rol  a
	and  #1
	eor  #1
	sta  p8v_xx
	; source: optimized_compares.p8:262   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:265   xx = b2<=21
	lda  p8v_b2
	cmp  #22
	rol  a
	and  #1
	eor  #1
	sta  p8v_xx
	; source: optimized_compares.p8:266   txt.print_ub(xx as ubyte)
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:269   xx = b2<=b1
	stz  p8v_xx
	lda  p8v_b1
	cmp  p8v_b2
	bcc  label_asm_31_afterif
	lda  #1
	sta  p8v_xx
label_asm_31_afterif
	; source: optimized_compares.p8:270   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:273   xx = b2<=b4
	stz  p8v_xx
	lda  p8v_b4
	cmp  p8v_b2
	bcc  label_asm_32_afterif
	lda  #1
	sta  p8v_xx
label_asm_32_afterif
	; source: optimized_compares.p8:274   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:277   xx = b2<=b3
	stz  p8v_xx
	lda  p8v_b3
	cmp  p8v_b2
...
label_asm_33_afterif
	; source: optimized_compares.p8:278   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:281   xx = b2<=value(19)
	stz  p8v_xx
	lda  #$13
	jsr  p8b_main.p8s_value
	cmp  p8v_b2
	bcc  label_asm_34_afterif
	lda  #1
	sta  p8v_xx
label_asm_34_afterif
	; source: optimized_compares.p8:282   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:284   xx = b2<=value(20)
	stz  p8v_xx
	lda  #$14
	jsr  p8b_main.p8s_value
	cmp  p8v_b2
	bcc  label_asm_35_afterif
	lda  #1
	sta  p8v_xx
label_asm_35_afterif
	; source: optimized_compares.p8:285   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:287   xx = b2<=value(21)
	stz  p8v_xx
	lda  #$15
	jsr  p8b_main.p8s_value
	cmp  p8v_b2
...
label_asm_36_afterif
	; source: optimized_compares.p8:288   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
; variables
	...
	.pend
	; source: optimized_compares.p8:294   sub lesseq_signed () {

p8s_lesseq_signed	.proc
p8v_xx 	= 36 	; zp BOOL
p8v_b4 	= 37 	; zp BYTE
p8v_b3 	= 38 	; zp BYTE
p8v_b2 	= 39 	; zp BYTE
p8v_b1 	= 40 	; zp BYTE
; statements
	; source: optimized_compares.p8:295   byte @shared b1 = -19
	; source: optimized_compares.p8:296   byte @shared b2 = -20
	; source: optimized_compares.p8:297   byte @shared b3 = -21
	; source: optimized_compares.p8:298   byte @shared b4 = -20
	; source: optimized_compares.p8:301   bool xx
	; source: optimized_compares.p8:295   byte @shared b1 = -19
	lda  #-$13
	sta  p8v_b1
	; source: optimized_compares.p8:296   byte @shared b2 = -20
	...
	lda  #-$14
	sta  p8v_b4
	; source: optimized_compares.p8:300   txt.print("<=(s): 110110110: ")
	ldy  #>prog8_interned_strings.string_8
	lda  #<prog8_interned_strings.string_8
	jsr  txt.print
	; source: optimized_compares.p8:302   xx = b2<= -19
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-18
	bpl  label_asm_37_afterif
	lda  #1
	sta  p8v_xx
label_asm_37_afterif
	; source: optimized_compares.p8:303   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:306   xx = b2<= -20
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-19
	bpl  label_asm_38_afterif
	lda  #1
	sta  p8v_xx
label_asm_38_afterif
	; source: optimized_compares.p8:307   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:310   xx = b2<= -21
	stz  p8v_xx
	lda  p8v_b2
	cmp  #-20
...
label_asm_39_afterif
	; source: optimized_compares.p8:311   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:314   xx = b2<=b1
	stz  p8v_xx
	lda  p8v_b1
	cmp  p8v_b2
	bmi  label_asm_40_afterif
	lda  #1
	sta  p8v_xx
label_asm_40_afterif
	; source: optimized_compares.p8:315   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:318   xx = b2<=b4
	stz  p8v_xx
	lda  p8v_b4
	cmp  p8v_b2
	bmi  label_asm_41_afterif
	lda  #1
	sta  p8v_xx
label_asm_41_afterif
	; source: optimized_compares.p8:319   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:322   xx = b2<=b3
	stz  p8v_xx
	lda  p8v_b3
	cmp  p8v_b2
...
label_asm_42_afterif
	; source: optimized_compares.p8:323   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:326   xx = b2<=svalue(-19)
	stz  p8v_xx
	lda  #-$13
	jsr  p8b_main.p8s_svalue
	cmp  p8v_b2
	bmi  label_asm_43_afterif
	lda  #1
	sta  p8v_xx
label_asm_43_afterif
	; source: optimized_compares.p8:327   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:329   xx = b2<=svalue(-20)
	stz  p8v_xx
	lda  #-$14
	jsr  p8b_main.p8s_svalue
	cmp  p8v_b2
	bmi  label_asm_44_afterif
	lda  #1
	sta  p8v_xx
label_asm_44_afterif
	; source: optimized_compares.p8:330   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
	jsr  txt.chrout
	; source: optimized_compares.p8:332   xx = b2<=svalue(-21)
	stz  p8v_xx
	lda  #-$15
	jsr  p8b_main.p8s_svalue
	cmp  p8v_b2
...
label_asm_45_afterif
	; source: optimized_compares.p8:333   txt.print_ub(xx as ubyte)
	lda  p8v_xx
	jsr  txt.print_ub
	; source: library:/prog8lib/cx16/textio.p8:33   chrout(' ')
	lda  #$20
...
string_1	; PETSCII:">(u):  101010: "
	.byte  $3e, $28, $55, $29, $3a, $20, $20, $31, $30, $31, $30, $31, $30, $3a, $20, $00
string_2	; PETSCII:">(s):  101010: "
	.byte  $3e, $28, $53, $29, $3a, $20, $20, $31, $30, $31, $30, $31, $30, $3a, $20, $00
string_3	; PETSCII:"<(u):  101010: "
	.byte  $3c, $28, $55, $29, $3a, $20, $20, $31, $30, $31, $30, $31, $30, $3a, $20, $00
string_4	; PETSCII:"<(s):  101010: "
	.byte  $3c, $28, $53, $29, $3a, $20, $20, $31, $30, $31, $30, $31, $30, $3a, $20, $00
string_5	; PETSCII:">=(u): 110110110: "
	.byte  $3e, $3d, $28, $55, $29, $3a, $20, $31, $31, $30, $31, $31, $30, $31, $31, $30
	.byte  $3a, $20, $00
string_6	; PETSCII:">=(s): 011011011: "
	.byte  $3e, $3d, $28, $53, $29, $3a, $20, $30, $31, $31, $30, $31, $31, $30, $31, $31
	.byte  $3a, $20, $00
string_7	; PETSCII:"<=(u): 011011011: "
	.byte  $3c, $3d, $28, $55, $29, $3a, $20, $30, $31, $31, $30, $31, $31, $30, $31, $31
	.byte  $3a, $20, $00
string_8	; PETSCII:"<=(s): 110110110: "
	.byte  $3c, $3d, $28, $53, $29, $3a, $20, $31, $31, $30, $31, $31, $30, $31, $31, $30
	.byte  $3a, $20, $00
