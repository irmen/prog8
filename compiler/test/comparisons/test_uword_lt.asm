; w65c02 assembly code for 'test_uword_lt'
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: test_uword_lt.p8:8   main {
...
p8v_datatype	; PETSCII:"uword"
	...
	; source: test_uword_lt.p8:9   ubyte success = 0
	; source: test_uword_lt.p8:10   str datatype = "uword"
	; source: test_uword_lt.p8:11   uword @shared comparison
	; source: test_uword_lt.p8:13   sub start() {
...
+        
	...
	clc
; statements
	; source: test_uword_lt.p8:14   txt.print("\nless-than tests for: ")
	ldy  #>prog8_interned_strings.string_1
	lda  #<prog8_interned_strings.string_1
	jsr  txt.print
	; source: test_uword_lt.p8:15   txt.print(datatype)
...
; variables
	...
	.pend
	; source: test_uword_lt.p8:29   sub verify_success(ubyte expected) {

p8s_verify_success	.proc
; simple int arg(s) passed via register(s)
	sta  p8v_expected
; statements
	; source: test_uword_lt.p8:30   if success==expected {
	lda  p8b_main.p8v_success
	cmp  p8v_expected
	bne  label_asm_2_else
	; source: test_uword_lt.p8:31   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_uword_lt.p8:33   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_7
	lda  #<prog8_interned_strings.string_7
	jsr  txt.print
	; source: test_uword_lt.p8:34   txt.print_ub(success)
	lda  p8b_main.p8v_success
	jsr  txt.print_ub
	; source: test_uword_lt.p8:35   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_8
	lda  #<prog8_interned_strings.string_8
	jsr  txt.print
	; source: test_uword_lt.p8:36   txt.print_ub(expected)
	lda  p8v_expected
	jsr  txt.print_ub
label_asm_1_afterif
	; source: test_uword_lt.p8:29   sub verify_success(ubyte expected) {
...
p8v_expected	.byte  ?
	.send BSS
	.pend
	; source: test_uword_lt.p8:58   sub fail_uword(uword idx) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_idx+1
; statements
	; source: test_uword_lt.p8:59   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_9
	lda  #<prog8_interned_strings.string_9
	jsr  txt.print
	; source: test_uword_lt.p8:60   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_uword_lt.p8:61   txt.print(" **")
...
p8v_idx	.word  ?
	.send BSS
	.pend
	; source: test_uword_lt.p8:71   sub test_cmp_number() {

p8s_test_cmp_number	.proc
; statements
	; source: test_uword_lt.p8:72   uword @shared x
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_lt.p8:73   success = 0
	stz  p8b_main.p8v_success
	; source: test_uword_lt.p8:74   x=0
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_lt.p8:78   goto skip1a
	bra  p8l_skip1a
	; source: test_uword_lt.p8:79   lbl1a:   fail_uword(1)
p8l_lbl1a
	ldy  #>1
	lda  #<1
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:80   skip1a:
p8l_skip1a
	; source: test_uword_lt.p8:82   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:85   goto skip1b
	bra  p8l_skip1b
	; source: test_uword_lt.p8:86   lbl1b:   fail_uword(2)
p8l_lbl1b
	ldy  #>2
	lda  #<2
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:87   skip1b:
p8l_skip1b
	; source: test_uword_lt.p8:96   success++
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:99   if x<1
	lda  p8v_x
	ora  p8v_x+1
	beq  p8l_lbl2a
	; source: test_uword_lt.p8:101   goto skip2a
	bra  p8l_skip2a
	; source: test_uword_lt.p8:102   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:103   skip2a:
p8l_skip2a
	; source: test_uword_lt.p8:105   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:106   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  +
	jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:108   goto skip2b
	bra  p8l_skip2b
	; source: test_uword_lt.p8:109   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:110   skip2b:
p8l_skip2b
	; source: test_uword_lt.p8:112   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_3_afterif
	; source: test_uword_lt.p8:113   success++
	inc  p8b_main.p8v_success
label_asm_3_afterif
	; source: test_uword_lt.p8:116   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_5_else
	; source: test_uword_lt.p8:117   success++
	inc  p8b_main.p8v_success
	bra  label_asm_4_afterif
label_asm_5_else
	; source: test_uword_lt.p8:119   cx16.r0L++
	inc  cx16.r0L
label_asm_4_afterif
	; source: test_uword_lt.p8:122   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  p8l_lbl3a
	...
	bcc  p8l_lbl3a
+
	; source: test_uword_lt.p8:124   goto skip3a
	bra  p8l_skip3a
	; source: test_uword_lt.p8:125   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:126   skip3a:
p8l_skip3a
	; source: test_uword_lt.p8:128   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:129   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:131   goto skip3b
	bra  p8l_skip3b
	; source: test_uword_lt.p8:132   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:133   skip3b:
p8l_skip3b
	; source: test_uword_lt.p8:135   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:136   success++
	inc  p8b_main.p8v_success
label_asm_6_afterif
	; source: test_uword_lt.p8:139   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:140   success++
	inc  p8b_main.p8v_success
	bra  label_asm_7_afterif
label_asm_8_else
	; source: test_uword_lt.p8:142   cx16.r0L++
	inc  cx16.r0L
label_asm_7_afterif
	; source: test_uword_lt.p8:145   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  p8l_lbl4a
	...
	bcc  p8l_lbl4a
+
	; source: test_uword_lt.p8:147   goto skip4a
	bra  p8l_skip4a
	; source: test_uword_lt.p8:148   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:149   skip4a:
p8l_skip4a
	; source: test_uword_lt.p8:151   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:152   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:154   goto skip4b
	bra  p8l_skip4b
	; source: test_uword_lt.p8:155   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:156   skip4b:
p8l_skip4b
	; source: test_uword_lt.p8:158   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:159   success++
	inc  p8b_main.p8v_success
label_asm_9_afterif
	; source: test_uword_lt.p8:162   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:163   success++
	inc  p8b_main.p8v_success
	bra  label_asm_10_afterif
label_asm_11_else
	; source: test_uword_lt.p8:165   cx16.r0L++
	inc  cx16.r0L
label_asm_10_afterif
	; source: test_uword_lt.p8:167   x=1
	lda  #<1
	ldy  #>1
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:171   goto skip5a
	bra  p8l_skip5a
	; source: test_uword_lt.p8:172   lbl5a:   fail_uword(5)
p8l_lbl5a
	ldy  #>5
	lda  #<5
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:173   skip5a:
p8l_skip5a
	; source: test_uword_lt.p8:175   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:178   goto skip5b
	bra  p8l_skip5b
	; source: test_uword_lt.p8:179   lbl5b:   fail_uword(6)
p8l_lbl5b
	ldy  #>6
	lda  #<6
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:180   skip5b:
p8l_skip5b
	; source: test_uword_lt.p8:189   success++
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:192   if x<1
	lda  p8v_x
	ora  p8v_x+1
	beq  p8l_lbl6a
	; source: test_uword_lt.p8:194   goto skip6a
	bra  p8l_skip6a
	; source: test_uword_lt.p8:195   lbl6a:   fail_uword(9)
p8l_lbl6a
	ldy  #>9
	lda  #<9
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:196   skip6a:
p8l_skip6a
	; source: test_uword_lt.p8:198   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:199   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  +
	jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:201   goto skip6b
	bra  p8l_skip6b
	; source: test_uword_lt.p8:202   lbl6b:   fail_uword(10)
p8l_lbl6b
	ldy  #>10
	lda  #<10
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:203   skip6b:
p8l_skip6b
	; source: test_uword_lt.p8:205   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_12_afterif
	; source: test_uword_lt.p8:206   fail_uword(11)
	ldy  #>11
	lda  #<11
	jsr  p8b_main.p8s_fail_uword
label_asm_12_afterif
	; source: test_uword_lt.p8:209   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_14_else
	; source: test_uword_lt.p8:210   fail_uword(12)
	ldy  #>12
	lda  #<12
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_13_afterif
label_asm_14_else
	; source: test_uword_lt.p8:212   success++
	inc  p8b_main.p8v_success
label_asm_13_afterif
	; source: test_uword_lt.p8:215   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  p8l_lbl7a
	...
	bcc  p8l_lbl7a
+
	; source: test_uword_lt.p8:217   goto skip7a
	bra  p8l_skip7a
	; source: test_uword_lt.p8:218   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:219   skip7a:
p8l_skip7a
	; source: test_uword_lt.p8:221   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:222   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:224   goto skip7b
	bra  p8l_skip7b
	; source: test_uword_lt.p8:225   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:226   skip7b:
p8l_skip7b
	; source: test_uword_lt.p8:228   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:229   success++
	inc  p8b_main.p8v_success
label_asm_15_afterif
	; source: test_uword_lt.p8:232   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:233   success++
	inc  p8b_main.p8v_success
	bra  label_asm_16_afterif
label_asm_17_else
	; source: test_uword_lt.p8:235   cx16.r0L++
	inc  cx16.r0L
label_asm_16_afterif
	; source: test_uword_lt.p8:238   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  p8l_lbl8a
	...
	bcc  p8l_lbl8a
+
	; source: test_uword_lt.p8:240   goto skip8a
	bra  p8l_skip8a
	; source: test_uword_lt.p8:241   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:242   skip8a:
p8l_skip8a
	; source: test_uword_lt.p8:244   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:245   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:247   goto skip8b
	bra  p8l_skip8b
	; source: test_uword_lt.p8:248   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:249   skip8b:
p8l_skip8b
	; source: test_uword_lt.p8:251   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:252   success++
	inc  p8b_main.p8v_success
label_asm_18_afterif
	; source: test_uword_lt.p8:255   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:256   success++
	inc  p8b_main.p8v_success
	bra  label_asm_19_afterif
label_asm_20_else
	; source: test_uword_lt.p8:258   cx16.r0L++
	inc  cx16.r0L
label_asm_19_afterif
	; source: test_uword_lt.p8:260   x=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:264   goto skip9a
	bra  p8l_skip9a
	; source: test_uword_lt.p8:265   lbl9a:   fail_uword(13)
p8l_lbl9a
	ldy  #>13
	lda  #<13
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:266   skip9a:
p8l_skip9a
	; source: test_uword_lt.p8:268   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:271   goto skip9b
	bra  p8l_skip9b
	; source: test_uword_lt.p8:272   lbl9b:   fail_uword(14)
p8l_lbl9b
	ldy  #>14
	lda  #<14
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:273   skip9b:
p8l_skip9b
	; source: test_uword_lt.p8:282   success++
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:285   if x<1
	lda  p8v_x
	ora  p8v_x+1
	beq  p8l_lbl10a
	; source: test_uword_lt.p8:287   goto skip10a
	bra  p8l_skip10a
	; source: test_uword_lt.p8:288   lbl10a:   fail_uword(17)
p8l_lbl10a
	ldy  #>$11
	lda  #<$11
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:289   skip10a:
p8l_skip10a
	; source: test_uword_lt.p8:291   cx16.r3 = &lbl10b
	lda  #<p8l_lbl10b
	ldy  #>p8l_lbl10b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:292   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  +
	jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:294   goto skip10b
	bra  p8l_skip10b
	; source: test_uword_lt.p8:295   lbl10b:   fail_uword(18)
p8l_lbl10b
	ldy  #>$12
	lda  #<$12
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:296   skip10b:
p8l_skip10b
	; source: test_uword_lt.p8:298   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_21_afterif
	; source: test_uword_lt.p8:299   fail_uword(19)
	ldy  #>$13
	lda  #<$13
	jsr  p8b_main.p8s_fail_uword
label_asm_21_afterif
	; source: test_uword_lt.p8:302   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_23_else
	; source: test_uword_lt.p8:303   fail_uword(20)
	ldy  #>$14
	lda  #<$14
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_22_afterif
label_asm_23_else
	; source: test_uword_lt.p8:305   success++
	inc  p8b_main.p8v_success
label_asm_22_afterif
	; source: test_uword_lt.p8:308   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  p8l_lbl11a
	...
	bcc  p8l_lbl11a
+
	; source: test_uword_lt.p8:310   goto skip11a
	bra  p8l_skip11a
	; source: test_uword_lt.p8:311   lbl11a:   fail_uword(21)
p8l_lbl11a
	ldy  #>$15
	lda  #<$15
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:312   skip11a:
p8l_skip11a
	; source: test_uword_lt.p8:314   cx16.r3 = &lbl11b
	lda  #<p8l_lbl11b
	ldy  #>p8l_lbl11b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:315   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:317   goto skip11b
	bra  p8l_skip11b
	; source: test_uword_lt.p8:318   lbl11b:   fail_uword(22)
p8l_lbl11b
	ldy  #>$16
	lda  #<$16
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:319   skip11b:
p8l_skip11b
	; source: test_uword_lt.p8:321   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:322   fail_uword(23)
	ldy  #>$17
	lda  #<$17
	jsr  p8b_main.p8s_fail_uword
label_asm_24_afterif
	; source: test_uword_lt.p8:325   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:326   fail_uword(24)
	ldy  #>$18
	lda  #<$18
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_25_afterif
label_asm_26_else
	; source: test_uword_lt.p8:328   success++
	inc  p8b_main.p8v_success
label_asm_25_afterif
	; source: test_uword_lt.p8:331   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  p8l_lbl12a
	...
	bcc  p8l_lbl12a
+
	; source: test_uword_lt.p8:333   goto skip12a
	bra  p8l_skip12a
	; source: test_uword_lt.p8:334   lbl12a:   success++
p8l_lbl12a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:335   skip12a:
p8l_skip12a
	; source: test_uword_lt.p8:337   cx16.r3 = &lbl12b
	lda  #<p8l_lbl12b
	ldy  #>p8l_lbl12b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:338   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:340   goto skip12b
	bra  p8l_skip12b
	; source: test_uword_lt.p8:341   lbl12b:   success++
p8l_lbl12b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:342   skip12b:
p8l_skip12b
	; source: test_uword_lt.p8:344   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:345   success++
	inc  p8b_main.p8v_success
label_asm_27_afterif
	; source: test_uword_lt.p8:348   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:349   success++
	inc  p8b_main.p8v_success
	bra  label_asm_28_afterif
label_asm_29_else
	; source: test_uword_lt.p8:351   cx16.r0L++
	inc  cx16.r0L
label_asm_28_afterif
	; source: test_uword_lt.p8:353   x=65535
	lda  #$ff
	sta  p8v_x
	sta  p8v_x+1
	
	; source: test_uword_lt.p8:357   goto skip13a
	bra  p8l_skip13a
	; source: test_uword_lt.p8:358   lbl13a:   fail_uword(25)
p8l_lbl13a
	ldy  #>$19
	lda  #<$19
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:359   skip13a:
p8l_skip13a
	; source: test_uword_lt.p8:361   cx16.r3 = &lbl13b
	lda  #<p8l_lbl13b
	ldy  #>p8l_lbl13b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:364   goto skip13b
	bra  p8l_skip13b
	; source: test_uword_lt.p8:365   lbl13b:   fail_uword(26)
p8l_lbl13b
	ldy  #>$1a
	lda  #<$1a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:366   skip13b:
p8l_skip13b
	; source: test_uword_lt.p8:375   success++
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:378   if x<1
	lda  p8v_x
	ora  p8v_x+1
	beq  p8l_lbl14a
	; source: test_uword_lt.p8:380   goto skip14a
	bra  p8l_skip14a
	; source: test_uword_lt.p8:381   lbl14a:   fail_uword(29)
p8l_lbl14a
	ldy  #>$1d
	lda  #<$1d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:382   skip14a:
p8l_skip14a
	; source: test_uword_lt.p8:384   cx16.r3 = &lbl14b
	lda  #<p8l_lbl14b
	ldy  #>p8l_lbl14b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:385   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  +
	jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:387   goto skip14b
	bra  p8l_skip14b
	; source: test_uword_lt.p8:388   lbl14b:   fail_uword(30)
p8l_lbl14b
	ldy  #>$1e
	lda  #<$1e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:389   skip14b:
p8l_skip14b
	; source: test_uword_lt.p8:391   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_30_afterif
	; source: test_uword_lt.p8:392   fail_uword(31)
	ldy  #>$1f
	lda  #<$1f
	jsr  p8b_main.p8s_fail_uword
label_asm_30_afterif
	; source: test_uword_lt.p8:395   if x<1
	lda  p8v_x
	ora  p8v_x+1
	bne  label_asm_32_else
	; source: test_uword_lt.p8:396   fail_uword(32)
	ldy  #>$20
	lda  #<$20
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_31_afterif
label_asm_32_else
	; source: test_uword_lt.p8:398   success++
	inc  p8b_main.p8v_success
label_asm_31_afterif
	; source: test_uword_lt.p8:401   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  p8l_lbl15a
	...
	bcc  p8l_lbl15a
+
	; source: test_uword_lt.p8:403   goto skip15a
	bra  p8l_skip15a
	; source: test_uword_lt.p8:404   lbl15a:   fail_uword(33)
p8l_lbl15a
	ldy  #>$21
	lda  #<$21
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:405   skip15a:
p8l_skip15a
	; source: test_uword_lt.p8:407   cx16.r3 = &lbl15b
	lda  #<p8l_lbl15b
	ldy  #>p8l_lbl15b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:408   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$7700
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:410   goto skip15b
	bra  p8l_skip15b
	; source: test_uword_lt.p8:411   lbl15b:   fail_uword(34)
p8l_lbl15b
	ldy  #>$22
	lda  #<$22
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:412   skip15b:
p8l_skip15b
	; source: test_uword_lt.p8:414   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:415   fail_uword(35)
	ldy  #>$23
	lda  #<$23
	jsr  p8b_main.p8s_fail_uword
label_asm_33_afterif
	; source: test_uword_lt.p8:418   if x<30464
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$7700
	tya
	...
	; source: test_uword_lt.p8:419   fail_uword(36)
	ldy  #>$24
	lda  #<$24
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_34_afterif
label_asm_35_else
	; source: test_uword_lt.p8:421   success++
	inc  p8b_main.p8v_success
label_asm_34_afterif
	; source: test_uword_lt.p8:424   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  p8l_lbl16a
	...
	bcc  p8l_lbl16a
+
	; source: test_uword_lt.p8:426   goto skip16a
	bra  p8l_skip16a
	; source: test_uword_lt.p8:427   lbl16a:   fail_uword(37)
p8l_lbl16a
	ldy  #>$25
	lda  #<$25
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:428   skip16a:
p8l_skip16a
	; source: test_uword_lt.p8:430   cx16.r3 = &lbl16b
	lda  #<p8l_lbl16b
	ldy  #>p8l_lbl16b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:431   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cpy  #>$ffff
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:433   goto skip16b
	bra  p8l_skip16b
	; source: test_uword_lt.p8:434   lbl16b:   fail_uword(38)
p8l_lbl16b
	ldy  #>$26
	lda  #<$26
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:435   skip16b:
p8l_skip16b
	; source: test_uword_lt.p8:437   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:438   fail_uword(39)
	ldy  #>$27
	lda  #<$27
	jsr  p8b_main.p8s_fail_uword
label_asm_36_afterif
	; source: test_uword_lt.p8:441   if x<65535
	ldy  p8v_x+1
	lda  p8v_x
	cmp  #<$ffff
	tya
	...
	; source: test_uword_lt.p8:442   fail_uword(40)
	ldy  #>$28
	lda  #<$28
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_37_afterif
label_asm_38_else
	; source: test_uword_lt.p8:444   success++
	inc  p8b_main.p8v_success
label_asm_37_afterif
	; source: test_uword_lt.p8:446   verify_success(34)
	lda  #$22
...
p8v_x	.word  ?
	.send BSS
	.pend
	; source: test_uword_lt.p8:448   sub test_cmp_var() {

p8s_test_cmp_var	.proc
; statements
	; source: test_uword_lt.p8:449   uword @shared x, value
	stz  p8v_x
	stz  p8v_x+1
	lda  p8v_x
	ldy  p8v_x+1
	sta  p8v_value
	sty  p8v_value+1
	; source: test_uword_lt.p8:450   success = 0
	stz  p8b_main.p8v_success
	; source: test_uword_lt.p8:451   x=0
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_lt.p8:452   value=0
	stz  p8v_value
	stz  p8v_value+1
	; source: test_uword_lt.p8:454   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl1a
	...
	bcc  p8l_lbl1a
+
	; source: test_uword_lt.p8:456   goto skip1a
	bra  p8l_skip1a
	; source: test_uword_lt.p8:457   lbl1a:   fail_uword(41)
p8l_lbl1a
	ldy  #>$29
	lda  #<$29
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:458   skip1a:
p8l_skip1a
	; source: test_uword_lt.p8:460   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:461   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:463   goto skip1b
	bra  p8l_skip1b
	; source: test_uword_lt.p8:464   lbl1b:   fail_uword(42)
p8l_lbl1b
	ldy  #>$2a
	lda  #<$2a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:465   skip1b:
p8l_skip1b
	; source: test_uword_lt.p8:467   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:468   fail_uword(43)
	ldy  #>$2b
	lda  #<$2b
	jsr  p8b_main.p8s_fail_uword
label_asm_39_afterif
	; source: test_uword_lt.p8:471   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:472   fail_uword(44)
	ldy  #>$2c
	lda  #<$2c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_40_afterif
label_asm_41_else
	; source: test_uword_lt.p8:474   success++
	inc  p8b_main.p8v_success
label_asm_40_afterif
	; source: test_uword_lt.p8:476   value=1
	lda  #<1
	ldy  #>1
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:478   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl2a
	...
	bcc  p8l_lbl2a
+
	; source: test_uword_lt.p8:480   goto skip2a
	bra  p8l_skip2a
	; source: test_uword_lt.p8:481   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:482   skip2a:
p8l_skip2a
	; source: test_uword_lt.p8:484   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:485   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:487   goto skip2b
	bra  p8l_skip2b
	; source: test_uword_lt.p8:488   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:489   skip2b:
p8l_skip2b
	; source: test_uword_lt.p8:491   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:492   success++
	inc  p8b_main.p8v_success
label_asm_42_afterif
	; source: test_uword_lt.p8:495   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:496   success++
	inc  p8b_main.p8v_success
	bra  label_asm_43_afterif
label_asm_44_else
	; source: test_uword_lt.p8:498   cx16.r0L++
	inc  cx16.r0L
label_asm_43_afterif
	; source: test_uword_lt.p8:500   value=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:502   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl3a
	...
	bcc  p8l_lbl3a
+
	; source: test_uword_lt.p8:504   goto skip3a
	bra  p8l_skip3a
	; source: test_uword_lt.p8:505   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:506   skip3a:
p8l_skip3a
	; source: test_uword_lt.p8:508   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:509   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:511   goto skip3b
	bra  p8l_skip3b
	; source: test_uword_lt.p8:512   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:513   skip3b:
p8l_skip3b
	; source: test_uword_lt.p8:515   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:516   success++
	inc  p8b_main.p8v_success
label_asm_45_afterif
	; source: test_uword_lt.p8:519   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:520   success++
	inc  p8b_main.p8v_success
	bra  label_asm_46_afterif
label_asm_47_else
	; source: test_uword_lt.p8:522   cx16.r0L++
	inc  cx16.r0L
label_asm_46_afterif
	; source: test_uword_lt.p8:524   value=65535
	lda  #$ff
	sta  p8v_value
	sta  p8v_value+1
	
	; source: test_uword_lt.p8:526   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl4a
	...
	bcc  p8l_lbl4a
+
	; source: test_uword_lt.p8:528   goto skip4a
	bra  p8l_skip4a
	; source: test_uword_lt.p8:529   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:530   skip4a:
p8l_skip4a
	; source: test_uword_lt.p8:532   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:533   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:535   goto skip4b
	bra  p8l_skip4b
	; source: test_uword_lt.p8:536   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:537   skip4b:
p8l_skip4b
	; source: test_uword_lt.p8:539   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:540   success++
	inc  p8b_main.p8v_success
label_asm_48_afterif
	; source: test_uword_lt.p8:543   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:544   success++
	inc  p8b_main.p8v_success
	bra  label_asm_49_afterif
label_asm_50_else
	; source: test_uword_lt.p8:546   cx16.r0L++
	inc  cx16.r0L
label_asm_49_afterif
	; source: test_uword_lt.p8:548   x=1
	lda  #<1
	ldy  #>1
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:549   value=0
	stz  p8v_value
	stz  p8v_value+1
	; source: test_uword_lt.p8:551   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl5a
	...
	bcc  p8l_lbl5a
+
	; source: test_uword_lt.p8:553   goto skip5a
	bra  p8l_skip5a
	; source: test_uword_lt.p8:554   lbl5a:   fail_uword(45)
p8l_lbl5a
	ldy  #>$2d
	lda  #<$2d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:555   skip5a:
p8l_skip5a
	; source: test_uword_lt.p8:557   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:558   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:560   goto skip5b
	bra  p8l_skip5b
	; source: test_uword_lt.p8:561   lbl5b:   fail_uword(46)
p8l_lbl5b
	ldy  #>$2e
	lda  #<$2e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:562   skip5b:
p8l_skip5b
	; source: test_uword_lt.p8:564   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:565   fail_uword(47)
	ldy  #>$2f
	lda  #<$2f
	jsr  p8b_main.p8s_fail_uword
label_asm_51_afterif
	; source: test_uword_lt.p8:568   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:569   fail_uword(48)
	ldy  #>$30
	lda  #<$30
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_52_afterif
label_asm_53_else
	; source: test_uword_lt.p8:571   success++
	inc  p8b_main.p8v_success
label_asm_52_afterif
	; source: test_uword_lt.p8:573   value=1
	lda  #<1
	ldy  #>1
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:575   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl6a
	...
	bcc  p8l_lbl6a
+
	; source: test_uword_lt.p8:577   goto skip6a
	bra  p8l_skip6a
	; source: test_uword_lt.p8:578   lbl6a:   fail_uword(49)
p8l_lbl6a
	ldy  #>$31
	lda  #<$31
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:579   skip6a:
p8l_skip6a
	; source: test_uword_lt.p8:581   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:582   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:584   goto skip6b
	bra  p8l_skip6b
	; source: test_uword_lt.p8:585   lbl6b:   fail_uword(50)
p8l_lbl6b
	ldy  #>$32
	lda  #<$32
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:586   skip6b:
p8l_skip6b
	; source: test_uword_lt.p8:588   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:589   fail_uword(51)
	ldy  #>$33
	lda  #<$33
	jsr  p8b_main.p8s_fail_uword
label_asm_54_afterif
	; source: test_uword_lt.p8:592   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:593   fail_uword(52)
	ldy  #>$34
	lda  #<$34
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_55_afterif
label_asm_56_else
	; source: test_uword_lt.p8:595   success++
	inc  p8b_main.p8v_success
label_asm_55_afterif
	; source: test_uword_lt.p8:597   value=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:599   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl7a
	...
	bcc  p8l_lbl7a
+
	; source: test_uword_lt.p8:601   goto skip7a
	bra  p8l_skip7a
	; source: test_uword_lt.p8:602   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:603   skip7a:
p8l_skip7a
	; source: test_uword_lt.p8:605   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:606   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:608   goto skip7b
	bra  p8l_skip7b
	; source: test_uword_lt.p8:609   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:610   skip7b:
p8l_skip7b
	; source: test_uword_lt.p8:612   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:613   success++
	inc  p8b_main.p8v_success
label_asm_57_afterif
	; source: test_uword_lt.p8:616   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:617   success++
	inc  p8b_main.p8v_success
	bra  label_asm_58_afterif
label_asm_59_else
	; source: test_uword_lt.p8:619   cx16.r0L++
	inc  cx16.r0L
label_asm_58_afterif
	; source: test_uword_lt.p8:621   value=65535
	lda  #$ff
	sta  p8v_value
	sta  p8v_value+1
	
	; source: test_uword_lt.p8:623   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl8a
	...
	bcc  p8l_lbl8a
+
	; source: test_uword_lt.p8:625   goto skip8a
	bra  p8l_skip8a
	; source: test_uword_lt.p8:626   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:627   skip8a:
p8l_skip8a
	; source: test_uword_lt.p8:629   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:630   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:632   goto skip8b
	bra  p8l_skip8b
	; source: test_uword_lt.p8:633   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:634   skip8b:
p8l_skip8b
	; source: test_uword_lt.p8:636   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:637   success++
	inc  p8b_main.p8v_success
label_asm_60_afterif
	; source: test_uword_lt.p8:640   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:641   success++
	inc  p8b_main.p8v_success
	bra  label_asm_61_afterif
label_asm_62_else
	; source: test_uword_lt.p8:643   cx16.r0L++
	inc  cx16.r0L
label_asm_61_afterif
	; source: test_uword_lt.p8:645   x=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:646   value=0
	stz  p8v_value
	stz  p8v_value+1
	; source: test_uword_lt.p8:648   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl9a
	...
	bcc  p8l_lbl9a
+
	; source: test_uword_lt.p8:650   goto skip9a
	bra  p8l_skip9a
	; source: test_uword_lt.p8:651   lbl9a:   fail_uword(53)
p8l_lbl9a
	ldy  #>$35
	lda  #<$35
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:652   skip9a:
p8l_skip9a
	; source: test_uword_lt.p8:654   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:655   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:657   goto skip9b
	bra  p8l_skip9b
	; source: test_uword_lt.p8:658   lbl9b:   fail_uword(54)
p8l_lbl9b
	ldy  #>$36
	lda  #<$36
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:659   skip9b:
p8l_skip9b
	; source: test_uword_lt.p8:661   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:662   fail_uword(55)
	ldy  #>$37
	lda  #<$37
	jsr  p8b_main.p8s_fail_uword
label_asm_63_afterif
	; source: test_uword_lt.p8:665   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:666   fail_uword(56)
	ldy  #>$38
	lda  #<$38
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_64_afterif
label_asm_65_else
	; source: test_uword_lt.p8:668   success++
	inc  p8b_main.p8v_success
label_asm_64_afterif
	; source: test_uword_lt.p8:670   value=1
	lda  #<1
	ldy  #>1
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:672   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl10a
	...
	bcc  p8l_lbl10a
+
	; source: test_uword_lt.p8:674   goto skip10a
	bra  p8l_skip10a
	; source: test_uword_lt.p8:675   lbl10a:   fail_uword(57)
p8l_lbl10a
	ldy  #>$39
	lda  #<$39
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:676   skip10a:
p8l_skip10a
	; source: test_uword_lt.p8:678   cx16.r3 = &lbl10b
	lda  #<p8l_lbl10b
	ldy  #>p8l_lbl10b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:679   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:681   goto skip10b
	bra  p8l_skip10b
	; source: test_uword_lt.p8:682   lbl10b:   fail_uword(58)
p8l_lbl10b
	ldy  #>$3a
	lda  #<$3a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:683   skip10b:
p8l_skip10b
	; source: test_uword_lt.p8:685   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:686   fail_uword(59)
	ldy  #>$3b
	lda  #<$3b
	jsr  p8b_main.p8s_fail_uword
label_asm_66_afterif
	; source: test_uword_lt.p8:689   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:690   fail_uword(60)
	ldy  #>$3c
	lda  #<$3c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_67_afterif
label_asm_68_else
	; source: test_uword_lt.p8:692   success++
	inc  p8b_main.p8v_success
label_asm_67_afterif
	; source: test_uword_lt.p8:694   value=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:696   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl11a
	...
	bcc  p8l_lbl11a
+
	; source: test_uword_lt.p8:698   goto skip11a
	bra  p8l_skip11a
	; source: test_uword_lt.p8:699   lbl11a:   fail_uword(61)
p8l_lbl11a
	ldy  #>$3d
	lda  #<$3d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:700   skip11a:
p8l_skip11a
	; source: test_uword_lt.p8:702   cx16.r3 = &lbl11b
	lda  #<p8l_lbl11b
	ldy  #>p8l_lbl11b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:703   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:705   goto skip11b
	bra  p8l_skip11b
	; source: test_uword_lt.p8:706   lbl11b:   fail_uword(62)
p8l_lbl11b
	ldy  #>$3e
	lda  #<$3e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:707   skip11b:
p8l_skip11b
	; source: test_uword_lt.p8:709   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:710   fail_uword(63)
	ldy  #>$3f
	lda  #<$3f
	jsr  p8b_main.p8s_fail_uword
label_asm_69_afterif
	; source: test_uword_lt.p8:713   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:714   fail_uword(64)
	ldy  #>$40
	lda  #<$40
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_70_afterif
label_asm_71_else
	; source: test_uword_lt.p8:716   success++
	inc  p8b_main.p8v_success
label_asm_70_afterif
	; source: test_uword_lt.p8:718   value=65535
	lda  #$ff
	sta  p8v_value
	sta  p8v_value+1
	
	; source: test_uword_lt.p8:720   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl12a
	...
	bcc  p8l_lbl12a
+
	; source: test_uword_lt.p8:722   goto skip12a
	bra  p8l_skip12a
	; source: test_uword_lt.p8:723   lbl12a:   success++
p8l_lbl12a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:724   skip12a:
p8l_skip12a
	; source: test_uword_lt.p8:726   cx16.r3 = &lbl12b
	lda  #<p8l_lbl12b
	ldy  #>p8l_lbl12b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:727   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:729   goto skip12b
	bra  p8l_skip12b
	; source: test_uword_lt.p8:730   lbl12b:   success++
p8l_lbl12b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:731   skip12b:
p8l_skip12b
	; source: test_uword_lt.p8:733   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:734   success++
	inc  p8b_main.p8v_success
label_asm_72_afterif
	; source: test_uword_lt.p8:737   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:738   success++
	inc  p8b_main.p8v_success
	bra  label_asm_73_afterif
label_asm_74_else
	; source: test_uword_lt.p8:740   cx16.r0L++
	inc  cx16.r0L
label_asm_73_afterif
	; source: test_uword_lt.p8:742   x=65535
	lda  #$ff
	sta  p8v_x
	sta  p8v_x+1
	
	; source: test_uword_lt.p8:743   value=0
	stz  p8v_value
	stz  p8v_value+1
	; source: test_uword_lt.p8:745   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl13a
	...
	bcc  p8l_lbl13a
+
	; source: test_uword_lt.p8:747   goto skip13a
	bra  p8l_skip13a
	; source: test_uword_lt.p8:748   lbl13a:   fail_uword(65)
p8l_lbl13a
	ldy  #>$41
	lda  #<$41
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:749   skip13a:
p8l_skip13a
	; source: test_uword_lt.p8:751   cx16.r3 = &lbl13b
	lda  #<p8l_lbl13b
	ldy  #>p8l_lbl13b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:752   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:754   goto skip13b
	bra  p8l_skip13b
	; source: test_uword_lt.p8:755   lbl13b:   fail_uword(66)
p8l_lbl13b
	ldy  #>$42
	lda  #<$42
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:756   skip13b:
p8l_skip13b
	; source: test_uword_lt.p8:758   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:759   fail_uword(67)
	ldy  #>$43
	lda  #<$43
	jsr  p8b_main.p8s_fail_uword
label_asm_75_afterif
	; source: test_uword_lt.p8:762   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:763   fail_uword(68)
	ldy  #>$44
	lda  #<$44
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_76_afterif
label_asm_77_else
	; source: test_uword_lt.p8:765   success++
	inc  p8b_main.p8v_success
label_asm_76_afterif
	; source: test_uword_lt.p8:767   value=1
	lda  #<1
	ldy  #>1
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:769   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl14a
	...
	bcc  p8l_lbl14a
+
	; source: test_uword_lt.p8:771   goto skip14a
	bra  p8l_skip14a
	; source: test_uword_lt.p8:772   lbl14a:   fail_uword(69)
p8l_lbl14a
	ldy  #>$45
	lda  #<$45
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:773   skip14a:
p8l_skip14a
	; source: test_uword_lt.p8:775   cx16.r3 = &lbl14b
	lda  #<p8l_lbl14b
	ldy  #>p8l_lbl14b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:776   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:778   goto skip14b
	bra  p8l_skip14b
	; source: test_uword_lt.p8:779   lbl14b:   fail_uword(70)
p8l_lbl14b
	ldy  #>$46
	lda  #<$46
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:780   skip14b:
p8l_skip14b
	; source: test_uword_lt.p8:782   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:783   fail_uword(71)
	ldy  #>$47
	lda  #<$47
	jsr  p8b_main.p8s_fail_uword
label_asm_78_afterif
	; source: test_uword_lt.p8:786   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:787   fail_uword(72)
	ldy  #>$48
	lda  #<$48
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_79_afterif
label_asm_80_else
	; source: test_uword_lt.p8:789   success++
	inc  p8b_main.p8v_success
label_asm_79_afterif
	; source: test_uword_lt.p8:791   value=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_value
	sty  p8v_value+1
	
	; source: test_uword_lt.p8:793   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl15a
	...
	bcc  p8l_lbl15a
+
	; source: test_uword_lt.p8:795   goto skip15a
	bra  p8l_skip15a
	; source: test_uword_lt.p8:796   lbl15a:   fail_uword(73)
p8l_lbl15a
	ldy  #>$49
	lda  #<$49
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:797   skip15a:
p8l_skip15a
	; source: test_uword_lt.p8:799   cx16.r3 = &lbl15b
	lda  #<p8l_lbl15b
	ldy  #>p8l_lbl15b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:800   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:802   goto skip15b
	bra  p8l_skip15b
	; source: test_uword_lt.p8:803   lbl15b:   fail_uword(74)
p8l_lbl15b
	ldy  #>$4a
	lda  #<$4a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:804   skip15b:
p8l_skip15b
	; source: test_uword_lt.p8:806   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:807   fail_uword(75)
	ldy  #>$4b
	lda  #<$4b
	jsr  p8b_main.p8s_fail_uword
label_asm_81_afterif
	; source: test_uword_lt.p8:810   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:811   fail_uword(76)
	ldy  #>$4c
	lda  #<$4c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_82_afterif
label_asm_83_else
	; source: test_uword_lt.p8:813   success++
	inc  p8b_main.p8v_success
label_asm_82_afterif
	; source: test_uword_lt.p8:815   value=65535
	lda  #$ff
	sta  p8v_value
	sta  p8v_value+1
	
	; source: test_uword_lt.p8:817   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  p8l_lbl16a
	...
	bcc  p8l_lbl16a
+
	; source: test_uword_lt.p8:819   goto skip16a
	bra  p8l_skip16a
	; source: test_uword_lt.p8:820   lbl16a:   fail_uword(77)
p8l_lbl16a
	ldy  #>$4d
	lda  #<$4d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:821   skip16a:
p8l_skip16a
	; source: test_uword_lt.p8:823   cx16.r3 = &lbl16b
	lda  #<p8l_lbl16b
	ldy  #>p8l_lbl16b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:824   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cpy  p8v_value+1
	bcc  _jump
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:826   goto skip16b
	bra  p8l_skip16b
	; source: test_uword_lt.p8:827   lbl16b:   fail_uword(78)
p8l_lbl16b
	ldy  #>$4e
	lda  #<$4e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:828   skip16b:
p8l_skip16b
	; source: test_uword_lt.p8:830   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:831   fail_uword(79)
	ldy  #>$4f
	lda  #<$4f
	jsr  p8b_main.p8s_fail_uword
label_asm_84_afterif
	; source: test_uword_lt.p8:834   if x<value
	ldy  p8v_x+1
	lda  p8v_x
	cmp  p8v_value
	tya
	...
	; source: test_uword_lt.p8:835   fail_uword(80)
	ldy  #>$50
	lda  #<$50
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_85_afterif
label_asm_86_else
	; source: test_uword_lt.p8:837   success++
	inc  p8b_main.p8v_success
...
p8v_x	.word  ?
	.send BSS
	.pend
	; source: test_uword_lt.p8:841   sub test_cmp_array() {

p8s_test_cmp_array	.proc
; statements
	; source: test_uword_lt.p8:842   uword @shared x
	; source: test_uword_lt.p8:843   uword[] values = [0, 0]
	; source: test_uword_lt.p8:842   uword @shared x
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_lt.p8:844   success = 0
	stz  p8b_main.p8v_success
	; source: test_uword_lt.p8:845   x=0
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_lt.p8:846   values[1]=0
	ldy  #2
	lda  #0
	sta  p8v_values,y
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:848   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	...
	bcc  p8l_lbl1a
+
	; source: test_uword_lt.p8:850   goto skip1a
	bra  p8l_skip1a
	; source: test_uword_lt.p8:851   lbl1a:   fail_uword(81)
p8l_lbl1a
	ldy  #>$51
	lda  #<$51
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:852   skip1a:
p8l_skip1a
	; source: test_uword_lt.p8:854   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:855   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:857   goto skip1b
	bra  p8l_skip1b
	; source: test_uword_lt.p8:858   lbl1b:   fail_uword(82)
p8l_lbl1b
	ldy  #>$52
	lda  #<$52
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:859   skip1b:
p8l_skip1b
	; source: test_uword_lt.p8:861   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:862   fail_uword(83)
	ldy  #>$53
	lda  #<$53
	jsr  p8b_main.p8s_fail_uword
label_asm_87_afterif
	; source: test_uword_lt.p8:865   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:866   fail_uword(84)
	ldy  #>$54
	lda  #<$54
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_88_afterif
label_asm_89_else
	; source: test_uword_lt.p8:868   success++
	inc  p8b_main.p8v_success
label_asm_88_afterif
	; source: test_uword_lt.p8:870   values[1]=1
	ldy  #2
	lda  #<1
	sta  p8v_values,y
	lda  #>1
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:872   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl2a
+
	; source: test_uword_lt.p8:874   goto skip2a
	bra  p8l_skip2a
	; source: test_uword_lt.p8:875   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:876   skip2a:
p8l_skip2a
	; source: test_uword_lt.p8:878   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:879   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:881   goto skip2b
	bra  p8l_skip2b
	; source: test_uword_lt.p8:882   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:883   skip2b:
p8l_skip2b
	; source: test_uword_lt.p8:885   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:886   success++
	inc  p8b_main.p8v_success
label_asm_90_afterif
	; source: test_uword_lt.p8:889   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:890   success++
	inc  p8b_main.p8v_success
	bra  label_asm_91_afterif
label_asm_92_else
	; source: test_uword_lt.p8:892   cx16.r0L++
	inc  cx16.r0L
label_asm_91_afterif
	; source: test_uword_lt.p8:894   values[1]=30464
	ldy  #2
	lda  #<$7700
	sta  p8v_values,y
	lda  #>$7700
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:896   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl3a
+
	; source: test_uword_lt.p8:898   goto skip3a
	bra  p8l_skip3a
	; source: test_uword_lt.p8:899   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:900   skip3a:
p8l_skip3a
	; source: test_uword_lt.p8:902   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:903   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:905   goto skip3b
	bra  p8l_skip3b
	; source: test_uword_lt.p8:906   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:907   skip3b:
p8l_skip3b
	; source: test_uword_lt.p8:909   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:910   success++
	inc  p8b_main.p8v_success
label_asm_93_afterif
	; source: test_uword_lt.p8:913   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:914   success++
	inc  p8b_main.p8v_success
	bra  label_asm_94_afterif
label_asm_95_else
	; source: test_uword_lt.p8:916   cx16.r0L++
	inc  cx16.r0L
label_asm_94_afterif
	; source: test_uword_lt.p8:918   values[1]=65535
	ldy  #2
	lda  #<$ffff
	sta  p8v_values,y
	lda  #>$ffff
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:920   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl4a
+
	; source: test_uword_lt.p8:922   goto skip4a
	bra  p8l_skip4a
	; source: test_uword_lt.p8:923   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:924   skip4a:
p8l_skip4a
	; source: test_uword_lt.p8:926   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:927   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:929   goto skip4b
	bra  p8l_skip4b
	; source: test_uword_lt.p8:930   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:931   skip4b:
p8l_skip4b
	; source: test_uword_lt.p8:933   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:934   success++
	inc  p8b_main.p8v_success
label_asm_96_afterif
	; source: test_uword_lt.p8:937   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:938   success++
	inc  p8b_main.p8v_success
	bra  label_asm_97_afterif
label_asm_98_else
	; source: test_uword_lt.p8:940   cx16.r0L++
	inc  cx16.r0L
label_asm_97_afterif
	; source: test_uword_lt.p8:942   x=1
	lda  #<1
	ldy  #>1
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:943   values[1]=0
	ldy  #2
	lda  #0
	sta  p8v_values,y
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:945   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl5a
+
	; source: test_uword_lt.p8:947   goto skip5a
	bra  p8l_skip5a
	; source: test_uword_lt.p8:948   lbl5a:   fail_uword(85)
p8l_lbl5a
	ldy  #>$55
	lda  #<$55
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:949   skip5a:
p8l_skip5a
	; source: test_uword_lt.p8:951   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:952   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:954   goto skip5b
	bra  p8l_skip5b
	; source: test_uword_lt.p8:955   lbl5b:   fail_uword(86)
p8l_lbl5b
	ldy  #>$56
	lda  #<$56
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:956   skip5b:
p8l_skip5b
	; source: test_uword_lt.p8:958   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:959   fail_uword(87)
	ldy  #>$57
	lda  #<$57
	jsr  p8b_main.p8s_fail_uword
label_asm_99_afterif
	; source: test_uword_lt.p8:962   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:963   fail_uword(88)
	ldy  #>$58
	lda  #<$58
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_100_afterif
label_asm_101_else
	; source: test_uword_lt.p8:965   success++
	inc  p8b_main.p8v_success
label_asm_100_afterif
	; source: test_uword_lt.p8:967   values[1]=1
	ldy  #2
	lda  #<1
	sta  p8v_values,y
	lda  #>1
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:969   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl6a
+
	; source: test_uword_lt.p8:971   goto skip6a
	bra  p8l_skip6a
	; source: test_uword_lt.p8:972   lbl6a:   fail_uword(89)
p8l_lbl6a
	ldy  #>$59
	lda  #<$59
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:973   skip6a:
p8l_skip6a
	; source: test_uword_lt.p8:975   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:976   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:978   goto skip6b
	bra  p8l_skip6b
	; source: test_uword_lt.p8:979   lbl6b:   fail_uword(90)
p8l_lbl6b
	ldy  #>$5a
	lda  #<$5a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:980   skip6b:
p8l_skip6b
	; source: test_uword_lt.p8:982   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:983   fail_uword(91)
	ldy  #>$5b
	lda  #<$5b
	jsr  p8b_main.p8s_fail_uword
label_asm_102_afterif
	; source: test_uword_lt.p8:986   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:987   fail_uword(92)
	ldy  #>$5c
	lda  #<$5c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_103_afterif
label_asm_104_else
	; source: test_uword_lt.p8:989   success++
	inc  p8b_main.p8v_success
label_asm_103_afterif
	; source: test_uword_lt.p8:991   values[1]=30464
	ldy  #2
	lda  #<$7700
	sta  p8v_values,y
	lda  #>$7700
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:993   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl7a
+
	; source: test_uword_lt.p8:995   goto skip7a
	bra  p8l_skip7a
	; source: test_uword_lt.p8:996   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:997   skip7a:
p8l_skip7a
	; source: test_uword_lt.p8:999   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1000   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1002   goto skip7b
	bra  p8l_skip7b
	; source: test_uword_lt.p8:1003   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1004   skip7b:
p8l_skip7b
	; source: test_uword_lt.p8:1006   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1007   success++
	inc  p8b_main.p8v_success
label_asm_105_afterif
	; source: test_uword_lt.p8:1010   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1011   success++
	inc  p8b_main.p8v_success
	bra  label_asm_106_afterif
label_asm_107_else
	; source: test_uword_lt.p8:1013   cx16.r0L++
	inc  cx16.r0L
label_asm_106_afterif
	; source: test_uword_lt.p8:1015   values[1]=65535
	ldy  #2
	lda  #<$ffff
	sta  p8v_values,y
	lda  #>$ffff
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1017   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl8a
+
	; source: test_uword_lt.p8:1019   goto skip8a
	bra  p8l_skip8a
	; source: test_uword_lt.p8:1020   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1021   skip8a:
p8l_skip8a
	; source: test_uword_lt.p8:1023   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1024   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1026   goto skip8b
	bra  p8l_skip8b
	; source: test_uword_lt.p8:1027   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1028   skip8b:
p8l_skip8b
	; source: test_uword_lt.p8:1030   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1031   success++
	inc  p8b_main.p8v_success
label_asm_108_afterif
	; source: test_uword_lt.p8:1034   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1035   success++
	inc  p8b_main.p8v_success
	bra  label_asm_109_afterif
label_asm_110_else
	; source: test_uword_lt.p8:1037   cx16.r0L++
	inc  cx16.r0L
label_asm_109_afterif
	; source: test_uword_lt.p8:1039   x=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:1040   values[1]=0
	ldy  #2
	lda  #0
	sta  p8v_values,y
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1042   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl9a
+
	; source: test_uword_lt.p8:1044   goto skip9a
	bra  p8l_skip9a
	; source: test_uword_lt.p8:1045   lbl9a:   fail_uword(93)
p8l_lbl9a
	ldy  #>$5d
	lda  #<$5d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1046   skip9a:
p8l_skip9a
	; source: test_uword_lt.p8:1048   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1049   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1051   goto skip9b
	bra  p8l_skip9b
	; source: test_uword_lt.p8:1052   lbl9b:   fail_uword(94)
p8l_lbl9b
	ldy  #>$5e
	lda  #<$5e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1053   skip9b:
p8l_skip9b
	; source: test_uword_lt.p8:1055   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1056   fail_uword(95)
	ldy  #>$5f
	lda  #<$5f
	jsr  p8b_main.p8s_fail_uword
label_asm_111_afterif
	; source: test_uword_lt.p8:1059   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1060   fail_uword(96)
	ldy  #>$60
	lda  #<$60
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_112_afterif
label_asm_113_else
	; source: test_uword_lt.p8:1062   success++
	inc  p8b_main.p8v_success
label_asm_112_afterif
	; source: test_uword_lt.p8:1064   values[1]=1
	ldy  #2
	lda  #<1
	sta  p8v_values,y
	lda  #>1
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1066   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl10a
+
	; source: test_uword_lt.p8:1068   goto skip10a
	bra  p8l_skip10a
	; source: test_uword_lt.p8:1069   lbl10a:   fail_uword(97)
p8l_lbl10a
	ldy  #>$61
	lda  #<$61
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1070   skip10a:
p8l_skip10a
	; source: test_uword_lt.p8:1072   cx16.r3 = &lbl10b
	lda  #<p8l_lbl10b
	ldy  #>p8l_lbl10b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1073   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1075   goto skip10b
	bra  p8l_skip10b
	; source: test_uword_lt.p8:1076   lbl10b:   fail_uword(98)
p8l_lbl10b
	ldy  #>$62
	lda  #<$62
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1077   skip10b:
p8l_skip10b
	; source: test_uword_lt.p8:1079   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1080   fail_uword(99)
	ldy  #>$63
	lda  #<$63
	jsr  p8b_main.p8s_fail_uword
label_asm_114_afterif
	; source: test_uword_lt.p8:1083   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1084   fail_uword(100)
	ldy  #>$64
	lda  #<$64
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_115_afterif
label_asm_116_else
	; source: test_uword_lt.p8:1086   success++
	inc  p8b_main.p8v_success
label_asm_115_afterif
	; source: test_uword_lt.p8:1088   values[1]=30464
	ldy  #2
	lda  #<$7700
	sta  p8v_values,y
	lda  #>$7700
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1090   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl11a
+
	; source: test_uword_lt.p8:1092   goto skip11a
	bra  p8l_skip11a
	; source: test_uword_lt.p8:1093   lbl11a:   fail_uword(101)
p8l_lbl11a
	ldy  #>$65
	lda  #<$65
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1094   skip11a:
p8l_skip11a
	; source: test_uword_lt.p8:1096   cx16.r3 = &lbl11b
	lda  #<p8l_lbl11b
	ldy  #>p8l_lbl11b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1097   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1099   goto skip11b
	bra  p8l_skip11b
	; source: test_uword_lt.p8:1100   lbl11b:   fail_uword(102)
p8l_lbl11b
	ldy  #>$66
	lda  #<$66
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1101   skip11b:
p8l_skip11b
	; source: test_uword_lt.p8:1103   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1104   fail_uword(103)
	ldy  #>$67
	lda  #<$67
	jsr  p8b_main.p8s_fail_uword
label_asm_117_afterif
	; source: test_uword_lt.p8:1107   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1108   fail_uword(104)
	ldy  #>$68
	lda  #<$68
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_118_afterif
label_asm_119_else
	; source: test_uword_lt.p8:1110   success++
	inc  p8b_main.p8v_success
label_asm_118_afterif
	; source: test_uword_lt.p8:1112   values[1]=65535
	ldy  #2
	lda  #<$ffff
	sta  p8v_values,y
	lda  #>$ffff
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1114   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl12a
+
	; source: test_uword_lt.p8:1116   goto skip12a
	bra  p8l_skip12a
	; source: test_uword_lt.p8:1117   lbl12a:   success++
p8l_lbl12a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1118   skip12a:
p8l_skip12a
	; source: test_uword_lt.p8:1120   cx16.r3 = &lbl12b
	lda  #<p8l_lbl12b
	ldy  #>p8l_lbl12b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1121   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1123   goto skip12b
	bra  p8l_skip12b
	; source: test_uword_lt.p8:1124   lbl12b:   success++
p8l_lbl12b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1125   skip12b:
p8l_skip12b
	; source: test_uword_lt.p8:1127   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1128   success++
	inc  p8b_main.p8v_success
label_asm_120_afterif
	; source: test_uword_lt.p8:1131   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1132   success++
	inc  p8b_main.p8v_success
	bra  label_asm_121_afterif
label_asm_122_else
	; source: test_uword_lt.p8:1134   cx16.r0L++
	inc  cx16.r0L
label_asm_121_afterif
	; source: test_uword_lt.p8:1136   x=65535
	lda  #$ff
	sta  p8v_x
	sta  p8v_x+1
	
	; source: test_uword_lt.p8:1137   values[1]=0
	ldy  #2
	lda  #0
	sta  p8v_values,y
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1139   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl13a
+
	; source: test_uword_lt.p8:1141   goto skip13a
	bra  p8l_skip13a
	; source: test_uword_lt.p8:1142   lbl13a:   fail_uword(105)
p8l_lbl13a
	ldy  #>$69
	lda  #<$69
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1143   skip13a:
p8l_skip13a
	; source: test_uword_lt.p8:1145   cx16.r3 = &lbl13b
	lda  #<p8l_lbl13b
	ldy  #>p8l_lbl13b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1146   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1148   goto skip13b
	bra  p8l_skip13b
	; source: test_uword_lt.p8:1149   lbl13b:   fail_uword(106)
p8l_lbl13b
	ldy  #>$6a
	lda  #<$6a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1150   skip13b:
p8l_skip13b
	; source: test_uword_lt.p8:1152   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1153   fail_uword(107)
	ldy  #>$6b
	lda  #<$6b
	jsr  p8b_main.p8s_fail_uword
label_asm_123_afterif
	; source: test_uword_lt.p8:1156   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1157   fail_uword(108)
	ldy  #>$6c
	lda  #<$6c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_124_afterif
label_asm_125_else
	; source: test_uword_lt.p8:1159   success++
	inc  p8b_main.p8v_success
label_asm_124_afterif
	; source: test_uword_lt.p8:1161   values[1]=1
	ldy  #2
	lda  #<1
	sta  p8v_values,y
	lda  #>1
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1163   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl14a
+
	; source: test_uword_lt.p8:1165   goto skip14a
	bra  p8l_skip14a
	; source: test_uword_lt.p8:1166   lbl14a:   fail_uword(109)
p8l_lbl14a
	ldy  #>$6d
	lda  #<$6d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1167   skip14a:
p8l_skip14a
	; source: test_uword_lt.p8:1169   cx16.r3 = &lbl14b
	lda  #<p8l_lbl14b
	ldy  #>p8l_lbl14b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1170   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1172   goto skip14b
	bra  p8l_skip14b
	; source: test_uword_lt.p8:1173   lbl14b:   fail_uword(110)
p8l_lbl14b
	ldy  #>$6e
	lda  #<$6e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1174   skip14b:
p8l_skip14b
	; source: test_uword_lt.p8:1176   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1177   fail_uword(111)
	ldy  #>$6f
	lda  #<$6f
	jsr  p8b_main.p8s_fail_uword
label_asm_126_afterif
	; source: test_uword_lt.p8:1180   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1181   fail_uword(112)
	ldy  #>$70
	lda  #<$70
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_127_afterif
label_asm_128_else
	; source: test_uword_lt.p8:1183   success++
	inc  p8b_main.p8v_success
label_asm_127_afterif
	; source: test_uword_lt.p8:1185   values[1]=30464
	ldy  #2
	lda  #<$7700
	sta  p8v_values,y
	lda  #>$7700
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1187   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl15a
+
	; source: test_uword_lt.p8:1189   goto skip15a
	bra  p8l_skip15a
	; source: test_uword_lt.p8:1190   lbl15a:   fail_uword(113)
p8l_lbl15a
	ldy  #>$71
	lda  #<$71
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1191   skip15a:
p8l_skip15a
	; source: test_uword_lt.p8:1193   cx16.r3 = &lbl15b
	lda  #<p8l_lbl15b
	ldy  #>p8l_lbl15b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1194   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1196   goto skip15b
	bra  p8l_skip15b
	; source: test_uword_lt.p8:1197   lbl15b:   fail_uword(114)
p8l_lbl15b
	ldy  #>$72
	lda  #<$72
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1198   skip15b:
p8l_skip15b
	; source: test_uword_lt.p8:1200   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1201   fail_uword(115)
	ldy  #>$73
	lda  #<$73
	jsr  p8b_main.p8s_fail_uword
label_asm_129_afterif
	; source: test_uword_lt.p8:1204   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1205   fail_uword(116)
	ldy  #>$74
	lda  #<$74
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_130_afterif
label_asm_131_else
	; source: test_uword_lt.p8:1207   success++
	inc  p8b_main.p8v_success
label_asm_130_afterif
	; source: test_uword_lt.p8:1209   values[1]=65535
	ldy  #2
	lda  #<$ffff
	sta  p8v_values,y
	lda  #>$ffff
	sta  p8v_values+1,y
	; source: test_uword_lt.p8:1211   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	bcc  p8l_lbl16a
+
	; source: test_uword_lt.p8:1213   goto skip16a
	bra  p8l_skip16a
	; source: test_uword_lt.p8:1214   lbl16a:   fail_uword(117)
p8l_lbl16a
	ldy  #>$75
	lda  #<$75
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1215   skip16a:
p8l_skip16a
	; source: test_uword_lt.p8:1217   cx16.r3 = &lbl16b
	lda  #<p8l_lbl16b
	ldy  #>p8l_lbl16b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1218   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1220   goto skip16b
	bra  p8l_skip16b
	; source: test_uword_lt.p8:1221   lbl16b:   fail_uword(118)
p8l_lbl16b
	ldy  #>$76
	lda  #<$76
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1222   skip16b:
p8l_skip16b
	; source: test_uword_lt.p8:1224   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1225   fail_uword(119)
	ldy  #>$77
	lda  #<$77
	jsr  p8b_main.p8s_fail_uword
label_asm_132_afterif
	; source: test_uword_lt.p8:1228   if x<values[1]
	lda  p8v_values+2
	ldy  p8v_values+2+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_lt.p8:1229   fail_uword(120)
	ldy  #>$78
	lda  #<$78
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_133_afterif
label_asm_134_else
	; source: test_uword_lt.p8:1231   success++
	inc  p8b_main.p8v_success
label_asm_133_afterif
	; source: test_uword_lt.p8:1233   verify_success(34)
	lda  #$22
	jmp  p8b_main.p8s_verify_success
	; source: test_uword_lt.p8:841   sub test_cmp_array() {
; variables
...
p8v_values	.word  $0000, $0000
	.pend
	; source: test_uword_lt.p8:1235   sub test_cmp_expr() {

p8s_test_cmp_expr	.proc
; statements
	; source: test_uword_lt.p8:1236   uword @shared x
	; source: test_uword_lt.p8:1239   float @shared f4 = 1.0
	; source: test_uword_lt.p8:1240   float @shared f5 = 1.0
	; source: test_uword_lt.p8:1236   uword @shared x
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_lt.p8:1237   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_uword_lt.p8:1238   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_uword_lt.p8:1241   success = 0
	stz  p8b_main.p8v_success
	; source: test_uword_lt.p8:1242   x=0
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_lt.p8:1244   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	bcc  p8l_lbl1a
+
	; source: test_uword_lt.p8:1246   goto skip1a
	bra  p8l_skip1a
	; source: test_uword_lt.p8:1247   lbl1a:   fail_uword(121)
p8l_lbl1a
	ldy  #>$79
	lda  #<$79
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1248   skip1a:
p8l_skip1a
	; source: test_uword_lt.p8:1250   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1251   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1253   goto skip1b
	bra  p8l_skip1b
	; source: test_uword_lt.p8:1254   lbl1b:   fail_uword(122)
p8l_lbl1b
	ldy  #>$7a
	lda  #<$7a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1255   skip1b:
p8l_skip1b
	; source: test_uword_lt.p8:1257   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1258   fail_uword(123)
	ldy  #>$7b
	lda  #<$7b
	jsr  p8b_main.p8s_fail_uword
label_asm_135_afterif
	; source: test_uword_lt.p8:1261   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1262   fail_uword(124)
	ldy  #>$7c
	lda  #<$7c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_136_afterif
label_asm_137_else
	; source: test_uword_lt.p8:1264   success++
	inc  p8b_main.p8v_success
label_asm_136_afterif
	; source: test_uword_lt.p8:1267   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	bcc  p8l_lbl2a
+
	; source: test_uword_lt.p8:1269   goto skip2a
	bra  p8l_skip2a
	; source: test_uword_lt.p8:1270   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1271   skip2a:
p8l_skip2a
	; source: test_uword_lt.p8:1273   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1274   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1276   goto skip2b
	bra  p8l_skip2b
	; source: test_uword_lt.p8:1277   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1278   skip2b:
p8l_skip2b
	; source: test_uword_lt.p8:1280   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1281   success++
	inc  p8b_main.p8v_success
label_asm_138_afterif
	; source: test_uword_lt.p8:1284   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1285   success++
	inc  p8b_main.p8v_success
	bra  label_asm_139_afterif
label_asm_140_else
	; source: test_uword_lt.p8:1287   cx16.r0L++
	inc  cx16.r0L
label_asm_139_afterif
	; source: test_uword_lt.p8:1290   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	bcc  p8l_lbl3a
+
	; source: test_uword_lt.p8:1292   goto skip3a
	bra  p8l_skip3a
	; source: test_uword_lt.p8:1293   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1294   skip3a:
p8l_skip3a
	; source: test_uword_lt.p8:1296   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1297   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1299   goto skip3b
	bra  p8l_skip3b
	; source: test_uword_lt.p8:1300   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1301   skip3b:
p8l_skip3b
	; source: test_uword_lt.p8:1303   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1304   success++
	inc  p8b_main.p8v_success
label_asm_141_afterif
	; source: test_uword_lt.p8:1307   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1308   success++
	inc  p8b_main.p8v_success
	bra  label_asm_142_afterif
label_asm_143_else
	; source: test_uword_lt.p8:1310   cx16.r0L++
	inc  cx16.r0L
label_asm_142_afterif
	; source: test_uword_lt.p8:1313   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	bcc  p8l_lbl4a
+
	; source: test_uword_lt.p8:1315   goto skip4a
	bra  p8l_skip4a
	; source: test_uword_lt.p8:1316   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1317   skip4a:
p8l_skip4a
	; source: test_uword_lt.p8:1319   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1320   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1322   goto skip4b
	bra  p8l_skip4b
	; source: test_uword_lt.p8:1323   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1324   skip4b:
p8l_skip4b
	; source: test_uword_lt.p8:1326   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1327   success++
	inc  p8b_main.p8v_success
label_asm_144_afterif
	; source: test_uword_lt.p8:1330   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1331   success++
	inc  p8b_main.p8v_success
	bra  label_asm_145_afterif
label_asm_146_else
	; source: test_uword_lt.p8:1333   cx16.r0L++
	inc  cx16.r0L
label_asm_145_afterif
	; source: test_uword_lt.p8:1335   x=1
	lda  #<1
	ldy  #>1
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:1337   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	bcc  p8l_lbl5a
+
	; source: test_uword_lt.p8:1339   goto skip5a
	bra  p8l_skip5a
	; source: test_uword_lt.p8:1340   lbl5a:   fail_uword(125)
p8l_lbl5a
	ldy  #>$7d
	lda  #<$7d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1341   skip5a:
p8l_skip5a
	; source: test_uword_lt.p8:1343   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1344   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1346   goto skip5b
	bra  p8l_skip5b
	; source: test_uword_lt.p8:1347   lbl5b:   fail_uword(126)
p8l_lbl5b
	ldy  #>$7e
	lda  #<$7e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1348   skip5b:
p8l_skip5b
	; source: test_uword_lt.p8:1350   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1351   fail_uword(127)
	ldy  #>$7f
	lda  #<$7f
	jsr  p8b_main.p8s_fail_uword
label_asm_147_afterif
	; source: test_uword_lt.p8:1354   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1355   fail_uword(128)
	ldy  #>$80
	lda  #<$80
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_148_afterif
label_asm_149_else
	; source: test_uword_lt.p8:1357   success++
	inc  p8b_main.p8v_success
label_asm_148_afterif
	; source: test_uword_lt.p8:1360   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	bcc  p8l_lbl6a
+
	; source: test_uword_lt.p8:1362   goto skip6a
	bra  p8l_skip6a
	; source: test_uword_lt.p8:1363   lbl6a:   fail_uword(129)
p8l_lbl6a
	ldy  #>$81
	lda  #<$81
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1364   skip6a:
p8l_skip6a
	; source: test_uword_lt.p8:1366   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1367   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1369   goto skip6b
	bra  p8l_skip6b
	; source: test_uword_lt.p8:1370   lbl6b:   fail_uword(130)
p8l_lbl6b
	ldy  #>$82
	lda  #<$82
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1371   skip6b:
p8l_skip6b
	; source: test_uword_lt.p8:1373   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1374   fail_uword(131)
	ldy  #>$83
	lda  #<$83
	jsr  p8b_main.p8s_fail_uword
label_asm_150_afterif
	; source: test_uword_lt.p8:1377   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1378   fail_uword(132)
	ldy  #>$84
	lda  #<$84
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_151_afterif
label_asm_152_else
	; source: test_uword_lt.p8:1380   success++
	inc  p8b_main.p8v_success
label_asm_151_afterif
	; source: test_uword_lt.p8:1383   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	bcc  p8l_lbl7a
+
	; source: test_uword_lt.p8:1385   goto skip7a
	bra  p8l_skip7a
	; source: test_uword_lt.p8:1386   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1387   skip7a:
p8l_skip7a
	; source: test_uword_lt.p8:1389   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1390   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1392   goto skip7b
	bra  p8l_skip7b
	; source: test_uword_lt.p8:1393   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1394   skip7b:
p8l_skip7b
	; source: test_uword_lt.p8:1396   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1397   success++
	inc  p8b_main.p8v_success
label_asm_153_afterif
	; source: test_uword_lt.p8:1400   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1401   success++
	inc  p8b_main.p8v_success
...
label_asm_154_afterif
	; source: test_uword_lt.p8:1406   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	bcc  p8l_lbl8a
+
	; source: test_uword_lt.p8:1408   goto skip8a
	bra  p8l_skip8a
	; source: test_uword_lt.p8:1409   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1410   skip8a:
p8l_skip8a
	; source: test_uword_lt.p8:1412   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1413   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1415   goto skip8b
	bra  p8l_skip8b
	; source: test_uword_lt.p8:1416   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1417   skip8b:
p8l_skip8b
	; source: test_uword_lt.p8:1419   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1420   success++
	inc  p8b_main.p8v_success
label_asm_156_afterif
	; source: test_uword_lt.p8:1423   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1424   success++
	inc  p8b_main.p8v_success
	bra  label_asm_157_afterif
label_asm_158_else
	; source: test_uword_lt.p8:1426   cx16.r0L++
	inc  cx16.r0L
label_asm_157_afterif
	; source: test_uword_lt.p8:1428   x=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_lt.p8:1430   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	bcc  p8l_lbl9a
+
	; source: test_uword_lt.p8:1432   goto skip9a
	bra  p8l_skip9a
	; source: test_uword_lt.p8:1433   lbl9a:   fail_uword(133)
p8l_lbl9a
	ldy  #>$85
	lda  #<$85
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1434   skip9a:
p8l_skip9a
	; source: test_uword_lt.p8:1436   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1437   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1439   goto skip9b
	bra  p8l_skip9b
	; source: test_uword_lt.p8:1440   lbl9b:   fail_uword(134)
p8l_lbl9b
	ldy  #>$86
	lda  #<$86
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1441   skip9b:
p8l_skip9b
	; source: test_uword_lt.p8:1443   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1444   fail_uword(135)
	ldy  #>$87
	lda  #<$87
	jsr  p8b_main.p8s_fail_uword
label_asm_159_afterif
	; source: test_uword_lt.p8:1447   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1448   fail_uword(136)
	ldy  #>$88
	lda  #<$88
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_160_afterif
label_asm_161_else
	; source: test_uword_lt.p8:1450   success++
	inc  p8b_main.p8v_success
label_asm_160_afterif
	; source: test_uword_lt.p8:1453   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	bcc  p8l_lbl10a
+
	; source: test_uword_lt.p8:1455   goto skip10a
	bra  p8l_skip10a
	; source: test_uword_lt.p8:1456   lbl10a:   fail_uword(137)
p8l_lbl10a
	ldy  #>$89
	lda  #<$89
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1457   skip10a:
p8l_skip10a
	; source: test_uword_lt.p8:1459   cx16.r3 = &lbl10b
	lda  #<p8l_lbl10b
	ldy  #>p8l_lbl10b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1460   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1462   goto skip10b
	bra  p8l_skip10b
	; source: test_uword_lt.p8:1463   lbl10b:   fail_uword(138)
p8l_lbl10b
	ldy  #>$8a
	lda  #<$8a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1464   skip10b:
p8l_skip10b
	; source: test_uword_lt.p8:1466   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1467   fail_uword(139)
	ldy  #>$8b
	lda  #<$8b
	jsr  p8b_main.p8s_fail_uword
label_asm_162_afterif
	; source: test_uword_lt.p8:1470   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1471   fail_uword(140)
	ldy  #>$8c
	lda  #<$8c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_163_afterif
label_asm_164_else
	; source: test_uword_lt.p8:1473   success++
	inc  p8b_main.p8v_success
label_asm_163_afterif
	; source: test_uword_lt.p8:1476   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	bcc  p8l_lbl11a
+
	; source: test_uword_lt.p8:1478   goto skip11a
	bra  p8l_skip11a
	; source: test_uword_lt.p8:1479   lbl11a:   fail_uword(141)
p8l_lbl11a
	ldy  #>$8d
	lda  #<$8d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1480   skip11a:
p8l_skip11a
	; source: test_uword_lt.p8:1482   cx16.r3 = &lbl11b
	lda  #<p8l_lbl11b
	ldy  #>p8l_lbl11b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1483   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1485   goto skip11b
	bra  p8l_skip11b
	; source: test_uword_lt.p8:1486   lbl11b:   fail_uword(142)
p8l_lbl11b
	ldy  #>$8e
	lda  #<$8e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1487   skip11b:
p8l_skip11b
	; source: test_uword_lt.p8:1489   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1490   fail_uword(143)
	ldy  #>$8f
	lda  #<$8f
	jsr  p8b_main.p8s_fail_uword
label_asm_165_afterif
	; source: test_uword_lt.p8:1493   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1494   fail_uword(144)
	ldy  #>$90
	lda  #<$90
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_166_afterif
label_asm_167_else
	; source: test_uword_lt.p8:1496   success++
	inc  p8b_main.p8v_success
label_asm_166_afterif
	; source: test_uword_lt.p8:1499   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	bcc  p8l_lbl12a
+
	; source: test_uword_lt.p8:1501   goto skip12a
	bra  p8l_skip12a
	; source: test_uword_lt.p8:1502   lbl12a:   success++
p8l_lbl12a
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1503   skip12a:
p8l_skip12a
	; source: test_uword_lt.p8:1505   cx16.r3 = &lbl12b
	lda  #<p8l_lbl12b
	ldy  #>p8l_lbl12b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1506   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1508   goto skip12b
	bra  p8l_skip12b
	; source: test_uword_lt.p8:1509   lbl12b:   success++
p8l_lbl12b
	inc  p8b_main.p8v_success
	; source: test_uword_lt.p8:1510   skip12b:
p8l_skip12b
	; source: test_uword_lt.p8:1512   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1513   success++
	inc  p8b_main.p8v_success
label_asm_168_afterif
	; source: test_uword_lt.p8:1516   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1517   success++
	inc  p8b_main.p8v_success
...
label_asm_169_afterif
	; source: test_uword_lt.p8:1521   x=65535
	lda  #$ff
	sta  p8v_x
	sta  p8v_x+1
	
	; source: test_uword_lt.p8:1523   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	bcc  p8l_lbl13a
+
	; source: test_uword_lt.p8:1525   goto skip13a
	bra  p8l_skip13a
	; source: test_uword_lt.p8:1526   lbl13a:   fail_uword(145)
p8l_lbl13a
	ldy  #>$91
	lda  #<$91
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1527   skip13a:
p8l_skip13a
	; source: test_uword_lt.p8:1529   cx16.r3 = &lbl13b
	lda  #<p8l_lbl13b
	ldy  #>p8l_lbl13b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1530   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1532   goto skip13b
	bra  p8l_skip13b
	; source: test_uword_lt.p8:1533   lbl13b:   fail_uword(146)
p8l_lbl13b
	ldy  #>$92
	lda  #<$92
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1534   skip13b:
p8l_skip13b
	; source: test_uword_lt.p8:1536   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1537   fail_uword(147)
	ldy  #>$93
	lda  #<$93
	jsr  p8b_main.p8s_fail_uword
label_asm_171_afterif
	; source: test_uword_lt.p8:1540   if x<cx16.r4+0-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	sec
	sbc  cx16.r5
	...
	; source: test_uword_lt.p8:1541   fail_uword(148)
	ldy  #>$94
	lda  #<$94
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_172_afterif
label_asm_173_else
	; source: test_uword_lt.p8:1543   success++
	inc  p8b_main.p8v_success
label_asm_172_afterif
	; source: test_uword_lt.p8:1546   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	bcc  p8l_lbl14a
+
	; source: test_uword_lt.p8:1548   goto skip14a
	bra  p8l_skip14a
	; source: test_uword_lt.p8:1549   lbl14a:   fail_uword(149)
p8l_lbl14a
	ldy  #>$95
	lda  #<$95
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1550   skip14a:
p8l_skip14a
	; source: test_uword_lt.p8:1552   cx16.r3 = &lbl14b
	lda  #<p8l_lbl14b
	ldy  #>p8l_lbl14b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1553   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1555   goto skip14b
	bra  p8l_skip14b
	; source: test_uword_lt.p8:1556   lbl14b:   fail_uword(150)
p8l_lbl14b
	ldy  #>$96
	lda  #<$96
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1557   skip14b:
p8l_skip14b
	; source: test_uword_lt.p8:1559   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1560   fail_uword(151)
	ldy  #>$97
	lda  #<$97
	jsr  p8b_main.p8s_fail_uword
label_asm_174_afterif
	; source: test_uword_lt.p8:1563   if x<cx16.r4+1-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<1
	...
	; source: test_uword_lt.p8:1564   fail_uword(152)
	ldy  #>$98
	lda  #<$98
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_175_afterif
label_asm_176_else
	; source: test_uword_lt.p8:1566   success++
	inc  p8b_main.p8v_success
label_asm_175_afterif
	; source: test_uword_lt.p8:1569   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	bcc  p8l_lbl15a
+
	; source: test_uword_lt.p8:1571   goto skip15a
	bra  p8l_skip15a
	; source: test_uword_lt.p8:1572   lbl15a:   fail_uword(153)
p8l_lbl15a
	ldy  #>$99
	lda  #<$99
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1573   skip15a:
p8l_skip15a
	; source: test_uword_lt.p8:1575   cx16.r3 = &lbl15b
	lda  #<p8l_lbl15b
	ldy  #>p8l_lbl15b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1576   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1578   goto skip15b
	bra  p8l_skip15b
	; source: test_uword_lt.p8:1579   lbl15b:   fail_uword(154)
p8l_lbl15b
	ldy  #>$9a
	lda  #<$9a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1580   skip15b:
p8l_skip15b
	; source: test_uword_lt.p8:1582   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1583   fail_uword(155)
	ldy  #>$9b
	lda  #<$9b
	jsr  p8b_main.p8s_fail_uword
label_asm_177_afterif
	; source: test_uword_lt.p8:1586   if x<cx16.r4+30464-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$7700
	...
	; source: test_uword_lt.p8:1587   fail_uword(156)
	ldy  #>$9c
	lda  #<$9c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_178_afterif
label_asm_179_else
	; source: test_uword_lt.p8:1589   success++
	inc  p8b_main.p8v_success
label_asm_178_afterif
	; source: test_uword_lt.p8:1592   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	bcc  p8l_lbl16a
+
	; source: test_uword_lt.p8:1594   goto skip16a
	bra  p8l_skip16a
	; source: test_uword_lt.p8:1595   lbl16a:   fail_uword(157)
p8l_lbl16a
	ldy  #>$9d
	lda  #<$9d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1596   skip16a:
p8l_skip16a
	; source: test_uword_lt.p8:1598   cx16.r3 = &lbl16b
	lda  #<p8l_lbl16b
	ldy  #>p8l_lbl16b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_lt.p8:1599   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
...
_jump                       jmp  (cx16.r3)
+
	; source: test_uword_lt.p8:1601   goto skip16b
	bra  p8l_skip16b
	; source: test_uword_lt.p8:1602   lbl16b:   fail_uword(158)
p8l_lbl16b
	ldy  #>$9e
	lda  #<$9e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_lt.p8:1603   skip16b:
p8l_skip16b
	; source: test_uword_lt.p8:1605   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1606   fail_uword(159)
	ldy  #>$9f
	lda  #<$9f
	jsr  p8b_main.p8s_fail_uword
label_asm_180_afterif
	; source: test_uword_lt.p8:1609   if x<cx16.r4+65535-cx16.r5
	lda  cx16.r4
	ldy  cx16.r4+1
	clc
	adc  #<$ffff
	...
	; source: test_uword_lt.p8:1610   fail_uword(160)
	ldy  #>$a0
	lda  #<$a0
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_181_afterif
label_asm_182_else
	; source: test_uword_lt.p8:1612   success++
	inc  p8b_main.p8v_success
label_asm_181_afterif
	; source: test_uword_lt.p8:1614   verify_success(34)
	lda  #$22
	jmp  p8b_main.p8s_verify_success
	; source: test_uword_lt.p8:1235   sub test_cmp_expr() {
; variables
...
string_9	; PETSCII:" **fail#"
	...
	; source: test_uword_lt.p8:33   txt.print(" **failed** ")
	; source: test_uword_lt.p8:35   txt.print(" success, expected ")
	; source: test_uword_lt.p8:41   txt.print(" **fail#")
	; source: test_uword_lt.p8:43   txt.print(" **")
	.pend
