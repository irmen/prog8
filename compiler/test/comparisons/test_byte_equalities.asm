; w65c02 assembly code for 'test_byte_equalities'
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-03-13T21:14:41
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: test_byte_equalities.p8:8   main {
...
p8v_datatype	; PETSCII:"byte"
	.byte  $42, $59, $54, $45, $00

	; source: test_byte_equalities.p8:9   ubyte success = 0
	; source: test_byte_equalities.p8:10   str datatype = "byte"
	; source: test_byte_equalities.p8:11   uword @shared comparison
	; source: test_byte_equalities.p8:13   sub start() {
...
; variables
	...
	.pend
	; source: test_byte_equalities.p8:41   sub verify_success(ubyte expected) {

p8s_verify_success	.proc
; simple int arg(s) passed via register(s)
	sta  p8v_expected
; statements
	; source: test_byte_equalities.p8:42   if success==expected {
	lda  p8b_main.p8v_success
	cmp  p8v_expected
	bne  label_asm_2_else
	; source: test_byte_equalities.p8:43   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_byte_equalities.p8:45   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_13
	lda  #<prog8_interned_strings.string_13
	jsr  txt.print
	; source: test_byte_equalities.p8:46   txt.print_ub(success)
	lda  p8b_main.p8v_success
	jsr  txt.print_ub
	; source: test_byte_equalities.p8:47   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_14
	lda  #<prog8_interned_strings.string_14
	jsr  txt.print
	; source: test_byte_equalities.p8:48   txt.print_ub(expected)
	lda  p8v_expected
	jsr  txt.print_ub
label_asm_1_afterif
	; source: test_byte_equalities.p8:41   sub verify_success(ubyte expected) {
...
p8v_expected	.byte  ?
	.send BSS
	.pend
	; source: test_byte_equalities.p8:52   sub fail_byte(uword idx, byte v1) {

p8s_fail_byte	.proc
; statements
	; source: test_byte_equalities.p8:53   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_15
	lda  #<prog8_interned_strings.string_15
	jsr  txt.print
	; source: test_byte_equalities.p8:54   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_byte_equalities.p8:55   txt.chrout(':')
	lda  #$3a
	jsr  txt.chrout
	; source: test_byte_equalities.p8:56   txt.print_b(v1)
	lda  p8v_v1
	jsr  txt.print_b
	; source: test_byte_equalities.p8:57   txt.print(" **")
...
p8v_v1	.char  ?
	.send BSS
	.pend
	; source: test_byte_equalities.p8:94   sub test_is_zero() {

p8s_test_is_zero	.proc
; statements
	; source: test_byte_equalities.p8:95   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:96   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:98   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:100   if x==0
	lda  p8v_x
	beq  p8l_lbl1
	; source: test_byte_equalities.p8:102   goto skip1
	bra  p8l_skip1
	; source: test_byte_equalities.p8:103   lbl1:   success++
p8l_lbl1
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:104   skip1:
p8l_skip1
	; source: test_byte_equalities.p8:106   cx16.r3 = &lbl2
	lda  #<p8l_lbl2
	ldy  #>p8l_lbl2
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:107   if x==0
	lda  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:109   goto skip2
	bra  p8l_skip2
	; source: test_byte_equalities.p8:110   lbl2:   success++
p8l_lbl2
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:111   skip2:
p8l_skip2
	; source: test_byte_equalities.p8:113   if x==0
	lda  p8v_x
	bne  label_asm_3_afterif
	; source: test_byte_equalities.p8:114   success++
	inc  p8b_main.p8v_success
label_asm_3_afterif
	; source: test_byte_equalities.p8:117   if x==0
	lda  p8v_x
	bne  label_asm_5_else
	; source: test_byte_equalities.p8:118   success++
	inc  p8b_main.p8v_success
	bra  label_asm_4_afterif
label_asm_5_else
	; source: test_byte_equalities.p8:120   cx16.r0L++
	inc  cx16.r0L
label_asm_4_afterif
	; source: test_byte_equalities.p8:122   x = -100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:124   if x==0
	beq  p8l_skip3
	; source: test_byte_equalities.p8:126   success++
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:127   skip3:
p8l_skip3
	; source: test_byte_equalities.p8:129   cx16.r3 = &skip4
	lda  #<p8l_skip4
	ldy  #>p8l_skip4
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:130   if x==0
	lda  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:132   success++
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:133   skip4:
p8l_skip4
	; source: test_byte_equalities.p8:135   success++
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:136   if x==0
	lda  p8v_x
	bne  label_asm_6_afterif
	; source: test_byte_equalities.p8:137   success--
	dec  p8b_main.p8v_success
label_asm_6_afterif
	; source: test_byte_equalities.p8:140   if x==0
	lda  p8v_x
	bne  label_asm_8_else
	; source: test_byte_equalities.p8:141   cx16.r0L++
	inc  cx16.r0L
	bra  label_asm_7_afterif
label_asm_8_else
	; source: test_byte_equalities.p8:143   success++
	inc  p8b_main.p8v_success
label_asm_7_afterif
	; source: test_byte_equalities.p8:145   verify_success(8)
	lda  #8
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_equalities.p8:149   sub test_not_zero() {

p8s_test_not_zero	.proc
; statements
	; source: test_byte_equalities.p8:150   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:151   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:153   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:155   if x!=0
	bne  p8l_lbl1
	; source: test_byte_equalities.p8:157   goto skip1
	bra  p8l_skip1
	; source: test_byte_equalities.p8:158   lbl1:   success++
p8l_lbl1
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:159   skip1:
p8l_skip1
	; source: test_byte_equalities.p8:161   cx16.r3 = &lbl2
	lda  #<p8l_lbl2
	ldy  #>p8l_lbl2
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:162   if x!=0
	lda  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:164   goto skip2
	bra  p8l_skip2
	; source: test_byte_equalities.p8:165   lbl2:   success++
p8l_lbl2
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:166   skip2:
p8l_skip2
	; source: test_byte_equalities.p8:168   if x!=0
	lda  p8v_x
	beq  label_asm_9_afterif
	; source: test_byte_equalities.p8:169   success++
	inc  p8b_main.p8v_success
label_asm_9_afterif
	; source: test_byte_equalities.p8:172   if x!=0
	lda  p8v_x
	beq  label_asm_11_else
	; source: test_byte_equalities.p8:173   success++
	inc  p8b_main.p8v_success
	bra  label_asm_10_afterif
label_asm_11_else
	; source: test_byte_equalities.p8:175   cx16.r0L++
	inc  cx16.r0L
label_asm_10_afterif
	; source: test_byte_equalities.p8:177   x = 0
	stz  p8v_x
	; source: test_byte_equalities.p8:179   if x!=0
	lda  p8v_x
	bne  p8l_skip3
	; source: test_byte_equalities.p8:181   success++
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:182   skip3:
p8l_skip3
	; source: test_byte_equalities.p8:184   cx16.r3 = &skip4
	lda  #<p8l_skip4
	ldy  #>p8l_skip4
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:185   if x!=0
	lda  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:187   success++
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:188   skip4:
p8l_skip4
	; source: test_byte_equalities.p8:190   success++
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:191   if x!=0
	lda  p8v_x
	beq  label_asm_12_afterif
	; source: test_byte_equalities.p8:192   success--
	dec  p8b_main.p8v_success
label_asm_12_afterif
	; source: test_byte_equalities.p8:195   if x!=0
	lda  p8v_x
	beq  label_asm_14_else
	; source: test_byte_equalities.p8:196   cx16.r0L++
	inc  cx16.r0L
	bra  label_asm_13_afterif
label_asm_14_else
	; source: test_byte_equalities.p8:198   success++
	inc  p8b_main.p8v_success
label_asm_13_afterif
	; source: test_byte_equalities.p8:200   verify_success(8)
	lda  #8
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:149   sub test_not_zero() {
; variables
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_equalities.p8:203   sub test_is_number() {

p8s_test_is_number	.proc
; statements
	; source: test_byte_equalities.p8:204   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:205   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:206   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:208   if x==-100
	cmp  #-100
	beq  p8l_lbl1a
	; source: test_byte_equalities.p8:210   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:211   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:212   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:214   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:215   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:217   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:218   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:219   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:221   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  label_asm_15_afterif
	; source: test_byte_equalities.p8:222   success++
	inc  p8b_main.p8v_success
label_asm_15_afterif
	; source: test_byte_equalities.p8:225   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  label_asm_17_else
	; source: test_byte_equalities.p8:226   success++
	inc  p8b_main.p8v_success
	bra  label_asm_16_afterif
label_asm_17_else
	; source: test_byte_equalities.p8:228   cx16.r0L++
	inc  cx16.r0L
label_asm_16_afterif
	; source: test_byte_equalities.p8:231   if x==100
	lda  p8v_x
	cmp  #100
	beq  p8l_lbl2a
	; source: test_byte_equalities.p8:233   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:234   lbl2a:   fail_byte(1,-100)
p8l_lbl2a
	lda  #<1
	ldy  #>1
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
	
	lda  #-$64
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:235   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:237   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:238   if x==100
	lda  p8v_x
	cmp  #100
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:240   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:241   lbl2b:   fail_byte(2,-100)
p8l_lbl2b
	lda  #<2
	ldy  #>2
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:242   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:244   if x==100
	lda  p8v_x
	cmp  #100
	bne  label_asm_18_afterif
	; source: test_byte_equalities.p8:245   fail_byte(3,-100)
	lda  #<3
	ldy  #>3
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_18_afterif
	; source: test_byte_equalities.p8:248   if x==100
	lda  p8v_x
	cmp  #100
	bne  label_asm_20_else
	; source: test_byte_equalities.p8:249   fail_byte(4,-100)
	lda  #<4
	ldy  #>4
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_20_else
	; source: test_byte_equalities.p8:251   cx16.r0L++
	inc  cx16.r0L
label_asm_19_afterif
	; source: test_byte_equalities.p8:253   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:255   if x==-100
	lda  p8v_x
	cmp  #-100
	beq  p8l_lbl3a
	; source: test_byte_equalities.p8:257   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:258   lbl3a:   fail_byte(5,0)
p8l_lbl3a
	lda  #<5
	ldy  #>5
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:259   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:261   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:262   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:264   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:265   lbl3b:   fail_byte(6,0)
p8l_lbl3b
	lda  #<6
	ldy  #>6
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:266   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:268   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  label_asm_21_afterif
	; source: test_byte_equalities.p8:269   fail_byte(7,0)
	lda  #<7
	ldy  #>7
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_21_afterif
	; source: test_byte_equalities.p8:272   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  label_asm_23_else
	; source: test_byte_equalities.p8:273   fail_byte(8,0)
	lda  #<8
	ldy  #>8
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_22_afterif
	; source: test_byte_equalities.p8:278   if x==100
	lda  p8v_x
	cmp  #100
	beq  p8l_lbl4a
	; source: test_byte_equalities.p8:280   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:281   lbl4a:   fail_byte(9,0)
p8l_lbl4a
	lda  #<9
	ldy  #>9
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:282   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:284   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:285   if x==100
	lda  p8v_x
	cmp  #100
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:287   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:288   lbl4b:   fail_byte(10,0)
p8l_lbl4b
	lda  #<10
	ldy  #>10
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:289   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:291   if x==100
	lda  p8v_x
	cmp  #100
...
label_asm_24_afterif
	; source: test_byte_equalities.p8:295   if x==100
	lda  p8v_x
	cmp  #100
	bne  label_asm_26_else
	; source: test_byte_equalities.p8:296   fail_byte(12,0)
	lda  #<12
	ldy  #>12
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_26_else
	; source: test_byte_equalities.p8:298   cx16.r0L++
	inc  cx16.r0L
label_asm_25_afterif
	; source: test_byte_equalities.p8:300   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:302   if x==-100
	cmp  #-100
	beq  p8l_lbl5a
	; source: test_byte_equalities.p8:304   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:305   lbl5a:   fail_byte(13,100)
p8l_lbl5a
	lda  #<13
	ldy  #>13
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:306   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:308   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:309   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:311   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:312   lbl5b:   fail_byte(14,100)
p8l_lbl5b
	lda  #<14
	ldy  #>14
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:313   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:315   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  label_asm_27_afterif
	; source: test_byte_equalities.p8:316   fail_byte(15,100)
	lda  #<15
	ldy  #>15
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_27_afterif
	; source: test_byte_equalities.p8:319   if x==-100
	lda  p8v_x
	cmp  #-100
	bne  label_asm_29_else
	; source: test_byte_equalities.p8:320   fail_byte(16,100)
	lda  #<$10
	ldy  #>$10
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_29_else
	; source: test_byte_equalities.p8:322   cx16.r0L++
	inc  cx16.r0L
label_asm_28_afterif
	; source: test_byte_equalities.p8:325   if x==100
	lda  p8v_x
	cmp  #100
	beq  p8l_lbl6a
	; source: test_byte_equalities.p8:327   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:328   lbl6a:   success++
p8l_lbl6a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:329   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:331   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:332   if x==100
	lda  p8v_x
	cmp  #100
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:334   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:335   lbl6b:   success++
p8l_lbl6b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:336   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:338   if x==100
	lda  p8v_x
	cmp  #100
	bne  label_asm_30_afterif
	; source: test_byte_equalities.p8:339   success++
	inc  p8b_main.p8v_success
label_asm_30_afterif
	; source: test_byte_equalities.p8:342   if x==100
	lda  p8v_x
	cmp  #100
	bne  label_asm_32_else
	; source: test_byte_equalities.p8:343   success++
	inc  p8b_main.p8v_success
	bra  label_asm_31_afterif
label_asm_32_else
	; source: test_byte_equalities.p8:345   cx16.r0L++
	inc  cx16.r0L
label_asm_31_afterif
	; source: test_byte_equalities.p8:347   verify_success(8)
	lda  #8
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:203   sub test_is_number() {
; variables
...
; statements
	; source: test_byte_equalities.p8:350   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:351   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:352   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:354   if x!=-100
	cmp  #-100
	bne  p8l_lbl1a
	; source: test_byte_equalities.p8:356   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:357   lbl1a:   fail_byte(17,-100)
p8l_lbl1a
	lda  #<$11
	ldy  #>$11
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:358   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:360   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:361   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:363   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:364   lbl1b:   fail_byte(18,-100)
p8l_lbl1b
	lda  #<$12
	ldy  #>$12
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:365   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:367   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  label_asm_33_afterif
	; source: test_byte_equalities.p8:368   fail_byte(19,-100)
	lda  #<$13
	ldy  #>$13
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_33_afterif
	; source: test_byte_equalities.p8:371   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  label_asm_35_else
	; source: test_byte_equalities.p8:372   fail_byte(20,-100)
	lda  #<$14
	ldy  #>$14
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_35_else
	; source: test_byte_equalities.p8:374   cx16.r0L++
	inc  cx16.r0L
label_asm_34_afterif
	; source: test_byte_equalities.p8:377   if x!=100
	lda  p8v_x
	cmp  #100
	bne  p8l_lbl2a
	; source: test_byte_equalities.p8:379   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:380   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:381   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:383   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:384   if x!=100
	lda  p8v_x
	cmp  #100
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:386   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:387   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:388   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:390   if x!=100
	lda  p8v_x
	cmp  #100
	beq  label_asm_36_afterif
	; source: test_byte_equalities.p8:391   success++
	inc  p8b_main.p8v_success
label_asm_36_afterif
	; source: test_byte_equalities.p8:394   if x!=100
	lda  p8v_x
	cmp  #100
	beq  label_asm_38_else
	; source: test_byte_equalities.p8:395   success++
	inc  p8b_main.p8v_success
	bra  label_asm_37_afterif
label_asm_38_else
	; source: test_byte_equalities.p8:397   cx16.r0L++
	inc  cx16.r0L
label_asm_37_afterif
	; source: test_byte_equalities.p8:399   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:401   if x!=-100
	lda  p8v_x
	cmp  #-100
	bne  p8l_lbl3a
	; source: test_byte_equalities.p8:403   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:404   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:405   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:407   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:408   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:410   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:411   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:412   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:414   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  label_asm_39_afterif
	; source: test_byte_equalities.p8:415   success++
	inc  p8b_main.p8v_success
label_asm_39_afterif
	; source: test_byte_equalities.p8:418   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  label_asm_41_else
	; source: test_byte_equalities.p8:419   success++
	inc  p8b_main.p8v_success
	bra  label_asm_40_afterif
label_asm_41_else
	; source: test_byte_equalities.p8:421   cx16.r0L++
	inc  cx16.r0L
label_asm_40_afterif
	; source: test_byte_equalities.p8:424   if x!=100
	lda  p8v_x
	cmp  #100
	bne  p8l_lbl4a
	; source: test_byte_equalities.p8:426   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:427   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:428   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:430   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:431   if x!=100
	lda  p8v_x
	cmp  #100
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:433   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:434   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:435   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:437   if x!=100
	lda  p8v_x
	cmp  #100
	beq  label_asm_42_afterif
	; source: test_byte_equalities.p8:438   success++
	inc  p8b_main.p8v_success
label_asm_42_afterif
	; source: test_byte_equalities.p8:441   if x!=100
	lda  p8v_x
	cmp  #100
	beq  label_asm_44_else
	; source: test_byte_equalities.p8:442   success++
	inc  p8b_main.p8v_success
...
label_asm_43_afterif
	; source: test_byte_equalities.p8:446   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:448   if x!=-100
	cmp  #-100
	bne  p8l_lbl5a
	; source: test_byte_equalities.p8:450   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:451   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:452   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:454   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:455   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:457   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:458   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:459   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:461   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  label_asm_45_afterif
	; source: test_byte_equalities.p8:462   success++
	inc  p8b_main.p8v_success
label_asm_45_afterif
	; source: test_byte_equalities.p8:465   if x!=-100
	lda  p8v_x
	cmp  #-100
	beq  label_asm_47_else
	; source: test_byte_equalities.p8:466   success++
	inc  p8b_main.p8v_success
	bra  label_asm_46_afterif
label_asm_47_else
	; source: test_byte_equalities.p8:468   cx16.r0L++
	inc  cx16.r0L
label_asm_46_afterif
	; source: test_byte_equalities.p8:471   if x!=100
	lda  p8v_x
	cmp  #100
	bne  p8l_lbl6a
	; source: test_byte_equalities.p8:473   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:474   lbl6a:   fail_byte(21,100)
p8l_lbl6a
	lda  #<$15
	ldy  #>$15
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:475   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:477   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:478   if x!=100
	lda  p8v_x
	cmp  #100
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:480   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:481   lbl6b:   fail_byte(22,100)
p8l_lbl6b
	lda  #<$16
	ldy  #>$16
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:482   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:484   if x!=100
	lda  p8v_x
	cmp  #100
	beq  label_asm_48_afterif
	; source: test_byte_equalities.p8:485   fail_byte(23,100)
	lda  #<$17
	ldy  #>$17
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_48_afterif
	; source: test_byte_equalities.p8:488   if x!=100
	lda  p8v_x
	cmp  #100
	beq  label_asm_50_else
	; source: test_byte_equalities.p8:489   fail_byte(24,100)
	lda  #<$18
	ldy  #>$18
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_50_else
	; source: test_byte_equalities.p8:491   cx16.r0L++
	inc  cx16.r0L
label_asm_49_afterif
	; source: test_byte_equalities.p8:493   verify_success(16)
	lda  #$10
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:349   sub test_not_number() {
; variables
...
; statements
	; source: test_byte_equalities.p8:496   byte @shared x, value
	stz  p8v_x
	lda  p8v_x
	sta  p8v_value
	
	; source: test_byte_equalities.p8:497   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:498   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:499   value=-100
	sta  p8v_value
	; source: test_byte_equalities.p8:501   if x==value
	cmp  p8v_value
	beq  p8l_lbl1a
	; source: test_byte_equalities.p8:503   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:504   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:505   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:507   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:508   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:510   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:511   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:512   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:514   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_51_afterif
	; source: test_byte_equalities.p8:515   success++
	inc  p8b_main.p8v_success
label_asm_51_afterif
	; source: test_byte_equalities.p8:518   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_53_else
	; source: test_byte_equalities.p8:519   success++
	inc  p8b_main.p8v_success
	bra  label_asm_52_afterif
label_asm_53_else
	; source: test_byte_equalities.p8:521   cx16.r0L++
	inc  cx16.r0L
label_asm_52_afterif
	; source: test_byte_equalities.p8:523   value=100
	lda  #$64
	sta  p8v_value
	; source: test_byte_equalities.p8:525   if x==value
	lda  p8v_x
	cmp  p8v_value
	beq  p8l_lbl2a
	; source: test_byte_equalities.p8:527   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:528   lbl2a:   fail_byte(25,-100)
p8l_lbl2a
	lda  #<$19
	ldy  #>$19
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:529   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:531   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:532   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:534   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:535   lbl2b:   fail_byte(26,-100)
p8l_lbl2b
	lda  #<$1a
	ldy  #>$1a
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:536   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:538   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_54_afterif
	; source: test_byte_equalities.p8:539   fail_byte(27,-100)
	lda  #<$1b
	ldy  #>$1b
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_54_afterif
	; source: test_byte_equalities.p8:542   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_56_else
	; source: test_byte_equalities.p8:543   fail_byte(28,-100)
	lda  #<$1c
	ldy  #>$1c
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_56_else
	; source: test_byte_equalities.p8:545   cx16.r0L++
	inc  cx16.r0L
label_asm_55_afterif
	; source: test_byte_equalities.p8:547   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:548   value=-100
	lda  #-$64
	sta  p8v_value
	; source: test_byte_equalities.p8:550   if x==value
	lda  p8v_x
	cmp  p8v_value
	beq  p8l_lbl3a
	; source: test_byte_equalities.p8:552   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:553   lbl3a:   fail_byte(29,0)
p8l_lbl3a
	lda  #<$1d
	ldy  #>$1d
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:554   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:556   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:557   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:559   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:560   lbl3b:   fail_byte(30,0)
p8l_lbl3b
	lda  #<$1e
	ldy  #>$1e
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:561   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:563   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_57_afterif
	; source: test_byte_equalities.p8:564   fail_byte(31,0)
	lda  #<$1f
	ldy  #>$1f
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_57_afterif
	; source: test_byte_equalities.p8:567   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_59_else
	; source: test_byte_equalities.p8:568   fail_byte(32,0)
	lda  #<$20
	ldy  #>$20
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_59_else
	; source: test_byte_equalities.p8:570   cx16.r0L++
	inc  cx16.r0L
label_asm_58_afterif
	; source: test_byte_equalities.p8:572   value=100
	lda  #$64
	sta  p8v_value
	; source: test_byte_equalities.p8:574   if x==value
	lda  p8v_x
	cmp  p8v_value
	beq  p8l_lbl4a
	; source: test_byte_equalities.p8:576   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:577   lbl4a:   fail_byte(33,0)
p8l_lbl4a
	lda  #<$21
	ldy  #>$21
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:578   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:580   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:581   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:583   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:584   lbl4b:   fail_byte(34,0)
p8l_lbl4b
	lda  #<$22
	ldy  #>$22
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:585   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:587   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_60_afterif
	; source: test_byte_equalities.p8:588   fail_byte(35,0)
	lda  #<$23
	ldy  #>$23
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_60_afterif
	; source: test_byte_equalities.p8:591   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_62_else
	; source: test_byte_equalities.p8:592   fail_byte(36,0)
	lda  #<$24
	ldy  #>$24
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_62_else
	; source: test_byte_equalities.p8:594   cx16.r0L++
	inc  cx16.r0L
label_asm_61_afterif
	; source: test_byte_equalities.p8:596   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:597   value=-100
	lda  #-$64
	sta  p8v_value
	; source: test_byte_equalities.p8:599   if x==value
	lda  p8v_x
	cmp  p8v_value
	beq  p8l_lbl5a
	; source: test_byte_equalities.p8:601   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:602   lbl5a:   fail_byte(37,100)
p8l_lbl5a
	lda  #<$25
	ldy  #>$25
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:603   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:605   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:606   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:608   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:609   lbl5b:   fail_byte(38,100)
p8l_lbl5b
	lda  #<$26
	ldy  #>$26
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:610   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:612   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_63_afterif
	; source: test_byte_equalities.p8:613   fail_byte(39,100)
	lda  #<$27
	ldy  #>$27
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_63_afterif
	; source: test_byte_equalities.p8:616   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_65_else
	; source: test_byte_equalities.p8:617   fail_byte(40,100)
	lda  #<$28
	ldy  #>$28
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_64_afterif
	; source: test_byte_equalities.p8:621   value=100
	lda  #$64
	sta  p8v_value
	; source: test_byte_equalities.p8:623   if x==value
	lda  p8v_x
	cmp  p8v_value
	beq  p8l_lbl6a
	; source: test_byte_equalities.p8:625   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:626   lbl6a:   success++
p8l_lbl6a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:627   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:629   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:630   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:632   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:633   lbl6b:   success++
p8l_lbl6b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:634   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:636   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_66_afterif
	; source: test_byte_equalities.p8:637   success++
	inc  p8b_main.p8v_success
label_asm_66_afterif
	; source: test_byte_equalities.p8:640   if x==value
	lda  p8v_x
	cmp  p8v_value
	bne  label_asm_68_else
	; source: test_byte_equalities.p8:641   success++
	inc  p8b_main.p8v_success
	bra  label_asm_67_afterif
label_asm_68_else
	; source: test_byte_equalities.p8:643   cx16.r0L++
	inc  cx16.r0L
label_asm_67_afterif
	; source: test_byte_equalities.p8:645   verify_success(8)
	lda  #8
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:495   sub test_is_var() {
; variables
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_equalities.p8:647   sub test_not_var() {

p8s_test_not_var	.proc
; statements
	; source: test_byte_equalities.p8:648   byte @shared x, value
	stz  p8v_x
	lda  p8v_x
	sta  p8v_value
	
	; source: test_byte_equalities.p8:649   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:650   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:651   value=-100
	sta  p8v_value
	; source: test_byte_equalities.p8:653   if x!=value
	cmp  p8v_value
	bne  p8l_lbl1a
	; source: test_byte_equalities.p8:655   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:656   lbl1a:   fail_byte(41,-100)
p8l_lbl1a
	lda  #<$29
	ldy  #>$29
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:657   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:659   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:660   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:662   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:663   lbl1b:   fail_byte(42,-100)
p8l_lbl1b
	lda  #<$2a
	ldy  #>$2a
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:664   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:666   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_69_afterif
	; source: test_byte_equalities.p8:667   fail_byte(43,-100)
	lda  #<$2b
	ldy  #>$2b
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_69_afterif
	; source: test_byte_equalities.p8:670   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_71_else
	; source: test_byte_equalities.p8:671   fail_byte(44,-100)
	lda  #<$2c
	ldy  #>$2c
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_71_else
	; source: test_byte_equalities.p8:673   cx16.r0L++
	inc  cx16.r0L
label_asm_70_afterif
	; source: test_byte_equalities.p8:675   value=100
	lda  #$64
	sta  p8v_value
	; source: test_byte_equalities.p8:677   if x!=value
	lda  p8v_x
	cmp  p8v_value
	bne  p8l_lbl2a
	; source: test_byte_equalities.p8:679   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:680   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:681   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:683   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:684   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:686   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:687   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:688   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:690   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_72_afterif
	; source: test_byte_equalities.p8:691   success++
	inc  p8b_main.p8v_success
label_asm_72_afterif
	; source: test_byte_equalities.p8:694   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_74_else
	; source: test_byte_equalities.p8:695   success++
	inc  p8b_main.p8v_success
	bra  label_asm_73_afterif
label_asm_74_else
	; source: test_byte_equalities.p8:697   cx16.r0L++
	inc  cx16.r0L
label_asm_73_afterif
	; source: test_byte_equalities.p8:699   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:700   value=-100
	lda  #-$64
	sta  p8v_value
	; source: test_byte_equalities.p8:702   if x!=value
	lda  p8v_x
	cmp  p8v_value
	bne  p8l_lbl3a
	; source: test_byte_equalities.p8:704   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:705   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:706   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:708   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:709   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:711   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:712   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:713   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:715   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_75_afterif
	; source: test_byte_equalities.p8:716   success++
	inc  p8b_main.p8v_success
label_asm_75_afterif
	; source: test_byte_equalities.p8:719   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_77_else
	; source: test_byte_equalities.p8:720   success++
	inc  p8b_main.p8v_success
	bra  label_asm_76_afterif
label_asm_77_else
	; source: test_byte_equalities.p8:722   cx16.r0L++
	inc  cx16.r0L
label_asm_76_afterif
	; source: test_byte_equalities.p8:724   value=100
	lda  #$64
	sta  p8v_value
	; source: test_byte_equalities.p8:726   if x!=value
	lda  p8v_x
	cmp  p8v_value
	bne  p8l_lbl4a
	; source: test_byte_equalities.p8:728   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:729   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:730   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:732   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:733   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:735   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:736   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:737   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:739   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_78_afterif
	; source: test_byte_equalities.p8:740   success++
	inc  p8b_main.p8v_success
label_asm_78_afterif
	; source: test_byte_equalities.p8:743   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_80_else
	; source: test_byte_equalities.p8:744   success++
	inc  p8b_main.p8v_success
	bra  label_asm_79_afterif
label_asm_80_else
	; source: test_byte_equalities.p8:746   cx16.r0L++
	inc  cx16.r0L
label_asm_79_afterif
	; source: test_byte_equalities.p8:748   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:749   value=-100
	lda  #-$64
	sta  p8v_value
	; source: test_byte_equalities.p8:751   if x!=value
	lda  p8v_x
	cmp  p8v_value
	bne  p8l_lbl5a
	; source: test_byte_equalities.p8:753   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:754   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:755   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:757   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:758   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:760   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:761   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:762   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:764   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_81_afterif
	; source: test_byte_equalities.p8:765   success++
	inc  p8b_main.p8v_success
label_asm_81_afterif
	; source: test_byte_equalities.p8:768   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_83_else
	; source: test_byte_equalities.p8:769   success++
	inc  p8b_main.p8v_success
...
label_asm_82_afterif
	; source: test_byte_equalities.p8:773   value=100
	lda  #$64
	sta  p8v_value
	; source: test_byte_equalities.p8:775   if x!=value
	lda  p8v_x
	cmp  p8v_value
	bne  p8l_lbl6a
	; source: test_byte_equalities.p8:777   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:778   lbl6a:   fail_byte(45,100)
p8l_lbl6a
	lda  #<$2d
	ldy  #>$2d
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:779   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:781   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:782   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:784   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:785   lbl6b:   fail_byte(46,100)
p8l_lbl6b
	lda  #<$2e
	ldy  #>$2e
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:786   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:788   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_84_afterif
	; source: test_byte_equalities.p8:789   fail_byte(47,100)
	lda  #<$2f
	ldy  #>$2f
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_84_afterif
	; source: test_byte_equalities.p8:792   if x!=value
	lda  p8v_x
	cmp  p8v_value
	beq  label_asm_86_else
	; source: test_byte_equalities.p8:793   fail_byte(48,100)
	lda  #<$30
	ldy  #>$30
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_86_else
	; source: test_byte_equalities.p8:795   cx16.r0L++
	inc  cx16.r0L
label_asm_85_afterif
	; source: test_byte_equalities.p8:797   verify_success(16)
	lda  #$10
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:647   sub test_not_var() {
; variables
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_equalities.p8:799   sub test_is_expr() {

p8s_test_is_expr	.proc
; statements
	; source: test_byte_equalities.p8:800   byte @shared x
	; source: test_byte_equalities.p8:803   float @shared f4 = 1.0
	; source: test_byte_equalities.p8:804   float @shared f5 = 1.0
	; source: test_byte_equalities.p8:800   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:801   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_byte_equalities.p8:802   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_byte_equalities.p8:805   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:806   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:808   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	cmp  p8v_x
	beq  p8l_lbl1a
	; source: test_byte_equalities.p8:810   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:811   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:812   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:814   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:815   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:817   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:818   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:819   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:821   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:822   success++
	inc  p8b_main.p8v_success
label_asm_87_afterif
	; source: test_byte_equalities.p8:825   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:826   success++
	inc  p8b_main.p8v_success
	bra  label_asm_88_afterif
label_asm_89_else
	; source: test_byte_equalities.p8:828   cx16.r0L++
	inc  cx16.r0L
label_asm_88_afterif
	; source: test_byte_equalities.p8:831   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	cmp  p8v_x
	beq  p8l_lbl2a
	; source: test_byte_equalities.p8:833   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:834   lbl2a:   fail_byte(49,-100)
p8l_lbl2a
	lda  #<$31
	ldy  #>$31
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:835   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:837   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:838   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:840   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:841   lbl2b:   fail_byte(50,-100)
p8l_lbl2b
	lda  #<$32
	ldy  #>$32
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:842   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:844   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:845   fail_byte(51,-100)
	lda  #<$33
	ldy  #>$33
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_90_afterif
	; source: test_byte_equalities.p8:848   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:849   fail_byte(52,-100)
	lda  #<$34
	ldy  #>$34
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_92_else
	; source: test_byte_equalities.p8:851   cx16.r0L++
	inc  cx16.r0L
label_asm_91_afterif
	; source: test_byte_equalities.p8:853   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:855   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	cmp  p8v_x
	beq  p8l_lbl3a
	; source: test_byte_equalities.p8:857   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:858   lbl3a:   fail_byte(53,0)
p8l_lbl3a
	lda  #<$35
	ldy  #>$35
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:859   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:861   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:862   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:864   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:865   lbl3b:   fail_byte(54,0)
p8l_lbl3b
	lda  #<$36
	ldy  #>$36
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:866   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:868   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:869   fail_byte(55,0)
	lda  #<$37
	ldy  #>$37
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_93_afterif
	; source: test_byte_equalities.p8:872   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:873   fail_byte(56,0)
	lda  #<$38
	ldy  #>$38
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_95_else
	; source: test_byte_equalities.p8:875   cx16.r0L++
	inc  cx16.r0L
label_asm_94_afterif
	; source: test_byte_equalities.p8:878   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	cmp  p8v_x
	beq  p8l_lbl4a
	; source: test_byte_equalities.p8:880   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:881   lbl4a:   fail_byte(57,0)
p8l_lbl4a
	lda  #<$39
	ldy  #>$39
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:882   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:884   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:885   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:887   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:888   lbl4b:   fail_byte(58,0)
p8l_lbl4b
	lda  #<$3a
	ldy  #>$3a
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:889   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:891   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:892   fail_byte(59,0)
	lda  #<$3b
	ldy  #>$3b
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_96_afterif
	; source: test_byte_equalities.p8:895   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:896   fail_byte(60,0)
	lda  #<$3c
	ldy  #>$3c
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_98_else
	; source: test_byte_equalities.p8:898   cx16.r0L++
	inc  cx16.r0L
label_asm_97_afterif
	; source: test_byte_equalities.p8:900   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:902   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	cmp  p8v_x
	beq  p8l_lbl5a
	; source: test_byte_equalities.p8:904   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:905   lbl5a:   fail_byte(61,100)
p8l_lbl5a
	lda  #<$3d
	ldy  #>$3d
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:906   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:908   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:909   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:911   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:912   lbl5b:   fail_byte(62,100)
p8l_lbl5b
	lda  #<$3e
	ldy  #>$3e
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:913   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:915   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:916   fail_byte(63,100)
	lda  #<$3f
	ldy  #>$3f
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_99_afterif
	; source: test_byte_equalities.p8:919   if x==cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:920   fail_byte(64,100)
	lda  #<$40
	ldy  #>$40
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_101_else
	; source: test_byte_equalities.p8:922   cx16.r0L++
	inc  cx16.r0L
label_asm_100_afterif
	; source: test_byte_equalities.p8:925   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	cmp  p8v_x
	beq  p8l_lbl6a
	; source: test_byte_equalities.p8:927   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:928   lbl6a:   success++
p8l_lbl6a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:929   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:931   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:932   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:934   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:935   lbl6b:   success++
p8l_lbl6b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:936   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:938   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:939   success++
	inc  p8b_main.p8v_success
label_asm_102_afterif
	; source: test_byte_equalities.p8:942   if x==cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:943   success++
	inc  p8b_main.p8v_success
	bra  label_asm_103_afterif
label_asm_104_else
	; source: test_byte_equalities.p8:945   cx16.r0L++
	inc  cx16.r0L
label_asm_103_afterif
	; source: test_byte_equalities.p8:947   verify_success(8)
	lda  #8
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:799   sub test_is_expr() {
; variables
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_equalities.p8:949   sub test_not_expr() {

p8s_test_not_expr	.proc
; statements
	; source: test_byte_equalities.p8:950   byte @shared x
	; source: test_byte_equalities.p8:953   float @shared f4 = 1.0
	; source: test_byte_equalities.p8:954   float @shared f5 = 1.0
	; source: test_byte_equalities.p8:950   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:951   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_byte_equalities.p8:952   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_byte_equalities.p8:955   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:956   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:958   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	cmp  p8v_x
	bne  p8l_lbl1a
	; source: test_byte_equalities.p8:960   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:961   lbl1a:   fail_byte(65,-100)
p8l_lbl1a
	lda  #<$41
	ldy  #>$41
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:962   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:964   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:965   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:967   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:968   lbl1b:   fail_byte(66,-100)
p8l_lbl1b
	lda  #<$42
	ldy  #>$42
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:969   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:971   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:972   fail_byte(67,-100)
	lda  #<$43
	ldy  #>$43
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_105_afterif
	; source: test_byte_equalities.p8:975   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:976   fail_byte(68,-100)
	lda  #<$44
	ldy  #>$44
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_106_afterif
	; source: test_byte_equalities.p8:981   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	cmp  p8v_x
	bne  p8l_lbl2a
	; source: test_byte_equalities.p8:983   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:984   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:985   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:987   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:988   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:990   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:991   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:992   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:994   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:995   success++
	inc  p8b_main.p8v_success
label_asm_108_afterif
	; source: test_byte_equalities.p8:998   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:999   success++
	inc  p8b_main.p8v_success
	bra  label_asm_109_afterif
label_asm_110_else
	; source: test_byte_equalities.p8:1001   cx16.r0L++
	inc  cx16.r0L
label_asm_109_afterif
	; source: test_byte_equalities.p8:1003   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:1005   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	cmp  p8v_x
	bne  p8l_lbl3a
	; source: test_byte_equalities.p8:1007   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:1008   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1009   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:1011   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1012   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1014   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:1015   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1016   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:1018   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1019   success++
	inc  p8b_main.p8v_success
label_asm_111_afterif
	; source: test_byte_equalities.p8:1022   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1023   success++
	inc  p8b_main.p8v_success
	bra  label_asm_112_afterif
label_asm_113_else
	; source: test_byte_equalities.p8:1025   cx16.r0L++
	inc  cx16.r0L
label_asm_112_afterif
	; source: test_byte_equalities.p8:1028   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	cmp  p8v_x
	bne  p8l_lbl4a
	; source: test_byte_equalities.p8:1030   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:1031   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1032   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:1034   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1035   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1037   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:1038   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1039   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:1041   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1042   success++
	inc  p8b_main.p8v_success
label_asm_114_afterif
	; source: test_byte_equalities.p8:1045   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1046   success++
	inc  p8b_main.p8v_success
	bra  label_asm_115_afterif
label_asm_116_else
	; source: test_byte_equalities.p8:1048   cx16.r0L++
	inc  cx16.r0L
label_asm_115_afterif
	; source: test_byte_equalities.p8:1050   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:1052   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	cmp  p8v_x
	bne  p8l_lbl5a
	; source: test_byte_equalities.p8:1054   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:1055   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1056   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:1058   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1059   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1061   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:1062   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1063   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:1065   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1066   success++
	inc  p8b_main.p8v_success
label_asm_117_afterif
	; source: test_byte_equalities.p8:1069   if x!=cx16.r4sL+-100-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1070   success++
	inc  p8b_main.p8v_success
	bra  label_asm_118_afterif
label_asm_119_else
	; source: test_byte_equalities.p8:1072   cx16.r0L++
	inc  cx16.r0L
label_asm_118_afterif
	; source: test_byte_equalities.p8:1075   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	cmp  p8v_x
	bne  p8l_lbl6a
	; source: test_byte_equalities.p8:1077   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:1078   lbl6a:   fail_byte(69,100)
p8l_lbl6a
	lda  #<$45
	ldy  #>$45
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1079   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:1081   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1082   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1084   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:1085   lbl6b:   fail_byte(70,100)
p8l_lbl6b
	lda  #<$46
	ldy  #>$46
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1086   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:1088   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1089   fail_byte(71,100)
	lda  #<$47
	ldy  #>$47
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_120_afterif
	; source: test_byte_equalities.p8:1092   if x!=cx16.r4sL+100-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #$64
	sec
	...
	; source: test_byte_equalities.p8:1093   fail_byte(72,100)
	lda  #<$48
	ldy  #>$48
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_122_else
	; source: test_byte_equalities.p8:1095   cx16.r0L++
	inc  cx16.r0L
label_asm_121_afterif
	; source: test_byte_equalities.p8:1097   verify_success(16)
	lda  #$10
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:949   sub test_not_expr() {
; variables
...
; statements
	; source: test_byte_equalities.p8:1100   byte @shared x
	; source: test_byte_equalities.p8:1101   byte[] values = [0, 0]
	; source: test_byte_equalities.p8:1102   byte[] sources = [0, 0]
	; source: test_byte_equalities.p8:1100   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:1103   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1104   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:1105   sources[1]=-100
	sta  p8v_sources+1
	; source: test_byte_equalities.p8:1106   values[1]=-100
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1108   if x==values[1]
	cmp  p8v_x
	beq  p8l_lbl1a
	; source: test_byte_equalities.p8:1110   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:1111   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1112   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:1114   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1115   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1117   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:1118   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1119   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:1121   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_123_afterif
	; source: test_byte_equalities.p8:1122   success++
	inc  p8b_main.p8v_success
label_asm_123_afterif
	; source: test_byte_equalities.p8:1125   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_125_else
	; source: test_byte_equalities.p8:1126   success++
	inc  p8b_main.p8v_success
	bra  label_asm_124_afterif
label_asm_125_else
	; source: test_byte_equalities.p8:1128   cx16.r0L++
	inc  cx16.r0L
label_asm_124_afterif
	; source: test_byte_equalities.p8:1131   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  p8l_lbl1c
	; source: test_byte_equalities.p8:1133   goto skip1c
	bra  p8l_skip1c
	; source: test_byte_equalities.p8:1134   lbl1c:   success++
p8l_lbl1c
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1135   skip1c:
p8l_skip1c
	; source: test_byte_equalities.p8:1137   cx16.r3 = &lbl1d
	lda  #<p8l_lbl1d
	ldy  #>p8l_lbl1d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1138   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1140   goto skip1d
	bra  p8l_skip1d
	; source: test_byte_equalities.p8:1141   lbl1d:   success++
p8l_lbl1d
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1142   skip1d:
p8l_skip1d
	; source: test_byte_equalities.p8:1144   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_126_afterif
	; source: test_byte_equalities.p8:1145   success++
	inc  p8b_main.p8v_success
label_asm_126_afterif
	; source: test_byte_equalities.p8:1148   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_128_else
	; source: test_byte_equalities.p8:1149   success++
	inc  p8b_main.p8v_success
	bra  label_asm_127_afterif
label_asm_128_else
	; source: test_byte_equalities.p8:1151   cx16.r0L++
	inc  cx16.r0L
label_asm_127_afterif
	; source: test_byte_equalities.p8:1153   values[1]=100
	lda  #$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1155   if x==values[1]
	cmp  p8v_x
	beq  p8l_lbl2a
	; source: test_byte_equalities.p8:1157   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:1158   lbl2a:   fail_byte(73,-100)
p8l_lbl2a
	lda  #<$49
	ldy  #>$49
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1159   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:1161   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1162   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1164   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:1165   lbl2b:   fail_byte(74,-100)
p8l_lbl2b
	lda  #<$4a
	ldy  #>$4a
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1166   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:1168   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_129_afterif
	; source: test_byte_equalities.p8:1169   fail_byte(75,-100)
	lda  #<$4b
	ldy  #>$4b
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_129_afterif
	; source: test_byte_equalities.p8:1172   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_131_else
	; source: test_byte_equalities.p8:1173   fail_byte(76,-100)
	lda  #<$4c
	ldy  #>$4c
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_131_else
	; source: test_byte_equalities.p8:1175   cx16.r0L++
	inc  cx16.r0L
label_asm_130_afterif
	; source: test_byte_equalities.p8:1178   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  p8l_lbl2c
	; source: test_byte_equalities.p8:1180   goto skip2c
	bra  p8l_skip2c
	; source: test_byte_equalities.p8:1181   lbl2c:   fail_byte(77,-100)
p8l_lbl2c
	lda  #<$4d
	ldy  #>$4d
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1182   skip2c:
p8l_skip2c
	; source: test_byte_equalities.p8:1184   cx16.r3 = &lbl2d
	lda  #<p8l_lbl2d
	ldy  #>p8l_lbl2d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1185   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1187   goto skip2d
	bra  p8l_skip2d
	; source: test_byte_equalities.p8:1188   lbl2d:   fail_byte(78,-100)
p8l_lbl2d
	lda  #<$4e
	ldy  #>$4e
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1189   skip2d:
p8l_skip2d
	; source: test_byte_equalities.p8:1191   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_132_afterif
	; source: test_byte_equalities.p8:1192   fail_byte(79,-100)
	lda  #<$4f
	ldy  #>$4f
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_132_afterif
	; source: test_byte_equalities.p8:1195   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_134_else
	; source: test_byte_equalities.p8:1196   fail_byte(80,-100)
	lda  #<$50
	ldy  #>$50
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_134_else
	; source: test_byte_equalities.p8:1198   cx16.r0L++
	inc  cx16.r0L
label_asm_133_afterif
	; source: test_byte_equalities.p8:1200   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:1201   sources[1]=0
	stz  p8v_sources+1
	; source: test_byte_equalities.p8:1202   values[1]=-100
	lda  #-$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1204   if x==values[1]
	cmp  p8v_x
	beq  p8l_lbl3a
	; source: test_byte_equalities.p8:1206   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:1207   lbl3a:   fail_byte(81,0)
p8l_lbl3a
	lda  #<$51
	ldy  #>$51
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1208   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:1210   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1211   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1213   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:1214   lbl3b:   fail_byte(82,0)
p8l_lbl3b
	lda  #<$52
	ldy  #>$52
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1215   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:1217   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_135_afterif
	; source: test_byte_equalities.p8:1218   fail_byte(83,0)
	lda  #<$53
	ldy  #>$53
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_135_afterif
	; source: test_byte_equalities.p8:1221   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_137_else
	; source: test_byte_equalities.p8:1222   fail_byte(84,0)
	lda  #<$54
	ldy  #>$54
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_137_else
	; source: test_byte_equalities.p8:1224   cx16.r0L++
	inc  cx16.r0L
label_asm_136_afterif
	; source: test_byte_equalities.p8:1227   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  p8l_lbl3c
	; source: test_byte_equalities.p8:1229   goto skip3c
	bra  p8l_skip3c
	; source: test_byte_equalities.p8:1230   lbl3c:   fail_byte(85,0)
p8l_lbl3c
	lda  #<$55
	ldy  #>$55
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1231   skip3c:
p8l_skip3c
	; source: test_byte_equalities.p8:1233   cx16.r3 = &lbl3d
	lda  #<p8l_lbl3d
	ldy  #>p8l_lbl3d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1234   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1236   goto skip3d
	bra  p8l_skip3d
	; source: test_byte_equalities.p8:1237   lbl3d:   fail_byte(86,0)
p8l_lbl3d
	lda  #<$56
	ldy  #>$56
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1238   skip3d:
p8l_skip3d
	; source: test_byte_equalities.p8:1240   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_138_afterif
	; source: test_byte_equalities.p8:1241   fail_byte(87,0)
	lda  #<$57
	ldy  #>$57
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_138_afterif
	; source: test_byte_equalities.p8:1244   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_140_else
	; source: test_byte_equalities.p8:1245   fail_byte(88,0)
	lda  #<$58
	ldy  #>$58
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_140_else
	; source: test_byte_equalities.p8:1247   cx16.r0L++
	inc  cx16.r0L
label_asm_139_afterif
	; source: test_byte_equalities.p8:1249   values[1]=100
	lda  #$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1251   if x==values[1]
	cmp  p8v_x
	beq  p8l_lbl4a
	; source: test_byte_equalities.p8:1253   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:1254   lbl4a:   fail_byte(89,0)
p8l_lbl4a
	lda  #<$59
	ldy  #>$59
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1255   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:1257   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1258   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1260   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:1261   lbl4b:   fail_byte(90,0)
p8l_lbl4b
	lda  #<$5a
	ldy  #>$5a
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1262   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:1264   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_141_afterif
	; source: test_byte_equalities.p8:1265   fail_byte(91,0)
	lda  #<$5b
	ldy  #>$5b
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_141_afterif
	; source: test_byte_equalities.p8:1268   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_143_else
	; source: test_byte_equalities.p8:1269   fail_byte(92,0)
	lda  #<$5c
	ldy  #>$5c
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_143_else
	; source: test_byte_equalities.p8:1271   cx16.r0L++
	inc  cx16.r0L
label_asm_142_afterif
	; source: test_byte_equalities.p8:1274   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  p8l_lbl4c
	; source: test_byte_equalities.p8:1276   goto skip4c
	bra  p8l_skip4c
	; source: test_byte_equalities.p8:1277   lbl4c:   fail_byte(93,0)
p8l_lbl4c
	lda  #<$5d
	ldy  #>$5d
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1278   skip4c:
p8l_skip4c
	; source: test_byte_equalities.p8:1280   cx16.r3 = &lbl4d
	lda  #<p8l_lbl4d
	ldy  #>p8l_lbl4d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1281   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1283   goto skip4d
	bra  p8l_skip4d
	; source: test_byte_equalities.p8:1284   lbl4d:   fail_byte(94,0)
p8l_lbl4d
	lda  #<$5e
	ldy  #>$5e
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	stz  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1285   skip4d:
p8l_skip4d
	; source: test_byte_equalities.p8:1287   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_144_afterif
	; source: test_byte_equalities.p8:1288   fail_byte(95,0)
	lda  #<$5f
	ldy  #>$5f
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_144_afterif
	; source: test_byte_equalities.p8:1291   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_146_else
	; source: test_byte_equalities.p8:1292   fail_byte(96,0)
	lda  #<$60
	ldy  #>$60
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_146_else
	; source: test_byte_equalities.p8:1294   cx16.r0L++
	inc  cx16.r0L
label_asm_145_afterif
	; source: test_byte_equalities.p8:1296   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:1297   sources[1]=100
	sta  p8v_sources+1
	; source: test_byte_equalities.p8:1298   values[1]=-100
	lda  #-$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1300   if x==values[1]
	cmp  p8v_x
	beq  p8l_lbl5a
	; source: test_byte_equalities.p8:1302   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:1303   lbl5a:   fail_byte(97,100)
p8l_lbl5a
	lda  #<$61
	ldy  #>$61
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1304   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:1306   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1307   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1309   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:1310   lbl5b:   fail_byte(98,100)
p8l_lbl5b
	lda  #<$62
	ldy  #>$62
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1311   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:1313   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_147_afterif
	; source: test_byte_equalities.p8:1314   fail_byte(99,100)
	lda  #<$63
	ldy  #>$63
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_147_afterif
	; source: test_byte_equalities.p8:1317   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_149_else
	; source: test_byte_equalities.p8:1318   fail_byte(100,100)
	lda  #<$64
	ldy  #>$64
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_149_else
	; source: test_byte_equalities.p8:1320   cx16.r0L++
	inc  cx16.r0L
label_asm_148_afterif
	; source: test_byte_equalities.p8:1323   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  p8l_lbl5c
	; source: test_byte_equalities.p8:1325   goto skip5c
	bra  p8l_skip5c
	; source: test_byte_equalities.p8:1326   lbl5c:   fail_byte(101,100)
p8l_lbl5c
	lda  #<$65
	ldy  #>$65
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1327   skip5c:
p8l_skip5c
	; source: test_byte_equalities.p8:1329   cx16.r3 = &lbl5d
	lda  #<p8l_lbl5d
	ldy  #>p8l_lbl5d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1330   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1332   goto skip5d
	bra  p8l_skip5d
	; source: test_byte_equalities.p8:1333   lbl5d:   fail_byte(102,100)
p8l_lbl5d
	lda  #<$66
	ldy  #>$66
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1334   skip5d:
p8l_skip5d
	; source: test_byte_equalities.p8:1336   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_150_afterif
	; source: test_byte_equalities.p8:1337   fail_byte(103,100)
	lda  #<$67
	ldy  #>$67
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_150_afterif
	; source: test_byte_equalities.p8:1340   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_152_else
	; source: test_byte_equalities.p8:1341   fail_byte(104,100)
	lda  #<$68
	ldy  #>$68
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_152_else
	; source: test_byte_equalities.p8:1343   cx16.r0L++
	inc  cx16.r0L
label_asm_151_afterif
	; source: test_byte_equalities.p8:1345   values[1]=100
	lda  #$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1347   if x==values[1]
	cmp  p8v_x
	beq  p8l_lbl6a
	; source: test_byte_equalities.p8:1349   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:1350   lbl6a:   success++
p8l_lbl6a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1351   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:1353   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1354   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1356   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:1357   lbl6b:   success++
p8l_lbl6b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1358   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:1360   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_153_afterif
	; source: test_byte_equalities.p8:1361   success++
	inc  p8b_main.p8v_success
label_asm_153_afterif
	; source: test_byte_equalities.p8:1364   if x==values[1]
	lda  p8v_values+1
	cmp  p8v_x
	bne  label_asm_155_else
	; source: test_byte_equalities.p8:1365   success++
	inc  p8b_main.p8v_success
...
label_asm_154_afterif
	; source: test_byte_equalities.p8:1370   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  p8l_lbl6c
	; source: test_byte_equalities.p8:1372   goto skip6c
	bra  p8l_skip6c
	; source: test_byte_equalities.p8:1373   lbl6c:   success++
p8l_lbl6c
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1374   skip6c:
p8l_skip6c
	; source: test_byte_equalities.p8:1376   cx16.r3 = &lbl6d
	lda  #<p8l_lbl6d
	ldy  #>p8l_lbl6d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1377   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1379   goto skip6d
	bra  p8l_skip6d
	; source: test_byte_equalities.p8:1380   lbl6d:   success++
p8l_lbl6d
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1381   skip6d:
p8l_skip6d
	; source: test_byte_equalities.p8:1383   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_156_afterif
	; source: test_byte_equalities.p8:1384   success++
	inc  p8b_main.p8v_success
label_asm_156_afterif
	; source: test_byte_equalities.p8:1387   if sources[1]==values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  label_asm_158_else
	; source: test_byte_equalities.p8:1388   success++
	inc  p8b_main.p8v_success
	bra  label_asm_157_afterif
label_asm_158_else
	; source: test_byte_equalities.p8:1390   cx16.r0L++
	inc  cx16.r0L
label_asm_157_afterif
	; source: test_byte_equalities.p8:1392   verify_success(16)
	lda  #$10
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:1099   sub test_is_array() {
; variables
...
p8v_x	.char  ?
	.send BSS
; non-zeropage variables
p8v_sources	.char  $00, $00
p8v_values	.char  $00, $00
	.pend
	; source: test_byte_equalities.p8:1394   sub test_not_array() {

p8s_test_not_array	.proc
; statements
	; source: test_byte_equalities.p8:1395   byte @shared x
	; source: test_byte_equalities.p8:1396   byte[] values = [0, 0]
	; source: test_byte_equalities.p8:1397   byte[] sources = [0, 0]
	; source: test_byte_equalities.p8:1395   byte @shared x
	stz  p8v_x
	; source: test_byte_equalities.p8:1398   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1399   x=-100
	lda  #-$64
	sta  p8v_x
	; source: test_byte_equalities.p8:1400   sources[1]=-100
	sta  p8v_sources+1
	; source: test_byte_equalities.p8:1401   values[1]=-100
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1403   if x!=values[1]
	cmp  p8v_x
	bne  p8l_lbl1a
	; source: test_byte_equalities.p8:1405   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_equalities.p8:1406   lbl1a:   fail_byte(105,-100)
p8l_lbl1a
	lda  #<$69
	ldy  #>$69
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1407   skip1a:
p8l_skip1a
	; source: test_byte_equalities.p8:1409   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1410   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1412   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_equalities.p8:1413   lbl1b:   fail_byte(106,-100)
p8l_lbl1b
	lda  #<$6a
	ldy  #>$6a
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1414   skip1b:
p8l_skip1b
	; source: test_byte_equalities.p8:1416   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_159_afterif
	; source: test_byte_equalities.p8:1417   fail_byte(107,-100)
	lda  #<$6b
	ldy  #>$6b
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_159_afterif
	; source: test_byte_equalities.p8:1420   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_161_else
	; source: test_byte_equalities.p8:1421   fail_byte(108,-100)
	lda  #<$6c
	ldy  #>$6c
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_160_afterif
	; source: test_byte_equalities.p8:1426   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  p8l_lbl1c
	; source: test_byte_equalities.p8:1428   goto skip1c
	bra  p8l_skip1c
	; source: test_byte_equalities.p8:1429   lbl1c:   fail_byte(109,-100)
p8l_lbl1c
	lda  #<$6d
	ldy  #>$6d
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1430   skip1c:
p8l_skip1c
	; source: test_byte_equalities.p8:1432   cx16.r3 = &lbl1d
	lda  #<p8l_lbl1d
	ldy  #>p8l_lbl1d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1433   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1435   goto skip1d
	bra  p8l_skip1d
	; source: test_byte_equalities.p8:1436   lbl1d:   fail_byte(110,-100)
p8l_lbl1d
	lda  #<$6e
	ldy  #>$6e
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1437   skip1d:
p8l_skip1d
	; source: test_byte_equalities.p8:1439   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
...
label_asm_162_afterif
	; source: test_byte_equalities.p8:1443   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_164_else
	; source: test_byte_equalities.p8:1444   fail_byte(112,-100)
	lda  #<$70
	ldy  #>$70
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_164_else
	; source: test_byte_equalities.p8:1446   cx16.r0L++
	inc  cx16.r0L
label_asm_163_afterif
	; source: test_byte_equalities.p8:1448   values[1]=100
	lda  #$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1450   if x!=values[1]
	cmp  p8v_x
	bne  p8l_lbl2a
	; source: test_byte_equalities.p8:1452   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_equalities.p8:1453   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1454   skip2a:
p8l_skip2a
	; source: test_byte_equalities.p8:1456   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1457   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1459   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_equalities.p8:1460   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1461   skip2b:
p8l_skip2b
	; source: test_byte_equalities.p8:1463   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
...
label_asm_165_afterif
	; source: test_byte_equalities.p8:1467   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_167_else
	; source: test_byte_equalities.p8:1468   success++
	inc  p8b_main.p8v_success
	bra  label_asm_166_afterif
label_asm_167_else
	; source: test_byte_equalities.p8:1470   cx16.r0L++
	inc  cx16.r0L
label_asm_166_afterif
	; source: test_byte_equalities.p8:1473   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  p8l_lbl2c
	; source: test_byte_equalities.p8:1475   goto skip2c
	bra  p8l_skip2c
	; source: test_byte_equalities.p8:1476   lbl2c:   success++
p8l_lbl2c
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1477   skip2c:
p8l_skip2c
	; source: test_byte_equalities.p8:1479   cx16.r3 = &lbl2d
	lda  #<p8l_lbl2d
	ldy  #>p8l_lbl2d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1480   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1482   goto skip2d
	bra  p8l_skip2d
	; source: test_byte_equalities.p8:1483   lbl2d:   success++
p8l_lbl2d
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1484   skip2d:
p8l_skip2d
	; source: test_byte_equalities.p8:1486   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_168_afterif
	; source: test_byte_equalities.p8:1487   success++
	inc  p8b_main.p8v_success
label_asm_168_afterif
	; source: test_byte_equalities.p8:1490   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_170_else
	; source: test_byte_equalities.p8:1491   success++
	inc  p8b_main.p8v_success
...
label_asm_169_afterif
	; source: test_byte_equalities.p8:1495   x=0
	stz  p8v_x
	; source: test_byte_equalities.p8:1496   sources[1]=0
	stz  p8v_sources+1
	; source: test_byte_equalities.p8:1497   values[1]=-100
	lda  #-$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1499   if x!=values[1]
	cmp  p8v_x
	bne  p8l_lbl3a
	; source: test_byte_equalities.p8:1501   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_equalities.p8:1502   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1503   skip3a:
p8l_skip3a
	; source: test_byte_equalities.p8:1505   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1506   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1508   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_equalities.p8:1509   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1510   skip3b:
p8l_skip3b
	; source: test_byte_equalities.p8:1512   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_171_afterif
	; source: test_byte_equalities.p8:1513   success++
	inc  p8b_main.p8v_success
label_asm_171_afterif
	; source: test_byte_equalities.p8:1516   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_173_else
	; source: test_byte_equalities.p8:1517   success++
	inc  p8b_main.p8v_success
	bra  label_asm_172_afterif
label_asm_173_else
	; source: test_byte_equalities.p8:1519   cx16.r0L++
	inc  cx16.r0L
label_asm_172_afterif
	; source: test_byte_equalities.p8:1522   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  p8l_lbl3c
	; source: test_byte_equalities.p8:1524   goto skip3c
	bra  p8l_skip3c
	; source: test_byte_equalities.p8:1525   lbl3c:   success++
p8l_lbl3c
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1526   skip3c:
p8l_skip3c
	; source: test_byte_equalities.p8:1528   cx16.r3 = &lbl3d
	lda  #<p8l_lbl3d
	ldy  #>p8l_lbl3d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1529   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1531   goto skip3d
	bra  p8l_skip3d
	; source: test_byte_equalities.p8:1532   lbl3d:   success++
p8l_lbl3d
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1533   skip3d:
p8l_skip3d
	; source: test_byte_equalities.p8:1535   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_174_afterif
	; source: test_byte_equalities.p8:1536   success++
	inc  p8b_main.p8v_success
label_asm_174_afterif
	; source: test_byte_equalities.p8:1539   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_176_else
	; source: test_byte_equalities.p8:1540   success++
	inc  p8b_main.p8v_success
	bra  label_asm_175_afterif
label_asm_176_else
	; source: test_byte_equalities.p8:1542   cx16.r0L++
	inc  cx16.r0L
label_asm_175_afterif
	; source: test_byte_equalities.p8:1544   values[1]=100
	lda  #$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1546   if x!=values[1]
	cmp  p8v_x
	bne  p8l_lbl4a
	; source: test_byte_equalities.p8:1548   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_equalities.p8:1549   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1550   skip4a:
p8l_skip4a
	; source: test_byte_equalities.p8:1552   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1553   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1555   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_equalities.p8:1556   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1557   skip4b:
p8l_skip4b
	; source: test_byte_equalities.p8:1559   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_177_afterif
	; source: test_byte_equalities.p8:1560   success++
	inc  p8b_main.p8v_success
label_asm_177_afterif
	; source: test_byte_equalities.p8:1563   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_179_else
	; source: test_byte_equalities.p8:1564   success++
	inc  p8b_main.p8v_success
...
label_asm_178_afterif
	; source: test_byte_equalities.p8:1569   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  p8l_lbl4c
	; source: test_byte_equalities.p8:1571   goto skip4c
	bra  p8l_skip4c
	; source: test_byte_equalities.p8:1572   lbl4c:   success++
p8l_lbl4c
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1573   skip4c:
p8l_skip4c
	; source: test_byte_equalities.p8:1575   cx16.r3 = &lbl4d
	lda  #<p8l_lbl4d
	ldy  #>p8l_lbl4d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1576   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1578   goto skip4d
	bra  p8l_skip4d
	; source: test_byte_equalities.p8:1579   lbl4d:   success++
p8l_lbl4d
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1580   skip4d:
p8l_skip4d
	; source: test_byte_equalities.p8:1582   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_180_afterif
	; source: test_byte_equalities.p8:1583   success++
	inc  p8b_main.p8v_success
label_asm_180_afterif
	; source: test_byte_equalities.p8:1586   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_182_else
	; source: test_byte_equalities.p8:1587   success++
	inc  p8b_main.p8v_success
...
label_asm_181_afterif
	; source: test_byte_equalities.p8:1591   x=100
	lda  #$64
	sta  p8v_x
	; source: test_byte_equalities.p8:1592   sources[1]=100
	sta  p8v_sources+1
	; source: test_byte_equalities.p8:1593   values[1]=-100
	lda  #-$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1595   if x!=values[1]
	cmp  p8v_x
	bne  p8l_lbl5a
	; source: test_byte_equalities.p8:1597   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_equalities.p8:1598   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1599   skip5a:
p8l_skip5a
	; source: test_byte_equalities.p8:1601   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1602   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1604   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_equalities.p8:1605   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1606   skip5b:
p8l_skip5b
	; source: test_byte_equalities.p8:1608   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_183_afterif
	; source: test_byte_equalities.p8:1609   success++
	inc  p8b_main.p8v_success
label_asm_183_afterif
	; source: test_byte_equalities.p8:1612   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_185_else
	; source: test_byte_equalities.p8:1613   success++
	inc  p8b_main.p8v_success
	bra  label_asm_184_afterif
label_asm_185_else
	; source: test_byte_equalities.p8:1615   cx16.r0L++
	inc  cx16.r0L
label_asm_184_afterif
	; source: test_byte_equalities.p8:1618   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  p8l_lbl5c
	; source: test_byte_equalities.p8:1620   goto skip5c
	bra  p8l_skip5c
	; source: test_byte_equalities.p8:1621   lbl5c:   success++
p8l_lbl5c
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1622   skip5c:
p8l_skip5c
	; source: test_byte_equalities.p8:1624   cx16.r3 = &lbl5d
	lda  #<p8l_lbl5d
	ldy  #>p8l_lbl5d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1625   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1627   goto skip5d
	bra  p8l_skip5d
	; source: test_byte_equalities.p8:1628   lbl5d:   success++
p8l_lbl5d
	inc  p8b_main.p8v_success
	; source: test_byte_equalities.p8:1629   skip5d:
p8l_skip5d
	; source: test_byte_equalities.p8:1631   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_186_afterif
	; source: test_byte_equalities.p8:1632   success++
	inc  p8b_main.p8v_success
label_asm_186_afterif
	; source: test_byte_equalities.p8:1635   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_188_else
	; source: test_byte_equalities.p8:1636   success++
	inc  p8b_main.p8v_success
	bra  label_asm_187_afterif
label_asm_188_else
	; source: test_byte_equalities.p8:1638   cx16.r0L++
	inc  cx16.r0L
label_asm_187_afterif
	; source: test_byte_equalities.p8:1640   values[1]=100
	lda  #$64
	sta  p8v_values+1
	; source: test_byte_equalities.p8:1642   if x!=values[1]
	cmp  p8v_x
	bne  p8l_lbl6a
	; source: test_byte_equalities.p8:1644   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_equalities.p8:1645   lbl6a:   fail_byte(113,100)
p8l_lbl6a
	lda  #<$71
	ldy  #>$71
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1646   skip6a:
p8l_skip6a
	; source: test_byte_equalities.p8:1648   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1649   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1651   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_equalities.p8:1652   lbl6b:   fail_byte(114,100)
p8l_lbl6b
	lda  #<$72
	ldy  #>$72
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1653   skip6b:
p8l_skip6b
	; source: test_byte_equalities.p8:1655   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_189_afterif
	; source: test_byte_equalities.p8:1656   fail_byte(115,100)
	lda  #<$73
	ldy  #>$73
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_189_afterif
	; source: test_byte_equalities.p8:1659   if x!=values[1]
	lda  p8v_values+1
	cmp  p8v_x
	beq  label_asm_191_else
	; source: test_byte_equalities.p8:1660   fail_byte(116,100)
	lda  #<$74
	ldy  #>$74
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_191_else
	; source: test_byte_equalities.p8:1662   cx16.r0L++
	inc  cx16.r0L
label_asm_190_afterif
	; source: test_byte_equalities.p8:1665   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	bne  p8l_lbl6c
	; source: test_byte_equalities.p8:1667   goto skip6c
	bra  p8l_skip6c
	; source: test_byte_equalities.p8:1668   lbl6c:   fail_byte(117,100)
p8l_lbl6c
	lda  #<$75
	ldy  #>$75
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1669   skip6c:
p8l_skip6c
	; source: test_byte_equalities.p8:1671   cx16.r3 = &lbl6d
	lda  #<p8l_lbl6d
	ldy  #>p8l_lbl6d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_equalities.p8:1672   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_equalities.p8:1674   goto skip6d
	bra  p8l_skip6d
	; source: test_byte_equalities.p8:1675   lbl6d:   fail_byte(118,100)
p8l_lbl6d
	lda  #<$76
	ldy  #>$76
	sta  p8b_main.p8s_fail_byte.p8v_idx
	...
	sta  p8b_main.p8s_fail_byte.p8v_v1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_equalities.p8:1676   skip6d:
p8l_skip6d
	; source: test_byte_equalities.p8:1678   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_192_afterif
	; source: test_byte_equalities.p8:1679   fail_byte(119,100)
	lda  #<$77
	ldy  #>$77
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_192_afterif
	; source: test_byte_equalities.p8:1682   if sources[1]!=values[1]
	lda  p8v_sources+1
	ldy  #1
	cmp  p8v_values,y
	beq  label_asm_194_else
	; source: test_byte_equalities.p8:1683   fail_byte(120,100)
	lda  #<$78
	ldy  #>$78
	sta  p8b_main.p8s_fail_byte.p8v_idx
	sty  p8b_main.p8s_fail_byte.p8v_idx+1
...
label_asm_194_else
	; source: test_byte_equalities.p8:1685   cx16.r0L++
	inc  cx16.r0L
label_asm_193_afterif
	; source: test_byte_equalities.p8:1687   verify_success(32)
	lda  #$20
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_equalities.p8:1394   sub test_not_array() {
; variables
