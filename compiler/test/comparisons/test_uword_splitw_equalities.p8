...
skip12b:
    ...
    sources[1]=0
    ; direct jump
        if sources[1]==cx16.r4+1-cx16.r5
            goto lbl1a
        goto skip1a
...
skip1b:
    ...
    ; direct jump
        if sources[1]==cx16.r4+30464-cx16.r5
            goto lbl2a
        goto skip2a
...
skip2b:
    ...
    ; direct jump
        if sources[1]==cx16.r4+65535-cx16.r5
            goto lbl3a
        goto skip3a
