; w65c02 assembly code for 'test_byte_gt'
...
p8v_datatype	; PETSCII:"byte"
	...
	; source: test_byte_gt.p8:9   ubyte success = 0
	; source: test_byte_gt.p8:10   str datatype = "byte"
	; source: test_byte_gt.p8:11   uword @shared comparison
	; source: test_byte_gt.p8:13   sub start() {
...
; variables
	...
	.pend
	; source: test_byte_gt.p8:29   sub verify_success(ubyte expected) {

p8s_verify_success	.proc
; simple int arg(s) passed via register(s)
	sta  p8v_expected
; statements
	; source: test_byte_gt.p8:30   if success==expected {
	lda  p8b_main.p8v_success
	cmp  p8v_expected
	bne  label_asm_2_else
	; source: test_byte_gt.p8:31   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_byte_gt.p8:33   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_7
	lda  #<prog8_interned_strings.string_7
	jsr  txt.print
	; source: test_byte_gt.p8:34   txt.print_ub(success)
	lda  p8b_main.p8v_success
	jsr  txt.print_ub
	; source: test_byte_gt.p8:35   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_8
	lda  #<prog8_interned_strings.string_8
	jsr  txt.print
	; source: test_byte_gt.p8:36   txt.print_ub(expected)
	lda  p8v_expected
	jsr  txt.print_ub
label_asm_1_afterif
	; source: test_byte_gt.p8:29   sub verify_success(ubyte expected) {
...
p8v_expected	.byte  ?
	.send BSS
	.pend
	; source: test_byte_gt.p8:40   sub fail_byte(uword idx) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_idx+1
; statements
	; source: test_byte_gt.p8:41   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_9
	lda  #<prog8_interned_strings.string_9
	jsr  txt.print
	; source: test_byte_gt.p8:42   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_byte_gt.p8:43   txt.print(" **")
...
p8v_idx	.word  ?
	.send BSS
	.pend
	; source: test_byte_gt.p8:71   sub test_cmp_number() {

p8s_test_cmp_number	.proc
; statements
	; source: test_byte_gt.p8:72   byte @shared x
	stz  p8v_x
	; source: test_byte_gt.p8:73   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gt.p8:74   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gt.p8:76   if x>-1
	bpl  p8l_lbl1a
	; source: test_byte_gt.p8:78   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gt.p8:79   lbl1a:   fail_byte(1)
p8l_lbl1a
	ldy  #>1
	lda  #<1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:80   skip1a:
p8l_skip1a
	; source: test_byte_gt.p8:82   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:83   if x>-1
	lda  p8v_x
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:85   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gt.p8:86   lbl1b:   fail_byte(2)
p8l_lbl1b
	ldy  #>2
	lda  #<2
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:87   skip1b:
p8l_skip1b
	; source: test_byte_gt.p8:89   if x>-1
	lda  p8v_x
	bmi  label_asm_3_afterif
	; source: test_byte_gt.p8:90   fail_byte(3)
	ldy  #>3
	lda  #<3
	jsr  p8b_main.p8s_fail_byte
label_asm_3_afterif
	; source: test_byte_gt.p8:93   if x>-1
	lda  p8v_x
	bmi  label_asm_5_else
	; source: test_byte_gt.p8:94   fail_byte(4)
	ldy  #>4
	lda  #<4
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_4_afterif
label_asm_5_else
	; source: test_byte_gt.p8:96   success++
	inc  p8b_main.p8v_success
label_asm_4_afterif
	; source: test_byte_gt.p8:99   if x>0
	lda  p8v_x
	beq  +
	bpl  p8l_lbl2a
+
	; source: test_byte_gt.p8:101   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gt.p8:102   lbl2a:   fail_byte(5)
p8l_lbl2a
	ldy  #>5
	lda  #<5
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:103   skip2a:
p8l_skip2a
	; source: test_byte_gt.p8:105   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:106   if x>0
	lda  p8v_x
	bmi  +
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:108   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gt.p8:109   lbl2b:   fail_byte(6)
p8l_lbl2b
	ldy  #>6
	lda  #<6
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:110   skip2b:
p8l_skip2b
	; source: test_byte_gt.p8:112   if x>0
	lda  p8v_x
	bmi  label_asm_6_afterif
	beq  label_asm_6_afterif
	; source: test_byte_gt.p8:113   fail_byte(7)
	ldy  #>7
	lda  #<7
	jsr  p8b_main.p8s_fail_byte
label_asm_6_afterif
	; source: test_byte_gt.p8:116   if x>0
	lda  p8v_x
	bmi  label_asm_8_else
	beq  label_asm_8_else
	; source: test_byte_gt.p8:117   fail_byte(8)
	ldy  #>8
	lda  #<8
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_7_afterif
label_asm_8_else
	; source: test_byte_gt.p8:119   success++
	inc  p8b_main.p8v_success
label_asm_7_afterif
	; source: test_byte_gt.p8:122   if x>1
	lda  p8v_x
	cmp  #2
	bpl  p8l_lbl3a
	; source: test_byte_gt.p8:124   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gt.p8:125   lbl3a:   fail_byte(9)
p8l_lbl3a
	ldy  #>9
	lda  #<9
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:126   skip3a:
p8l_skip3a
	; source: test_byte_gt.p8:128   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:129   if x>1
	lda  p8v_x
	cmp  #2
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:131   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gt.p8:132   lbl3b:   fail_byte(10)
p8l_lbl3b
	ldy  #>10
	lda  #<10
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:133   skip3b:
p8l_skip3b
	; source: test_byte_gt.p8:135   if x>1
	lda  p8v_x
	cmp  #2
	bmi  label_asm_9_afterif
	; source: test_byte_gt.p8:136   fail_byte(11)
	ldy  #>11
	lda  #<11
	jsr  p8b_main.p8s_fail_byte
label_asm_9_afterif
	; source: test_byte_gt.p8:139   if x>1
	lda  p8v_x
	cmp  #2
	bmi  label_asm_11_else
	; source: test_byte_gt.p8:140   fail_byte(12)
	ldy  #>12
	lda  #<12
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_10_afterif
label_asm_11_else
	; source: test_byte_gt.p8:142   success++
	inc  p8b_main.p8v_success
label_asm_10_afterif
	; source: test_byte_gt.p8:144   x=0
	stz  p8v_x
	; source: test_byte_gt.p8:146   if x>-1
	lda  p8v_x
	bpl  p8l_lbl4a
	; source: test_byte_gt.p8:148   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gt.p8:149   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:150   skip4a:
p8l_skip4a
	; source: test_byte_gt.p8:152   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:153   if x>-1
	lda  p8v_x
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:155   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gt.p8:156   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:157   skip4b:
p8l_skip4b
	; source: test_byte_gt.p8:159   if x>-1
	lda  p8v_x
	bmi  label_asm_12_afterif
	; source: test_byte_gt.p8:160   success++
	inc  p8b_main.p8v_success
label_asm_12_afterif
	; source: test_byte_gt.p8:163   if x>-1
	lda  p8v_x
	bmi  label_asm_14_else
	; source: test_byte_gt.p8:164   success++
	inc  p8b_main.p8v_success
	bra  label_asm_13_afterif
label_asm_14_else
	; source: test_byte_gt.p8:166   cx16.r0L++
	inc  cx16.r0L
label_asm_13_afterif
	; source: test_byte_gt.p8:169   if x>0
	lda  p8v_x
	beq  +
	bpl  p8l_lbl5a
+
	; source: test_byte_gt.p8:171   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gt.p8:172   lbl5a:   fail_byte(13)
p8l_lbl5a
	ldy  #>13
	lda  #<13
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:173   skip5a:
p8l_skip5a
	; source: test_byte_gt.p8:175   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:176   if x>0
	lda  p8v_x
	bmi  +
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:178   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gt.p8:179   lbl5b:   fail_byte(14)
p8l_lbl5b
	ldy  #>14
	lda  #<14
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:180   skip5b:
p8l_skip5b
	; source: test_byte_gt.p8:182   if x>0
	lda  p8v_x
	bmi  label_asm_15_afterif
	beq  label_asm_15_afterif
	; source: test_byte_gt.p8:183   fail_byte(15)
	ldy  #>15
	lda  #<15
	jsr  p8b_main.p8s_fail_byte
label_asm_15_afterif
	; source: test_byte_gt.p8:186   if x>0
	lda  p8v_x
	bmi  label_asm_17_else
	beq  label_asm_17_else
	; source: test_byte_gt.p8:187   fail_byte(16)
	ldy  #>$10
	lda  #<$10
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_16_afterif
label_asm_17_else
	; source: test_byte_gt.p8:189   success++
	inc  p8b_main.p8v_success
label_asm_16_afterif
	; source: test_byte_gt.p8:192   if x>1
	lda  p8v_x
	cmp  #2
	bpl  p8l_lbl6a
	; source: test_byte_gt.p8:194   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_gt.p8:195   lbl6a:   fail_byte(17)
p8l_lbl6a
	ldy  #>$11
	lda  #<$11
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:196   skip6a:
p8l_skip6a
	; source: test_byte_gt.p8:198   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:199   if x>1
	lda  p8v_x
	cmp  #2
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:201   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gt.p8:202   lbl6b:   fail_byte(18)
p8l_lbl6b
	ldy  #>$12
	lda  #<$12
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:203   skip6b:
p8l_skip6b
	; source: test_byte_gt.p8:205   if x>1
	lda  p8v_x
	cmp  #2
	bmi  label_asm_18_afterif
	; source: test_byte_gt.p8:206   fail_byte(19)
	ldy  #>$13
	lda  #<$13
	jsr  p8b_main.p8s_fail_byte
label_asm_18_afterif
	; source: test_byte_gt.p8:209   if x>1
	lda  p8v_x
	cmp  #2
	bmi  label_asm_20_else
	; source: test_byte_gt.p8:210   fail_byte(20)
	ldy  #>$14
	lda  #<$14
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_19_afterif
label_asm_20_else
	; source: test_byte_gt.p8:212   success++
	inc  p8b_main.p8v_success
label_asm_19_afterif
	; source: test_byte_gt.p8:214   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gt.p8:216   if x>-1
	bpl  p8l_lbl7a
	; source: test_byte_gt.p8:218   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gt.p8:219   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:220   skip7a:
p8l_skip7a
	; source: test_byte_gt.p8:222   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:223   if x>-1
	lda  p8v_x
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:225   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gt.p8:226   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:227   skip7b:
p8l_skip7b
	; source: test_byte_gt.p8:229   if x>-1
	lda  p8v_x
	bmi  label_asm_21_afterif
	; source: test_byte_gt.p8:230   success++
	inc  p8b_main.p8v_success
label_asm_21_afterif
	; source: test_byte_gt.p8:233   if x>-1
	lda  p8v_x
...
label_asm_22_afterif
	; source: test_byte_gt.p8:239   if x>0
	lda  p8v_x
	beq  +
	bpl  p8l_lbl8a
+
	; source: test_byte_gt.p8:241   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gt.p8:242   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:243   skip8a:
p8l_skip8a
	; source: test_byte_gt.p8:245   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:246   if x>0
	lda  p8v_x
	bmi  +
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:248   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gt.p8:249   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:250   skip8b:
p8l_skip8b
	; source: test_byte_gt.p8:252   if x>0
	lda  p8v_x
	bmi  label_asm_24_afterif
	beq  label_asm_24_afterif
	; source: test_byte_gt.p8:253   success++
	inc  p8b_main.p8v_success
label_asm_24_afterif
	; source: test_byte_gt.p8:256   if x>0
	lda  p8v_x
	bmi  label_asm_26_else
	beq  label_asm_26_else
	; source: test_byte_gt.p8:257   success++
	inc  p8b_main.p8v_success
	bra  label_asm_25_afterif
label_asm_26_else
	; source: test_byte_gt.p8:259   cx16.r0L++
	inc  cx16.r0L
label_asm_25_afterif
	; source: test_byte_gt.p8:262   if x>1
	lda  p8v_x
	cmp  #2
	bpl  p8l_lbl9a
	; source: test_byte_gt.p8:264   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gt.p8:265   lbl9a:   fail_byte(21)
p8l_lbl9a
	ldy  #>$15
	lda  #<$15
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:266   skip9a:
p8l_skip9a
	; source: test_byte_gt.p8:268   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:269   if x>1
	lda  p8v_x
	cmp  #2
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:271   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gt.p8:272   lbl9b:   fail_byte(22)
p8l_lbl9b
	ldy  #>$16
	lda  #<$16
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:273   skip9b:
p8l_skip9b
	; source: test_byte_gt.p8:275   if x>1
	lda  p8v_x
	cmp  #2
	bmi  label_asm_27_afterif
	; source: test_byte_gt.p8:276   fail_byte(23)
	ldy  #>$17
	lda  #<$17
	jsr  p8b_main.p8s_fail_byte
label_asm_27_afterif
	; source: test_byte_gt.p8:279   if x>1
	lda  p8v_x
	cmp  #2
	bmi  label_asm_29_else
	; source: test_byte_gt.p8:280   fail_byte(24)
	ldy  #>$18
	lda  #<$18
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_28_afterif
label_asm_29_else
	; source: test_byte_gt.p8:282   success++
	inc  p8b_main.p8v_success
label_asm_28_afterif
	; source: test_byte_gt.p8:284   verify_success(18)
	lda  #$12
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_gt.p8:286   sub test_cmp_var() {

p8s_test_cmp_var	.proc
; statements
	; source: test_byte_gt.p8:287   byte @shared x, value
	stz  p8v_x
	lda  p8v_x
	sta  p8v_value
	
	; source: test_byte_gt.p8:288   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gt.p8:289   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gt.p8:290   value=-1
	sta  p8v_value
	; source: test_byte_gt.p8:292   if x>value
	sec
	sbc  p8v_x
	bmi  p8l_lbl1a
	; source: test_byte_gt.p8:294   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gt.p8:295   lbl1a:   fail_byte(25)
p8l_lbl1a
	ldy  #>$19
	lda  #<$19
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:296   skip1a:
p8l_skip1a
	; source: test_byte_gt.p8:298   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:299   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:301   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gt.p8:302   lbl1b:   fail_byte(26)
p8l_lbl1b
	ldy  #>$1a
	lda  #<$1a
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:303   skip1b:
p8l_skip1b
	; source: test_byte_gt.p8:305   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_30_afterif
	; source: test_byte_gt.p8:306   fail_byte(27)
	ldy  #>$1b
	lda  #<$1b
	jsr  p8b_main.p8s_fail_byte
label_asm_30_afterif
	; source: test_byte_gt.p8:309   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_32_else
	; source: test_byte_gt.p8:310   fail_byte(28)
	ldy  #>$1c
	lda  #<$1c
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_31_afterif
label_asm_32_else
	; source: test_byte_gt.p8:312   success++
	inc  p8b_main.p8v_success
label_asm_31_afterif
	; source: test_byte_gt.p8:314   value=0
	stz  p8v_value
	; source: test_byte_gt.p8:316   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bmi  p8l_lbl2a
	; source: test_byte_gt.p8:318   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gt.p8:319   lbl2a:   fail_byte(29)
p8l_lbl2a
	ldy  #>$1d
	lda  #<$1d
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:320   skip2a:
p8l_skip2a
	; source: test_byte_gt.p8:322   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:323   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:325   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gt.p8:326   lbl2b:   fail_byte(30)
p8l_lbl2b
	ldy  #>$1e
	lda  #<$1e
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:327   skip2b:
p8l_skip2b
	; source: test_byte_gt.p8:329   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_33_afterif
	; source: test_byte_gt.p8:330   fail_byte(31)
	ldy  #>$1f
	lda  #<$1f
	jsr  p8b_main.p8s_fail_byte
label_asm_33_afterif
	; source: test_byte_gt.p8:333   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_35_else
	; source: test_byte_gt.p8:334   fail_byte(32)
	ldy  #>$20
	lda  #<$20
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_34_afterif
label_asm_35_else
	; source: test_byte_gt.p8:336   success++
	inc  p8b_main.p8v_success
label_asm_34_afterif
	; source: test_byte_gt.p8:338   value=1
	lda  #1
	sta  p8v_value
	; source: test_byte_gt.p8:340   if x>value
	sec
	sbc  p8v_x
	bmi  p8l_lbl3a
	; source: test_byte_gt.p8:342   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gt.p8:343   lbl3a:   fail_byte(33)
p8l_lbl3a
	ldy  #>$21
	lda  #<$21
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:344   skip3a:
p8l_skip3a
	; source: test_byte_gt.p8:346   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:347   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:349   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gt.p8:350   lbl3b:   fail_byte(34)
p8l_lbl3b
	ldy  #>$22
	lda  #<$22
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:351   skip3b:
p8l_skip3b
	; source: test_byte_gt.p8:353   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_36_afterif
	; source: test_byte_gt.p8:354   fail_byte(35)
	ldy  #>$23
	lda  #<$23
	jsr  p8b_main.p8s_fail_byte
label_asm_36_afterif
	; source: test_byte_gt.p8:357   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_38_else
	; source: test_byte_gt.p8:358   fail_byte(36)
	ldy  #>$24
	lda  #<$24
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_37_afterif
label_asm_38_else
	; source: test_byte_gt.p8:360   success++
	inc  p8b_main.p8v_success
label_asm_37_afterif
	; source: test_byte_gt.p8:362   x=0
	stz  p8v_x
	; source: test_byte_gt.p8:363   value=-1
	lda  #-1
	sta  p8v_value
	; source: test_byte_gt.p8:365   if x>value
	sec
	sbc  p8v_x
	bmi  p8l_lbl4a
	; source: test_byte_gt.p8:367   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gt.p8:368   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:369   skip4a:
p8l_skip4a
	; source: test_byte_gt.p8:371   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:372   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:374   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gt.p8:375   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:376   skip4b:
p8l_skip4b
	; source: test_byte_gt.p8:378   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_39_afterif
	; source: test_byte_gt.p8:379   success++
	inc  p8b_main.p8v_success
label_asm_39_afterif
	; source: test_byte_gt.p8:382   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_41_else
	; source: test_byte_gt.p8:383   success++
	inc  p8b_main.p8v_success
	bra  label_asm_40_afterif
label_asm_41_else
	; source: test_byte_gt.p8:385   cx16.r0L++
	inc  cx16.r0L
label_asm_40_afterif
	; source: test_byte_gt.p8:387   value=0
	stz  p8v_value
	; source: test_byte_gt.p8:389   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bmi  p8l_lbl5a
	; source: test_byte_gt.p8:391   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gt.p8:392   lbl5a:   fail_byte(37)
p8l_lbl5a
	ldy  #>$25
	lda  #<$25
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:393   skip5a:
p8l_skip5a
	; source: test_byte_gt.p8:395   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:396   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:398   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gt.p8:399   lbl5b:   fail_byte(38)
p8l_lbl5b
	ldy  #>$26
	lda  #<$26
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:400   skip5b:
p8l_skip5b
	; source: test_byte_gt.p8:402   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_42_afterif
	; source: test_byte_gt.p8:403   fail_byte(39)
	ldy  #>$27
	lda  #<$27
	jsr  p8b_main.p8s_fail_byte
label_asm_42_afterif
	; source: test_byte_gt.p8:406   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_44_else
	; source: test_byte_gt.p8:407   fail_byte(40)
	ldy  #>$28
	lda  #<$28
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_43_afterif
label_asm_44_else
	; source: test_byte_gt.p8:409   success++
	inc  p8b_main.p8v_success
label_asm_43_afterif
	; source: test_byte_gt.p8:411   value=1
	lda  #1
	sta  p8v_value
	; source: test_byte_gt.p8:413   if x>value
	sec
	sbc  p8v_x
	bmi  p8l_lbl6a
	; source: test_byte_gt.p8:415   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_gt.p8:416   lbl6a:   fail_byte(41)
p8l_lbl6a
	ldy  #>$29
	lda  #<$29
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:417   skip6a:
p8l_skip6a
	; source: test_byte_gt.p8:419   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:420   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:422   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gt.p8:423   lbl6b:   fail_byte(42)
p8l_lbl6b
	ldy  #>$2a
	lda  #<$2a
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:424   skip6b:
p8l_skip6b
	; source: test_byte_gt.p8:426   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_45_afterif
	; source: test_byte_gt.p8:427   fail_byte(43)
	ldy  #>$2b
	lda  #<$2b
	jsr  p8b_main.p8s_fail_byte
label_asm_45_afterif
	; source: test_byte_gt.p8:430   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_47_else
	; source: test_byte_gt.p8:431   fail_byte(44)
	ldy  #>$2c
	lda  #<$2c
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_46_afterif
label_asm_47_else
	; source: test_byte_gt.p8:433   success++
	inc  p8b_main.p8v_success
label_asm_46_afterif
	; source: test_byte_gt.p8:435   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gt.p8:436   value=-1
	lda  #-1
	sta  p8v_value
	; source: test_byte_gt.p8:438   if x>value
	sec
	sbc  p8v_x
	bmi  p8l_lbl7a
	; source: test_byte_gt.p8:440   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gt.p8:441   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:442   skip7a:
p8l_skip7a
	; source: test_byte_gt.p8:444   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:445   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:447   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gt.p8:448   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:449   skip7b:
p8l_skip7b
	; source: test_byte_gt.p8:451   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_48_afterif
	; source: test_byte_gt.p8:452   success++
	inc  p8b_main.p8v_success
label_asm_48_afterif
	; source: test_byte_gt.p8:455   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_50_else
	; source: test_byte_gt.p8:456   success++
	inc  p8b_main.p8v_success
	bra  label_asm_49_afterif
label_asm_50_else
	; source: test_byte_gt.p8:458   cx16.r0L++
	inc  cx16.r0L
label_asm_49_afterif
	; source: test_byte_gt.p8:460   value=0
	stz  p8v_value
	; source: test_byte_gt.p8:462   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bmi  p8l_lbl8a
	; source: test_byte_gt.p8:464   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gt.p8:465   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:466   skip8a:
p8l_skip8a
	; source: test_byte_gt.p8:468   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:469   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:471   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gt.p8:472   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:473   skip8b:
p8l_skip8b
	; source: test_byte_gt.p8:475   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_51_afterif
	; source: test_byte_gt.p8:476   success++
	inc  p8b_main.p8v_success
label_asm_51_afterif
	; source: test_byte_gt.p8:479   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_53_else
	; source: test_byte_gt.p8:480   success++
	inc  p8b_main.p8v_success
	bra  label_asm_52_afterif
label_asm_53_else
	; source: test_byte_gt.p8:482   cx16.r0L++
	inc  cx16.r0L
label_asm_52_afterif
	; source: test_byte_gt.p8:484   value=1
	lda  #1
	sta  p8v_value
	; source: test_byte_gt.p8:486   if x>value
	sec
	sbc  p8v_x
	bmi  p8l_lbl9a
	; source: test_byte_gt.p8:488   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gt.p8:489   lbl9a:   fail_byte(45)
p8l_lbl9a
	ldy  #>$2d
	lda  #<$2d
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:490   skip9a:
p8l_skip9a
	; source: test_byte_gt.p8:492   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:493   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:495   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gt.p8:496   lbl9b:   fail_byte(46)
p8l_lbl9b
	ldy  #>$2e
	lda  #<$2e
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:497   skip9b:
p8l_skip9b
	; source: test_byte_gt.p8:499   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_54_afterif
	; source: test_byte_gt.p8:500   fail_byte(47)
	ldy  #>$2f
	lda  #<$2f
	jsr  p8b_main.p8s_fail_byte
label_asm_54_afterif
	; source: test_byte_gt.p8:503   if x>value
	lda  p8v_value
	sec
	sbc  p8v_x
	bpl  label_asm_56_else
	; source: test_byte_gt.p8:504   fail_byte(48)
	ldy  #>$30
	lda  #<$30
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_55_afterif
label_asm_56_else
	; source: test_byte_gt.p8:506   success++
	inc  p8b_main.p8v_success
label_asm_55_afterif
	; source: test_byte_gt.p8:508   verify_success(18)
	lda  #$12
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_gt.p8:286   sub test_cmp_var() {
; variables
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_gt.p8:510   sub test_cmp_array() {

p8s_test_cmp_array	.proc
; statements
	; source: test_byte_gt.p8:511   byte @shared x
	; source: test_byte_gt.p8:512   byte[] values = [0, 0]
	; source: test_byte_gt.p8:511   byte @shared x
	stz  p8v_x
	; source: test_byte_gt.p8:513   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gt.p8:514   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gt.p8:515   values[1]=-1
	sta  p8v_values+1
	; source: test_byte_gt.p8:517   if x>values[1]
	sec
	sbc  p8v_x
	bmi  p8l_lbl1a
	; source: test_byte_gt.p8:519   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gt.p8:520   lbl1a:   fail_byte(49)
p8l_lbl1a
	ldy  #>$31
	lda  #<$31
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:521   skip1a:
p8l_skip1a
	; source: test_byte_gt.p8:523   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:524   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:526   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gt.p8:527   lbl1b:   fail_byte(50)
p8l_lbl1b
	ldy  #>$32
	lda  #<$32
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:528   skip1b:
p8l_skip1b
	; source: test_byte_gt.p8:530   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_57_afterif
	; source: test_byte_gt.p8:531   fail_byte(51)
	ldy  #>$33
	lda  #<$33
	jsr  p8b_main.p8s_fail_byte
label_asm_57_afterif
	; source: test_byte_gt.p8:534   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_59_else
	; source: test_byte_gt.p8:535   fail_byte(52)
	ldy  #>$34
	lda  #<$34
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_58_afterif
label_asm_59_else
	; source: test_byte_gt.p8:537   success++
	inc  p8b_main.p8v_success
label_asm_58_afterif
	; source: test_byte_gt.p8:539   values[1]=0
	stz  p8v_values+1
	; source: test_byte_gt.p8:541   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bmi  p8l_lbl2a
	; source: test_byte_gt.p8:543   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gt.p8:544   lbl2a:   fail_byte(53)
p8l_lbl2a
	ldy  #>$35
	lda  #<$35
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:545   skip2a:
p8l_skip2a
	; source: test_byte_gt.p8:547   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:548   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:550   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gt.p8:551   lbl2b:   fail_byte(54)
p8l_lbl2b
	ldy  #>$36
	lda  #<$36
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:552   skip2b:
p8l_skip2b
	; source: test_byte_gt.p8:554   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_60_afterif
	; source: test_byte_gt.p8:555   fail_byte(55)
	ldy  #>$37
	lda  #<$37
	jsr  p8b_main.p8s_fail_byte
label_asm_60_afterif
	; source: test_byte_gt.p8:558   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_62_else
	; source: test_byte_gt.p8:559   fail_byte(56)
	ldy  #>$38
	lda  #<$38
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_61_afterif
label_asm_62_else
	; source: test_byte_gt.p8:561   success++
	inc  p8b_main.p8v_success
label_asm_61_afterif
	; source: test_byte_gt.p8:563   values[1]=1
	lda  #1
	sta  p8v_values+1
	; source: test_byte_gt.p8:565   if x>values[1]
	sec
	sbc  p8v_x
	bmi  p8l_lbl3a
	; source: test_byte_gt.p8:567   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gt.p8:568   lbl3a:   fail_byte(57)
p8l_lbl3a
	ldy  #>$39
	lda  #<$39
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:569   skip3a:
p8l_skip3a
	; source: test_byte_gt.p8:571   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:572   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:574   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gt.p8:575   lbl3b:   fail_byte(58)
p8l_lbl3b
	ldy  #>$3a
	lda  #<$3a
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:576   skip3b:
p8l_skip3b
	; source: test_byte_gt.p8:578   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_63_afterif
	; source: test_byte_gt.p8:579   fail_byte(59)
	ldy  #>$3b
	lda  #<$3b
	jsr  p8b_main.p8s_fail_byte
label_asm_63_afterif
	; source: test_byte_gt.p8:582   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_65_else
	; source: test_byte_gt.p8:583   fail_byte(60)
	ldy  #>$3c
	lda  #<$3c
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_64_afterif
label_asm_65_else
	; source: test_byte_gt.p8:585   success++
	inc  p8b_main.p8v_success
label_asm_64_afterif
	; source: test_byte_gt.p8:587   x=0
	stz  p8v_x
	; source: test_byte_gt.p8:588   values[1]=-1
	lda  #-1
	sta  p8v_values+1
	; source: test_byte_gt.p8:590   if x>values[1]
	sec
	sbc  p8v_x
	bmi  p8l_lbl4a
	; source: test_byte_gt.p8:592   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gt.p8:593   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:594   skip4a:
p8l_skip4a
	; source: test_byte_gt.p8:596   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:597   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:599   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gt.p8:600   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:601   skip4b:
p8l_skip4b
	; source: test_byte_gt.p8:603   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_66_afterif
	; source: test_byte_gt.p8:604   success++
	inc  p8b_main.p8v_success
label_asm_66_afterif
	; source: test_byte_gt.p8:607   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_68_else
	; source: test_byte_gt.p8:608   success++
	inc  p8b_main.p8v_success
	bra  label_asm_67_afterif
label_asm_68_else
	; source: test_byte_gt.p8:610   cx16.r0L++
	inc  cx16.r0L
label_asm_67_afterif
	; source: test_byte_gt.p8:612   values[1]=0
	stz  p8v_values+1
	; source: test_byte_gt.p8:614   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bmi  p8l_lbl5a
	; source: test_byte_gt.p8:616   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gt.p8:617   lbl5a:   fail_byte(61)
p8l_lbl5a
	ldy  #>$3d
	lda  #<$3d
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:618   skip5a:
p8l_skip5a
	; source: test_byte_gt.p8:620   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:621   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:623   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gt.p8:624   lbl5b:   fail_byte(62)
p8l_lbl5b
	ldy  #>$3e
	lda  #<$3e
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:625   skip5b:
p8l_skip5b
	; source: test_byte_gt.p8:627   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_69_afterif
	; source: test_byte_gt.p8:628   fail_byte(63)
	ldy  #>$3f
	lda  #<$3f
	jsr  p8b_main.p8s_fail_byte
label_asm_69_afterif
	; source: test_byte_gt.p8:631   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_71_else
	; source: test_byte_gt.p8:632   fail_byte(64)
	ldy  #>$40
	lda  #<$40
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_70_afterif
label_asm_71_else
	; source: test_byte_gt.p8:634   success++
	inc  p8b_main.p8v_success
label_asm_70_afterif
	; source: test_byte_gt.p8:636   values[1]=1
	lda  #1
	sta  p8v_values+1
	; source: test_byte_gt.p8:638   if x>values[1]
	sec
	sbc  p8v_x
	bmi  p8l_lbl6a
	; source: test_byte_gt.p8:640   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_gt.p8:641   lbl6a:   fail_byte(65)
p8l_lbl6a
	ldy  #>$41
	lda  #<$41
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:642   skip6a:
p8l_skip6a
	; source: test_byte_gt.p8:644   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:645   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:647   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gt.p8:648   lbl6b:   fail_byte(66)
p8l_lbl6b
	ldy  #>$42
	lda  #<$42
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:649   skip6b:
p8l_skip6b
	; source: test_byte_gt.p8:651   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_72_afterif
	; source: test_byte_gt.p8:652   fail_byte(67)
	ldy  #>$43
	lda  #<$43
	jsr  p8b_main.p8s_fail_byte
label_asm_72_afterif
	; source: test_byte_gt.p8:655   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_74_else
	; source: test_byte_gt.p8:656   fail_byte(68)
	ldy  #>$44
	lda  #<$44
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_73_afterif
label_asm_74_else
	; source: test_byte_gt.p8:658   success++
	inc  p8b_main.p8v_success
label_asm_73_afterif
	; source: test_byte_gt.p8:660   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gt.p8:661   values[1]=-1
	lda  #-1
	sta  p8v_values+1
	; source: test_byte_gt.p8:663   if x>values[1]
	sec
	sbc  p8v_x
	bmi  p8l_lbl7a
	; source: test_byte_gt.p8:665   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gt.p8:666   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:667   skip7a:
p8l_skip7a
	; source: test_byte_gt.p8:669   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:670   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:672   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gt.p8:673   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:674   skip7b:
p8l_skip7b
	; source: test_byte_gt.p8:676   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_75_afterif
	; source: test_byte_gt.p8:677   success++
	inc  p8b_main.p8v_success
label_asm_75_afterif
	; source: test_byte_gt.p8:680   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_77_else
	; source: test_byte_gt.p8:681   success++
	inc  p8b_main.p8v_success
	bra  label_asm_76_afterif
label_asm_77_else
	; source: test_byte_gt.p8:683   cx16.r0L++
	inc  cx16.r0L
label_asm_76_afterif
	; source: test_byte_gt.p8:685   values[1]=0
	stz  p8v_values+1
	; source: test_byte_gt.p8:687   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bmi  p8l_lbl8a
	; source: test_byte_gt.p8:689   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gt.p8:690   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:691   skip8a:
p8l_skip8a
	; source: test_byte_gt.p8:693   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:694   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:696   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gt.p8:697   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:698   skip8b:
p8l_skip8b
	; source: test_byte_gt.p8:700   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_78_afterif
	; source: test_byte_gt.p8:701   success++
	inc  p8b_main.p8v_success
label_asm_78_afterif
	; source: test_byte_gt.p8:704   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_80_else
	; source: test_byte_gt.p8:705   success++
	inc  p8b_main.p8v_success
	bra  label_asm_79_afterif
label_asm_80_else
	; source: test_byte_gt.p8:707   cx16.r0L++
	inc  cx16.r0L
label_asm_79_afterif
	; source: test_byte_gt.p8:709   values[1]=1
	lda  #1
	sta  p8v_values+1
	; source: test_byte_gt.p8:711   if x>values[1]
	sec
	sbc  p8v_x
	bmi  p8l_lbl9a
	; source: test_byte_gt.p8:713   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gt.p8:714   lbl9a:   fail_byte(69)
p8l_lbl9a
	ldy  #>$45
	lda  #<$45
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:715   skip9a:
p8l_skip9a
	; source: test_byte_gt.p8:717   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:718   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  +
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:720   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gt.p8:721   lbl9b:   fail_byte(70)
p8l_lbl9b
	ldy  #>$46
	lda  #<$46
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:722   skip9b:
p8l_skip9b
	; source: test_byte_gt.p8:724   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_81_afterif
	; source: test_byte_gt.p8:725   fail_byte(71)
	ldy  #>$47
	lda  #<$47
	jsr  p8b_main.p8s_fail_byte
label_asm_81_afterif
	; source: test_byte_gt.p8:728   if x>values[1]
	lda  p8v_values+1
	sec
	sbc  p8v_x
	bpl  label_asm_83_else
	; source: test_byte_gt.p8:729   fail_byte(72)
	ldy  #>$48
	lda  #<$48
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_82_afterif
label_asm_83_else
	; source: test_byte_gt.p8:731   success++
	inc  p8b_main.p8v_success
label_asm_82_afterif
	; source: test_byte_gt.p8:733   verify_success(18)
	lda  #$12
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_gt.p8:510   sub test_cmp_array() {
; variables
...
p8v_values	.char  $00, $00
	.pend
	; source: test_byte_gt.p8:735   sub test_cmp_expr() {

p8s_test_cmp_expr	.proc
; statements
	; source: test_byte_gt.p8:736   byte @shared x
	; source: test_byte_gt.p8:739   float @shared f4 = 1.0
	; source: test_byte_gt.p8:740   float @shared f5 = 1.0
	; source: test_byte_gt.p8:736   byte @shared x
	stz  p8v_x
	; source: test_byte_gt.p8:737   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_byte_gt.p8:738   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_byte_gt.p8:741   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gt.p8:742   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gt.p8:744   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	sbc  p8v_x
	bmi  p8l_lbl1a
	; source: test_byte_gt.p8:746   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gt.p8:747   lbl1a:   fail_byte(73)
p8l_lbl1a
	ldy  #>$49
	lda  #<$49
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:748   skip1a:
p8l_skip1a
	; source: test_byte_gt.p8:750   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:751   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:753   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gt.p8:754   lbl1b:   fail_byte(74)
p8l_lbl1b
	ldy  #>$4a
	lda  #<$4a
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:755   skip1b:
p8l_skip1b
	; source: test_byte_gt.p8:757   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	; source: test_byte_gt.p8:758   fail_byte(75)
	ldy  #>$4b
	lda  #<$4b
	jsr  p8b_main.p8s_fail_byte
label_asm_84_afterif
	; source: test_byte_gt.p8:761   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	; source: test_byte_gt.p8:762   fail_byte(76)
	ldy  #>$4c
	lda  #<$4c
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_85_afterif
label_asm_86_else
	; source: test_byte_gt.p8:764   success++
	inc  p8b_main.p8v_success
label_asm_85_afterif
	; source: test_byte_gt.p8:767   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	sbc  p8v_x
	bmi  p8l_lbl2a
	; source: test_byte_gt.p8:769   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gt.p8:770   lbl2a:   fail_byte(77)
p8l_lbl2a
	ldy  #>$4d
	lda  #<$4d
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:771   skip2a:
p8l_skip2a
	; source: test_byte_gt.p8:773   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:774   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:776   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gt.p8:777   lbl2b:   fail_byte(78)
p8l_lbl2b
	ldy  #>$4e
	lda  #<$4e
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:778   skip2b:
p8l_skip2b
	; source: test_byte_gt.p8:780   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	; source: test_byte_gt.p8:781   fail_byte(79)
	ldy  #>$4f
	lda  #<$4f
	jsr  p8b_main.p8s_fail_byte
label_asm_87_afterif
	; source: test_byte_gt.p8:784   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	; source: test_byte_gt.p8:785   fail_byte(80)
	ldy  #>$50
	lda  #<$50
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_88_afterif
label_asm_89_else
	; source: test_byte_gt.p8:787   success++
	inc  p8b_main.p8v_success
label_asm_88_afterif
	; source: test_byte_gt.p8:790   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	sbc  p8v_x
	bmi  p8l_lbl3a
	; source: test_byte_gt.p8:792   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gt.p8:793   lbl3a:   fail_byte(81)
p8l_lbl3a
	ldy  #>$51
	lda  #<$51
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:794   skip3a:
p8l_skip3a
	; source: test_byte_gt.p8:796   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:797   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:799   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gt.p8:800   lbl3b:   fail_byte(82)
p8l_lbl3b
	ldy  #>$52
	lda  #<$52
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:801   skip3b:
p8l_skip3b
	; source: test_byte_gt.p8:803   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	; source: test_byte_gt.p8:804   fail_byte(83)
	ldy  #>$53
	lda  #<$53
	jsr  p8b_main.p8s_fail_byte
label_asm_90_afterif
	; source: test_byte_gt.p8:807   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	; source: test_byte_gt.p8:808   fail_byte(84)
	ldy  #>$54
	lda  #<$54
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_91_afterif
label_asm_92_else
	; source: test_byte_gt.p8:810   success++
	inc  p8b_main.p8v_success
label_asm_91_afterif
	; source: test_byte_gt.p8:812   x=0
	stz  p8v_x
	; source: test_byte_gt.p8:814   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	sbc  p8v_x
	bmi  p8l_lbl4a
	; source: test_byte_gt.p8:816   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gt.p8:817   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:818   skip4a:
p8l_skip4a
	; source: test_byte_gt.p8:820   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:821   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:823   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gt.p8:824   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:825   skip4b:
p8l_skip4b
	; source: test_byte_gt.p8:827   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	; source: test_byte_gt.p8:828   success++
	inc  p8b_main.p8v_success
label_asm_93_afterif
	; source: test_byte_gt.p8:831   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	; source: test_byte_gt.p8:832   success++
	inc  p8b_main.p8v_success
	bra  label_asm_94_afterif
label_asm_95_else
	; source: test_byte_gt.p8:834   cx16.r0L++
	inc  cx16.r0L
label_asm_94_afterif
	; source: test_byte_gt.p8:837   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	sbc  p8v_x
	bmi  p8l_lbl5a
	; source: test_byte_gt.p8:839   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gt.p8:840   lbl5a:   fail_byte(85)
p8l_lbl5a
	ldy  #>$55
	lda  #<$55
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:841   skip5a:
p8l_skip5a
	; source: test_byte_gt.p8:843   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:844   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:846   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gt.p8:847   lbl5b:   fail_byte(86)
p8l_lbl5b
	ldy  #>$56
	lda  #<$56
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:848   skip5b:
p8l_skip5b
	; source: test_byte_gt.p8:850   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	; source: test_byte_gt.p8:851   fail_byte(87)
	ldy  #>$57
	lda  #<$57
	jsr  p8b_main.p8s_fail_byte
label_asm_96_afterif
	; source: test_byte_gt.p8:854   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	; source: test_byte_gt.p8:855   fail_byte(88)
	ldy  #>$58
	lda  #<$58
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_97_afterif
label_asm_98_else
	; source: test_byte_gt.p8:857   success++
	inc  p8b_main.p8v_success
label_asm_97_afterif
	; source: test_byte_gt.p8:860   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	sbc  p8v_x
	bmi  p8l_lbl6a
	; source: test_byte_gt.p8:862   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_gt.p8:863   lbl6a:   fail_byte(89)
p8l_lbl6a
	ldy  #>$59
	lda  #<$59
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:864   skip6a:
p8l_skip6a
	; source: test_byte_gt.p8:866   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:867   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:869   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gt.p8:870   lbl6b:   fail_byte(90)
p8l_lbl6b
	ldy  #>$5a
	lda  #<$5a
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:871   skip6b:
p8l_skip6b
	; source: test_byte_gt.p8:873   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	; source: test_byte_gt.p8:874   fail_byte(91)
	ldy  #>$5b
	lda  #<$5b
	jsr  p8b_main.p8s_fail_byte
label_asm_99_afterif
	; source: test_byte_gt.p8:877   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	; source: test_byte_gt.p8:878   fail_byte(92)
	ldy  #>$5c
	lda  #<$5c
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_100_afterif
label_asm_101_else
	; source: test_byte_gt.p8:880   success++
	inc  p8b_main.p8v_success
label_asm_100_afterif
	; source: test_byte_gt.p8:882   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gt.p8:884   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	sbc  p8v_x
	bmi  p8l_lbl7a
	; source: test_byte_gt.p8:886   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gt.p8:887   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:888   skip7a:
p8l_skip7a
	; source: test_byte_gt.p8:890   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:891   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:893   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gt.p8:894   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:895   skip7b:
p8l_skip7b
	; source: test_byte_gt.p8:897   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	; source: test_byte_gt.p8:898   success++
	inc  p8b_main.p8v_success
label_asm_102_afterif
	; source: test_byte_gt.p8:901   if x>cx16.r4sL+-1-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  #1
	sec
	...
	; source: test_byte_gt.p8:902   success++
	inc  p8b_main.p8v_success
	bra  label_asm_103_afterif
label_asm_104_else
	; source: test_byte_gt.p8:904   cx16.r0L++
	inc  cx16.r0L
label_asm_103_afterif
	; source: test_byte_gt.p8:907   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	sbc  p8v_x
	bmi  p8l_lbl8a
	; source: test_byte_gt.p8:909   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gt.p8:910   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:911   skip8a:
p8l_skip8a
	; source: test_byte_gt.p8:913   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:914   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:916   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gt.p8:917   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gt.p8:918   skip8b:
p8l_skip8b
	; source: test_byte_gt.p8:920   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	; source: test_byte_gt.p8:921   success++
	inc  p8b_main.p8v_success
label_asm_105_afterif
	; source: test_byte_gt.p8:924   if x>cx16.r4sL+0-cx16.r5sL
	lda  cx16.r4sL
	sec
	sbc  cx16.r5sL
	sec
	...
	; source: test_byte_gt.p8:925   success++
	inc  p8b_main.p8v_success
...
label_asm_106_afterif
	; source: test_byte_gt.p8:930   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	sbc  p8v_x
	bmi  p8l_lbl9a
	; source: test_byte_gt.p8:932   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gt.p8:933   lbl9a:   fail_byte(93)
p8l_lbl9a
	ldy  #>$5d
	lda  #<$5d
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:934   skip9a:
p8l_skip9a
	; source: test_byte_gt.p8:936   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gt.p8:937   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gt.p8:939   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gt.p8:940   lbl9b:   fail_byte(94)
p8l_lbl9b
	ldy  #>$5e
	lda  #<$5e
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gt.p8:941   skip9b:
p8l_skip9b
	; source: test_byte_gt.p8:943   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	; source: test_byte_gt.p8:944   fail_byte(95)
	ldy  #>$5f
	lda  #<$5f
	jsr  p8b_main.p8s_fail_byte
label_asm_108_afterif
	; source: test_byte_gt.p8:947   if x>cx16.r4sL+1-cx16.r5sL
	lda  cx16.r4sL
	clc
	adc  #1
	sec
	...
	; source: test_byte_gt.p8:948   fail_byte(96)
	ldy  #>$60
	lda  #<$60
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_109_afterif
label_asm_110_else
	; source: test_byte_gt.p8:950   success++
	inc  p8b_main.p8v_success
label_asm_109_afterif
	; source: test_byte_gt.p8:952   verify_success(18)
	lda  #$12
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_gt.p8:735   sub test_cmp_expr() {
; variables
