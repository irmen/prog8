; w65c02 assembly code for 'test_uword_splitw_lte'
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: test_uword_splitw_lte.p8:8   main {
...
p8v_datatype	; PETSCII:"uword"
	...
	; source: test_uword_splitw_lte.p8:9   uword success = 0
	; source: test_uword_splitw_lte.p8:10   str datatype = "uword"
	; source: test_uword_splitw_lte.p8:11   uword @shared comparison
	; source: test_uword_splitw_lte.p8:13   sub start() {
...
; statements
	...
	lda  #13
	jsr  txt.chrout
	; source: test_uword_splitw_lte.p8:17   test_stack.test()
	jsr  test_stack.test
	; source: test_uword_splitw_lte.p8:18   txt.print("\n<=array[]: ")
	ldy  #>prog8_interned_strings.string_2
	lda  #<prog8_interned_strings.string_2
	jsr  txt.print
	; source: test_uword_splitw_lte.p8:19   test_cmp_array()
	jsr  p8b_main.p8s_test_cmp_array
	; source: test_uword_splitw_lte.p8:20   test_stack.test()
	jmp  test_stack.test
	; source: test_uword_splitw_lte.p8:13   sub start() {
; variables
	.section BSS
	...
	.pend
	; source: test_uword_splitw_lte.p8:23   sub verify_success(uword expected) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_expected+1
; statements
	; source: test_uword_splitw_lte.p8:24   if success==expected {
	...
	bne  label_asm_2_else
	; source: test_uword_splitw_lte.p8:25   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_uword_splitw_lte.p8:27   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_4
	lda  #<prog8_interned_strings.string_4
	jsr  txt.print
	; source: test_uword_splitw_lte.p8:28   txt.print_uw(success)
	ldy  p8b_main.p8v_success+1
	lda  p8b_main.p8v_success
	jsr  txt.print_uw
	; source: test_uword_splitw_lte.p8:29   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_5
	lda  #<prog8_interned_strings.string_5
	jsr  txt.print
	; source: test_uword_splitw_lte.p8:30   txt.print_uw(expected)
	ldy  p8v_expected+1
	lda  p8v_expected
	jsr  txt.print_uw
label_asm_1_afterif
...
p8v_expected	.word  ?
	.send BSS
	.pend
	; source: test_uword_splitw_lte.p8:40   sub fail_uword(uword idx) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_idx+1
; statements
	; source: test_uword_splitw_lte.p8:41   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_6
	lda  #<prog8_interned_strings.string_6
	jsr  txt.print
	; source: test_uword_splitw_lte.p8:42   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_uword_splitw_lte.p8:43   txt.print(" **")
...
p8v_idx	.word  ?
	.send BSS
	.pend
	; source: test_uword_splitw_lte.p8:47   sub test_cmp_array() {

p8s_test_cmp_array	.proc
; statements
	; source: test_uword_splitw_lte.p8:48   uword @shared x
	; source: test_uword_splitw_lte.p8:49   uword[] @split values = [0, 0]
	; source: test_uword_splitw_lte.p8:50   uword[] @split sources = [0, 0]
	; source: test_uword_splitw_lte.p8:48   uword @shared x
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_splitw_lte.p8:51   success = 0
	stz  p8b_main.p8v_success
	stz  p8b_main.p8v_success+1
	; source: test_uword_splitw_lte.p8:52   x=0
	stz  p8v_x
	stz  p8v_x+1
	; source: test_uword_splitw_lte.p8:53   sources[1]=0
	ldy  #1
	lda  #0
	sta  p8v_sources_lsb,y
	sta  p8v_sources_msb,y
	; source: test_uword_splitw_lte.p8:54   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:56   if x<=values[1]
	...
	sbc  p8v_x+1
	bcs  p8l_lbl1a
	; source: test_uword_splitw_lte.p8:58   goto skip1a
	bra  p8l_skip1a
	; source: test_uword_splitw_lte.p8:59   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:60   skip1a:
p8l_skip1a
	; source: test_uword_splitw_lte.p8:62   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:63   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:65   goto skip1b
	bra  p8l_skip1b
	; source: test_uword_splitw_lte.p8:66   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:67   skip1b:
p8l_skip1b
	; source: test_uword_splitw_lte.p8:69   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcc  label_asm_3_afterif
	; source: test_uword_splitw_lte.p8:70   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_3_afterif
	; source: test_uword_splitw_lte.p8:73   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcc  label_asm_5_else
	; source: test_uword_splitw_lte.p8:74   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_5_else
	; source: test_uword_splitw_lte.p8:76   cx16.r0L++
	inc  cx16.r0L
label_asm_4_afterif
	; source: test_uword_splitw_lte.p8:79   if sources[1]<=values[1]
	...
	bcs  p8l_lbl1c
	; source: test_uword_splitw_lte.p8:81   goto skip1c
	bra  p8l_skip1c
	; source: test_uword_splitw_lte.p8:82   lbl1c:   success++
p8l_lbl1c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:83   skip1c:
p8l_skip1c
	; source: test_uword_splitw_lte.p8:85   cx16.r3 = &lbl1d
	lda  #<p8l_lbl1d
	ldy  #>p8l_lbl1d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:86   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:88   goto skip1d
	bra  p8l_skip1d
	; source: test_uword_splitw_lte.p8:89   lbl1d:   success++
p8l_lbl1d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:90   skip1d:
p8l_skip1d
	; source: test_uword_splitw_lte.p8:92   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:93   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_6_afterif
	; source: test_uword_splitw_lte.p8:96   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:97   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_8_else
	; source: test_uword_splitw_lte.p8:99   cx16.r0L++
	inc  cx16.r0L
label_asm_7_afterif
	; source: test_uword_splitw_lte.p8:101   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:103   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl2a
	; source: test_uword_splitw_lte.p8:105   goto skip2a
	bra  p8l_skip2a
	; source: test_uword_splitw_lte.p8:106   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:107   skip2a:
p8l_skip2a
	; source: test_uword_splitw_lte.p8:109   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:110   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:112   goto skip2b
	bra  p8l_skip2b
	; source: test_uword_splitw_lte.p8:113   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:114   skip2b:
p8l_skip2b
	; source: test_uword_splitw_lte.p8:116   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:117   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_9_afterif
	; source: test_uword_splitw_lte.p8:120   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:121   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_11_else
	; source: test_uword_splitw_lte.p8:123   cx16.r0L++
	inc  cx16.r0L
label_asm_10_afterif
	; source: test_uword_splitw_lte.p8:126   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl2c
	; source: test_uword_splitw_lte.p8:128   goto skip2c
	bra  p8l_skip2c
	; source: test_uword_splitw_lte.p8:129   lbl2c:   success++
p8l_lbl2c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:130   skip2c:
p8l_skip2c
	; source: test_uword_splitw_lte.p8:132   cx16.r3 = &lbl2d
	lda  #<p8l_lbl2d
	ldy  #>p8l_lbl2d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:133   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:135   goto skip2d
	bra  p8l_skip2d
	; source: test_uword_splitw_lte.p8:136   lbl2d:   success++
p8l_lbl2d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:137   skip2d:
p8l_skip2d
	; source: test_uword_splitw_lte.p8:139   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:140   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_12_afterif
	; source: test_uword_splitw_lte.p8:143   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:144   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_14_else
	; source: test_uword_splitw_lte.p8:146   cx16.r0L++
	inc  cx16.r0L
label_asm_13_afterif
	; source: test_uword_splitw_lte.p8:148   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:150   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl3a
	; source: test_uword_splitw_lte.p8:152   goto skip3a
	bra  p8l_skip3a
	; source: test_uword_splitw_lte.p8:153   lbl3a:   success++
p8l_lbl3a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:154   skip3a:
p8l_skip3a
	; source: test_uword_splitw_lte.p8:156   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:157   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:159   goto skip3b
	bra  p8l_skip3b
	; source: test_uword_splitw_lte.p8:160   lbl3b:   success++
p8l_lbl3b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:161   skip3b:
p8l_skip3b
	; source: test_uword_splitw_lte.p8:163   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:164   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_15_afterif
	; source: test_uword_splitw_lte.p8:167   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:168   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_17_else
	; source: test_uword_splitw_lte.p8:170   cx16.r0L++
	inc  cx16.r0L
label_asm_16_afterif
	; source: test_uword_splitw_lte.p8:173   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl3c
	; source: test_uword_splitw_lte.p8:175   goto skip3c
	bra  p8l_skip3c
	; source: test_uword_splitw_lte.p8:176   lbl3c:   success++
p8l_lbl3c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:177   skip3c:
p8l_skip3c
	; source: test_uword_splitw_lte.p8:179   cx16.r3 = &lbl3d
	lda  #<p8l_lbl3d
	ldy  #>p8l_lbl3d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:180   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:182   goto skip3d
	bra  p8l_skip3d
	; source: test_uword_splitw_lte.p8:183   lbl3d:   success++
p8l_lbl3d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:184   skip3d:
p8l_skip3d
	; source: test_uword_splitw_lte.p8:186   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:187   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_18_afterif
	; source: test_uword_splitw_lte.p8:190   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:191   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_20_else
	; source: test_uword_splitw_lte.p8:193   cx16.r0L++
	inc  cx16.r0L
label_asm_19_afterif
	; source: test_uword_splitw_lte.p8:195   values[1]=65535
	ldy  #1
	lda  #<$ffff
	sta  p8v_values_lsb,y
	lda  #>$ffff
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:197   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl4a
	; source: test_uword_splitw_lte.p8:199   goto skip4a
	bra  p8l_skip4a
	; source: test_uword_splitw_lte.p8:200   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:201   skip4a:
p8l_skip4a
	; source: test_uword_splitw_lte.p8:203   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:204   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:206   goto skip4b
	bra  p8l_skip4b
	; source: test_uword_splitw_lte.p8:207   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:208   skip4b:
p8l_skip4b
	; source: test_uword_splitw_lte.p8:210   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:211   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_21_afterif
	; source: test_uword_splitw_lte.p8:214   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:215   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_22_afterif
	; source: test_uword_splitw_lte.p8:220   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl4c
	; source: test_uword_splitw_lte.p8:222   goto skip4c
	bra  p8l_skip4c
	; source: test_uword_splitw_lte.p8:223   lbl4c:   success++
p8l_lbl4c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:224   skip4c:
p8l_skip4c
	; source: test_uword_splitw_lte.p8:226   cx16.r3 = &lbl4d
	lda  #<p8l_lbl4d
	ldy  #>p8l_lbl4d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:227   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:229   goto skip4d
	bra  p8l_skip4d
	; source: test_uword_splitw_lte.p8:230   lbl4d:   success++
p8l_lbl4d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:231   skip4d:
p8l_skip4d
	; source: test_uword_splitw_lte.p8:233   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:234   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_24_afterif
	; source: test_uword_splitw_lte.p8:237   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:238   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_26_else
	; source: test_uword_splitw_lte.p8:240   cx16.r0L++
	inc  cx16.r0L
label_asm_25_afterif
	; source: test_uword_splitw_lte.p8:242   x=1
	lda  #<1
	ldy  #>1
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_splitw_lte.p8:243   sources[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_sources_lsb,y
	lda  #>1
	sta  p8v_sources_msb,y
	; source: test_uword_splitw_lte.p8:244   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:246   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl5a
	; source: test_uword_splitw_lte.p8:248   goto skip5a
	bra  p8l_skip5a
	; source: test_uword_splitw_lte.p8:249   lbl5a:   fail_uword(1)
p8l_lbl5a
	ldy  #>1
	lda  #<1
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:250   skip5a:
p8l_skip5a
	; source: test_uword_splitw_lte.p8:252   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:253   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:255   goto skip5b
	bra  p8l_skip5b
	; source: test_uword_splitw_lte.p8:256   lbl5b:   fail_uword(2)
p8l_lbl5b
	ldy  #>2
	lda  #<2
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:257   skip5b:
p8l_skip5b
	; source: test_uword_splitw_lte.p8:259   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:260   fail_uword(3)
	ldy  #>3
	lda  #<3
	jsr  p8b_main.p8s_fail_uword
label_asm_27_afterif
	; source: test_uword_splitw_lte.p8:263   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:264   fail_uword(4)
	ldy  #>4
	lda  #<4
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_28_afterif
label_asm_29_else
	; source: test_uword_splitw_lte.p8:266   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_28_afterif
	; source: test_uword_splitw_lte.p8:269   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl5c
	; source: test_uword_splitw_lte.p8:271   goto skip5c
	bra  p8l_skip5c
	; source: test_uword_splitw_lte.p8:272   lbl5c:   fail_uword(5)
p8l_lbl5c
	ldy  #>5
	lda  #<5
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:273   skip5c:
p8l_skip5c
	; source: test_uword_splitw_lte.p8:275   cx16.r3 = &lbl5d
	lda  #<p8l_lbl5d
	ldy  #>p8l_lbl5d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:276   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:278   goto skip5d
	bra  p8l_skip5d
	; source: test_uword_splitw_lte.p8:279   lbl5d:   fail_uword(6)
p8l_lbl5d
	ldy  #>6
	lda  #<6
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:280   skip5d:
p8l_skip5d
	; source: test_uword_splitw_lte.p8:282   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:283   fail_uword(7)
	ldy  #>7
	lda  #<7
	jsr  p8b_main.p8s_fail_uword
label_asm_30_afterif
	; source: test_uword_splitw_lte.p8:286   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:287   fail_uword(8)
	ldy  #>8
	lda  #<8
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_31_afterif
label_asm_32_else
	; source: test_uword_splitw_lte.p8:289   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_31_afterif
	; source: test_uword_splitw_lte.p8:291   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:293   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl6a
	; source: test_uword_splitw_lte.p8:295   goto skip6a
	bra  p8l_skip6a
	; source: test_uword_splitw_lte.p8:296   lbl6a:   success++
p8l_lbl6a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:297   skip6a:
p8l_skip6a
	; source: test_uword_splitw_lte.p8:299   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:300   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:302   goto skip6b
	bra  p8l_skip6b
	; source: test_uword_splitw_lte.p8:303   lbl6b:   success++
p8l_lbl6b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:304   skip6b:
p8l_skip6b
	; source: test_uword_splitw_lte.p8:306   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:307   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_33_afterif
	; source: test_uword_splitw_lte.p8:310   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:311   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_35_else
	; source: test_uword_splitw_lte.p8:313   cx16.r0L++
	inc  cx16.r0L
label_asm_34_afterif
	; source: test_uword_splitw_lte.p8:316   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl6c
	; source: test_uword_splitw_lte.p8:318   goto skip6c
	bra  p8l_skip6c
	; source: test_uword_splitw_lte.p8:319   lbl6c:   success++
p8l_lbl6c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:320   skip6c:
p8l_skip6c
	; source: test_uword_splitw_lte.p8:322   cx16.r3 = &lbl6d
	lda  #<p8l_lbl6d
	ldy  #>p8l_lbl6d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:323   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:325   goto skip6d
	bra  p8l_skip6d
	; source: test_uword_splitw_lte.p8:326   lbl6d:   success++
p8l_lbl6d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:327   skip6d:
p8l_skip6d
	; source: test_uword_splitw_lte.p8:329   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:330   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_36_afterif
	; source: test_uword_splitw_lte.p8:333   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:334   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_38_else
	; source: test_uword_splitw_lte.p8:336   cx16.r0L++
	inc  cx16.r0L
label_asm_37_afterif
	; source: test_uword_splitw_lte.p8:338   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:340   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl7a
	; source: test_uword_splitw_lte.p8:342   goto skip7a
	bra  p8l_skip7a
	; source: test_uword_splitw_lte.p8:343   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:344   skip7a:
p8l_skip7a
	; source: test_uword_splitw_lte.p8:346   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:347   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:349   goto skip7b
	bra  p8l_skip7b
	; source: test_uword_splitw_lte.p8:350   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:351   skip7b:
p8l_skip7b
	; source: test_uword_splitw_lte.p8:353   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:354   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_39_afterif
	; source: test_uword_splitw_lte.p8:357   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:358   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_41_else
	; source: test_uword_splitw_lte.p8:360   cx16.r0L++
	inc  cx16.r0L
label_asm_40_afterif
	; source: test_uword_splitw_lte.p8:363   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl7c
	; source: test_uword_splitw_lte.p8:365   goto skip7c
	bra  p8l_skip7c
	; source: test_uword_splitw_lte.p8:366   lbl7c:   success++
p8l_lbl7c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:367   skip7c:
p8l_skip7c
	; source: test_uword_splitw_lte.p8:369   cx16.r3 = &lbl7d
	lda  #<p8l_lbl7d
	ldy  #>p8l_lbl7d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:370   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:372   goto skip7d
	bra  p8l_skip7d
	; source: test_uword_splitw_lte.p8:373   lbl7d:   success++
p8l_lbl7d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:374   skip7d:
p8l_skip7d
	; source: test_uword_splitw_lte.p8:376   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:377   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_42_afterif
	; source: test_uword_splitw_lte.p8:380   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:381   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_43_afterif
	; source: test_uword_splitw_lte.p8:385   values[1]=65535
	ldy  #1
	lda  #<$ffff
	sta  p8v_values_lsb,y
	lda  #>$ffff
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:387   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl8a
	; source: test_uword_splitw_lte.p8:389   goto skip8a
	bra  p8l_skip8a
	; source: test_uword_splitw_lte.p8:390   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:391   skip8a:
p8l_skip8a
	; source: test_uword_splitw_lte.p8:393   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:394   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:396   goto skip8b
	bra  p8l_skip8b
	; source: test_uword_splitw_lte.p8:397   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:398   skip8b:
p8l_skip8b
	; source: test_uword_splitw_lte.p8:400   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:401   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_45_afterif
	; source: test_uword_splitw_lte.p8:404   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:405   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_47_else
	; source: test_uword_splitw_lte.p8:407   cx16.r0L++
	inc  cx16.r0L
label_asm_46_afterif
	; source: test_uword_splitw_lte.p8:410   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl8c
	; source: test_uword_splitw_lte.p8:412   goto skip8c
	bra  p8l_skip8c
	; source: test_uword_splitw_lte.p8:413   lbl8c:   success++
p8l_lbl8c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:414   skip8c:
p8l_skip8c
	; source: test_uword_splitw_lte.p8:416   cx16.r3 = &lbl8d
	lda  #<p8l_lbl8d
	ldy  #>p8l_lbl8d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:417   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:419   goto skip8d
	bra  p8l_skip8d
	; source: test_uword_splitw_lte.p8:420   lbl8d:   success++
p8l_lbl8d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:421   skip8d:
p8l_skip8d
	; source: test_uword_splitw_lte.p8:423   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:424   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_48_afterif
	; source: test_uword_splitw_lte.p8:427   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:428   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_50_else
	; source: test_uword_splitw_lte.p8:430   cx16.r0L++
	inc  cx16.r0L
label_asm_49_afterif
	; source: test_uword_splitw_lte.p8:432   x=30464
	lda  #<$7700
	ldy  #>$7700
	sta  p8v_x
	sty  p8v_x+1
	
	; source: test_uword_splitw_lte.p8:433   sources[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_sources_lsb,y
	lda  #>$7700
	sta  p8v_sources_msb,y
	; source: test_uword_splitw_lte.p8:434   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:436   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl9a
	; source: test_uword_splitw_lte.p8:438   goto skip9a
	bra  p8l_skip9a
	; source: test_uword_splitw_lte.p8:439   lbl9a:   fail_uword(9)
p8l_lbl9a
	ldy  #>9
	lda  #<9
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:440   skip9a:
p8l_skip9a
	; source: test_uword_splitw_lte.p8:442   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:443   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:445   goto skip9b
	bra  p8l_skip9b
	; source: test_uword_splitw_lte.p8:446   lbl9b:   fail_uword(10)
p8l_lbl9b
	ldy  #>10
	lda  #<10
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:447   skip9b:
p8l_skip9b
	; source: test_uword_splitw_lte.p8:449   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:450   fail_uword(11)
	ldy  #>11
	lda  #<11
	jsr  p8b_main.p8s_fail_uword
label_asm_51_afterif
	; source: test_uword_splitw_lte.p8:453   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:454   fail_uword(12)
	ldy  #>12
	lda  #<12
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_52_afterif
label_asm_53_else
	; source: test_uword_splitw_lte.p8:456   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_52_afterif
	; source: test_uword_splitw_lte.p8:459   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl9c
	; source: test_uword_splitw_lte.p8:461   goto skip9c
	bra  p8l_skip9c
	; source: test_uword_splitw_lte.p8:462   lbl9c:   fail_uword(13)
p8l_lbl9c
	ldy  #>13
	lda  #<13
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:463   skip9c:
p8l_skip9c
	; source: test_uword_splitw_lte.p8:465   cx16.r3 = &lbl9d
	lda  #<p8l_lbl9d
	ldy  #>p8l_lbl9d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:466   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:468   goto skip9d
	bra  p8l_skip9d
	; source: test_uword_splitw_lte.p8:469   lbl9d:   fail_uword(14)
p8l_lbl9d
	ldy  #>14
	lda  #<14
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:470   skip9d:
p8l_skip9d
	; source: test_uword_splitw_lte.p8:472   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:473   fail_uword(15)
	ldy  #>15
	lda  #<15
	jsr  p8b_main.p8s_fail_uword
label_asm_54_afterif
	; source: test_uword_splitw_lte.p8:476   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:477   fail_uword(16)
	ldy  #>$10
	lda  #<$10
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_55_afterif
label_asm_56_else
	; source: test_uword_splitw_lte.p8:479   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_55_afterif
	; source: test_uword_splitw_lte.p8:481   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:483   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl10a
	; source: test_uword_splitw_lte.p8:485   goto skip10a
	bra  p8l_skip10a
	; source: test_uword_splitw_lte.p8:486   lbl10a:   fail_uword(17)
p8l_lbl10a
	ldy  #>$11
	lda  #<$11
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:487   skip10a:
p8l_skip10a
	; source: test_uword_splitw_lte.p8:489   cx16.r3 = &lbl10b
	lda  #<p8l_lbl10b
	ldy  #>p8l_lbl10b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:490   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:492   goto skip10b
	bra  p8l_skip10b
	; source: test_uword_splitw_lte.p8:493   lbl10b:   fail_uword(18)
p8l_lbl10b
	ldy  #>$12
	lda  #<$12
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:494   skip10b:
p8l_skip10b
	; source: test_uword_splitw_lte.p8:496   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:497   fail_uword(19)
	ldy  #>$13
	lda  #<$13
	jsr  p8b_main.p8s_fail_uword
label_asm_57_afterif
	; source: test_uword_splitw_lte.p8:500   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:501   fail_uword(20)
	ldy  #>$14
	lda  #<$14
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_58_afterif
label_asm_59_else
	; source: test_uword_splitw_lte.p8:503   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_58_afterif
	; source: test_uword_splitw_lte.p8:506   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl10c
	; source: test_uword_splitw_lte.p8:508   goto skip10c
	bra  p8l_skip10c
	; source: test_uword_splitw_lte.p8:509   lbl10c:   fail_uword(21)
p8l_lbl10c
	ldy  #>$15
	lda  #<$15
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:510   skip10c:
p8l_skip10c
	; source: test_uword_splitw_lte.p8:512   cx16.r3 = &lbl10d
	lda  #<p8l_lbl10d
	ldy  #>p8l_lbl10d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:513   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:515   goto skip10d
	bra  p8l_skip10d
	; source: test_uword_splitw_lte.p8:516   lbl10d:   fail_uword(22)
p8l_lbl10d
	ldy  #>$16
	lda  #<$16
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:517   skip10d:
p8l_skip10d
	; source: test_uword_splitw_lte.p8:519   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:520   fail_uword(23)
	ldy  #>$17
	lda  #<$17
	jsr  p8b_main.p8s_fail_uword
label_asm_60_afterif
	; source: test_uword_splitw_lte.p8:523   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:524   fail_uword(24)
	ldy  #>$18
	lda  #<$18
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_61_afterif
label_asm_62_else
	; source: test_uword_splitw_lte.p8:526   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_61_afterif
	; source: test_uword_splitw_lte.p8:528   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:530   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl11a
	; source: test_uword_splitw_lte.p8:532   goto skip11a
	bra  p8l_skip11a
	; source: test_uword_splitw_lte.p8:533   lbl11a:   success++
p8l_lbl11a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:534   skip11a:
p8l_skip11a
	; source: test_uword_splitw_lte.p8:536   cx16.r3 = &lbl11b
	lda  #<p8l_lbl11b
	ldy  #>p8l_lbl11b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:537   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:539   goto skip11b
	bra  p8l_skip11b
	; source: test_uword_splitw_lte.p8:540   lbl11b:   success++
p8l_lbl11b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:541   skip11b:
p8l_skip11b
	; source: test_uword_splitw_lte.p8:543   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:544   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_63_afterif
	; source: test_uword_splitw_lte.p8:547   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:548   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_64_afterif
	; source: test_uword_splitw_lte.p8:553   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl11c
	; source: test_uword_splitw_lte.p8:555   goto skip11c
	bra  p8l_skip11c
	; source: test_uword_splitw_lte.p8:556   lbl11c:   success++
p8l_lbl11c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:557   skip11c:
p8l_skip11c
	; source: test_uword_splitw_lte.p8:559   cx16.r3 = &lbl11d
	lda  #<p8l_lbl11d
	ldy  #>p8l_lbl11d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:560   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:562   goto skip11d
	bra  p8l_skip11d
	; source: test_uword_splitw_lte.p8:563   lbl11d:   success++
p8l_lbl11d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:564   skip11d:
p8l_skip11d
	; source: test_uword_splitw_lte.p8:566   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:567   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_66_afterif
	; source: test_uword_splitw_lte.p8:570   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:571   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_68_else
	; source: test_uword_splitw_lte.p8:573   cx16.r0L++
	inc  cx16.r0L
label_asm_67_afterif
	; source: test_uword_splitw_lte.p8:575   values[1]=65535
	ldy  #1
	lda  #<$ffff
	sta  p8v_values_lsb,y
	lda  #>$ffff
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:577   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl12a
	; source: test_uword_splitw_lte.p8:579   goto skip12a
	bra  p8l_skip12a
	; source: test_uword_splitw_lte.p8:580   lbl12a:   success++
p8l_lbl12a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:581   skip12a:
p8l_skip12a
	; source: test_uword_splitw_lte.p8:583   cx16.r3 = &lbl12b
	lda  #<p8l_lbl12b
	ldy  #>p8l_lbl12b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:584   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:586   goto skip12b
	bra  p8l_skip12b
	; source: test_uword_splitw_lte.p8:587   lbl12b:   success++
p8l_lbl12b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:588   skip12b:
p8l_skip12b
	; source: test_uword_splitw_lte.p8:590   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:591   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_69_afterif
	; source: test_uword_splitw_lte.p8:594   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:595   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_71_else
	; source: test_uword_splitw_lte.p8:597   cx16.r0L++
	inc  cx16.r0L
label_asm_70_afterif
	; source: test_uword_splitw_lte.p8:600   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl12c
	; source: test_uword_splitw_lte.p8:602   goto skip12c
	bra  p8l_skip12c
	; source: test_uword_splitw_lte.p8:603   lbl12c:   success++
p8l_lbl12c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:604   skip12c:
p8l_skip12c
	; source: test_uword_splitw_lte.p8:606   cx16.r3 = &lbl12d
	lda  #<p8l_lbl12d
	ldy  #>p8l_lbl12d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:607   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:609   goto skip12d
	bra  p8l_skip12d
	; source: test_uword_splitw_lte.p8:610   lbl12d:   success++
p8l_lbl12d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:611   skip12d:
p8l_skip12d
	; source: test_uword_splitw_lte.p8:613   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:614   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_72_afterif
	; source: test_uword_splitw_lte.p8:617   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:618   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_74_else
	; source: test_uword_splitw_lte.p8:620   cx16.r0L++
	inc  cx16.r0L
label_asm_73_afterif
	; source: test_uword_splitw_lte.p8:622   x=65535
	lda  #$ff
	sta  p8v_x
	sta  p8v_x+1
	
	; source: test_uword_splitw_lte.p8:623   sources[1]=65535
	ldy  #1
	lda  #<$ffff
	sta  p8v_sources_lsb,y
	lda  #>$ffff
	sta  p8v_sources_msb,y
	; source: test_uword_splitw_lte.p8:624   values[1]=0
	ldy  #1
	lda  #0
	sta  p8v_values_lsb,y
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:626   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl13a
	; source: test_uword_splitw_lte.p8:628   goto skip13a
	bra  p8l_skip13a
	; source: test_uword_splitw_lte.p8:629   lbl13a:   fail_uword(25)
p8l_lbl13a
	ldy  #>$19
	lda  #<$19
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:630   skip13a:
p8l_skip13a
	; source: test_uword_splitw_lte.p8:632   cx16.r3 = &lbl13b
	lda  #<p8l_lbl13b
	ldy  #>p8l_lbl13b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:633   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:635   goto skip13b
	bra  p8l_skip13b
	; source: test_uword_splitw_lte.p8:636   lbl13b:   fail_uword(26)
p8l_lbl13b
	ldy  #>$1a
	lda  #<$1a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:637   skip13b:
p8l_skip13b
	; source: test_uword_splitw_lte.p8:639   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:640   fail_uword(27)
	ldy  #>$1b
	lda  #<$1b
	jsr  p8b_main.p8s_fail_uword
label_asm_75_afterif
	; source: test_uword_splitw_lte.p8:643   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:644   fail_uword(28)
	ldy  #>$1c
	lda  #<$1c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_76_afterif
label_asm_77_else
	; source: test_uword_splitw_lte.p8:646   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_76_afterif
	; source: test_uword_splitw_lte.p8:649   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl13c
	; source: test_uword_splitw_lte.p8:651   goto skip13c
	bra  p8l_skip13c
	; source: test_uword_splitw_lte.p8:652   lbl13c:   fail_uword(29)
p8l_lbl13c
	ldy  #>$1d
	lda  #<$1d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:653   skip13c:
p8l_skip13c
	; source: test_uword_splitw_lte.p8:655   cx16.r3 = &lbl13d
	lda  #<p8l_lbl13d
	ldy  #>p8l_lbl13d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:656   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:658   goto skip13d
	bra  p8l_skip13d
	; source: test_uword_splitw_lte.p8:659   lbl13d:   fail_uword(30)
p8l_lbl13d
	ldy  #>$1e
	lda  #<$1e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:660   skip13d:
p8l_skip13d
	; source: test_uword_splitw_lte.p8:662   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:663   fail_uword(31)
	ldy  #>$1f
	lda  #<$1f
	jsr  p8b_main.p8s_fail_uword
label_asm_78_afterif
	; source: test_uword_splitw_lte.p8:666   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:667   fail_uword(32)
	ldy  #>$20
	lda  #<$20
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_79_afterif
label_asm_80_else
	; source: test_uword_splitw_lte.p8:669   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_79_afterif
	; source: test_uword_splitw_lte.p8:671   values[1]=1
	ldy  #1
	lda  #<1
	sta  p8v_values_lsb,y
	lda  #>1
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:673   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl14a
	; source: test_uword_splitw_lte.p8:675   goto skip14a
	bra  p8l_skip14a
	; source: test_uword_splitw_lte.p8:676   lbl14a:   fail_uword(33)
p8l_lbl14a
	ldy  #>$21
	lda  #<$21
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:677   skip14a:
p8l_skip14a
	; source: test_uword_splitw_lte.p8:679   cx16.r3 = &lbl14b
	lda  #<p8l_lbl14b
	ldy  #>p8l_lbl14b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:680   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:682   goto skip14b
	bra  p8l_skip14b
	; source: test_uword_splitw_lte.p8:683   lbl14b:   fail_uword(34)
p8l_lbl14b
	ldy  #>$22
	lda  #<$22
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:684   skip14b:
p8l_skip14b
	; source: test_uword_splitw_lte.p8:686   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:687   fail_uword(35)
	ldy  #>$23
	lda  #<$23
	jsr  p8b_main.p8s_fail_uword
label_asm_81_afterif
	; source: test_uword_splitw_lte.p8:690   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:691   fail_uword(36)
	ldy  #>$24
	lda  #<$24
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_82_afterif
label_asm_83_else
	; source: test_uword_splitw_lte.p8:693   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_82_afterif
	; source: test_uword_splitw_lte.p8:696   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl14c
	; source: test_uword_splitw_lte.p8:698   goto skip14c
	bra  p8l_skip14c
	; source: test_uword_splitw_lte.p8:699   lbl14c:   fail_uword(37)
p8l_lbl14c
	ldy  #>$25
	lda  #<$25
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:700   skip14c:
p8l_skip14c
	; source: test_uword_splitw_lte.p8:702   cx16.r3 = &lbl14d
	lda  #<p8l_lbl14d
	ldy  #>p8l_lbl14d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:703   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:705   goto skip14d
	bra  p8l_skip14d
	; source: test_uword_splitw_lte.p8:706   lbl14d:   fail_uword(38)
p8l_lbl14d
	ldy  #>$26
	lda  #<$26
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:707   skip14d:
p8l_skip14d
	; source: test_uword_splitw_lte.p8:709   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:710   fail_uword(39)
	ldy  #>$27
	lda  #<$27
	jsr  p8b_main.p8s_fail_uword
label_asm_84_afterif
	; source: test_uword_splitw_lte.p8:713   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:714   fail_uword(40)
	ldy  #>$28
	lda  #<$28
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_85_afterif
label_asm_86_else
	; source: test_uword_splitw_lte.p8:716   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_85_afterif
	; source: test_uword_splitw_lte.p8:718   values[1]=30464
	ldy  #1
	lda  #<$7700
	sta  p8v_values_lsb,y
	lda  #>$7700
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:720   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl15a
	; source: test_uword_splitw_lte.p8:722   goto skip15a
	bra  p8l_skip15a
	; source: test_uword_splitw_lte.p8:723   lbl15a:   fail_uword(41)
p8l_lbl15a
	ldy  #>$29
	lda  #<$29
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:724   skip15a:
p8l_skip15a
	; source: test_uword_splitw_lte.p8:726   cx16.r3 = &lbl15b
	lda  #<p8l_lbl15b
	ldy  #>p8l_lbl15b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:727   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:729   goto skip15b
	bra  p8l_skip15b
	; source: test_uword_splitw_lte.p8:730   lbl15b:   fail_uword(42)
p8l_lbl15b
	ldy  #>$2a
	lda  #<$2a
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:731   skip15b:
p8l_skip15b
	; source: test_uword_splitw_lte.p8:733   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:734   fail_uword(43)
	ldy  #>$2b
	lda  #<$2b
	jsr  p8b_main.p8s_fail_uword
label_asm_87_afterif
	; source: test_uword_splitw_lte.p8:737   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:738   fail_uword(44)
	ldy  #>$2c
	lda  #<$2c
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_88_afterif
label_asm_89_else
	; source: test_uword_splitw_lte.p8:740   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_88_afterif
	; source: test_uword_splitw_lte.p8:743   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl15c
	; source: test_uword_splitw_lte.p8:745   goto skip15c
	bra  p8l_skip15c
	; source: test_uword_splitw_lte.p8:746   lbl15c:   fail_uword(45)
p8l_lbl15c
	ldy  #>$2d
	lda  #<$2d
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:747   skip15c:
p8l_skip15c
	; source: test_uword_splitw_lte.p8:749   cx16.r3 = &lbl15d
	lda  #<p8l_lbl15d
	ldy  #>p8l_lbl15d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:750   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:752   goto skip15d
	bra  p8l_skip15d
	; source: test_uword_splitw_lte.p8:753   lbl15d:   fail_uword(46)
p8l_lbl15d
	ldy  #>$2e
	lda  #<$2e
	jsr  p8b_main.p8s_fail_uword
	; source: test_uword_splitw_lte.p8:754   skip15d:
p8l_skip15d
	; source: test_uword_splitw_lte.p8:756   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:757   fail_uword(47)
	ldy  #>$2f
	lda  #<$2f
	jsr  p8b_main.p8s_fail_uword
label_asm_90_afterif
	; source: test_uword_splitw_lte.p8:760   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:761   fail_uword(48)
	ldy  #>$30
	lda  #<$30
	jsr  p8b_main.p8s_fail_uword
	bra  label_asm_91_afterif
label_asm_92_else
	; source: test_uword_splitw_lte.p8:763   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_91_afterif
	; source: test_uword_splitw_lte.p8:765   values[1]=65535
	ldy  #1
	lda  #<$ffff
	sta  p8v_values_lsb,y
	lda  #>$ffff
	sta  p8v_values_msb,y
	; source: test_uword_splitw_lte.p8:767   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	sbc  p8v_x+1
	bcs  p8l_lbl16a
	; source: test_uword_splitw_lte.p8:769   goto skip16a
	bra  p8l_skip16a
	; source: test_uword_splitw_lte.p8:770   lbl16a:   success++
p8l_lbl16a
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:771   skip16a:
p8l_skip16a
	; source: test_uword_splitw_lte.p8:773   cx16.r3 = &lbl16b
	lda  #<p8l_lbl16b
	ldy  #>p8l_lbl16b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:774   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:776   goto skip16b
	bra  p8l_skip16b
	; source: test_uword_splitw_lte.p8:777   lbl16b:   success++
p8l_lbl16b
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:778   skip16b:
p8l_skip16b
	; source: test_uword_splitw_lte.p8:780   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:781   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_93_afterif
	; source: test_uword_splitw_lte.p8:784   if x<=values[1]
	lda  p8v_values_lsb+1
	ldy  p8v_values_msb+1
	cmp  p8v_x
	tya
	...
	; source: test_uword_splitw_lte.p8:785   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_95_else
	; source: test_uword_splitw_lte.p8:787   cx16.r0L++
	inc  cx16.r0L
label_asm_94_afterif
	; source: test_uword_splitw_lte.p8:790   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	sbc  P8ZP_SCRATCH_W2+1
	bcs  p8l_lbl16c
	; source: test_uword_splitw_lte.p8:792   goto skip16c
	bra  p8l_skip16c
	; source: test_uword_splitw_lte.p8:793   lbl16c:   success++
p8l_lbl16c
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:794   skip16c:
p8l_skip16c
	; source: test_uword_splitw_lte.p8:796   cx16.r3 = &lbl16d
	lda  #<p8l_lbl16d
	ldy  #>p8l_lbl16d
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_uword_splitw_lte.p8:797   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	jmp  (cx16.r3)
+
	; source: test_uword_splitw_lte.p8:799   goto skip16d
	bra  p8l_skip16d
	; source: test_uword_splitw_lte.p8:800   lbl16d:   success++
p8l_lbl16d
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
	; source: test_uword_splitw_lte.p8:801   skip16d:
p8l_skip16d
	; source: test_uword_splitw_lte.p8:803   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:804   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
label_asm_96_afterif
	; source: test_uword_splitw_lte.p8:807   if sources[1]<=values[1]
	lda  p8v_sources_lsb+1
	ldy  p8v_sources_msb+1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
	...
	; source: test_uword_splitw_lte.p8:808   success++
	inc  p8b_main.p8v_success
	bne  +
	inc  p8b_main.p8v_success+1
+
...
label_asm_98_else
	; source: test_uword_splitw_lte.p8:810   cx16.r0L++
	inc  cx16.r0L
label_asm_97_afterif
	; source: test_uword_splitw_lte.p8:812   verify_success(92)
	ldy  #>$5c
	lda  #<$5c
...
string_7	; PETSCII:" **"
	...
	; source: test_uword_splitw_lte.p8:27   txt.print(" **failed** ")
	; source: test_uword_splitw_lte.p8:29   txt.print(" success, expected ")
	; source: test_uword_splitw_lte.p8:35   txt.print(" **fail#")
	; source: test_uword_splitw_lte.p8:37   txt.print(" **")
	.pend
