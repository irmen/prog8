; w65c02 assembly code for 'test_float_lte'
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: test_float_lte.p8:8   main {
...
p8v_datatype	; PETSCII:"float"
	...
	; source: test_float_lte.p8:9   ubyte success = 0
	; source: test_float_lte.p8:10   str datatype = "float"
	; source: test_float_lte.p8:11   uword @shared comparison
	; source: test_float_lte.p8:13   sub start() {
...
; variables
	...
	.pend
	; source: test_float_lte.p8:29   sub verify_success(ubyte expected) {

p8s_verify_success	.proc
; simple int arg(s) passed via register(s)
	sta  p8v_expected
; statements
	; source: test_float_lte.p8:30   if success==expected {
	lda  p8b_main.p8v_success
	cmp  p8v_expected
	bne  label_asm_2_else
	; source: test_float_lte.p8:31   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_float_lte.p8:33   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_7
	lda  #<prog8_interned_strings.string_7
	jsr  txt.print
	; source: test_float_lte.p8:34   txt.print_ub(success)
	lda  p8b_main.p8v_success
	jsr  txt.print_ub
	; source: test_float_lte.p8:35   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_8
	lda  #<prog8_interned_strings.string_8
	jsr  txt.print
	; source: test_float_lte.p8:36   txt.print_ub(expected)
	lda  p8v_expected
	jsr  txt.print_ub
label_asm_1_afterif
	; source: test_float_lte.p8:29   sub verify_success(ubyte expected) {
...
p8v_expected	.byte  ?
	.send BSS
	.pend
	; source: test_float_lte.p8:64   sub fail_float(uword idx) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_idx+1
; statements
	; source: test_float_lte.p8:65   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_9
	lda  #<prog8_interned_strings.string_9
	jsr  txt.print
	; source: test_float_lte.p8:66   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_float_lte.p8:67   txt.print(" **")
...
p8v_idx	.word  ?
	.send BSS
	.pend
	; source: test_float_lte.p8:71   sub test_cmp_number() {

p8s_test_cmp_number	.proc
; statements
	; source: test_float_lte.p8:72   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_lte.p8:73   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_lte.p8:74   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_lte.p8:76   if x<=0.0
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl1a
	; source: test_float_lte.p8:78   goto skip1a
	bra  p8l_skip1a
	; source: test_float_lte.p8:79   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:80   skip1a:
p8l_skip1a
	; source: test_float_lte.p8:82   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:83   if x<=0.0
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:85   goto skip1b
	bra  p8l_skip1b
	; source: test_float_lte.p8:86   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:87   skip1b:
p8l_skip1b
	; source: test_float_lte.p8:89   if x<=0.0
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:90   success++
	inc  p8b_main.p8v_success
label_asm_3_afterif
	; source: test_float_lte.p8:93   if x<=0.0
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:94   success++
	inc  p8b_main.p8v_success
	bra  label_asm_4_afterif
label_asm_5_else
	; source: test_float_lte.p8:96   cx16.r0L++
	inc  cx16.r0L
label_asm_4_afterif
	; source: test_float_lte.p8:99   if x<=1234.56
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl2a
	; source: test_float_lte.p8:101   goto skip2a
	bra  p8l_skip2a
	; source: test_float_lte.p8:102   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:103   skip2a:
p8l_skip2a
	; source: test_float_lte.p8:105   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:106   if x<=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:108   goto skip2b
	bra  p8l_skip2b
	; source: test_float_lte.p8:109   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:110   skip2b:
p8l_skip2b
	; source: test_float_lte.p8:112   if x<=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:113   success++
	inc  p8b_main.p8v_success
label_asm_6_afterif
	; source: test_float_lte.p8:116   if x<=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:117   success++
	inc  p8b_main.p8v_success
	bra  label_asm_7_afterif
label_asm_8_else
	; source: test_float_lte.p8:119   cx16.r0L++
	inc  cx16.r0L
label_asm_7_afterif
	; source: test_float_lte.p8:121   x=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	; source: test_float_lte.p8:123   if x<=0.0
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl3a
	; source: test_float_lte.p8:125   goto skip3a
	bra  p8l_skip3a
	; source: test_float_lte.p8:126   lbl3a:   fail_float(1)
p8l_lbl3a
	ldy  #>1
	lda  #<1
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:127   skip3a:
p8l_skip3a
	; source: test_float_lte.p8:129   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:130   if x<=0.0
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:132   goto skip3b
	bra  p8l_skip3b
	; source: test_float_lte.p8:133   lbl3b:   fail_float(2)
p8l_lbl3b
	ldy  #>2
	lda  #<2
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:134   skip3b:
p8l_skip3b
	; source: test_float_lte.p8:136   if x<=0.0
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:137   fail_float(3)
	ldy  #>3
	lda  #<3
	jsr  p8b_main.p8s_fail_float
label_asm_9_afterif
	; source: test_float_lte.p8:140   if x<=0.0
	lda  #<prog8_float_const_0
	ldy  #>prog8_float_const_0
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:141   fail_float(4)
	ldy  #>4
	lda  #<4
	jsr  p8b_main.p8s_fail_float
	bra  label_asm_10_afterif
label_asm_11_else
	; source: test_float_lte.p8:143   success++
	inc  p8b_main.p8v_success
label_asm_10_afterif
	; source: test_float_lte.p8:146   if x<=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl4a
	; source: test_float_lte.p8:148   goto skip4a
	bra  p8l_skip4a
	; source: test_float_lte.p8:149   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:150   skip4a:
p8l_skip4a
	; source: test_float_lte.p8:152   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:153   if x<=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:155   goto skip4b
	bra  p8l_skip4b
	; source: test_float_lte.p8:156   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:157   skip4b:
p8l_skip4b
	; source: test_float_lte.p8:159   if x<=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:160   success++
	inc  p8b_main.p8v_success
label_asm_12_afterif
	; source: test_float_lte.p8:163   if x<=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:164   success++
	inc  p8b_main.p8v_success
	bra  label_asm_13_afterif
label_asm_14_else
	; source: test_float_lte.p8:166   cx16.r0L++
	inc  cx16.r0L
label_asm_13_afterif
	; source: test_float_lte.p8:168   verify_success(13)
	lda  #13
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_lte.p8:170   sub test_cmp_var() {

p8s_test_cmp_var	.proc
; statements
	; source: test_float_lte.p8:171   float @shared x, value
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_lte.p8:172   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_lte.p8:173   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_lte.p8:174   value=0.0
	stz  p8v_value
	stz  p8v_value+1
	stz  p8v_value+2
	stz  p8v_value+3
	...
	; source: test_float_lte.p8:176   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl1a
	; source: test_float_lte.p8:178   goto skip1a
	bra  p8l_skip1a
	; source: test_float_lte.p8:179   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:180   skip1a:
p8l_skip1a
	; source: test_float_lte.p8:182   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:183   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:185   goto skip1b
	bra  p8l_skip1b
	; source: test_float_lte.p8:186   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:187   skip1b:
p8l_skip1b
	; source: test_float_lte.p8:189   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:190   success++
	inc  p8b_main.p8v_success
label_asm_15_afterif
	; source: test_float_lte.p8:193   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:194   success++
	inc  p8b_main.p8v_success
	bra  label_asm_16_afterif
label_asm_17_else
	; source: test_float_lte.p8:196   cx16.r0L++
	inc  cx16.r0L
label_asm_16_afterif
	; source: test_float_lte.p8:198   value=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_lte.p8:200   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl2a
	; source: test_float_lte.p8:202   goto skip2a
	bra  p8l_skip2a
	; source: test_float_lte.p8:203   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:204   skip2a:
p8l_skip2a
	; source: test_float_lte.p8:206   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:207   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:209   goto skip2b
	bra  p8l_skip2b
	; source: test_float_lte.p8:210   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:211   skip2b:
p8l_skip2b
	; source: test_float_lte.p8:213   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:214   success++
	inc  p8b_main.p8v_success
label_asm_18_afterif
	; source: test_float_lte.p8:217   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:218   success++
	inc  p8b_main.p8v_success
	bra  label_asm_19_afterif
label_asm_20_else
	; source: test_float_lte.p8:220   cx16.r0L++
	inc  cx16.r0L
label_asm_19_afterif
	; source: test_float_lte.p8:222   x=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_lte.p8:223   value=0.0
	stz  p8v_value
	stz  p8v_value+1
	stz  p8v_value+2
	stz  p8v_value+3
	...
	; source: test_float_lte.p8:225   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl3a
	; source: test_float_lte.p8:227   goto skip3a
	bra  p8l_skip3a
	; source: test_float_lte.p8:228   lbl3a:   fail_float(5)
p8l_lbl3a
	ldy  #>5
	lda  #<5
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:229   skip3a:
p8l_skip3a
	; source: test_float_lte.p8:231   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:232   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:234   goto skip3b
	bra  p8l_skip3b
	; source: test_float_lte.p8:235   lbl3b:   fail_float(6)
p8l_lbl3b
	ldy  #>6
	lda  #<6
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:236   skip3b:
p8l_skip3b
	; source: test_float_lte.p8:238   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:239   fail_float(7)
	ldy  #>7
	lda  #<7
	jsr  p8b_main.p8s_fail_float
label_asm_21_afterif
	; source: test_float_lte.p8:242   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:243   fail_float(8)
	ldy  #>8
	lda  #<8
	jsr  p8b_main.p8s_fail_float
	bra  label_asm_22_afterif
label_asm_23_else
	; source: test_float_lte.p8:245   success++
	inc  p8b_main.p8v_success
label_asm_22_afterif
	; source: test_float_lte.p8:247   value=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_value
	jsr  floats.copy_float
	; source: test_float_lte.p8:249   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl4a
	; source: test_float_lte.p8:251   goto skip4a
	bra  p8l_skip4a
	; source: test_float_lte.p8:252   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:253   skip4a:
p8l_skip4a
	; source: test_float_lte.p8:255   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:256   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:258   goto skip4b
	bra  p8l_skip4b
	; source: test_float_lte.p8:259   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:260   skip4b:
p8l_skip4b
	; source: test_float_lte.p8:262   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:263   success++
	inc  p8b_main.p8v_success
label_asm_24_afterif
	; source: test_float_lte.p8:266   if x<=value
	lda  #<p8v_value
	ldy  #>p8v_value
	sta  P8ZP_SCRATCH_W2
	sty  P8ZP_SCRATCH_W2+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:267   success++
	inc  p8b_main.p8v_success
	bra  label_asm_25_afterif
label_asm_26_else
	; source: test_float_lte.p8:269   cx16.r0L++
	inc  cx16.r0L
label_asm_25_afterif
	; source: test_float_lte.p8:271   verify_success(13)
	lda  #13
	jmp  p8b_main.p8s_verify_success
	; source: test_float_lte.p8:170   sub test_cmp_var() {
; variables
...
p8v_x	.fill  5
	.send BSS
	.pend
	; source: test_float_lte.p8:273   sub test_cmp_array() {

p8s_test_cmp_array	.proc
; statements
	; source: test_float_lte.p8:274   float @shared x
	; source: test_float_lte.p8:275   float[] values = [0, 0]
	; source: test_float_lte.p8:274   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	...
	; source: test_float_lte.p8:276   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_lte.p8:277   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_lte.p8:278   values[1]=0.0
	lda  #1
	ldy  #<p8v_values
	sty  P8ZP_SCRATCH_W1
	ldy  #>p8v_values
	...
	; source: test_float_lte.p8:280   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl1a
	; source: test_float_lte.p8:282   goto skip1a
	bra  p8l_skip1a
	; source: test_float_lte.p8:283   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:284   skip1a:
p8l_skip1a
	; source: test_float_lte.p8:286   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:287   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:289   goto skip1b
	bra  p8l_skip1b
	; source: test_float_lte.p8:290   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:291   skip1b:
p8l_skip1b
	; source: test_float_lte.p8:293   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:294   success++
	inc  p8b_main.p8v_success
label_asm_27_afterif
	; source: test_float_lte.p8:297   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:298   success++
	inc  p8b_main.p8v_success
	bra  label_asm_28_afterif
label_asm_29_else
	; source: test_float_lte.p8:300   cx16.r0L++
	inc  cx16.r0L
label_asm_28_afterif
	; source: test_float_lte.p8:302   values[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_1
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_1
	...
	; source: test_float_lte.p8:304   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl2a
	; source: test_float_lte.p8:306   goto skip2a
	bra  p8l_skip2a
	; source: test_float_lte.p8:307   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:308   skip2a:
p8l_skip2a
	; source: test_float_lte.p8:310   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:311   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:313   goto skip2b
	bra  p8l_skip2b
	; source: test_float_lte.p8:314   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:315   skip2b:
p8l_skip2b
	; source: test_float_lte.p8:317   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:318   success++
	inc  p8b_main.p8v_success
label_asm_30_afterif
	; source: test_float_lte.p8:321   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:322   success++
	inc  p8b_main.p8v_success
	bra  label_asm_31_afterif
label_asm_32_else
	; source: test_float_lte.p8:324   cx16.r0L++
	inc  cx16.r0L
label_asm_31_afterif
	; source: test_float_lte.p8:326   x=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_lte.p8:327   values[1]=0.0
	lda  #1
	ldy  #<p8v_values
	sty  P8ZP_SCRATCH_W1
	ldy  #>p8v_values
	sty  P8ZP_SCRATCH_W1+1
	jsr  floats.set_0_array_float
	; source: test_float_lte.p8:329   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl3a
	; source: test_float_lte.p8:331   goto skip3a
	bra  p8l_skip3a
	; source: test_float_lte.p8:332   lbl3a:   fail_float(9)
p8l_lbl3a
	ldy  #>9
	lda  #<9
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:333   skip3a:
p8l_skip3a
	; source: test_float_lte.p8:335   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:336   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:338   goto skip3b
	bra  p8l_skip3b
	; source: test_float_lte.p8:339   lbl3b:   fail_float(10)
p8l_lbl3b
	ldy  #>10
	lda  #<10
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:340   skip3b:
p8l_skip3b
	; source: test_float_lte.p8:342   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:343   fail_float(11)
	ldy  #>11
	lda  #<11
	jsr  p8b_main.p8s_fail_float
label_asm_33_afterif
	; source: test_float_lte.p8:346   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:347   fail_float(12)
	ldy  #>12
	lda  #<12
	jsr  p8b_main.p8s_fail_float
	bra  label_asm_34_afterif
label_asm_35_else
	; source: test_float_lte.p8:349   success++
	inc  p8b_main.p8v_success
label_asm_34_afterif
	; source: test_float_lte.p8:351   values[1]=1234.56
	lda  #1
	ldy  #<prog8_float_const_1
	sty  P8ZP_SCRATCH_W1
	ldy  #>prog8_float_const_1
	...
	; source: test_float_lte.p8:353   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl4a
	; source: test_float_lte.p8:355   goto skip4a
	bra  p8l_skip4a
	; source: test_float_lte.p8:356   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:357   skip4a:
p8l_skip4a
	; source: test_float_lte.p8:359   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:360   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:362   goto skip4b
	bra  p8l_skip4b
	; source: test_float_lte.p8:363   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:364   skip4b:
p8l_skip4b
	; source: test_float_lte.p8:366   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:367   success++
	inc  p8b_main.p8v_success
label_asm_36_afterif
	; source: test_float_lte.p8:370   if x<=values[1]
	lda  #<(p8v_values+5)
	ldy  #>(p8v_values+5)
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:371   success++
	inc  p8b_main.p8v_success
	bra  label_asm_37_afterif
label_asm_38_else
	; source: test_float_lte.p8:373   cx16.r0L++
	inc  cx16.r0L
label_asm_37_afterif
	; source: test_float_lte.p8:375   verify_success(13)
	lda  #13
	jmp  p8b_main.p8s_verify_success
	; source: test_float_lte.p8:273   sub test_cmp_array() {
; variables
...
; non-zeropage variables
p8v_values
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@5b2b8d86
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@7fef0b40
	.pend
	; source: test_float_lte.p8:377   sub test_cmp_expr() {

p8s_test_cmp_expr	.proc
; statements
	; source: test_float_lte.p8:378   float @shared x
	; source: test_float_lte.p8:381   float @shared f4 = 1.0
	; source: test_float_lte.p8:382   float @shared f5 = 1.0
	; source: test_float_lte.p8:378   float @shared x
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	...
	; source: test_float_lte.p8:379   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_float_lte.p8:380   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_float_lte.p8:383   success = 0
	stz  p8b_main.p8v_success
	; source: test_float_lte.p8:384   x=0.0
	stz  p8v_x
	stz  p8v_x+1
	stz  p8v_x+2
	stz  p8v_x+3
	...
	; source: test_float_lte.p8:386   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl1a
	; source: test_float_lte.p8:388   goto skip1a
	bra  p8l_skip1a
	; source: test_float_lte.p8:389   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:390   skip1a:
p8l_skip1a
	; source: test_float_lte.p8:392   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:393   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:395   goto skip1b
	bra  p8l_skip1b
	; source: test_float_lte.p8:396   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:397   skip1b:
p8l_skip1b
	; source: test_float_lte.p8:399   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:400   success++
	inc  p8b_main.p8v_success
label_asm_39_afterif
	; source: test_float_lte.p8:403   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:404   success++
	inc  p8b_main.p8v_success
	bra  label_asm_40_afterif
label_asm_41_else
	; source: test_float_lte.p8:406   cx16.r0L++
	inc  cx16.r0L
label_asm_40_afterif
	; source: test_float_lte.p8:409   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl2a
	; source: test_float_lte.p8:411   goto skip2a
	bra  p8l_skip2a
	; source: test_float_lte.p8:412   lbl2a:   success++
p8l_lbl2a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:413   skip2a:
p8l_skip2a
	; source: test_float_lte.p8:415   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:416   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:418   goto skip2b
	bra  p8l_skip2b
	; source: test_float_lte.p8:419   lbl2b:   success++
p8l_lbl2b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:420   skip2b:
p8l_skip2b
	; source: test_float_lte.p8:422   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:423   success++
	inc  p8b_main.p8v_success
label_asm_42_afterif
	; source: test_float_lte.p8:426   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:427   success++
	inc  p8b_main.p8v_success
	bra  label_asm_43_afterif
label_asm_44_else
	; source: test_float_lte.p8:429   cx16.r0L++
	inc  cx16.r0L
label_asm_43_afterif
	; source: test_float_lte.p8:431   x=1234.56
	lda  #<prog8_float_const_1
	ldy  #>prog8_float_const_1
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	ldy  #>p8v_x
	jsr  floats.copy_float
	; source: test_float_lte.p8:433   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl3a
	; source: test_float_lte.p8:435   goto skip3a
	bra  p8l_skip3a
	; source: test_float_lte.p8:436   lbl3a:   fail_float(13)
p8l_lbl3a
	ldy  #>13
	lda  #<13
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:437   skip3a:
p8l_skip3a
	; source: test_float_lte.p8:439   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:440   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:442   goto skip3b
	bra  p8l_skip3b
	; source: test_float_lte.p8:443   lbl3b:   fail_float(14)
p8l_lbl3b
	ldy  #>14
	lda  #<14
	jsr  p8b_main.p8s_fail_float
	; source: test_float_lte.p8:444   skip3b:
p8l_skip3b
	; source: test_float_lte.p8:446   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:447   fail_float(15)
	ldy  #>15
	lda  #<15
	jsr  p8b_main.p8s_fail_float
label_asm_45_afterif
	; source: test_float_lte.p8:450   if x<=f4+0.0-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	lda  #<p8v_f4
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:451   fail_float(16)
	ldy  #>$10
	lda  #<$10
	jsr  p8b_main.p8s_fail_float
	bra  label_asm_46_afterif
label_asm_47_else
	; source: test_float_lte.p8:453   success++
	inc  p8b_main.p8v_success
label_asm_46_afterif
	; source: test_float_lte.p8:456   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	bne  p8l_lbl4a
	; source: test_float_lte.p8:458   goto skip4a
	bra  p8l_skip4a
	; source: test_float_lte.p8:459   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:460   skip4a:
p8l_skip4a
	; source: test_float_lte.p8:462   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_float_lte.p8:463   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	...
	jmp  (cx16.r3)
+
	; source: test_float_lte.p8:465   goto skip4b
	bra  p8l_skip4b
	; source: test_float_lte.p8:466   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_float_lte.p8:467   skip4b:
p8l_skip4b
	; source: test_float_lte.p8:469   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:470   success++
	inc  p8b_main.p8v_success
label_asm_48_afterif
	; source: test_float_lte.p8:473   if x<=f4+1234.56-f5
	lda  #<p8v_f5
	ldy  #>p8v_f5
	jsr  floats.MOVFM
	jsr  floats.pushFAC1
...
jsr  floats.vars_lesseq_f
	...
	; source: test_float_lte.p8:474   success++
	inc  p8b_main.p8v_success
	bra  label_asm_49_afterif
label_asm_50_else
	; source: test_float_lte.p8:476   cx16.r0L++
	inc  cx16.r0L
label_asm_49_afterif
	; source: test_float_lte.p8:478   verify_success(13)
	lda  #13
	jmp  p8b_main.p8s_verify_success
	; source: test_float_lte.p8:377   sub test_cmp_expr() {
; variables
...
string_9	; PETSCII:" **fail#"
	...
	; source: test_float_lte.p8:33   txt.print(" **failed** ")
	; source: test_float_lte.p8:35   txt.print(" success, expected ")
	; source: test_float_lte.p8:41   txt.print(" **fail#")
	; source: test_float_lte.p8:43   txt.print(" **")
	.pend
...
prog8_float_const_0	.byte  $00, $00, $00, $00, $00  ; float 0.0
prog8_float_const_1	.byte  $8b, $1a, $51, $eb, $85  ; float 1234.56
prog8_float_const_2	.byte  $81, $00, $00, $00, $00  ; float 1.0
