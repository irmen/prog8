; w65c02 assembly code for 'test_byte_gte'
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: test_byte_gte.p8:8   main {
...
p8v_datatype	; PETSCII:"byte"
	...
	; source: test_byte_gte.p8:9   ubyte success = 0
	; source: test_byte_gte.p8:10   str datatype = "byte"
	; source: test_byte_gte.p8:11   uword @shared comparison
	; source: test_byte_gte.p8:13   sub start() {
...
; variables
	...
	.pend
	; source: test_byte_gte.p8:29   sub verify_success(ubyte expected) {

p8s_verify_success	.proc
; simple int arg(s) passed via register(s)
	sta  p8v_expected
; statements
	; source: test_byte_gte.p8:30   if success==expected {
	lda  p8b_main.p8v_success
	cmp  p8v_expected
	bne  label_asm_2_else
	; source: test_byte_gte.p8:31   txt.print("ok")
	lda  #$4f
	jsr  txt.chrout
	lda  #$4b
	jsr  txt.chrout
...
label_asm_2_else
	; source: test_byte_gte.p8:33   txt.print(" **failed** ")
	ldy  #>prog8_interned_strings.string_7
	lda  #<prog8_interned_strings.string_7
	jsr  txt.print
	; source: test_byte_gte.p8:34   txt.print_ub(success)
	lda  p8b_main.p8v_success
	jsr  txt.print_ub
	; source: test_byte_gte.p8:35   txt.print(" success, expected ")
	ldy  #>prog8_interned_strings.string_8
	lda  #<prog8_interned_strings.string_8
	jsr  txt.print
	; source: test_byte_gte.p8:36   txt.print_ub(expected)
	lda  p8v_expected
	jsr  txt.print_ub
label_asm_1_afterif
	; source: test_byte_gte.p8:29   sub verify_success(ubyte expected) {
...
p8v_expected	.byte  ?
	.send BSS
	.pend
	; source: test_byte_gte.p8:40   sub fail_byte(uword idx) {
...
; simple int arg(s) passed via register(s)
	...
	sty  p8v_idx+1
; statements
	; source: test_byte_gte.p8:41   txt.print(" **fail#")
	ldy  #>prog8_interned_strings.string_9
	lda  #<prog8_interned_strings.string_9
	jsr  txt.print
	; source: test_byte_gte.p8:42   txt.print_uw(idx)
	ldy  p8v_idx+1
	lda  p8v_idx
	jsr  txt.print_uw
	; source: test_byte_gte.p8:43   txt.print(" **")
...
p8v_idx	.word  ?
	.send BSS
	.pend
	; source: test_byte_gte.p8:71   sub test_cmp_number() {

p8s_test_cmp_number	.proc
; statements
	; source: test_byte_gte.p8:72   byte @shared x
	stz  p8v_x
	; source: test_byte_gte.p8:73   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gte.p8:74   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gte.p8:76   if x>=-1
	cmp  #-1
	bpl  p8l_lbl1a
	; source: test_byte_gte.p8:78   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gte.p8:79   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:80   skip1a:
p8l_skip1a
	; source: test_byte_gte.p8:82   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:83   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:85   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gte.p8:86   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:87   skip1b:
p8l_skip1b
	; source: test_byte_gte.p8:89   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  label_asm_3_afterif
	; source: test_byte_gte.p8:90   success++
	inc  p8b_main.p8v_success
label_asm_3_afterif
	; source: test_byte_gte.p8:93   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  label_asm_5_else
	; source: test_byte_gte.p8:94   success++
	inc  p8b_main.p8v_success
	bra  label_asm_4_afterif
label_asm_5_else
	; source: test_byte_gte.p8:96   cx16.r0L++
	inc  cx16.r0L
label_asm_4_afterif
	; source: test_byte_gte.p8:99   if x>=0
	lda  p8v_x
	bpl  p8l_lbl2a
	; source: test_byte_gte.p8:101   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gte.p8:102   lbl2a:   fail_byte(1)
p8l_lbl2a
	ldy  #>1
	lda  #<1
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:103   skip2a:
p8l_skip2a
	; source: test_byte_gte.p8:105   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:106   if x>=0
	lda  p8v_x
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:108   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gte.p8:109   lbl2b:   fail_byte(2)
p8l_lbl2b
	ldy  #>2
	lda  #<2
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:110   skip2b:
p8l_skip2b
	; source: test_byte_gte.p8:112   if x>=0
	lda  p8v_x
	bmi  label_asm_6_afterif
	; source: test_byte_gte.p8:113   fail_byte(3)
	ldy  #>3
	lda  #<3
	jsr  p8b_main.p8s_fail_byte
label_asm_6_afterif
	; source: test_byte_gte.p8:116   if x>=0
	lda  p8v_x
	bmi  label_asm_8_else
	; source: test_byte_gte.p8:117   fail_byte(4)
	ldy  #>4
	lda  #<4
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_7_afterif
label_asm_8_else
	; source: test_byte_gte.p8:119   success++
	inc  p8b_main.p8v_success
label_asm_7_afterif
	; source: test_byte_gte.p8:122   if x>=1
	lda  p8v_x
	beq  +
	bpl  p8l_lbl3a
+
	; source: test_byte_gte.p8:124   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gte.p8:125   lbl3a:   fail_byte(5)
p8l_lbl3a
	ldy  #>5
	lda  #<5
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:126   skip3a:
p8l_skip3a
	; source: test_byte_gte.p8:128   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:129   if x>=1
	lda  p8v_x
	bmi  +
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:131   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gte.p8:132   lbl3b:   fail_byte(6)
p8l_lbl3b
	ldy  #>6
	lda  #<6
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:133   skip3b:
p8l_skip3b
	; source: test_byte_gte.p8:135   if x>=1
	lda  p8v_x
	bmi  label_asm_9_afterif
	beq  label_asm_9_afterif
	; source: test_byte_gte.p8:136   fail_byte(7)
	ldy  #>7
	lda  #<7
	jsr  p8b_main.p8s_fail_byte
label_asm_9_afterif
	; source: test_byte_gte.p8:139   if x>=1
	lda  p8v_x
	bmi  label_asm_11_else
	beq  label_asm_11_else
	; source: test_byte_gte.p8:140   fail_byte(8)
	ldy  #>8
	lda  #<8
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_10_afterif
label_asm_11_else
	; source: test_byte_gte.p8:142   success++
	inc  p8b_main.p8v_success
label_asm_10_afterif
	; source: test_byte_gte.p8:144   x=0
	stz  p8v_x
	; source: test_byte_gte.p8:146   if x>=-1
	lda  p8v_x
	cmp  #-1
	bpl  p8l_lbl4a
	; source: test_byte_gte.p8:148   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gte.p8:149   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:150   skip4a:
p8l_skip4a
	; source: test_byte_gte.p8:152   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:153   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:155   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gte.p8:156   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:157   skip4b:
p8l_skip4b
	; source: test_byte_gte.p8:159   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  label_asm_12_afterif
	; source: test_byte_gte.p8:160   success++
	inc  p8b_main.p8v_success
label_asm_12_afterif
	; source: test_byte_gte.p8:163   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  label_asm_14_else
	; source: test_byte_gte.p8:164   success++
	inc  p8b_main.p8v_success
	bra  label_asm_13_afterif
label_asm_14_else
	; source: test_byte_gte.p8:166   cx16.r0L++
	inc  cx16.r0L
label_asm_13_afterif
	; source: test_byte_gte.p8:169   if x>=0
	lda  p8v_x
	bpl  p8l_lbl5a
	; source: test_byte_gte.p8:171   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gte.p8:172   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:173   skip5a:
p8l_skip5a
	; source: test_byte_gte.p8:175   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:176   if x>=0
	lda  p8v_x
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:178   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gte.p8:179   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:180   skip5b:
p8l_skip5b
	; source: test_byte_gte.p8:182   if x>=0
	lda  p8v_x
	bmi  label_asm_15_afterif
	; source: test_byte_gte.p8:183   success++
	inc  p8b_main.p8v_success
label_asm_15_afterif
	; source: test_byte_gte.p8:186   if x>=0
	lda  p8v_x
	bmi  label_asm_17_else
	; source: test_byte_gte.p8:187   success++
	inc  p8b_main.p8v_success
	bra  label_asm_16_afterif
label_asm_17_else
	; source: test_byte_gte.p8:189   cx16.r0L++
	inc  cx16.r0L
label_asm_16_afterif
	; source: test_byte_gte.p8:192   if x>=1
	lda  p8v_x
	beq  +
	bpl  p8l_lbl6a
+
	; source: test_byte_gte.p8:194   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_gte.p8:195   lbl6a:   fail_byte(9)
p8l_lbl6a
	ldy  #>9
	lda  #<9
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:196   skip6a:
p8l_skip6a
	; source: test_byte_gte.p8:198   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:199   if x>=1
	lda  p8v_x
	bmi  +
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:201   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gte.p8:202   lbl6b:   fail_byte(10)
p8l_lbl6b
	ldy  #>10
	lda  #<10
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:203   skip6b:
p8l_skip6b
	; source: test_byte_gte.p8:205   if x>=1
	lda  p8v_x
	bmi  label_asm_18_afterif
	beq  label_asm_18_afterif
	; source: test_byte_gte.p8:206   fail_byte(11)
	ldy  #>11
	lda  #<11
	jsr  p8b_main.p8s_fail_byte
label_asm_18_afterif
	; source: test_byte_gte.p8:209   if x>=1
	lda  p8v_x
	bmi  label_asm_20_else
	beq  label_asm_20_else
	; source: test_byte_gte.p8:210   fail_byte(12)
	ldy  #>12
	lda  #<12
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_19_afterif
label_asm_20_else
	; source: test_byte_gte.p8:212   success++
	inc  p8b_main.p8v_success
label_asm_19_afterif
	; source: test_byte_gte.p8:214   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gte.p8:216   if x>=-1
	cmp  #-1
	bpl  p8l_lbl7a
	; source: test_byte_gte.p8:218   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gte.p8:219   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:220   skip7a:
p8l_skip7a
	; source: test_byte_gte.p8:222   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:223   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:225   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gte.p8:226   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:227   skip7b:
p8l_skip7b
	; source: test_byte_gte.p8:229   if x>=-1
	lda  p8v_x
	cmp  #-1
	bmi  label_asm_21_afterif
	; source: test_byte_gte.p8:230   success++
	inc  p8b_main.p8v_success
label_asm_21_afterif
	; source: test_byte_gte.p8:233   if x>=-1
	lda  p8v_x
	cmp  #-1
...
label_asm_22_afterif
	; source: test_byte_gte.p8:239   if x>=0
	lda  p8v_x
	bpl  p8l_lbl8a
	; source: test_byte_gte.p8:241   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gte.p8:242   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:243   skip8a:
p8l_skip8a
	; source: test_byte_gte.p8:245   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:246   if x>=0
	lda  p8v_x
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:248   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gte.p8:249   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:250   skip8b:
p8l_skip8b
	; source: test_byte_gte.p8:252   if x>=0
	lda  p8v_x
	bmi  label_asm_24_afterif
	; source: test_byte_gte.p8:253   success++
	inc  p8b_main.p8v_success
label_asm_24_afterif
	; source: test_byte_gte.p8:256   if x>=0
	lda  p8v_x
	bmi  label_asm_26_else
	; source: test_byte_gte.p8:257   success++
	inc  p8b_main.p8v_success
	bra  label_asm_25_afterif
label_asm_26_else
	; source: test_byte_gte.p8:259   cx16.r0L++
	inc  cx16.r0L
label_asm_25_afterif
	; source: test_byte_gte.p8:262   if x>=1
	lda  p8v_x
	beq  +
	bpl  p8l_lbl9a
+
	; source: test_byte_gte.p8:264   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gte.p8:265   lbl9a:   success++
p8l_lbl9a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:266   skip9a:
p8l_skip9a
	; source: test_byte_gte.p8:268   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:269   if x>=1
	lda  p8v_x
	bmi  +
	beq  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:271   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gte.p8:272   lbl9b:   success++
p8l_lbl9b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:273   skip9b:
p8l_skip9b
	; source: test_byte_gte.p8:275   if x>=1
	lda  p8v_x
	bmi  label_asm_27_afterif
	beq  label_asm_27_afterif
	; source: test_byte_gte.p8:276   success++
	inc  p8b_main.p8v_success
label_asm_27_afterif
	; source: test_byte_gte.p8:279   if x>=1
	lda  p8v_x
	bmi  label_asm_29_else
	beq  label_asm_29_else
	; source: test_byte_gte.p8:280   success++
	inc  p8b_main.p8v_success
	bra  label_asm_28_afterif
label_asm_29_else
	; source: test_byte_gte.p8:282   cx16.r0L++
	inc  cx16.r0L
label_asm_28_afterif
	; source: test_byte_gte.p8:284   verify_success(27)
	lda  #$1b
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_gte.p8:286   sub test_cmp_var() {

p8s_test_cmp_var	.proc
; statements
	; source: test_byte_gte.p8:287   byte @shared x, value
	stz  p8v_x
	lda  p8v_x
	sta  p8v_value
	
	; source: test_byte_gte.p8:288   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gte.p8:289   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gte.p8:290   value=-1
	sta  p8v_value
	; source: test_byte_gte.p8:292   if x>=value
	cmp  p8v_value
	bpl  p8l_lbl1a
	; source: test_byte_gte.p8:294   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gte.p8:295   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:296   skip1a:
p8l_skip1a
	; source: test_byte_gte.p8:298   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:299   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:301   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gte.p8:302   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:303   skip1b:
p8l_skip1b
	; source: test_byte_gte.p8:305   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_30_afterif
	; source: test_byte_gte.p8:306   success++
	inc  p8b_main.p8v_success
label_asm_30_afterif
	; source: test_byte_gte.p8:309   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_32_else
	; source: test_byte_gte.p8:310   success++
	inc  p8b_main.p8v_success
	bra  label_asm_31_afterif
label_asm_32_else
	; source: test_byte_gte.p8:312   cx16.r0L++
	inc  cx16.r0L
label_asm_31_afterif
	; source: test_byte_gte.p8:314   value=0
	stz  p8v_value
	; source: test_byte_gte.p8:316   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl2a
	; source: test_byte_gte.p8:318   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gte.p8:319   lbl2a:   fail_byte(13)
p8l_lbl2a
	ldy  #>13
	lda  #<13
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:320   skip2a:
p8l_skip2a
	; source: test_byte_gte.p8:322   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:323   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:325   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gte.p8:326   lbl2b:   fail_byte(14)
p8l_lbl2b
	ldy  #>14
	lda  #<14
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:327   skip2b:
p8l_skip2b
	; source: test_byte_gte.p8:329   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_33_afterif
	; source: test_byte_gte.p8:330   fail_byte(15)
	ldy  #>15
	lda  #<15
	jsr  p8b_main.p8s_fail_byte
label_asm_33_afterif
	; source: test_byte_gte.p8:333   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_35_else
	; source: test_byte_gte.p8:334   fail_byte(16)
	ldy  #>$10
	lda  #<$10
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_34_afterif
label_asm_35_else
	; source: test_byte_gte.p8:336   success++
	inc  p8b_main.p8v_success
label_asm_34_afterif
	; source: test_byte_gte.p8:338   value=1
	lda  #1
	sta  p8v_value
	; source: test_byte_gte.p8:340   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl3a
	; source: test_byte_gte.p8:342   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gte.p8:343   lbl3a:   fail_byte(17)
p8l_lbl3a
	ldy  #>$11
	lda  #<$11
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:344   skip3a:
p8l_skip3a
	; source: test_byte_gte.p8:346   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:347   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:349   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gte.p8:350   lbl3b:   fail_byte(18)
p8l_lbl3b
	ldy  #>$12
	lda  #<$12
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:351   skip3b:
p8l_skip3b
	; source: test_byte_gte.p8:353   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_36_afterif
	; source: test_byte_gte.p8:354   fail_byte(19)
	ldy  #>$13
	lda  #<$13
	jsr  p8b_main.p8s_fail_byte
label_asm_36_afterif
	; source: test_byte_gte.p8:357   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_38_else
	; source: test_byte_gte.p8:358   fail_byte(20)
	ldy  #>$14
	lda  #<$14
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_37_afterif
label_asm_38_else
	; source: test_byte_gte.p8:360   success++
	inc  p8b_main.p8v_success
label_asm_37_afterif
	; source: test_byte_gte.p8:362   x=0
	stz  p8v_x
	; source: test_byte_gte.p8:363   value=-1
	lda  #-1
	sta  p8v_value
	; source: test_byte_gte.p8:365   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl4a
	; source: test_byte_gte.p8:367   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gte.p8:368   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:369   skip4a:
p8l_skip4a
	; source: test_byte_gte.p8:371   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:372   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:374   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gte.p8:375   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:376   skip4b:
p8l_skip4b
	; source: test_byte_gte.p8:378   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_39_afterif
	; source: test_byte_gte.p8:379   success++
	inc  p8b_main.p8v_success
label_asm_39_afterif
	; source: test_byte_gte.p8:382   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_41_else
	; source: test_byte_gte.p8:383   success++
	inc  p8b_main.p8v_success
	bra  label_asm_40_afterif
label_asm_41_else
	; source: test_byte_gte.p8:385   cx16.r0L++
	inc  cx16.r0L
label_asm_40_afterif
	; source: test_byte_gte.p8:387   value=0
	stz  p8v_value
	; source: test_byte_gte.p8:389   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl5a
	; source: test_byte_gte.p8:391   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gte.p8:392   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:393   skip5a:
p8l_skip5a
	; source: test_byte_gte.p8:395   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:396   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:398   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gte.p8:399   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:400   skip5b:
p8l_skip5b
	; source: test_byte_gte.p8:402   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_42_afterif
	; source: test_byte_gte.p8:403   success++
	inc  p8b_main.p8v_success
label_asm_42_afterif
	; source: test_byte_gte.p8:406   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_44_else
	; source: test_byte_gte.p8:407   success++
	inc  p8b_main.p8v_success
...
label_asm_43_afterif
	; source: test_byte_gte.p8:411   value=1
	lda  #1
	sta  p8v_value
	; source: test_byte_gte.p8:413   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl6a
	; source: test_byte_gte.p8:415   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_gte.p8:416   lbl6a:   fail_byte(21)
p8l_lbl6a
	ldy  #>$15
	lda  #<$15
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:417   skip6a:
p8l_skip6a
	; source: test_byte_gte.p8:419   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:420   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:422   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gte.p8:423   lbl6b:   fail_byte(22)
p8l_lbl6b
	ldy  #>$16
	lda  #<$16
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:424   skip6b:
p8l_skip6b
	; source: test_byte_gte.p8:426   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_45_afterif
	; source: test_byte_gte.p8:427   fail_byte(23)
	ldy  #>$17
	lda  #<$17
	jsr  p8b_main.p8s_fail_byte
label_asm_45_afterif
	; source: test_byte_gte.p8:430   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_47_else
	; source: test_byte_gte.p8:431   fail_byte(24)
	ldy  #>$18
	lda  #<$18
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_46_afterif
label_asm_47_else
	; source: test_byte_gte.p8:433   success++
	inc  p8b_main.p8v_success
label_asm_46_afterif
	; source: test_byte_gte.p8:435   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gte.p8:436   value=-1
	lda  #-1
	sta  p8v_value
	; source: test_byte_gte.p8:438   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl7a
	; source: test_byte_gte.p8:440   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gte.p8:441   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:442   skip7a:
p8l_skip7a
	; source: test_byte_gte.p8:444   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:445   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:447   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gte.p8:448   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:449   skip7b:
p8l_skip7b
	; source: test_byte_gte.p8:451   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_48_afterif
	; source: test_byte_gte.p8:452   success++
	inc  p8b_main.p8v_success
label_asm_48_afterif
	; source: test_byte_gte.p8:455   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_50_else
	; source: test_byte_gte.p8:456   success++
	inc  p8b_main.p8v_success
	bra  label_asm_49_afterif
label_asm_50_else
	; source: test_byte_gte.p8:458   cx16.r0L++
	inc  cx16.r0L
label_asm_49_afterif
	; source: test_byte_gte.p8:460   value=0
	stz  p8v_value
	; source: test_byte_gte.p8:462   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl8a
	; source: test_byte_gte.p8:464   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gte.p8:465   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:466   skip8a:
p8l_skip8a
	; source: test_byte_gte.p8:468   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:469   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:471   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gte.p8:472   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:473   skip8b:
p8l_skip8b
	; source: test_byte_gte.p8:475   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_51_afterif
	; source: test_byte_gte.p8:476   success++
	inc  p8b_main.p8v_success
label_asm_51_afterif
	; source: test_byte_gte.p8:479   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_53_else
	; source: test_byte_gte.p8:480   success++
	inc  p8b_main.p8v_success
	bra  label_asm_52_afterif
label_asm_53_else
	; source: test_byte_gte.p8:482   cx16.r0L++
	inc  cx16.r0L
label_asm_52_afterif
	; source: test_byte_gte.p8:484   value=1
	lda  #1
	sta  p8v_value
	; source: test_byte_gte.p8:486   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bpl  p8l_lbl9a
	; source: test_byte_gte.p8:488   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gte.p8:489   lbl9a:   success++
p8l_lbl9a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:490   skip9a:
p8l_skip9a
	; source: test_byte_gte.p8:492   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:493   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:495   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gte.p8:496   lbl9b:   success++
p8l_lbl9b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:497   skip9b:
p8l_skip9b
	; source: test_byte_gte.p8:499   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_54_afterif
	; source: test_byte_gte.p8:500   success++
	inc  p8b_main.p8v_success
label_asm_54_afterif
	; source: test_byte_gte.p8:503   if x>=value
	lda  p8v_x
	cmp  p8v_value
	bmi  label_asm_56_else
	; source: test_byte_gte.p8:504   success++
	inc  p8b_main.p8v_success
	bra  label_asm_55_afterif
label_asm_56_else
	; source: test_byte_gte.p8:506   cx16.r0L++
	inc  cx16.r0L
label_asm_55_afterif
	; source: test_byte_gte.p8:508   verify_success(27)
	lda  #$1b
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_gte.p8:286   sub test_cmp_var() {
; variables
...
p8v_x	.char  ?
	.send BSS
	.pend
	; source: test_byte_gte.p8:510   sub test_cmp_array() {

p8s_test_cmp_array	.proc
; statements
	; source: test_byte_gte.p8:511   byte @shared x
	; source: test_byte_gte.p8:512   byte[] values = [0, 0]
	; source: test_byte_gte.p8:511   byte @shared x
	stz  p8v_x
	; source: test_byte_gte.p8:513   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gte.p8:514   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gte.p8:515   values[1]=-1
	sta  p8v_values+1
	; source: test_byte_gte.p8:517   if x>=values[1]
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl1a
	; source: test_byte_gte.p8:519   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gte.p8:520   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:521   skip1a:
p8l_skip1a
	; source: test_byte_gte.p8:523   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:524   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:526   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gte.p8:527   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:528   skip1b:
p8l_skip1b
	; source: test_byte_gte.p8:530   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_57_afterif
	; source: test_byte_gte.p8:531   success++
	inc  p8b_main.p8v_success
label_asm_57_afterif
	; source: test_byte_gte.p8:534   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_59_else
	; source: test_byte_gte.p8:535   success++
	inc  p8b_main.p8v_success
	bra  label_asm_58_afterif
label_asm_59_else
	; source: test_byte_gte.p8:537   cx16.r0L++
	inc  cx16.r0L
label_asm_58_afterif
	; source: test_byte_gte.p8:539   values[1]=0
	stz  p8v_values+1
	; source: test_byte_gte.p8:541   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl2a
	; source: test_byte_gte.p8:543   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gte.p8:544   lbl2a:   fail_byte(25)
p8l_lbl2a
	ldy  #>$19
	lda  #<$19
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:545   skip2a:
p8l_skip2a
	; source: test_byte_gte.p8:547   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:548   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:550   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gte.p8:551   lbl2b:   fail_byte(26)
p8l_lbl2b
	ldy  #>$1a
	lda  #<$1a
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:552   skip2b:
p8l_skip2b
	; source: test_byte_gte.p8:554   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_60_afterif
	; source: test_byte_gte.p8:555   fail_byte(27)
	ldy  #>$1b
	lda  #<$1b
	jsr  p8b_main.p8s_fail_byte
label_asm_60_afterif
	; source: test_byte_gte.p8:558   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_62_else
	; source: test_byte_gte.p8:559   fail_byte(28)
	ldy  #>$1c
	lda  #<$1c
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_61_afterif
label_asm_62_else
	; source: test_byte_gte.p8:561   success++
	inc  p8b_main.p8v_success
label_asm_61_afterif
	; source: test_byte_gte.p8:563   values[1]=1
	lda  #1
	sta  p8v_values+1
	; source: test_byte_gte.p8:565   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl3a
	; source: test_byte_gte.p8:567   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gte.p8:568   lbl3a:   fail_byte(29)
p8l_lbl3a
	ldy  #>$1d
	lda  #<$1d
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:569   skip3a:
p8l_skip3a
	; source: test_byte_gte.p8:571   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:572   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:574   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gte.p8:575   lbl3b:   fail_byte(30)
p8l_lbl3b
	ldy  #>$1e
	lda  #<$1e
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:576   skip3b:
p8l_skip3b
	; source: test_byte_gte.p8:578   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_63_afterif
	; source: test_byte_gte.p8:579   fail_byte(31)
	ldy  #>$1f
	lda  #<$1f
	jsr  p8b_main.p8s_fail_byte
label_asm_63_afterif
	; source: test_byte_gte.p8:582   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_65_else
	; source: test_byte_gte.p8:583   fail_byte(32)
	ldy  #>$20
	lda  #<$20
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_64_afterif
label_asm_65_else
	; source: test_byte_gte.p8:585   success++
	inc  p8b_main.p8v_success
label_asm_64_afterif
	; source: test_byte_gte.p8:587   x=0
	stz  p8v_x
	; source: test_byte_gte.p8:588   values[1]=-1
	lda  #-1
	sta  p8v_values+1
	; source: test_byte_gte.p8:590   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl4a
	; source: test_byte_gte.p8:592   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gte.p8:593   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:594   skip4a:
p8l_skip4a
	; source: test_byte_gte.p8:596   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:597   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:599   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gte.p8:600   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:601   skip4b:
p8l_skip4b
	; source: test_byte_gte.p8:603   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_66_afterif
	; source: test_byte_gte.p8:604   success++
	inc  p8b_main.p8v_success
label_asm_66_afterif
	; source: test_byte_gte.p8:607   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_68_else
	; source: test_byte_gte.p8:608   success++
	inc  p8b_main.p8v_success
	bra  label_asm_67_afterif
label_asm_68_else
	; source: test_byte_gte.p8:610   cx16.r0L++
	inc  cx16.r0L
label_asm_67_afterif
	; source: test_byte_gte.p8:612   values[1]=0
	stz  p8v_values+1
	; source: test_byte_gte.p8:614   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl5a
	; source: test_byte_gte.p8:616   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gte.p8:617   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:618   skip5a:
p8l_skip5a
	; source: test_byte_gte.p8:620   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:621   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:623   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gte.p8:624   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:625   skip5b:
p8l_skip5b
	; source: test_byte_gte.p8:627   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_69_afterif
	; source: test_byte_gte.p8:628   success++
	inc  p8b_main.p8v_success
label_asm_69_afterif
	; source: test_byte_gte.p8:631   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_71_else
	; source: test_byte_gte.p8:632   success++
	inc  p8b_main.p8v_success
	bra  label_asm_70_afterif
label_asm_71_else
	; source: test_byte_gte.p8:634   cx16.r0L++
	inc  cx16.r0L
label_asm_70_afterif
	; source: test_byte_gte.p8:636   values[1]=1
	lda  #1
	sta  p8v_values+1
	; source: test_byte_gte.p8:638   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl6a
	; source: test_byte_gte.p8:640   goto skip6a
	bra  p8l_skip6a
	; source: test_byte_gte.p8:641   lbl6a:   fail_byte(33)
p8l_lbl6a
	ldy  #>$21
	lda  #<$21
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:642   skip6a:
p8l_skip6a
	; source: test_byte_gte.p8:644   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:645   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:647   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gte.p8:648   lbl6b:   fail_byte(34)
p8l_lbl6b
	ldy  #>$22
	lda  #<$22
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:649   skip6b:
p8l_skip6b
	; source: test_byte_gte.p8:651   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_72_afterif
	; source: test_byte_gte.p8:652   fail_byte(35)
	ldy  #>$23
	lda  #<$23
	jsr  p8b_main.p8s_fail_byte
label_asm_72_afterif
	; source: test_byte_gte.p8:655   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_74_else
	; source: test_byte_gte.p8:656   fail_byte(36)
	ldy  #>$24
	lda  #<$24
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_73_afterif
label_asm_74_else
	; source: test_byte_gte.p8:658   success++
	inc  p8b_main.p8v_success
label_asm_73_afterif
	; source: test_byte_gte.p8:660   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gte.p8:661   values[1]=-1
	lda  #-1
	sta  p8v_values+1
	; source: test_byte_gte.p8:663   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl7a
	; source: test_byte_gte.p8:665   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gte.p8:666   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:667   skip7a:
p8l_skip7a
	; source: test_byte_gte.p8:669   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:670   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:672   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gte.p8:673   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:674   skip7b:
p8l_skip7b
	; source: test_byte_gte.p8:676   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_75_afterif
	; source: test_byte_gte.p8:677   success++
	inc  p8b_main.p8v_success
label_asm_75_afterif
	; source: test_byte_gte.p8:680   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_77_else
	; source: test_byte_gte.p8:681   success++
	inc  p8b_main.p8v_success
	bra  label_asm_76_afterif
label_asm_77_else
	; source: test_byte_gte.p8:683   cx16.r0L++
	inc  cx16.r0L
label_asm_76_afterif
	; source: test_byte_gte.p8:685   values[1]=0
	stz  p8v_values+1
	; source: test_byte_gte.p8:687   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl8a
	; source: test_byte_gte.p8:689   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gte.p8:690   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:691   skip8a:
p8l_skip8a
	; source: test_byte_gte.p8:693   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:694   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:696   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gte.p8:697   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:698   skip8b:
p8l_skip8b
	; source: test_byte_gte.p8:700   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_78_afterif
	; source: test_byte_gte.p8:701   success++
	inc  p8b_main.p8v_success
label_asm_78_afterif
	; source: test_byte_gte.p8:704   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_80_else
	; source: test_byte_gte.p8:705   success++
	inc  p8b_main.p8v_success
	bra  label_asm_79_afterif
label_asm_80_else
	; source: test_byte_gte.p8:707   cx16.r0L++
	inc  cx16.r0L
label_asm_79_afterif
	; source: test_byte_gte.p8:709   values[1]=1
	lda  #1
	sta  p8v_values+1
	; source: test_byte_gte.p8:711   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bpl  p8l_lbl9a
	; source: test_byte_gte.p8:713   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gte.p8:714   lbl9a:   success++
p8l_lbl9a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:715   skip9a:
p8l_skip9a
	; source: test_byte_gte.p8:717   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:718   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  +
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:720   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gte.p8:721   lbl9b:   success++
p8l_lbl9b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:722   skip9b:
p8l_skip9b
	; source: test_byte_gte.p8:724   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_81_afterif
	; source: test_byte_gte.p8:725   success++
	inc  p8b_main.p8v_success
label_asm_81_afterif
	; source: test_byte_gte.p8:728   if x>=values[1]
	lda  p8v_x
	ldy  #1
	cmp  p8v_values,y
	bmi  label_asm_83_else
	; source: test_byte_gte.p8:729   success++
	inc  p8b_main.p8v_success
	bra  label_asm_82_afterif
label_asm_83_else
	; source: test_byte_gte.p8:731   cx16.r0L++
	inc  cx16.r0L
label_asm_82_afterif
	; source: test_byte_gte.p8:733   verify_success(27)
	lda  #$1b
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_gte.p8:510   sub test_cmp_array() {
; variables
...
p8v_values	.char  $00, $00
	.pend
	; source: test_byte_gte.p8:735   sub test_cmp_expr() {

p8s_test_cmp_expr	.proc
; statements
	; source: test_byte_gte.p8:736   byte @shared x
	; source: test_byte_gte.p8:739   float @shared f4 = 1.0
	; source: test_byte_gte.p8:740   float @shared f5 = 1.0
	; source: test_byte_gte.p8:736   byte @shared x
	stz  p8v_x
	; source: test_byte_gte.p8:737   cx16.r4 = 1
	lda  #<1
	ldy  #>1
	sta  cx16.r4
	sty  cx16.r4+1
	
	; source: test_byte_gte.p8:738   cx16.r5 = 1
	sta  cx16.r5
	sty  cx16.r5+1
	...
	ldy  #>p8v_f5
	jsr  floats.copy_float
	; source: test_byte_gte.p8:741   success = 0
	stz  p8b_main.p8v_success
	; source: test_byte_gte.p8:742   x=-1
	lda  #-1
	sta  p8v_x
	; source: test_byte_gte.p8:744   if x>=cx16.r4sL+-1-cx16.r5sL
	pha
	lda  cx16.r4sL
	sec
	sbc  #1
	...
	bpl  p8l_lbl1a
	; source: test_byte_gte.p8:746   goto skip1a
	bra  p8l_skip1a
	; source: test_byte_gte.p8:747   lbl1a:   success++
p8l_lbl1a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:748   skip1a:
p8l_skip1a
	; source: test_byte_gte.p8:750   cx16.r3 = &lbl1b
	lda  #<p8l_lbl1b
	ldy  #>p8l_lbl1b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:751   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:753   goto skip1b
	bra  p8l_skip1b
	; source: test_byte_gte.p8:754   lbl1b:   success++
p8l_lbl1b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:755   skip1b:
p8l_skip1b
	; source: test_byte_gte.p8:757   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:758   success++
	inc  p8b_main.p8v_success
label_asm_84_afterif
	; source: test_byte_gte.p8:761   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:762   success++
	inc  p8b_main.p8v_success
	bra  label_asm_85_afterif
label_asm_86_else
	; source: test_byte_gte.p8:764   cx16.r0L++
	inc  cx16.r0L
label_asm_85_afterif
	; source: test_byte_gte.p8:767   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	cmp  P8ZP_SCRATCH_REG
	bpl  p8l_lbl2a
	; source: test_byte_gte.p8:769   goto skip2a
	bra  p8l_skip2a
	; source: test_byte_gte.p8:770   lbl2a:   fail_byte(37)
p8l_lbl2a
	ldy  #>$25
	lda  #<$25
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:771   skip2a:
p8l_skip2a
	; source: test_byte_gte.p8:773   cx16.r3 = &lbl2b
	lda  #<p8l_lbl2b
	ldy  #>p8l_lbl2b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:774   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:776   goto skip2b
	bra  p8l_skip2b
	; source: test_byte_gte.p8:777   lbl2b:   fail_byte(38)
p8l_lbl2b
	ldy  #>$26
	lda  #<$26
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:778   skip2b:
p8l_skip2b
	; source: test_byte_gte.p8:780   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:781   fail_byte(39)
	ldy  #>$27
	lda  #<$27
	jsr  p8b_main.p8s_fail_byte
label_asm_87_afterif
	; source: test_byte_gte.p8:784   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:785   fail_byte(40)
	ldy  #>$28
	lda  #<$28
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_88_afterif
label_asm_89_else
	; source: test_byte_gte.p8:787   success++
	inc  p8b_main.p8v_success
label_asm_88_afterif
	; source: test_byte_gte.p8:790   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	cmp  P8ZP_SCRATCH_REG
	bpl  p8l_lbl3a
	; source: test_byte_gte.p8:792   goto skip3a
	bra  p8l_skip3a
	; source: test_byte_gte.p8:793   lbl3a:   fail_byte(41)
p8l_lbl3a
	ldy  #>$29
	lda  #<$29
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:794   skip3a:
p8l_skip3a
	; source: test_byte_gte.p8:796   cx16.r3 = &lbl3b
	lda  #<p8l_lbl3b
	ldy  #>p8l_lbl3b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:797   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:799   goto skip3b
	bra  p8l_skip3b
	; source: test_byte_gte.p8:800   lbl3b:   fail_byte(42)
p8l_lbl3b
	ldy  #>$2a
	lda  #<$2a
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:801   skip3b:
p8l_skip3b
	; source: test_byte_gte.p8:803   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	; source: test_byte_gte.p8:804   fail_byte(43)
	ldy  #>$2b
	lda  #<$2b
	jsr  p8b_main.p8s_fail_byte
label_asm_90_afterif
	; source: test_byte_gte.p8:807   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	; source: test_byte_gte.p8:808   fail_byte(44)
	ldy  #>$2c
	lda  #<$2c
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_91_afterif
label_asm_92_else
	; source: test_byte_gte.p8:810   success++
	inc  p8b_main.p8v_success
label_asm_91_afterif
	; source: test_byte_gte.p8:812   x=0
	stz  p8v_x
	; source: test_byte_gte.p8:814   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	cmp  P8ZP_SCRATCH_REG
	bpl  p8l_lbl4a
	; source: test_byte_gte.p8:816   goto skip4a
	bra  p8l_skip4a
	; source: test_byte_gte.p8:817   lbl4a:   success++
p8l_lbl4a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:818   skip4a:
p8l_skip4a
	; source: test_byte_gte.p8:820   cx16.r3 = &lbl4b
	lda  #<p8l_lbl4b
	ldy  #>p8l_lbl4b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:821   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:823   goto skip4b
	bra  p8l_skip4b
	; source: test_byte_gte.p8:824   lbl4b:   success++
p8l_lbl4b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:825   skip4b:
p8l_skip4b
	; source: test_byte_gte.p8:827   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:828   success++
	inc  p8b_main.p8v_success
label_asm_93_afterif
	; source: test_byte_gte.p8:831   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:832   success++
	inc  p8b_main.p8v_success
	bra  label_asm_94_afterif
label_asm_95_else
	; source: test_byte_gte.p8:834   cx16.r0L++
	inc  cx16.r0L
label_asm_94_afterif
	; source: test_byte_gte.p8:837   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	cmp  P8ZP_SCRATCH_REG
	bpl  p8l_lbl5a
	; source: test_byte_gte.p8:839   goto skip5a
	bra  p8l_skip5a
	; source: test_byte_gte.p8:840   lbl5a:   success++
p8l_lbl5a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:841   skip5a:
p8l_skip5a
	; source: test_byte_gte.p8:843   cx16.r3 = &lbl5b
	lda  #<p8l_lbl5b
	ldy  #>p8l_lbl5b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:844   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:846   goto skip5b
	bra  p8l_skip5b
	; source: test_byte_gte.p8:847   lbl5b:   success++
p8l_lbl5b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:848   skip5b:
p8l_skip5b
	; source: test_byte_gte.p8:850   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:851   success++
	inc  p8b_main.p8v_success
label_asm_96_afterif
	; source: test_byte_gte.p8:854   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:855   success++
	inc  p8b_main.p8v_success
	bra  label_asm_97_afterif
label_asm_98_else
	; source: test_byte_gte.p8:857   cx16.r0L++
	inc  cx16.r0L
label_asm_97_afterif
	; source: test_byte_gte.p8:860   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	bra  p8l_skip6a
	; source: test_byte_gte.p8:863   lbl6a:   fail_byte(45)
p8l_lbl6a
	ldy  #>$2d
	lda  #<$2d
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:864   skip6a:
p8l_skip6a
	; source: test_byte_gte.p8:866   cx16.r3 = &lbl6b
	lda  #<p8l_lbl6b
	ldy  #>p8l_lbl6b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:867   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:869   goto skip6b
	bra  p8l_skip6b
	; source: test_byte_gte.p8:870   lbl6b:   fail_byte(46)
p8l_lbl6b
	ldy  #>$2e
	lda  #<$2e
	jsr  p8b_main.p8s_fail_byte
	; source: test_byte_gte.p8:871   skip6b:
p8l_skip6b
	; source: test_byte_gte.p8:873   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	; source: test_byte_gte.p8:874   fail_byte(47)
	ldy  #>$2f
	lda  #<$2f
	jsr  p8b_main.p8s_fail_byte
label_asm_99_afterif
	; source: test_byte_gte.p8:877   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	; source: test_byte_gte.p8:878   fail_byte(48)
	ldy  #>$30
	lda  #<$30
	jsr  p8b_main.p8s_fail_byte
	bra  label_asm_100_afterif
label_asm_101_else
	; source: test_byte_gte.p8:880   success++
	inc  p8b_main.p8v_success
label_asm_100_afterif
	; source: test_byte_gte.p8:882   x=1
	lda  #1
	sta  p8v_x
	; source: test_byte_gte.p8:884   if x>=cx16.r4sL+-1-cx16.r5sL
	pha
	lda  cx16.r4sL
	sec
	sbc  #1
	...
	cmp  P8ZP_SCRATCH_REG
	bpl  p8l_lbl7a
	; source: test_byte_gte.p8:886   goto skip7a
	bra  p8l_skip7a
	; source: test_byte_gte.p8:887   lbl7a:   success++
p8l_lbl7a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:888   skip7a:
p8l_skip7a
	; source: test_byte_gte.p8:890   cx16.r3 = &lbl7b
	lda  #<p8l_lbl7b
	ldy  #>p8l_lbl7b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:891   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:893   goto skip7b
	bra  p8l_skip7b
	; source: test_byte_gte.p8:894   lbl7b:   success++
p8l_lbl7b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:895   skip7b:
p8l_skip7b
	; source: test_byte_gte.p8:897   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:898   success++
	inc  p8b_main.p8v_success
label_asm_102_afterif
	; source: test_byte_gte.p8:901   if x>=cx16.r4sL+-1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:902   success++
	inc  p8b_main.p8v_success
	bra  label_asm_103_afterif
label_asm_104_else
	; source: test_byte_gte.p8:904   cx16.r0L++
	inc  cx16.r0L
label_asm_103_afterif
	; source: test_byte_gte.p8:907   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	cmp  P8ZP_SCRATCH_REG
	bpl  p8l_lbl8a
	; source: test_byte_gte.p8:909   goto skip8a
	bra  p8l_skip8a
	; source: test_byte_gte.p8:910   lbl8a:   success++
p8l_lbl8a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:911   skip8a:
p8l_skip8a
	; source: test_byte_gte.p8:913   cx16.r3 = &lbl8b
	lda  #<p8l_lbl8b
	ldy  #>p8l_lbl8b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:914   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:916   goto skip8b
	bra  p8l_skip8b
	; source: test_byte_gte.p8:917   lbl8b:   success++
p8l_lbl8b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:918   skip8b:
p8l_skip8b
	; source: test_byte_gte.p8:920   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:921   success++
	inc  p8b_main.p8v_success
label_asm_105_afterif
	; source: test_byte_gte.p8:924   if x>=cx16.r4sL+0-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	sec
	...
	; source: test_byte_gte.p8:925   success++
	inc  p8b_main.p8v_success
...
label_asm_106_afterif
	; source: test_byte_gte.p8:930   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	cmp  P8ZP_SCRATCH_REG
	bpl  p8l_lbl9a
	; source: test_byte_gte.p8:932   goto skip9a
	bra  p8l_skip9a
	; source: test_byte_gte.p8:933   lbl9a:   success++
p8l_lbl9a
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:934   skip9a:
p8l_skip9a
	; source: test_byte_gte.p8:936   cx16.r3 = &lbl9b
	lda  #<p8l_lbl9b
	ldy  #>p8l_lbl9b
	sta  cx16.r3
	sty  cx16.r3+1
	; source: test_byte_gte.p8:937   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	jmp  (cx16.r3)
+
	; source: test_byte_gte.p8:939   goto skip9b
	bra  p8l_skip9b
	; source: test_byte_gte.p8:940   lbl9b:   success++
p8l_lbl9b
	inc  p8b_main.p8v_success
	; source: test_byte_gte.p8:941   skip9b:
p8l_skip9b
	; source: test_byte_gte.p8:943   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	; source: test_byte_gte.p8:944   success++
	inc  p8b_main.p8v_success
label_asm_108_afterif
	; source: test_byte_gte.p8:947   if x>=cx16.r4sL+1-cx16.r5sL
	lda  p8v_x
	pha
	lda  cx16.r4sL
	clc
	...
	; source: test_byte_gte.p8:948   success++
	inc  p8b_main.p8v_success
	bra  label_asm_109_afterif
label_asm_110_else
	; source: test_byte_gte.p8:950   cx16.r0L++
	inc  cx16.r0L
label_asm_109_afterif
	; source: test_byte_gte.p8:952   verify_success(27)
	lda  #$1b
	jmp  p8b_main.p8s_verify_success
	; source: test_byte_gte.p8:735   sub test_cmp_expr() {
; variables
