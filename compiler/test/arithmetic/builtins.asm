; w65c02 assembly code for 'builtins'
...
+        
	...
	clc
; statements
	jsr  p8b_main.p8s_rotations
	jsr  p8b_main.p8s_integers
	jmp  p8b_main.p8s_floatingpoint
; variables
	.section BSS
	.send BSS
...
; statements
	...
	stz  p8v_ww+1
	lda  #20
	sta  label_asm_6_counter
label_asm_5_repeat
	lda  #13
	jsr  txt.chrout
	dec  label_asm_6_counter
	bne  label_asm_5_repeat
	; inlined routine follows: read_flags
            php
            pla
	; inlined routine end: read_flags
	sta  p8v_ub
	jsr  txt.print_ub
	lda  #13
	jsr  txt.chrout
...
+
	...
	jsr  prog8_lib.func_sqrt16_into_A
	sta  p8v_ub
	jsr  txt.print_ub
	lda  #13
	jsr  txt.chrout
	...
	sty  P8ZP_SCRATCH_W1+1
	lda  #13
	jsr  prog8_lib.func_sort_b
	lda  #<p8v_uwarr
	ldy  #>p8v_uwarr
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	lda  #10
	jsr  prog8_lib.func_sort_uw
	lda  #<p8v_warr
	ldy  #>p8v_warr
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	lda  #12
	jsr  prog8_lib.func_sort_w
	lda  #<p8v_ubarr
	ldy  #>p8v_ubarr
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	...
	sty  P8ZP_SCRATCH_W1+1
	lda  #12
	jmp  prog8_lib.func_reverse_w
; variables
	.section BSS
label_asm_6_counter = 50
	.send BSS

; non-zeropage variables
p8v_barr	.char  $01, $02, $03, $04, $05, -$04, $00, -$03, $02, $01, -$80, -$80, -$7f
p8v_ubarr	.byte  $01, $02, $03, $04, $05, $00, $04, $03, $02, $01, $ff, $ff, $ff
p8v_uwarr	.word  $0064, $00c8, $012c, $0190, $0000, $01f4, $0190, $012c, $00c8, $0064
p8v_warr	.sint  $0064, $00c8, $012c, $0190, $01f4, $0000, -$0190, -$012c, $00c8, $0064, -$0063, -$1000
	.pend

p8s_floatingpoint	.proc
p8v_zero 	= 44 	; zp UBYTE
p8v_uw 	= 45 	; zp UWORD
p8v_ub 	= 47 	; zp UBYTE
p8v_bb 	= 48 	; zp BYTE
; statements
...
; non-zeropage variables
p8v_flarr
	.byte  $81, $0c, $cc, $cc, $cc  ; float prog8.code.StArrayElement@6824b913
	.byte  $82, $0c, $cc, $cc, $cc  ; float prog8.code.StArrayElement@756aadfc
	.byte  $82, $53, $33, $33, $33  ; float prog8.code.StArrayElement@705a8dbc
	.byte  $00, $00, $00, $00, $00  ; float prog8.code.StArrayElement@40729f01
	.byte  $84, $9e, $66, $66, $66  ; float prog8.code.StArrayElement@d535a3d
	.byte  $83, $30, $00, $00, $00  ; float prog8.code.StArrayElement@2d760326
	.byte  $83, $0c, $cc, $cc, $cc  ; float prog8.code.StArrayElement@9e54c59
	.pend
	.pend
...
prog8_float_const_0	.byte  $84, $9e, $66, $66, $66  ; float -9.9
