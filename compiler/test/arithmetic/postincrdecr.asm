; w65c02 assembly code for 'postincrdecr'
...
+
	...
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	lda  #<p8b_main.p8s_check_fl.p8v_value
	ldy  #>p8b_main.p8s_check_fl.p8v_value
	jsr  floats.copy_float
	lda  #<prog8_float_const_2
	ldy  #>prog8_float_const_2
	sta  P8ZP_SCRATCH_W1
	sty  P8ZP_SCRATCH_W1+1
	lda  #<p8b_main.p8s_check_fl.p8v_expected
	ldy  #>p8b_main.p8s_check_fl.p8v_expected
	jsr  floats.copy_float
	jsr  p8b_main.p8s_check_fl
	lda  p8v_bb
	ldy  #-$63
	jsr  p8b_main.p8s_check_b
	lda  p8v_uw
	ldy  p8v_uw+1
	sta  p8b_main.p8s_check_uw.p8v_value
	sty  p8b_main.p8s_check_uw.p8v_value+1
	lda  #<$07d1
	ldy  #>$07d1
	sta  p8b_main.p8s_check_uw.p8v_expected
	sty  p8b_main.p8s_check_uw.p8v_expected+1
	
	jsr  p8b_main.p8s_check_uw
	lda  p8v_ww
	ldy  p8v_ww+1
	sta  p8b_main.p8s_check_w.p8v_value
	sty  p8b_main.p8s_check_w.p8v_value+1
	lda  #<-$03e7
	ldy  #>-$03e7
	sta  p8b_main.p8s_check_w.p8v_expected
	sty  p8b_main.p8s_check_w.p8v_expected+1
	
	jsr  p8b_main.p8s_check_w
	lda  p8v_ubarr+0
	ldy  #$c8
	jsr  p8b_main.p8s_check_ub
	lda  #<(p8v_flarr+0)
...
p8v_barr	.char  -$64, -$64, -$64
p8v_flarr
	.byte  $8a, $79, $ff, $5c, $28  ; float prog8.code.StArrayElement@37a0ec3c
	.byte  $8a, $79, $ff, $5c, $28  ; float prog8.code.StArrayElement@422ad5e2
	.byte  $8a, $79, $ff, $5c, $28  ; float prog8.code.StArrayElement@62a54948
p8v_ubarr	.byte  $c8, $c8, $c8
p8v_uwarr	.word  $07d0, $07d0, $07d0
p8v_warr	.sint  -$03e8, -$03e8, -$03e8
	.pend

p8s_check_ub	.proc
p8v_value 	= 49 	; zp UBYTE
p8v_expected 	= 50 	; zp UBYTE
...
p8s_check_b	.proc
p8v_value 	= 51 	; zp BYTE
p8v_expected 	= 52 	; zp BYTE
; simple int arg(s) passed via register(s)
	sta  p8v_value
	sty  p8v_expected
; statements
...
p8s_check_uw	.proc
p8v_value 	= 45 	; zp UWORD
p8v_expected 	= 47 	; zp UWORD
; statements
	lda  p8b_main.p8s_check_uw.p8v_value
	cmp  p8b_main.p8s_check_uw.p8v_expected
	bne  label_asm_6_else
	lda  p8b_main.p8s_check_uw.p8v_value+1
	cmp  p8b_main.p8s_check_uw.p8v_expected+1
	bne  label_asm_6_else
	ldy  #>prog8_interned_strings.string_3
	lda  #<prog8_interned_strings.string_3
	jsr  txt.print
...
p8s_check_w	.proc
p8v_value 	= 41 	; zp WORD
p8v_expected 	= 43 	; zp WORD
; statements
	lda  p8b_main.p8s_check_w.p8v_value
	cmp  p8b_main.p8s_check_w.p8v_expected
	bne  label_asm_8_else
	lda  p8b_main.p8s_check_w.p8v_value+1
	cmp  p8b_main.p8s_check_w.p8v_expected+1
	bne  label_asm_8_else
	ldy  #>prog8_interned_strings.string_3
	lda  #<prog8_interned_strings.string_3
	jsr  txt.print
...
string_4	; PETSCII:"err! "
	.byte  $45, $52, $52, $21, $20, $00
string_5	; PETSCII:" ubyte "
	.byte  $20, $55, $42, $59, $54, $45, $20, $00
string_6	; PETSCII:" byte "
	.byte  $20, $42, $59, $54, $45, $20, $00
string_7	; PETSCII:" uword "
	.byte  $20, $55, $57, $4f, $52, $44, $20, $00
string_8	; PETSCII:" word "
	.byte  $20, $57, $4f, $52, $44, $20, $00
string_9	; PETSCII:" float "
	.byte  $20, $46, $4c, $4f, $41, $54, $20, $00
...
prog8_float_const_0	.byte  $8a, $79, $ff, $5c, $28  ; float 999.99
prog8_float_const_1	.byte  $81, $00, $00, $00, $00  ; float 1.0
prog8_float_const_2	.byte  $8a, $7a, $3f, $5c, $28  ; float 1000.99
