; w65c02 assembly code for 'testrepeat'
...
+
	...
	beq  +
	iny
+           sta  label_asm_10_counter
	sty  label_asm_10_counter+1
label_asm_9_repeat
	inc  p8v_amount
	bne  +
	inc  p8v_amount+1
+
	dec  label_asm_10_counter
	bne  label_asm_9_repeat
	dec  label_asm_10_counter+1
	bne  label_asm_9_repeat
	ldy  p8v_amount+1
	lda  p8v_amount
	jsr  txt.print_uw
...
; variables
	.section BSS
label_asm_3_counter = 36
label_asm_10_counter = 37
	.send BSS
...
string_1	; PETSCII:"expected:\n 0, 1, 100, 255, 256, 257, 1000, 65535\n\n"
	.byte  $45, $58, $50, $45, $43, $54, $45, $44, $3a, $0d, $20, $30, $2c, $20, $31, $2c
	.byte  $20, $31, $30, $30, $2c, $20, $32, $35, $35, $2c, $20, $32, $35, $36, $2c, $20
	.byte  $32, $35, $37, $2c, $20, $31, $30, $30, $30, $2c, $20, $36, $35, $35, $33, $35
	.byte  $0d, $0d, $00
