...
class TestCompilerOnExamplesBothC64andCx16: FunSpec({
    ...
    val bothCx16AndC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pointers/animalgame", c64SizeOptimized=1880, c64SizeUnoptimized=2437, cx16SizeOptimized=1913, cx16SizeUnoptimized=2721),
            ExampleSizes("pointers/binarytree", c64SizeOptimized=2583, c64SizeUnoptimized=2648, cx16SizeOptimized=2101, cx16SizeUnoptimized=2409),
...
class TestCompilerOnExamplesVirtual: FunSpec({
    ...
    val onlyVirtual = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pointers/animalgame", virtualInstrCountOptimized=417, virtualInstrCountUnoptimized=2053, virtualRegCountOptimized=147, virtualRegCountUnoptimized=875),
            ExampleSizes("pointers/binarytree", virtualInstrCountOptimized=637, virtualInstrCountUnoptimized=2223, virtualRegCountOptimized=253, virtualRegCountUnoptimized=961),
            ExampleSizes("pointers/hashtable", virtualInstrCountOptimized=663, virtualInstrCountUnoptimized=2224, virtualRegCountOptimized=279, virtualRegCountUnoptimized=980),
            ExampleSizes("pointers/sortedlist", virtualInstrCountOptimized=386, virtualInstrCountUnoptimized=2386, virtualRegCountOptimized=122, virtualRegCountUnoptimized=1027),
