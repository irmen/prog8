...
class TestCompilerOnExamplesC64: FunSpec({
    ...
    val onlyC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("fileselector", c64SizeOptimized=3552, c64SizeUnoptimized=4738),
...
class TestCompilerOnExamplesCx16: FunSpec({
    ...
    val onlyCx16 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("amiga", cx16SizeOptimized=7638, cx16SizeUnoptimized=11865),
            ...
            ExampleSizes("test_gfx_hires", cx16SizeOptimized=4843, cx16SizeUnoptimized=7514),
            ExampleSizes("test_gfx_lores", cx16SizeOptimized=5871, cx16SizeUnoptimized=7188),
            ExampleSizes("testmonogfx", cx16SizeOptimized=10502, cx16SizeUnoptimized=11982),
