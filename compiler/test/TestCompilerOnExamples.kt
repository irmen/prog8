...
class TestCompilerOnExamplesCx16: FunSpec({
    ...
    val onlyCx16 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("life", cx16SizeOptimized=1304, cx16SizeUnoptimized=1751),
...
class TestCompilerOnExamplesBothC64andCx16: FunSpec({
    ...
    val bothCx16AndC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("maze", c64SizeOptimized=3100, c64SizeUnoptimized=3189, cx16SizeOptimized=2873, cx16SizeUnoptimized=3251),
