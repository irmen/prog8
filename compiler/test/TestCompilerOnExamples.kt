...
class TestCompilerOnExamplesCx16: FunSpec({
    ...
    val onlyCx16 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pcmaudio/stream-simple-aflow", cx16SizeOptimized=1850, cx16SizeUnoptimized=3618),
            ExampleSizes("pcmaudio/stream-simple-poll", cx16SizeOptimized=1564, cx16SizeUnoptimized=3329),
            ...
            ExampleSizes("sprites/dragons", cx16SizeOptimized=1527, cx16SizeUnoptimized=3650),
            ...
            ExampleSizes("circles", cx16SizeOptimized=2408, cx16SizeUnoptimized=4519),
            ExampleSizes("cobramk3-gfx", cx16SizeOptimized=7764, cx16SizeUnoptimized=10442),
            ...
            ExampleSizes("interpolation", cx16SizeOptimized=3791, cx16SizeUnoptimized=4727),
            ExampleSizes("kefrenbars", cx16SizeOptimized=2393, cx16SizeUnoptimized=4625),
            ExampleSizes("keyboardhandler", cx16SizeOptimized=412, cx16SizeUnoptimized=717),
            ExampleSizes("landscape", cx16SizeOptimized=1673, cx16SizeUnoptimized=2027),
            ...
            ExampleSizes("showbmx", cx16SizeOptimized=2745, cx16SizeUnoptimized=5101),
            ExampleSizes("snow", cx16SizeOptimized=3143, cx16SizeUnoptimized=5264),
            ...
            ExampleSizes("starszoom", cx16SizeOptimized=2406, cx16SizeUnoptimized=4828),
            ExampleSizes("test_gfx_hires", cx16SizeOptimized=4760, cx16SizeUnoptimized=7444),
            ExampleSizes("test_gfx_lores", cx16SizeOptimized=5828, cx16SizeUnoptimized=7004),
            ExampleSizes("testmonogfx", cx16SizeOptimized=10262, cx16SizeUnoptimized=11639),
...
class TestCompilerOnExamplesBothC64andCx16: FunSpec({
    ...
    val bothCx16AndC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("cube3d", c64SizeOptimized=2444, c64SizeUnoptimized=2521, cx16SizeOptimized=2381, cx16SizeUnoptimized=2712),
            ExampleSizes("cube3d-float", c64SizeOptimized=2654, c64SizeUnoptimized=2703, cx16SizeOptimized=2511, cx16SizeUnoptimized=2835),
            ExampleSizes("cube3d-gfx", c64SizeOptimized=3536, c64SizeUnoptimized=3633, cx16SizeOptimized=2206, cx16SizeUnoptimized=2522),
            ...
            ExampleSizes("tehtriz", c64SizeOptimized=4339, c64SizeUnoptimized=4608, cx16SizeOptimized=6252, cx16SizeUnoptimized=6773),
            ExampleSizes("textelite", c64SizeOptimized=11222, c64SizeUnoptimized=12115, cx16SizeOptimized=10707, cx16SizeUnoptimized=12707),
            ...
            ExampleSizes("pointers/sortedlist", c64SizeOptimized=1294, c64SizeUnoptimized=1336, cx16SizeOptimized=1239, cx16SizeUnoptimized=1552),
...
class TestCompilerOnExamplesPET32: FunSpec({
    ...
    val onlyPET32 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("music", pet32SizeOptimized=742, pet32SizeUnoptimized=781),
        ),
        listOf(false, true)
    )
