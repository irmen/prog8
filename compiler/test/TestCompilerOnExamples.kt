...
class TestCompilerOnExamplesC64: FunSpec({
    ...
    val onlyC64 = cartesianProduct(
        listOf(
            ExampleSizes("balloonflight", c64SizeOptimized=1674, c64SizeUnoptimized=1737),
            ExampleSizes("banking", c64SizeOptimized=680, c64SizeUnoptimized=1451),
            ...
            ExampleSizes("cube3d-sprites", c64SizeOptimized=2704, c64SizeUnoptimized=2756),
            ...
            ExampleSizes("petswirl", c64SizeOptimized=953, c64SizeUnoptimized=1021),
            ExampleSizes("plasma", c64SizeOptimized=1688, c64SizeUnoptimized=1723),
            ExampleSizes("rasterbars", c64SizeOptimized=845, c64SizeUnoptimized=892),
            ExampleSizes("simplemultiplexer", c64SizeOptimized=843, c64SizeUnoptimized=902),
            ExampleSizes("sprites", c64SizeOptimized=963, c64SizeUnoptimized=1040),
            ExampleSizes("starfield", c64SizeOptimized=743, c64SizeUnoptimized=758),
            ExampleSizes("turtle-gfx", c64SizeOptimized=2758, c64SizeUnoptimized=2860),
...
class TestCompilerOnExamplesCx16: FunSpec({
    ...
    val onlyCx16 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pcmaudio/play-adpcm", cx16SizeOptimized=36147, cx16SizeUnoptimized=36637),
            ExampleSizes("pcmaudio/stream-wav", cx16SizeOptimized=5636, cx16SizeUnoptimized=7878),
            ExampleSizes("pcmaudio/stream-simple-aflow", cx16SizeOptimized=1842, cx16SizeUnoptimized=3745),
            ExampleSizes("pcmaudio/stream-simple-poll", cx16SizeOptimized=1556, cx16SizeUnoptimized=3454),
            ...
            ExampleSizes("sprites/dragons", cx16SizeOptimized=1503, cx16SizeUnoptimized=3678),
            ExampleSizes("zsmkit_v1/demo1", cx16SizeOptimized=7546, cx16SizeUnoptimized=7984),
            ExampleSizes("zsmkit_v1/demo2", cx16SizeOptimized=708, cx16SizeUnoptimized=2579),
            ...
            ExampleSizes("amiga", cx16SizeOptimized=7631, cx16SizeUnoptimized=11865),
            ...
            ExampleSizes("bobs", cx16SizeOptimized=2800, cx16SizeUnoptimized=3406),
            ExampleSizes("bubbleuniverse", cx16SizeOptimized=1450, cx16SizeUnoptimized=1958),
            ExampleSizes("charfade", cx16SizeOptimized=1054, cx16SizeUnoptimized=1362),
            ExampleSizes("charsets", cx16SizeOptimized=1125, cx16SizeUnoptimized=1417),
            ExampleSizes("circles", cx16SizeOptimized=2384, cx16SizeUnoptimized=4539),
            ExampleSizes("cobramk3-gfx", cx16SizeOptimized=7697, cx16SizeUnoptimized=10604),
            ...
            ExampleSizes("diskspeed", cx16SizeOptimized=6280, cx16SizeUnoptimized=8283),
            ExampleSizes("fileseek", cx16SizeOptimized=2468, cx16SizeUnoptimized=4496),
            ExampleSizes("floatparse", cx16SizeOptimized=8303, cx16SizeUnoptimized=9190),
            ExampleSizes("interpolation", cx16SizeOptimized=3783, cx16SizeUnoptimized=4760),
            ExampleSizes("kefrenbars", cx16SizeOptimized=2393, cx16SizeUnoptimized=4654),
            ExampleSizes("keyboardhandler", cx16SizeOptimized=412, cx16SizeUnoptimized=717),
            ExampleSizes("landscape", cx16SizeOptimized=1665, cx16SizeUnoptimized=1989),
            ...
            ExampleSizes("plasma", cx16SizeOptimized=1731, cx16SizeUnoptimized=2058),
            ...
            ExampleSizes("showbmx", cx16SizeOptimized=2745, cx16SizeUnoptimized=5261),
            ExampleSizes("snow", cx16SizeOptimized=3119, cx16SizeUnoptimized=5287),
            ...
            ExampleSizes("starszoom", cx16SizeOptimized=2406, cx16SizeUnoptimized=4855),
            ExampleSizes("test_gfx_hires", cx16SizeOptimized=4835, cx16SizeUnoptimized=7514),
            ExampleSizes("test_gfx_lores", cx16SizeOptimized=5849, cx16SizeUnoptimized=7188),
            ExampleSizes("testmonogfx", cx16SizeOptimized=10480, cx16SizeUnoptimized=11974),
...
class TestCompilerOnExamplesBothC64andCx16: FunSpec({
    ...
    val bothCx16AndC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("cube3d", c64SizeOptimized=2436, c64SizeUnoptimized=2501, cx16SizeOptimized=2373, cx16SizeUnoptimized=2704),
            ExampleSizes("cube3d-float", c64SizeOptimized=2654, c64SizeUnoptimized=2703, cx16SizeOptimized=2511, cx16SizeUnoptimized=2835),
            ExampleSizes("cube3d-gfx", c64SizeOptimized=3528, c64SizeUnoptimized=3581, cx16SizeOptimized=2198, cx16SizeUnoptimized=2514),
            ...
            ExampleSizes("tehtriz", c64SizeOptimized=4331, c64SizeUnoptimized=4496, cx16SizeOptimized=6244, cx16SizeUnoptimized=6765),
            ExampleSizes("textelite", c64SizeOptimized=11428, c64SizeUnoptimized=12411, cx16SizeOptimized=10770, cx16SizeUnoptimized=13038),
            ...
            ExampleSizes("pointers/sortedlist", c64SizeOptimized=1262, c64SizeUnoptimized=1307, cx16SizeOptimized=1215, cx16SizeUnoptimized=1524),
            ExampleSizes("pointers/sorting", c64SizeOptimized=1776, c64SizeUnoptimized=2676, cx16SizeOptimized=1788, cx16SizeUnoptimized=2659),
        ),
        listOf(false, true),
...
class TestCompilerOnExamplesVirtual: FunSpec({
    ...
    val onlyVirtual = cartesianProduct(
        listOf(
            ExampleSizes("bouncegfx", virtualInstrCountOptimized=186, virtualInstrCountUnoptimized=846, virtualRegCountOptimized=92, virtualRegCountUnoptimized=386),
            ExampleSizes("bsieve", virtualInstrCountOptimized=158, virtualInstrCountUnoptimized=1961, virtualRegCountOptimized=66, virtualRegCountUnoptimized=866),
            ExampleSizes("fountain", virtualInstrCountOptimized=150, virtualInstrCountUnoptimized=813, virtualRegCountOptimized=75, virtualRegCountUnoptimized=369),
            ExampleSizes("pixelshader", virtualInstrCountOptimized=43, virtualInstrCountUnoptimized=308, virtualRegCountOptimized=15, virtualRegCountUnoptimized=115),
            ExampleSizes("sincos", virtualInstrCountOptimized=276, virtualInstrCountUnoptimized=920, virtualRegCountOptimized=133, virtualRegCountUnoptimized=409),
            ExampleSizes("pointers/animalgame", virtualInstrCountOptimized=221, virtualInstrCountUnoptimized=2105, virtualRegCountOptimized=103, virtualRegCountUnoptimized=939),
            ExampleSizes("pointers/binarytree", virtualInstrCountOptimized=510, virtualInstrCountUnoptimized=2259, virtualRegCountOptimized=251, virtualRegCountUnoptimized=1026),
            ExampleSizes("pointers/hashtable", virtualInstrCountOptimized=578, virtualInstrCountUnoptimized=2277, virtualRegCountOptimized=293, virtualRegCountUnoptimized=1051),
            ExampleSizes("pointers/sortedlist", virtualInstrCountOptimized=267, virtualInstrCountUnoptimized=2428, virtualRegCountOptimized=118, virtualRegCountUnoptimized=1092),
            ExampleSizes("pointers/fountain-virtual", virtualInstrCountOptimized=145, virtualInstrCountUnoptimized=807, virtualRegCountOptimized=70, virtualRegCountUnoptimized=363),
            ExampleSizes("pointers/sorting", virtualInstrCountOptimized=369, virtualInstrCountUnoptimized=2273, virtualRegCountOptimized=173, virtualRegCountUnoptimized=1016)
        ),
        listOf(false, true)
    )
...
class TestCompilerOnExamplesPET32: FunSpec({
    ...
    val onlyPET32 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("petswirl", pet32SizeOptimized=909, pet32SizeUnoptimized=977),
        ),
        listOf(false, true)
    )
