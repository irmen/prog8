...
class TestCompilerOnExamplesC64: FunSpec({
    ...
    val onlyC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("cube3d-sprites", c64SizeOptimized=2664, c64SizeUnoptimized=2641),
            ...
            ExampleSizes("turtle-gfx", c64SizeOptimized=2701, c64SizeUnoptimized=2812),
...
class TestCompilerOnExamplesCx16: FunSpec({
    ...
    val onlyCx16 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pointers/fountain-cx16", cx16SizeOptimized=1266, cx16SizeUnoptimized=1605),
            ExampleSizes("amiga", cx16SizeOptimized=7618, cx16SizeUnoptimized=11623),
            ...
            ExampleSizes("balloonflight", cx16SizeOptimized=3178, cx16SizeUnoptimized=4196),
            ...
            ExampleSizes("bubbleuniverse", cx16SizeOptimized=1367, cx16SizeUnoptimized=1883),
            ...
            ExampleSizes("circles", cx16SizeOptimized=2535, cx16SizeUnoptimized=4693),
            ExampleSizes("cobramk3-cpu", cx16SizeOptimized=7608, cx16SizeUnoptimized=10327),
            ExampleSizes("cobramk3-verafx", cx16SizeOptimized=4957, cx16SizeUnoptimized=5393),
            ...
            ExampleSizes("diskspeed", cx16SizeOptimized=6111, cx16SizeUnoptimized=8085),
            ...
            ExampleSizes("kefrenbars", cx16SizeOptimized=2386, cx16SizeUnoptimized=4623),
            ExampleSizes("keyboardhandler", cx16SizeOptimized=412, cx16SizeUnoptimized=717),
            ExampleSizes("landscape", cx16SizeOptimized=1634, cx16SizeUnoptimized=1988),
            ...
            ExampleSizes("plasma", cx16SizeOptimized=1731, cx16SizeUnoptimized=2060),
            ExampleSizes("rasterbars", cx16SizeOptimized=1268, cx16SizeUnoptimized=1685),
            ExampleSizes("serialdownload", cx16SizeOptimized=2887, cx16SizeUnoptimized=4034),
            ExampleSizes("showbmx", cx16SizeOptimized=2745, cx16SizeUnoptimized=5093),
            ExampleSizes("snow", cx16SizeOptimized=3092, cx16SizeUnoptimized=5246),
            ExampleSizes("sortingbench", cx16SizeOptimized=2928, cx16SizeUnoptimized=3857),
            ExampleSizes("spotlight", cx16SizeOptimized=908, cx16SizeUnoptimized=1358),
            ...
            ExampleSizes("testmonogfx", cx16SizeOptimized=10230, cx16SizeUnoptimized=11453),
...
class TestCompilerOnExamplesBothC64andCx16: FunSpec({
    ...
    val bothCx16AndC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("boingball", c64SizeOptimized=1487, c64SizeUnoptimized=1553, cx16SizeOptimized=1463, cx16SizeUnoptimized=1944),
            ExampleSizes("cube3d", c64SizeOptimized=2360, c64SizeUnoptimized=2386, cx16SizeOptimized=2299, cx16SizeUnoptimized=2595),
            ExampleSizes("cube3d-float", c64SizeOptimized=2390, c64SizeUnoptimized=2441, cx16SizeOptimized=2283, cx16SizeUnoptimized=2606),
            ExampleSizes("cube3d-gfx", c64SizeOptimized=3468, c64SizeUnoptimized=3540, cx16SizeOptimized=2138, cx16SizeUnoptimized=2422),
            ...
            ExampleSizes("maze", c64SizeOptimized=3082, c64SizeUnoptimized=3269, cx16SizeOptimized=2862, cx16SizeUnoptimized=3243),
            ...
            ExampleSizes("multitasking", c64SizeOptimized=1900, c64SizeUnoptimized=1955, cx16SizeOptimized=1804, cx16SizeUnoptimized=2137),
            ...
            ExampleSizes("tehtriz", c64SizeOptimized=4325, c64SizeUnoptimized=4600, cx16SizeOptimized=6244, cx16SizeUnoptimized=6767),
            ExampleSizes("textelite", c64SizeOptimized=11156, c64SizeUnoptimized=12073, cx16SizeOptimized=10681, cx16SizeUnoptimized=12719),
            ExampleSizes("pointers/animalgame", c64SizeOptimized=1973, c64SizeUnoptimized=2526, cx16SizeOptimized=1998, cx16SizeUnoptimized=2804),
            ExampleSizes("pointers/binarytree", c64SizeOptimized=2676, c64SizeUnoptimized=2737, cx16SizeOptimized=2188, cx16SizeUnoptimized=2494),
            ExampleSizes("pointers/hashtable", c64SizeOptimized=3388, c64SizeUnoptimized=4215, cx16SizeOptimized=2920, cx16SizeUnoptimized=3785),
            ExampleSizes("pointers/sortedlist", c64SizeOptimized=1355, c64SizeUnoptimized=1393, cx16SizeOptimized=1302, cx16SizeUnoptimized=1613),
...
class TestCompilerOnExamplesVirtual: FunSpec({
    ...
    val onlyVirtual = cartesianProduct(
        listOf(
            ExampleSizes("bouncegfx", virtualInstrCountOptimized=219, virtualInstrCountUnoptimized=740, virtualRegCountOptimized=90, virtualRegCountUnoptimized=325),
            ExampleSizes("bsieve", virtualInstrCountOptimized=262, virtualInstrCountUnoptimized=1890, virtualRegCountOptimized=74, virtualRegCountUnoptimized=800),
            ExampleSizes("fountain", virtualInstrCountOptimized=198, virtualInstrCountUnoptimized=719, virtualRegCountOptimized=80, virtualRegCountUnoptimized=318),
            ExampleSizes("pixelshader", virtualInstrCountOptimized=84, virtualInstrCountUnoptimized=210, virtualRegCountOptimized=17, virtualRegCountUnoptimized=60),
            ExampleSizes("sincos", virtualInstrCountOptimized=334, virtualInstrCountUnoptimized=826, virtualRegCountOptimized=148, virtualRegCountUnoptimized=357),
            ExampleSizes("pointers/animalgame", virtualInstrCountOptimized=450, virtualInstrCountUnoptimized=2081, virtualRegCountOptimized=158, virtualRegCountUnoptimized=882),
            ExampleSizes("pointers/binarytree", virtualInstrCountOptimized=670, virtualInstrCountUnoptimized=2250, virtualRegCountOptimized=264, virtualRegCountUnoptimized=968),
            ExampleSizes("pointers/hashtable", virtualInstrCountOptimized=690, virtualInstrCountUnoptimized=2246, virtualRegCountOptimized=290, virtualRegCountUnoptimized=987),
            ExampleSizes("pointers/sortedlist", virtualInstrCountOptimized=419, virtualInstrCountUnoptimized=2402, virtualRegCountOptimized=133, virtualRegCountUnoptimized=1034),
            ExampleSizes("pointers/fountain-virtual", virtualInstrCountOptimized=236, virtualInstrCountUnoptimized=759, virtualRegCountOptimized=88, virtualRegCountUnoptimized=320),
            ExampleSizes("pointers/sorting", virtualInstrCountOptimized=479, virtualInstrCountUnoptimized=2181, virtualRegCountOptimized=159, virtualRegCountUnoptimized=931)
        ),
        listOf(false, true)
    )
...
class TestCompilerOnExamplesPET32: FunSpec({
    ...
    val onlyPET32 = cartesianProduct(
        listOf(
            ExampleSizes("boingball", pet32SizeOptimized=1490, pet32SizeUnoptimized=1546),
