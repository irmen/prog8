...
class TestCompilerOnExamplesCx16: FunSpec({
    ...
    val onlyCx16 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pcmaudio/play-adpcm", cx16SizeOptimized=37714, cx16SizeUnoptimized=38218),
            ExampleSizes("pcmaudio/stream-wav", cx16SizeOptimized=8026, cx16SizeUnoptimized=10249),
            ...
            ExampleSizes("snow", cx16SizeOptimized=3099, cx16SizeUnoptimized=5254),
            ...
            ExampleSizes("test_gfx_hires", cx16SizeOptimized=4819, cx16SizeUnoptimized=7441),
...
class TestCompilerOnExamplesBothC64andCx16: FunSpec({
    ...
    val bothCx16AndC64 = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pointers/sortedlist", c64SizeOptimized=1353, c64SizeUnoptimized=1393, cx16SizeOptimized=1291, cx16SizeUnoptimized=1610),
...
class TestCompilerOnExamplesVirtual: FunSpec({
    ...
    val onlyVirtual = cartesianProduct(
        listOf(
            ...
            ExampleSizes("pointers/animalgame", virtualInstrCountOptimized=437, virtualInstrCountUnoptimized=2066, virtualRegCountOptimized=158, virtualRegCountUnoptimized=882),
            ExampleSizes("pointers/binarytree", virtualInstrCountOptimized=655, virtualInstrCountUnoptimized=2233, virtualRegCountOptimized=264, virtualRegCountUnoptimized=968),
            ExampleSizes("pointers/hashtable", virtualInstrCountOptimized=677, virtualInstrCountUnoptimized=2231, virtualRegCountOptimized=290, virtualRegCountUnoptimized=987),
            ExampleSizes("pointers/sortedlist", virtualInstrCountOptimized=400, virtualInstrCountUnoptimized=2385, virtualRegCountOptimized=133, virtualRegCountUnoptimized=1034),
            ExampleSizes("pointers/fountain-virtual", virtualInstrCountOptimized=216, virtualInstrCountUnoptimized=741, virtualRegCountOptimized=88, virtualRegCountUnoptimized=320),
